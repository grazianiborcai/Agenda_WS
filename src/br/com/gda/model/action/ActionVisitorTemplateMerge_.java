...
public abstract class ActionVisitorTemplateMerge_<T extends InfoRecord, S extends InfoRecord> implements ActionVisitorEnforce<T> {
	private DeciTreeOption<S> selOption;
	private Class<S> sClazz;
	

	public ActionVisitorTemplateMerge_(Connection conn, String schemaName, Class<S> clazz) {
