...
public class CodePasswordModel extends JsonBuilder {
	...
	public JsonObject getCodeJson(String email, String password, String name) {
		...
		int randomNum = rand.nextInt((10000 - 1000) + 1) + 1000;
		 ...
		 String msgBody = "\nPrezado " + name + ",";
		 msgBody+= "\n\nPara alterar sua senha, informe o c�digo abaixo no aplicativo e ent�o estar� autorizado a definir uma nova senha.";
		 msgBody+= "\n\nC�digo: "+randomNum;
		 msgBody+= "\n\n\nAtenciosamente,";
		 msgBody+= "\n\nSuporte Mind5";
		 msgBody+= "\n\nN�o resposda esse email, caso n�o consiga redefinir sua senha entre em contato com suporte@mind5.com.br ";
...
//			email2.setSSLCheckServerIdentity(true);
			...
			email2.setSubject("[MIND5] Mudan�a de senha");
