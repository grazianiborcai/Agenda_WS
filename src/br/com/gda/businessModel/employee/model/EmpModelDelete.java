package br.com.gda.businessModel.employee.model;
...
import br.com.gda.businessModel.employee.model.decisionTree.EmpRootDelete;
...
public final class EmpModelDelete implements Model {
	...
	public EmpModelDelete(EmpInfo employeeInfo) {
		initialize();
