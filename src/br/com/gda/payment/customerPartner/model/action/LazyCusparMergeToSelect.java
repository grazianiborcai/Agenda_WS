...
public final class LazyCusparMergeToSelect extends ActionLazyTemplate<CusparInfo, CusparInfo> {

	public LazyCusparMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusparInfo> getInstanceOfActionHook(DeciTreeOption<CusparInfo> option) {
		return new StdCusparMergeToSelect(option);
	}
