...
public final class LazyCusparEnforceCodUserExt extends ActionLazyTemplate<CusparInfo, CusparInfo> {

	public LazyCusparEnforceCodUserExt(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusparInfo> getInstanceOfActionHook(DeciTreeOption<CusparInfo> option) {
		return new StdCusparEnforceCodUserExt(option);
	}
