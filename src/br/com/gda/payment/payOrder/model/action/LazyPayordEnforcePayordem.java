...
public final class LazyPayordEnforcePayordem extends ActionLazyTemplate<PayordInfo, PayordInfo> {
	
	public LazyPayordEnforcePayordem(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordEnforcePayordem(option);
	}
