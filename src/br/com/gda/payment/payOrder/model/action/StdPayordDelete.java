...
import br.com.gda.payment.payOrder.dao.PayordDelete;
import br.com.gda.payment.payOrder.info.PayordInfo;

public final class StdPayordDelete implements ActionStd<PayordInfo> {
	private ActionStd<PayordInfo> actionHelper;
	
	
	public StdPayordDelete(DeciTreeOption<PayordInfo> option) {
	...
	private DaoStmtExec<PayordInfo> buildStmtExec(DeciTreeOption<PayordInfo> option) {
		...
		return new PayordDelete(stmtExecOptions);
	}
