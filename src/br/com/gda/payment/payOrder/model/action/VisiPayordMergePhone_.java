...
final class VisiPayordMergePhone_ extends ActionVisitorTemplateMergeV2<PayordInfo, PhoneInfo> {
	
	public VisiPayordMergePhone_(Connection conn, String schemaName) {
