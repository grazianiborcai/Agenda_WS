...
public final class LazyPayordFilterLatest extends ActionLazyTemplate<PayordInfo, PayordInfo> {
	
	public LazyPayordFilterLatest(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordFilterLatest(option);
	}
