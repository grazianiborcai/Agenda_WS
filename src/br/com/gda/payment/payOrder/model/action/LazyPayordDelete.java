...
public final class LazyPayordDelete extends ActionLazyTemplate<PayordInfo, PayordInfo> {
	
	public LazyPayordDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordDelete(option);
	}
