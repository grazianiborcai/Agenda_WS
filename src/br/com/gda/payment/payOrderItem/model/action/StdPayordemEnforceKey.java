...
public final class StdPayordemEnforceKey implements ActionStd<PayordemInfo> {
	private ActionStd<PayordemInfo> actionHelper;	
	
	
	public StdPayordemEnforceKey(DeciTreeOption<PayordemInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPayordemEnforceKey());
	}
