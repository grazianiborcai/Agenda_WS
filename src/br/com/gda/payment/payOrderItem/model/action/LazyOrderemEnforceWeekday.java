...
public final class LazyOrderemEnforceWeekday extends ActionLazyTemplate<PayordemInfo, PayordemInfo> {

	public LazyOrderemEnforceWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordemInfo> getInstanceOfActionHook(DeciTreeOption<PayordemInfo> option) {
		return new StdOrderemEnforceWeekday(option);
	}
