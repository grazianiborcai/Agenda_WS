...
public final class LazyOrderemSort_ extends ActionLazyTemplate<PayordemInfo, PayordemInfo> {
	
	public LazyOrderemSort_(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordemInfo> getInstanceOfActionHook(DeciTreeOption<PayordemInfo> option) {
		return new StdOrderemSort_(option);
	}
