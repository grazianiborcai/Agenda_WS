...
public final class OrderemSelectSingle implements DaoStmt<PayordemInfo> {	
	...
	public OrderemSelectSingle(Connection conn, PayordemInfo recordInfo, String schemaName) {
	...
	private static class ResultParser implements DaoResultParser<PayordemInfo> {
		...
		@Override public List<PayordemInfo> parseResult(ResultSet stmtResult, long lastId) throws SQLException {
			...
			do {
				...
				dataInfo.codPayOrder = stmtResult.getLong(OrderemDbTableColumn.COL_COD_ORDER);
