...
public final class StdPayordmoipEnforceSubtotals implements ActionStd<PayordmoipInfo> {
	private ActionStd<PayordmoipInfo> actionHelper;	
	
	
	public StdPayordmoipEnforceSubtotals(DeciTreeOption<PayordmoipInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPayordmoipEnforceSubtotals());
	}
