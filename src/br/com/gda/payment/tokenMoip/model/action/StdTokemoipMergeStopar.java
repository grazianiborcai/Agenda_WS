...
public final class StdTokemoipMergeStopar implements ActionStd<TokemoipInfo> {
	private ActionStd<TokemoipInfo> actionHelper;	
	
	
	public StdTokemoipMergeStopar(DeciTreeOption<TokemoipInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiTokemoipMergeStopar(option.conn, option.schemaName));
	}
