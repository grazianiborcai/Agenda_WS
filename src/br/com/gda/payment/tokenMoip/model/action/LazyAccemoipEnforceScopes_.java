...
public final class LazyAccemoipEnforceScopes_ extends ActionLazyTemplate<TokemoipInfo, TokemoipInfo> {
	
	public LazyAccemoipEnforceScopes_(Connection conn, String schemaName) {
