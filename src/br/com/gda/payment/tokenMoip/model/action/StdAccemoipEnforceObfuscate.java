...
public final class StdAccemoipEnforceObfuscate implements ActionStd<TokemoipInfo> {
	private ActionStd<TokemoipInfo> actionHelper;	
	
	
	public StdAccemoipEnforceObfuscate(DeciTreeOption<TokemoipInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiAccemoipEnforceObfuscate());
	}
