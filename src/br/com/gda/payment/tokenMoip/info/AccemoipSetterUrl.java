...
public final class AccemoipSetterUrl implements InfoSetter<TokemoipInfo> {
	...
	private TokemoipInfo setUrl(TokemoipInfo recordInfo) {
	...
	private String setParamClientId(String url, TokemoipInfo recordInfo) {
		return url + "&client_id=" + recordInfo.sysparData.idPayPartnerApp;
	}
	
	
	
	private String setParamRedirectUri(String url, TokemoipInfo recordInfo) {
