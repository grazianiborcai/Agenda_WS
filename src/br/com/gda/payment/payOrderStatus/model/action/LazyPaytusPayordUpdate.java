...
public final class LazyPaytusPayordUpdate extends ActionLazyTemplate<PaytusInfo, PaytusInfo> {
	
	public LazyPaytusPayordUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaytusInfo> getInstanceOfActionHook(DeciTreeOption<PaytusInfo> option) {
		return new StdPaytusPayordUpdate(option);
	}
