...
public final class StdPaytusOrderUpdate implements ActionStd<PaytusInfo> {
	private ActionStd<PaytusInfo> actionHelper;	
	
	
	public StdPaytusOrderUpdate(DeciTreeOption<PaytusInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPaytusOrderUpdate(option.conn, option.schemaName));
	}
