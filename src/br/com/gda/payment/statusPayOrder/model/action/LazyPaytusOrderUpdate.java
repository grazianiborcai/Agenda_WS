...
public final class LazyPaytusOrderUpdate extends ActionLazyTemplate<PaytusInfo, PaytusInfo> {
	
	public LazyPaytusOrderUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaytusInfo> getInstanceOfActionHook(DeciTreeOption<PaytusInfo> option) {
		return new StdPaytusOrderUpdate(option);
	}
