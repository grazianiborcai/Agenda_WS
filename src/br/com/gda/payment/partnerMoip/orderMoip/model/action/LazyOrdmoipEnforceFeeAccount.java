...
public final class LazyOrdmoipEnforceFeeAccount extends ActionLazyTemplate<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceFeeAccount(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceFeeAccount(option);
	}
