...
public final class LazyOrdmoipEnforceMaterials extends ActionLazyTemplate<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceMaterials(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceMaterials(option);
	}
