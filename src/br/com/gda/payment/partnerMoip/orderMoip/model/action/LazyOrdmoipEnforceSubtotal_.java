...
public final class LazyOrdmoipEnforceSubtotal_ extends ActionLazyTemplate<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceSubtotal_(Connection conn, String schemaName) {
