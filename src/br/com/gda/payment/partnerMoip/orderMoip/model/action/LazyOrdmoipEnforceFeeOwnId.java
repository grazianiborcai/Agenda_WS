...
public final class LazyOrdmoipEnforceFeeOwnId extends ActionLazyTemplate<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceFeeOwnId(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceFeeOwnId(option);
	}
