...
public final class StdMultmoipPlaceFee implements ActionStd<MultmoipInfo> {
	private ActionStd<MultmoipInfo> actionHelper;	
	
	
	public StdMultmoipPlaceFee(DeciTreeOption<MultmoipInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiMultmoipPlaceFee(option.conn, option.schemaName));
	}
