...
public final class LazyMultmoipPlaceFee extends ActionLazyTemplate<MultmoipInfo, MultmoipInfo> {
	
	public LazyMultmoipPlaceFee(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MultmoipInfo> getInstanceOfActionHook(DeciTreeOption<MultmoipInfo> option) {
		return new StdMultmoipPlaceFee(option);
	}
