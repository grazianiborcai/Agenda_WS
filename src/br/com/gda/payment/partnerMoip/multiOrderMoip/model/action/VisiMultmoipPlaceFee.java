...
import br.com.gda.payment.partnerMoip.orderMoip.model.decsionTree.RootOrdmoipFee;

final class VisiMultmoipPlaceFee extends ActionVisitorTemplateAction<MultmoipInfo, OrdmoipInfo> {
	public VisiMultmoipPlaceFee(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrdmoipInfo> getActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new RootOrdmoipFee(option).toAction();
	}
