...
public final class LazyPaycusMergeToSelect extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {

	public LazyPaycusMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusMergeToSelect(option);
	}
