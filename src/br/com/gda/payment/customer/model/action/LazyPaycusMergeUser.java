...
public final class LazyPaycusMergeUser extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {

	public LazyPaycusMergeUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusMergeUser(option);
	}
