...
public final class StdPaycusMergeUsername implements ActionStd<PaycusInfo> {
	private ActionStd<PaycusInfo> actionHelper;	
	
	
	public StdPaycusMergeUsername(DeciTreeOption<PaycusInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPaycusMergeUsername(option.conn, option.schemaName));
	}
