...
public final class LazyFilupEnforceCreatedBy extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupEnforceCreatedBy(option);
	}
