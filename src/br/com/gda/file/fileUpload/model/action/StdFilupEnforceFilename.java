...
public final class StdFilupEnforceFilename implements ActionStd<FilupInfo> {
	private ActionStd<FilupInfo> actionHelper;	
	
	
	public StdFilupEnforceFilename(DeciTreeOption<FilupInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiFilupEnforceFilename());
	}
