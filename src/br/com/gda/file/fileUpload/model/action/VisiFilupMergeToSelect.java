...
final class VisiFilupMergeToSelect extends ActionVisitorTemplateMergeV2<FilupInfo, FilupInfo> {
	
	public VisiFilupMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected List<FilupInfo> mergeHook(List<FilupInfo> recordInfos, List<FilupInfo> selectedInfos) {	
		return FilupMerger.mergeToSelect(selectedInfos, recordInfos);
	}
