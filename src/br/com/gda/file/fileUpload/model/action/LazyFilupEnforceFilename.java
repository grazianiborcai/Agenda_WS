...
public final class LazyFilupEnforceFilename extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupEnforceFilename(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupEnforceFilename(option);
	}
