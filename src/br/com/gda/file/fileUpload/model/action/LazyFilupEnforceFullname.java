...
public final class LazyFilupEnforceFullname extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupEnforceFullname(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupEnforceFullname(option);
	}
