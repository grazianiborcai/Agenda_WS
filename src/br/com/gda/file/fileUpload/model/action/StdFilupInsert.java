...
import br.com.gda.file.fileUpload.dao.FilupInsert;
...
public final class StdFilupInsert implements ActionStd<FilupInfo> {
	private ActionStd<FilupInfo> actionHelper;
	
	
	public StdFilupInsert(DeciTreeOption<FilupInfo> option) {
	...
	private DaoStmtExec<FilupInfo> buildStmtExec(DeciTreeOption<FilupInfo> option) {
		...
		return new FilupInsert(stmtExecOptions);
	}
