...
public final class LazyFilupEnforceCreatedOn extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupEnforceCreatedOn(option);
	}
