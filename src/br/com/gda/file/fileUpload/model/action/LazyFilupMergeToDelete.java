...
public final class LazyFilupMergeToDelete extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupMergeToDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupMergeToDelete(option);
	}
