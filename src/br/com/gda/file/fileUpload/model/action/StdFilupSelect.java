...
import br.com.gda.file.fileUpload.dao.FilupSelect;
...
public final class StdFilupSelect implements ActionStd<FilupInfo> {
	private ActionStd<FilupInfo> actionHelper;
	
	
	public StdFilupSelect(DeciTreeOption<FilupInfo> option) {
	...
	private DaoStmtExec<FilupInfo> buildStmtExec(DeciTreeOption<FilupInfo> option) {
		...
		return new FilupSelect(stmtExecOptions);
	}
