...
public final class LazyFilupMergeFath extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupMergeFath(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupMergeFath(option);
	}
