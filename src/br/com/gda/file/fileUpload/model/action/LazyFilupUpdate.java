...
public final class LazyFilupUpdate extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupUpdate(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupUpdate(option);
	}
