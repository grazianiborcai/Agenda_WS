...
public final class StdFilupMergeUsername implements ActionStd<FilupInfo> {
	private ActionStd<FilupInfo> actionHelper;	
	
	
	public StdFilupMergeUsername(DeciTreeOption<FilupInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiFilupMergeUsername(option.conn, option.schemaName));
	}
