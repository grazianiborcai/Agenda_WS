...
public final class LazyFilupInsert extends ActionLazyTemplate<FilupInfo, FilupInfo> {
	
	public LazyFilupInsert(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<FilupInfo> getInstanceOfActionHook(DeciTreeOption<FilupInfo> option) {
		return new StdFilupInsert(option);
	}
