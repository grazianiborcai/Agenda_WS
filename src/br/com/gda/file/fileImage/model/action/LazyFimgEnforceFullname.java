...
public final class LazyFimgEnforceFullname extends ActionLazyTemplate<FimgInfo, FimgInfo> {
	
	public LazyFimgEnforceFullname(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgEnforceFullname(option);
	}
