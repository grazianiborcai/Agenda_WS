...
public abstract class InfoMergerTemplate<T extends InfoRecord, K extends InfoRecord> implements InfoMerger<T, K> {	
	...
	@Override public List<T> merge(List<K> sourceOnes, List<T> sourceTwos) {
		InfoMergerVisitor<T,K,T> visitor = getVisitorHook();
	...
	protected InfoMergerVisitor<T,K,T> getVisitorHook() {
	...
	private List<T> write(List<K> sourceOnes, List<T> sourceTwos, InfoMergerVisitor<T,K,T> visitor) {
	...
	private T write(K sourceOne, T sourceTwo, InfoMergerVisitor<T,K,T> visitor) {
		try {
	...
	private T tryTowrite(K sourceOne, T sourceTwo, InfoMergerVisitor<T,K,T> visitor) {
	...
	private void checkArgument(K sourceOne, T sourceTwo, InfoMergerVisitor<T,K,T> visitor) {
		if (sourceOne == null) {
