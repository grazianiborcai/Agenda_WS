...
final class EmpStmtSelect implements SqlStmt<EmpInfo> {
	private final String LEFT_TABLE_EMPLOYEE = EmpDbTable.EMPLOYEE_TABLE;	
	private final String RIGHT_TABLE_GENDER_TEXT = EmpDbTable.GENDER_TEXT_TABLE;
	private final String RIGHT_TABLE_POSITION_TEXT = EmpDbTable.POSITION_TEXT_TABLE;
	private final String RIGHT_TABLE_COUNTRY_TEXT = EmpDbTable.COUNTRY_TEXT_TABLE;
	...
	private void buildStmtOption(Connection conn, EmpInfo recordInfo, String schemaName) {
		...
		this.stmtOption.columns = EmpDbTableColumn.getTableColumnsAsList(LEFT_TABLE_EMPLOYEE);
	...
	private static class ResultParser implements SqlResultParser<EmpInfo> {
		...
		private final String GENDER_TEXT_COLUMN = EmpDbTable.GENDER_TEXT_TABLE + "." + "Name";
		private final String POSITION_TEXT_COLUMN = EmpDbTable.POSITION_TEXT_TABLE + "." + "Name";
		private final String COUNTRY_TEXT_COLUMN = EmpDbTable.COUNTRY_TEXT_TABLE + "." + "Name";
