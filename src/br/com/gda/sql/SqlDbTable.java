...
public final class SqlDbTable {	
	...
	public static final String EMPLOYEE_LEAVE_DATE_TABLE = "employee_leave_time";
	...
	public static final String MATERIAL_UNIT_TABLE = "measure_unit";
	public static final String MATERIAL_UNIT_TEXT_TABLE = "measure_unit_text";
	public static final String STORE_TABLE = "store";
	public static final String MATERIAL_TABLE = "material";
	public static final String MATERIAL_TEXT_TABLE = "material_text";
	public static final String MATERIAL_TYPE_TABLE = "type";
	public static final String MATERIAL_TYPE_TEXT_TABLE = "type_text";	
	public static final String MATERIAL_CATEGORY_TABLE = "category";
	public static final String MATERIAL_CATEGORY_TEXT_TABLE = "category_text";
	...
	public static final String MATERIAL_GROUP_TABLE = "material_group";
	public static final String MATERIAL_GROUP_TEXT_TABLE = "material_group_text";
