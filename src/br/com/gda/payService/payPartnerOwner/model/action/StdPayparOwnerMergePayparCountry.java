...
public final class StdPayparOwnerMergePayparCountry implements ActionStd<PayparOwnerInfo> {
	private ActionStd<PayparOwnerInfo> actionHelper;	
	
	
	public StdPayparOwnerMergePayparCountry(DeciTreeOption<PayparOwnerInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPayparOwnerMergePayparCountry(option.conn, option.schemaName));
	}
