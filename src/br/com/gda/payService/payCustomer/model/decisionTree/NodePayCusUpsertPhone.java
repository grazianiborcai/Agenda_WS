...
import br.com.gda.payService.payCustomer.model.action.StdPayCusUpsertPhone;
import br.com.gda.payService.payCustomer.model.checker.PayCusCheckHasPhone;

public final class NodePayCusUpsertPhone implements DeciTree<PayCusInfo> {
	private DeciTree<PayCusInfo> tree;
	
	
	public NodePayCusUpsertPhone(DeciTreeOption<PayCusInfo> option) {
	...
	private List<ActionStd<PayCusInfo>> buildActionsOnPassed(DeciTreeOption<PayCusInfo> option) {
		...
		actions.add(new StdPayCusUpsertPhone(option));		
		return actions;
	}
