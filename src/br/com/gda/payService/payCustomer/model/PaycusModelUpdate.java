...
import br.com.gda.payService.payCustomer.model.decisionTree.RootPaycusUpdate;

public final class PaycusModelUpdate implements Model {
	...
	private static class TreeFactory implements DeciTreeFactory<PaycusInfo> {		
		@Override public DeciTree<PaycusInfo> getInstance(DeciTreeOption<PaycusInfo> option) {
			return new RootPaycusUpdate(option);
		}			
	}
}
