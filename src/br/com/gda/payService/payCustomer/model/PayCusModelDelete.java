...
import br.com.gda.payService.payCustomer.model.decisionTree.RootPayCusDelete;

public final class PayCusModelDelete implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public PayCusModelDelete(PayCusInfo recordInfo) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<PayCusInfo> {		
		@Override public DeciTree<PayCusInfo> getInstance(DeciTreeOption<PayCusInfo> option) {
			return new RootPayCusDelete(option);
		}		
	}
}
