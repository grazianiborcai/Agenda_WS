...
public final class LazyPaycusDelete extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {
	
	public LazyPaycusDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusDelete(option);
	}
