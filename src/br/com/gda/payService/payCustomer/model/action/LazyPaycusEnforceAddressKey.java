...
public final class LazyPaycusEnforceAddressKey extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {
	
	public LazyPaycusEnforceAddressKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusEnforceAddressKey(option);
	}
