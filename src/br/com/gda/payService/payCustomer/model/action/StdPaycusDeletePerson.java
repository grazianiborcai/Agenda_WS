...
public final class StdPaycusDeletePerson implements ActionStd<PaycusInfo> {
	private ActionStd<PaycusInfo> actionHelper;	
	
	
	public StdPaycusDeletePerson(DeciTreeOption<PaycusInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiPaycusDeletePerson(option.conn, option.schemaName));
	}
