...
public final class LazyPayCusDeleteAddress extends ActionLazyTemplate<PayCusInfo, PayCusInfo> {
	
	public LazyPayCusDeleteAddress(Connection conn, String schemaName) {
