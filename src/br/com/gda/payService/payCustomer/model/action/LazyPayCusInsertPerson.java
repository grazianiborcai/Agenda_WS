...
public final class LazyPayCusInsertPerson extends ActionLazyTemplate<PayCusInfo, PayCusInfo> {
	
	public LazyPayCusInsertPerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayCusInfo> getInstanceOfActionHook(DeciTreeOption<PayCusInfo> option) {
		return new StdPayCusInsertPerson(option);
	}
