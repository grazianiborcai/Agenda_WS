...
public final class StdPaycusUpsertAddress implements ActionStd<PaycusInfo> {
	private ActionStd<PaycusInfo> actionHelper;	
	
	
	public StdPaycusUpsertAddress(DeciTreeOption<PaycusInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiPaycusUpsertAddress(option.conn, option.schemaName));
	}
