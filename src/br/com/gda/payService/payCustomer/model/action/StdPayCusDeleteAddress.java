...
public final class StdPayCusDeleteAddress implements ActionStd<PayCusInfo> {
	private ActionStd<PayCusInfo> actionHelper;	
	
	
	public StdPayCusDeleteAddress(DeciTreeOption<PayCusInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiPasCusDeleteAddress(option.conn, option.schemaName));
	}
