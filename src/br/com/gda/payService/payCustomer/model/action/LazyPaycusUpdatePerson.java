...
public final class LazyPaycusUpdatePerson extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {
	
	public LazyPaycusUpdatePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusUpdatePerson(option);
	}
