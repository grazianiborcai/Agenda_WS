...
import br.com.gda.payService.payCustomer.dao.PayCusDelete;
import br.com.gda.payService.payCustomer.info.PayCusInfo;

public final class StdPayCusDelete implements ActionStd<PayCusInfo> {
	private ActionStd<PayCusInfo> actionHelper;
	
	
	public StdPayCusDelete(DeciTreeOption<PayCusInfo> option) {
	...
	private DaoStmtExec<PayCusInfo> buildStmtExec(DeciTreeOption<PayCusInfo> option) {
		...
		return new PayCusDelete(stmtExecOptions);
	}
