...
public final class LazyPayCusEnforceEntityCateg extends ActionLazyTemplate<PayCusInfo, PayCusInfo> {
	
	public LazyPayCusEnforceEntityCateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayCusInfo> getInstanceOfActionHook(DeciTreeOption<PayCusInfo> option) {
		return new StdPayCusEnforceEntityCateg(option);
	}
