...
public final class LazyPayCusEnforcePersonKey extends ActionLazyTemplate<PayCusInfo, PayCusInfo> {
	
	public LazyPayCusEnforcePersonKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayCusInfo> getInstanceOfActionHook(DeciTreeOption<PayCusInfo> option) {
		return new StdPayCusEnforcePersonKey(option);
	}
