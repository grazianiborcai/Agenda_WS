...
public final class LazyPayCusDeletePhone_ extends ActionLazyTemplate<PayCusInfo, PayCusInfo> {
	
	public LazyPayCusDeletePhone_(Connection conn, String schemaName) {
