...
public final class LazyPaycusDeletePerson extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {
	
	public LazyPaycusDeletePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusDeletePerson(option);
	}
