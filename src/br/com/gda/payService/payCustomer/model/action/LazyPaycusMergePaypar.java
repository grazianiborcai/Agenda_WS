...
public final class LazyPaycusMergePaypar extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {
	
	public LazyPaycusMergePaypar(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusMergePaypar(option);
	}
