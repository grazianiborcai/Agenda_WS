...
import br.com.gda.payService.payCustomer.dao.PaycusSelect;
import br.com.gda.payService.payCustomer.info.PaycusInfo;

public final class StdPaycusSelect implements ActionStd<PaycusInfo> {
	private ActionStd<PaycusInfo> actionHelper;
	
	
	public StdPaycusSelect(DeciTreeOption<PaycusInfo> option) {
	...
	private DaoStmtExec<PaycusInfo> buildStmtExec(DeciTreeOption<PaycusInfo> option) {
		...
		return new PaycusSelect(stmtExecOptions);
	}
