...
public final class StdPayCusUpsertPhone implements ActionStd<PayCusInfo> {
	private ActionStd<PayCusInfo> actionHelper;	
	
	
	public StdPayCusUpsertPhone(DeciTreeOption<PayCusInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiPayCusUpsertPhone(option.conn, option.schemaName));
	}
