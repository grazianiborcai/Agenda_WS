...
import br.com.gda.payService.payCustomer.model.decisionTree.NodePaycusUpsertAddress;

public final class LazyPaycusNodeUpsertAddress extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {
	
	public LazyPaycusNodeUpsertAddress(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new NodePaycusUpsertAddress(option).toAction();
	}
