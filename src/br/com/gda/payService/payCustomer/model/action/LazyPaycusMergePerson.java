...
public final class LazyPaycusMergePerson extends ActionLazyTemplate<PaycusInfo, PaycusInfo> {
	
	public LazyPaycusMergePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PaycusInfo> getInstanceOfActionHook(DeciTreeOption<PaycusInfo> option) {
		return new StdPaycusMergePerson(option);
	}
