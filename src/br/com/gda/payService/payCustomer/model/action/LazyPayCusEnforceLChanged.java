...
public final class LazyPayCusEnforceLChanged extends ActionLazyTemplate<PayCusInfo, PayCusInfo> {
	
	public LazyPayCusEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayCusInfo> getInstanceOfActionHook(DeciTreeOption<PayCusInfo> option) {
		return new StdPayCusEnforceLChanged(option);
	}
