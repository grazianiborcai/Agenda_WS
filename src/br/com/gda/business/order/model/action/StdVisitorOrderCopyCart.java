...
final class StdVisitorOrderCopyCart implements ActionVisitor<OrderInfo> {
	private DeciTreeOption<CartInfo> selOption;
	
	//TODO: Tornar um Template ?
	public StdVisitorOrderCopyCart(Connection conn, String schemaName) {
