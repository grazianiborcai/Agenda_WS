...
public final class LazyOrderMergeMatSnap extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderMergeMatSnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeMatSnap(option);
	}
