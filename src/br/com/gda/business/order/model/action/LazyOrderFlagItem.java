...
public final class LazyOrderFlagItem extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderFlagItem(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderFlagItem(option);
	}
