...
final class StdVisitorOrderMergeEmp extends ActionVisitorTemplateMerge<OrderInfo, EmpInfo> {
	
	public StdVisitorOrderMergeEmp(Connection conn, String schemaName) {
