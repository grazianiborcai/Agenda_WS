...
public final class LazyOrderUpsertCartem extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderUpsertCartem(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderUpsertCartem(option);
	}
