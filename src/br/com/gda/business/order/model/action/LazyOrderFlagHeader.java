...
public final class LazyOrderFlagHeader extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderFlagHeader(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderFlagHeader(option);
	}
