...
public final class LazyOrderMergeEmp extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderMergeEmp(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeEmp(option);
	}
