...
public final class LazyOrderMergeCartem extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderMergeCartem(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeCartem(option);
	}
