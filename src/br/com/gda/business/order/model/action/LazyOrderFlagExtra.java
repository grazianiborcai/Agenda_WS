...
public final class LazyOrderFlagExtra extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderFlagExtra(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderFlagExtra(option);
	}
