...
public final class LazyOrderFilterItm extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderFilterItm(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderFilterItm(option);
	}
