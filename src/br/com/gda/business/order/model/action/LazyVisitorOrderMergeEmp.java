...
final class LazyVisitorOrderMergeEmp extends ActionVisitorTemplateMerge<OrderInfo, EmpInfo> {
	
	public LazyVisitorOrderMergeEmp(Connection conn, String schemaName) {
