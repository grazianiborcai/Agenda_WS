...
public final class LazyOrderMergeCus extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderMergeCus(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeCus(option);
	}
