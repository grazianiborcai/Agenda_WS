...
final class LazyVisitorOrderMergeMat extends ActionVisitorTemplateMerge<OrderInfo, MatInfo> {
	
	public LazyVisitorOrderMergeMat(Connection conn, String schemaName) {
