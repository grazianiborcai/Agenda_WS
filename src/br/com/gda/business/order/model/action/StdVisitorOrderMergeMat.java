...
final class StdVisitorOrderMergeMat extends ActionVisitorTemplateMerge<OrderInfo, MatInfo> {
	
	public StdVisitorOrderMergeMat(Connection conn, String schemaName) {
