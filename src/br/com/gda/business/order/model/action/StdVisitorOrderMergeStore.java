...
final class StdVisitorOrderMergeStore extends ActionVisitorTemplateMerge<OrderInfo, StoreInfo> {
	
	public StdVisitorOrderMergeStore(Connection conn, String schemaName) {
