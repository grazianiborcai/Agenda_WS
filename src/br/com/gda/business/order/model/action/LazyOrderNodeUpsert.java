...
import br.com.gda.business.order.model.decisionTree.NodeOrderUpsert;
import br.com.gda.model.action.ActionStd;
import br.com.gda.model.action.ActionLazyTemplate;
import br.com.gda.model.decisionTree.DeciResult;
import br.com.gda.model.decisionTree.DeciTreeOption;

public final class LazyOrderNodeUpsert extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderNodeUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new NodeOrderUpsert(option).toAction();
	}
