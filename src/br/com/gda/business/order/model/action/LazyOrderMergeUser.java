...
public final class LazyOrderMergeUser extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderMergeUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeUser(option);
	}
