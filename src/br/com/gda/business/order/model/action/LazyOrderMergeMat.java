...
public final class LazyOrderMergeMat extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderMergeMat(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeMat(option);
	}
