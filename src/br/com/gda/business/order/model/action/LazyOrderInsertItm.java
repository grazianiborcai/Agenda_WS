...
public final class LazyOrderInsertItm extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderInsertItm(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderInsertItm(option);
	}
