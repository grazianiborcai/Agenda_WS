...
public final class LazyOrderMergeStore extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderMergeStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeStore(option);
	}
