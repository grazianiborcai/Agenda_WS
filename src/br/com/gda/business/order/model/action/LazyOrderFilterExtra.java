...
public final class LazyOrderFilterExtra extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderFilterExtra(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderFilterExtra(option);
	}
