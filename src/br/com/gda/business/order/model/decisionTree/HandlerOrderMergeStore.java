...
final class HandlerOrderMergeStore extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {
	
	public HandlerOrderMergeStore(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderMergeStore(option);
	}
