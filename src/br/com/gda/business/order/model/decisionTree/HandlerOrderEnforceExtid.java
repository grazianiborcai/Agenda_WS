...
final class HandlerOrderEnforceExtid extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {

	public HandlerOrderEnforceExtid(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderEnforceExtid(option);
	}
