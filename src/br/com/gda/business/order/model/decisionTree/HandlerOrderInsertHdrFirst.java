...
final class HandlerOrderInsertHdrFirst extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {
	
	public HandlerOrderInsertHdrFirst(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderInsertHdrFirst(option);
	}
