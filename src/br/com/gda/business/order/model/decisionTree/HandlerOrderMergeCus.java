...
final class HandlerOrderMergeCus extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {
	
	public HandlerOrderMergeCus(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderMergeCus(option);
	}
