...
final class HandlerOrderEnforceLChanged extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {

	public HandlerOrderEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderEnforceLChanged(option);
	}
