...
final class HandlerOrderInsertHdr extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {
	
	public HandlerOrderInsertHdr(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderInsertHdr(option);
	}
