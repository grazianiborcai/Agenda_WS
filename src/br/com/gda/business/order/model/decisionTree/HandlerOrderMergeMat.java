...
final class HandlerOrderMergeMat extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {
	
	public HandlerOrderMergeMat(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderMergeMat(option);
	}
