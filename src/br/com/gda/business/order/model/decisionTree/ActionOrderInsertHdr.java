...
import br.com.gda.business.order.dao.OrderInsertHdr;
...
final class ActionOrderInsertHdr implements DeciAction<OrderInfo> {
	private DeciAction<OrderInfo> actionHelper;
	
	
	public ActionOrderInsertHdr(DeciTreeOption<OrderInfo> option) {
	...
	private DaoStmtExec<OrderInfo> buildStmtExec(DeciTreeOption<OrderInfo> option) {
		...
		return new OrderInsertHdr(stmtExecOptions);
	}
