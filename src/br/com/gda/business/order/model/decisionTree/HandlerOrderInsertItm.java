...
final class HandlerOrderInsertItm extends DeciActionHandlerTemplate<OrderInfo, OrderInfo> {
	
	public HandlerOrderInsertItm(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new ActionOrderInsertItm(option);
	}
