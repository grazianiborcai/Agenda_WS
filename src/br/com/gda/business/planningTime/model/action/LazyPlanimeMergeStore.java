...
public final class LazyPlanimeMergeStore extends ActionLazyTemplate<PlanimeInfo, PlanimeInfo> {

	public LazyPlanimeMergeStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PlanimeInfo> getInstanceOfActionHook(DeciTreeOption<PlanimeInfo> option) {
		return new StdPlanimeMergeStore(option);
	}
