...
public final class LazyAddressFilterNew extends ActionLazyTemplate<AddressInfo, AddressInfo> {
	
	public LazyAddressFilterNew(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressFilterNew(option);
	}
