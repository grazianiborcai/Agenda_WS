...
public final class StdAddressMergeToDelete implements ActionStd<AddressInfo> {
	private ActionStd<AddressInfo> actionHelper;	
	
	
	public StdAddressMergeToDelete(DeciTreeOption<AddressInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiAddressMergeToDelete(option.conn, option.schemaName));
	}
