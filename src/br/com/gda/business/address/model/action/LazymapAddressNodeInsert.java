...
public final class LazymapAddressNodeInsert extends ActionLazyTemplate<AddressInfo, AddressInfo> {

	public LazymapAddressNodeInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new MapAddressNodeInsert(option);
	}
