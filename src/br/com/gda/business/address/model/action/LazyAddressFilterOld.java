...
public final class LazyAddressFilterOld extends ActionLazyTemplate<AddressInfo, AddressInfo> {
	
	public LazyAddressFilterOld(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressFilterOld(option);
	}
