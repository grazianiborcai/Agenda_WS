...
public final class VisimapAddressMergeForm extends ActionVisitorTemplateAction<AddressInfo, AddressInfo> {
	public VisimapAddressMergeForm(Connection conn, String schemaName) {
