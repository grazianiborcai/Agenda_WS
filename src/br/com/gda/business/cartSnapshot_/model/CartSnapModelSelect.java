package br.com.gda.business.cartSnapshot_.model;
...
public final class CartSnapModelSelect implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public CartSnapModelSelect(CartSnapInfo recordInfo) {
		initialize();
	...
	private void buildHelper(CartSnapInfo recordInfo) {
	...
	private static class TreeFactory implements DeciTreeFactory<CartSnapInfo> {		
		@Override public DeciTree<CartSnapInfo> getInstance(DeciTreeOption<CartSnapInfo> option) {
			return new RootCartSnapSelect(option);
		}		
	}
}
