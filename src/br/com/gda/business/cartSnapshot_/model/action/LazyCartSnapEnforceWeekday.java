...
public final class LazyCartSnapEnforceWeekday extends ActionLazyTemplate<CartSnapInfo, CartSnapInfo> {

	public LazyCartSnapEnforceWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartSnapInfo> getInstanceOfActionHook(DeciTreeOption<CartSnapInfo> option) {
		return new StdCartSnapEnforceWeekday(option);
	}
