...
import br.com.gda.business.cartSnapshot_.dao.CartSnapSelect;
...
public final class StdCartSnapSelect implements ActionStd<CartSnapInfo> {
	private ActionStd<CartSnapInfo> actionHelper;
	
	
	public StdCartSnapSelect(DeciTreeOption<CartSnapInfo> option) {
	...
	private DaoStmtExec<CartSnapInfo> buildStmtExec(DeciTreeOption<CartSnapInfo> option) {
		...
		return new CartSnapSelect(stmtExecOptions);
	}
