...
import br.com.gda.business.cartSnapshot_.model.decisionTree.NodeCartSnapSelectFee;
import br.com.gda.model.action.ActionLazyTemplate;
import br.com.gda.model.decisionTree.DeciResult;
import br.com.gda.model.decisionTree.DeciTreeOption;

public final class LazyCartSnapNodeSelectFee extends ActionLazyTemplate<CartSnapInfo, CartSnapInfo> {
	
	public LazyCartSnapNodeSelectFee(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartSnapInfo> getInstanceOfActionHook(DeciTreeOption<CartSnapInfo> option) {
		return new NodeCartSnapSelectFee(option).toAction();
	}
