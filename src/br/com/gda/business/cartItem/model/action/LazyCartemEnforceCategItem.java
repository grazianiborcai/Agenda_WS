...
public final class LazyCartemEnforceCategItem extends ActionLazyTemplate<CartemInfo, CartemInfo> {

	public LazyCartemEnforceCategItem(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartemInfo> getInstanceOfActionHook(DeciTreeOption<CartemInfo> option) {
		return new StdCartemEnforceItmCategItem(option);
	}
