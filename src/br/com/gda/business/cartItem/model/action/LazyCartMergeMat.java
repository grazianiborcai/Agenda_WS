...
public final class LazyCartMergeMat extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeMat(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeMat(option);
	}
