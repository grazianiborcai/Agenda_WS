...
import br.com.gda.business.cartItem.dao.CartInsertItm;
...
final class StdCartInsertItm implements ActionStd<CartInfo> {
	private ActionStd<CartInfo> actionHelper;
	
	
	public StdCartInsertItm(DeciTreeOption<CartInfo> option) {
