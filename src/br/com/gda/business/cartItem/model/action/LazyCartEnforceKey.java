...
public final class LazyCartEnforceKey extends ActionLazyTemplate<CartInfo, CartInfo> {

	public LazyCartEnforceKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartEnforceKey(option);
	}
