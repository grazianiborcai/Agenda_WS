...
public final class LazyCartEnforceItmCategItem extends ActionLazyTemplate<CartInfo, CartInfo> {

	public LazyCartEnforceItmCategItem(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartEnforceItmCategItem(option);
	}
