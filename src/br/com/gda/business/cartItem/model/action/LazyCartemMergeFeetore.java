...
public final class LazyCartemMergeFeetore extends ActionLazyTemplate<CartemInfo, CartemInfo> {
	
	public LazyCartemMergeFeetore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartemInfo> getInstanceOfActionHook(DeciTreeOption<CartemInfo> option) {
		return new StdCartemMergeFeetore(option);
	}
