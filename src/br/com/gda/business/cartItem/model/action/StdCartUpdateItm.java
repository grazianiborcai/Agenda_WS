...
import br.com.gda.business.cartItem.dao.CartUpdateItm;
...
public final class StdCartUpdateItm implements ActionStd<CartInfo> {
	private ActionStd<CartInfo> actionHelper;
	
	
	public StdCartUpdateItm(DeciTreeOption<CartInfo> option) {
	...
	private DaoStmtExec<CartInfo> buildStmtExec(DeciTreeOption<CartInfo> option) {
		...
		return new CartUpdateItm(stmtExecOptions);
	}
