...
public final class MultiCartemAddFee extends ActionMultiTemplate<CartemInfo> {
	static private final int TRIGGER_SIZE = 2;
	

	public MultiCartemAddFee(Connection conn, String schemaName) {
