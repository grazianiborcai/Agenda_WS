...
public final class LazyCartemFlagFee extends ActionLazyTemplate<CartemInfo, CartemInfo> {
	
	public LazyCartemFlagFee(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartemInfo> getInstanceOfActionHook(DeciTreeOption<CartemInfo> option) {
		return new StdCartemFlagFee(option);
	}
