...
public final class LazyCartemMergeFeeDefault extends ActionLazyTemplate<CartemInfo, CartemInfo> {
	
	public LazyCartemMergeFeeDefault(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartemInfo> getInstanceOfActionHook(DeciTreeOption<CartemInfo> option) {
		return new StdCartemMergeFeeDefault(option);
	}
