...
public final class LazyCartemEnforceItmNum extends ActionLazyTemplate<CartemInfo, CartemInfo> {
	
	public LazyCartemEnforceItmNum(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartemInfo> getInstanceOfActionHook(DeciTreeOption<CartemInfo> option) {
		return new StdCartemEnforceItmNum(option);
	}
