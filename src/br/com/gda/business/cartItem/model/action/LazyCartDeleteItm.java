...
public final class LazyCartDeleteItm extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartDeleteItm(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartDeleteItm(option);
	}
