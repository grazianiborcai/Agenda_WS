...
import br.com.gda.business.storeEmployee.model.decisionTree.RootStoreEmpSelect;
...
public final class StoreEmpModelSelect implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public StoreEmpModelSelect(StoreEmpInfo recordInfo) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<StoreEmpInfo> {		
		@Override public DeciTree<StoreEmpInfo> getInstance(DeciTreeOption<StoreEmpInfo> option) {
			return new RootStoreEmpSelect(option);
		}		
