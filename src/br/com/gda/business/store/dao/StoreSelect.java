...
public final class StoreSelect implements SqlStmt<StoreInfo> {
	...
	public StoreSelect(Connection conn, StoreInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<StoreInfo> getNewInstance() {
		return new StoreSelect(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
