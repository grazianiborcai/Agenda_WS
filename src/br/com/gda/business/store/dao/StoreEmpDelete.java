...
public final class StoreEmpDelete implements SqlStmt<StoreEmpInfo> {
	private SqlStmt<StoreEmpInfo> stmtSql;
	private SqlStmtOption<StoreEmpInfo> stmtOption;	
	
	
	public StoreEmpDelete(Connection conn, StoreEmpInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<StoreEmpInfo> getNewInstance() {
		return new StoreEmpDelete(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
