...
final class StoreStmtInsert implements SqlStmt<StoreInfo> {
	private SqlStmt<StoreInfo> stmtSql;
	private SqlStmtOption<StoreInfo> stmtOption;
	
	
	
	public StoreStmtInsert(Connection conn, StoreInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<StoreInfo> getNewInstance() {
		return new StoreStmtInsert(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
