...
public final class StoreEmpInsert implements SqlStmt<StoreEmpInfo> {
	private SqlStmt<StoreEmpInfo> stmtSql;
	private SqlStmtOption<StoreEmpInfo> stmtOption;
	
	
	
	public StoreEmpInsert(Connection conn, StoreEmpInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<StoreEmpInfo> getNewInstance() {
		return new StoreEmpInsert(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
