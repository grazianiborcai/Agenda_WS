...
public class StoreEmpStmtExecSelect implements SqlStmtExec<StoreEmpInfo> {
	private List<SqlStmt<StoreEmpInfo>> sqlStatements;
	private SqlStmtExec<StoreEmpInfo> helper;
	
	
	public StoreEmpStmtExecSelect(List<SqlStmtExecOption<StoreEmpInfo>> options) {
		if (options == null) 
	...
	private void prepareStatement(List<SqlStmtExecOption<StoreEmpInfo>> options) {
		...
		for (SqlStmtExecOption<StoreEmpInfo> eachOption : options) {
			SqlStmt<StoreEmpInfo> sqlStatement = new StoreEmpStmtSelect(eachOption.conn, eachOption.recordInfo, eachOption.schemaName);
