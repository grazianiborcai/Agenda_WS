...
public final class StoreUpdate implements SqlStmt<StoreInfo> {
	private SqlStmt<StoreInfo> stmtSql;
	private SqlStmtOption<StoreInfo> stmtOption;
	
	
	public StoreUpdate(Connection conn, StoreInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<StoreInfo> getNewInstance() {
		return new StoreUpdate(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
