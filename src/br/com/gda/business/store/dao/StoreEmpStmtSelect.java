...
final class StoreEmpStmtSelect implements SqlStmt<StoreEmpInfo> {	
	...
	public StoreEmpStmtSelect(Connection conn, StoreEmpInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<StoreEmpInfo> getNewInstance() {
		return new StoreEmpStmtSelect(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
