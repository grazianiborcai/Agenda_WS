...
public final class StoreEmpStmtUpdate implements SqlStmt<StoreEmpInfo> {
	private SqlStmt<StoreEmpInfo> stmtSql;
	private SqlStmtOption<StoreEmpInfo> stmtOption;
	
	
	public StoreEmpStmtUpdate(Connection conn, StoreEmpInfo recordInfo, String schemaName) {
	...
	private String buildWhereClause() {
		...
		StoreEmpStmtWhere whereClause = new StoreEmpStmtWhere(whereOption, stmtOption.tableName, stmtOption.recordInfo);
	...
	@Override public SqlStmt<StoreEmpInfo> getNewInstance() {
		return new StoreEmpStmtUpdate(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
