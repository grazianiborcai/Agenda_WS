...
final class StoreEmpStmtDelete implements SqlStmt<StoreEmpInfo> {
	private SqlStmt<StoreEmpInfo> stmtSql;
	private SqlStmtOption<StoreEmpInfo> stmtOption;	
	
	
	public StoreEmpStmtDelete(Connection conn, StoreEmpInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<StoreEmpInfo> getNewInstance() {
		return new StoreEmpStmtDelete(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
