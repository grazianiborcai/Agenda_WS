...
import br.com.gda.business.store.dao.StoreEmpInsertExec;
...
public final class ActionStoreEmpInsert implements DeciAction<StoreEmpInfo> {
	...
	private SqlStmtExec<StoreEmpInfo> buildStmtExec(DeciTreeOption<StoreEmpInfo> option) {
		...
		return new StoreEmpInsertExec(stmtExecOptions);
	}
