...
import br.com.gda.business.store.dao.StoreInsertExec;
...
public final class ActionStoreInsert implements DeciAction<StoreInfo> {
	...
	private SqlStmtExec<StoreInfo> buildStmtExec(DeciTreeOption<StoreInfo> option) {
		...
		return new StoreInsertExec(stmtExecOptions);
	}
