...
import br.com.gda.business.store.model.action.LazyStoreInsertPhone;
...
public final class NodeStoreInsertPhone extends DeciTreeWriteTemplate<StoreInfo> {
	
	public NodeStoreInsertPhone(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> insertPhone = new LazyStoreInsertPhone(option.conn, option.schemaName);	
