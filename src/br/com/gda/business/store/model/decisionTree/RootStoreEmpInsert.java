...
import br.com.gda.business.store.model.checker.StoreEmpCheckEmp;
import br.com.gda.business.store.model.checker.StoreEmpCheckEmpPos;
import br.com.gda.business.store.model.checker.StoreEmpCheckExist;
import br.com.gda.business.store.model.checker.StoreEmpCheckStore;
...
public final class RootStoreEmpInsert implements DeciTree<StoreEmpInfo> {
	...
	private static class ActionNodeInsert implements DeciAction<StoreEmpInfo> {
		...
		public ActionNodeInsert(DeciTreeOption<StoreEmpInfo> option) {
			treeHelper = new NodeStoreEmpInsert(option);
		}
