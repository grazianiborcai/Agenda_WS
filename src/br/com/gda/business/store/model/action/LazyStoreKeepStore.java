...
public final class LazyStoreKeepStore extends ActionLazyTemplate<StoreInfo, StoreInfo> {
	
	public LazyStoreKeepStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreKeepStore(option);
	}
