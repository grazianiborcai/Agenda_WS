...
public final class LazyCusEnforcePhoneKey extends ActionLazyTemplate<CusInfo, CusInfo> {
	
	public LazyCusEnforcePhoneKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusEnforcePhoneKey(option);
	}
