...
public final class LazyCusInsertUser extends ActionLazyTemplate<CusInfo, CusInfo> {
	
	public LazyCusInsertUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusInsertUser(option);
	}
