...
public final class LazyCusMergePersonUser extends ActionLazyTemplate<CusInfo, CusInfo> {
	
	public LazyCusMergePersonUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusMergePersonUser(option);
	}
