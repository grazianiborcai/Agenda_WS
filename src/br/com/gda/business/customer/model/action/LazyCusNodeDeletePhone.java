...
import br.com.gda.business.customer.model.decisionTree.NodeCusDeletePhone;
import br.com.gda.model.action.ActionStd;
import br.com.gda.model.action.ActionLazyTemplate;
import br.com.gda.model.decisionTree.DeciResult;
import br.com.gda.model.decisionTree.DeciTreeOption;

public final class LazyCusNodeDeletePhone extends ActionLazyTemplate<CusInfo, CusInfo> {
	...
	@Override protected ActionStd<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new NodeCusDeletePhone(option).toAction();
	}
