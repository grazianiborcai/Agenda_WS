...
public final class LazyCusEnforceAddressKey extends ActionLazyTemplate<CusInfo, CusInfo> {
	
	public LazyCusEnforceAddressKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusEnforceAddressKey(option);
	}
