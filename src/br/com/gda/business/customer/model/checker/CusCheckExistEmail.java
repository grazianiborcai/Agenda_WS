...
import br.com.gda.business.customer.model.decisionTree.ActionCusEnforceEmail;
...
public final class CusCheckExistEmail extends ModelCheckerTemplateSimple<CusInfo> {
	...
	private void buildAction(CusInfo recordInfo, Connection conn, String schemaName) {
		...
		actionSelect = new ActionCusEnforceEmail(option);
	...
	@Override protected String makeFailureExplanationHook(boolean checkerResult) {		
		if (makeFailureCodeHook(checkerResult) == SystemCode.CUS_EMAIL_ALREADY_EXIST)
