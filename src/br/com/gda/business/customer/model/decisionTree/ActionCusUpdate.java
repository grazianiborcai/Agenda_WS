...
import br.com.gda.business.customer.dao.CusUpdate;
...
public final class ActionCusUpdate implements DeciAction<CusInfo> {
	DeciAction<CusInfo> actionHelper;
	
	
	public ActionCusUpdate(DeciTreeOption<CusInfo> option) {
