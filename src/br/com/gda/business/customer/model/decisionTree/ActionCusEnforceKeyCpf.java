...
public final class ActionCusEnforceKeyCpf implements ActionStd<CusInfo> {
	private ActionStd<CusInfo> actionHelper;	
	
	
	public ActionCusEnforceKeyCpf(DeciTreeOption<CusInfo> option) {			
		actionHelper = new ActionStdHelperTrans<>(option.recordInfos, new VisitorCusEnforceKeyCpf());
	}
