...
import br.com.gda.business.customer.model.action.StdCusInsertAddress;
...
public final class NodeCusInsertAddress implements DeciTree<CusInfo> {
	...
	private List<ActionStd<CusInfo>> buildActionsOnPassed(DeciTreeOption<CusInfo> option) {
		...
		actions.add(new StdCusInsertAddress(option));		
		return actions;
	}
