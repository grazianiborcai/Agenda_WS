...
public final class ActionCusEnforceKeyEmail implements ActionStd<CusInfo> {
	private ActionStd<CusInfo> actionHelper;	
	
	
	public ActionCusEnforceKeyEmail(DeciTreeOption<CusInfo> option) {			
		actionHelper = new ActionStdHelperTrans<>(option.recordInfos, new VisitorCusEnforceKeyEmail());
	}
