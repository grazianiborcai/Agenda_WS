...
import br.com.gda.business.customer.dao.CusSelect;
...
public final class ActionCusSelect implements DeciAction<CusInfo> {
	DeciAction<CusInfo> actionHelper;
	
	
	public ActionCusSelect(DeciTreeOption<CusInfo> option) {
	...
	private SqlStmtExec<CusInfo> buildStmtExec(DeciTreeOption<CusInfo> option) {
		...
		return new CusSelect(stmtExecOptions);
	}
