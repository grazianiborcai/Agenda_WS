...
public final class LazyEmpEnforceEntityCateg extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforceEntityCateg(Connection conn, String schemaName) {
