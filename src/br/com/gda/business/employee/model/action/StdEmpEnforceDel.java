...
public final class StdEmpEnforceDel implements ActionStd<EmpInfo> {
	private ActionStd<EmpInfo> actionHelper;	
	
	
	public StdEmpEnforceDel(DeciTreeOption<EmpInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiEmpEnforceDel());
	}
