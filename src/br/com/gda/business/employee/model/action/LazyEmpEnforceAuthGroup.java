...
public final class LazyEmpEnforceAuthGroup extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforceAuthGroup(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEnforceAuthGroup(option);
	}
