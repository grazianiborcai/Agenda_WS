...
import br.com.gda.business.employee.model.action.StdEmpDeleteEmpmat;
import br.com.gda.business.employee.model.action.StdEmpSuccess;
import br.com.gda.business.employee.model.checker.EmpCheckHasEmpmat;
...
public final class NodeEmpDeleteEmpmat implements DeciTree<EmpInfo> {
	...
	private List<ActionStd<EmpInfo>> buildActionsOnPassed(DeciTreeOption<EmpInfo> option) {
		...
		ActionStd<EmpInfo> deleteEmpmat = new StdEmpDeleteEmpmat(option);
