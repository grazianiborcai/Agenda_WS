...
import br.com.gda.business.employee.model.action.StdEmpEnforceCpf;
...
public final class EmpCheckExistCpf_ extends ModelCheckerTemplateAction<EmpInfo> {
	
	public EmpCheckExistCpf_(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected ActionStd<EmpInfo> buildActionHook(EmpInfo recordInfo, Connection conn, String schemaName) {
		...
		ActionStd<EmpInfo> actionSelect = new StdEmpEnforceCpf(option);
