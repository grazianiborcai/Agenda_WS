...
public final class HandlerStoreCoSelect extends ActionLazyTemplate<StoreCoInfo, StoreCoInfo> {
	...
	@Override protected ActionStd<StoreCoInfo> getInstanceOfActionHook(DeciTreeOption<StoreCoInfo> option) {
