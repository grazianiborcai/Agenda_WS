...
public final class LazyPersonFilterEmailFilled extends ActionLazyTemplate<PersonInfo, PersonInfo> {
	
	public LazyPersonFilterEmailFilled(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonFilterEmailFilled(option);
	}
