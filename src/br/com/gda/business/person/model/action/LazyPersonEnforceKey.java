...
public final class LazyPersonEnforceKey extends ActionLazyTemplate<PersonInfo, PersonInfo> {
	
	public LazyPersonEnforceKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonEnforceKey(option);
	}
