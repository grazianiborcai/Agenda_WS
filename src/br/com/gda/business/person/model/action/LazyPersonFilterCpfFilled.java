...
public final class LazyPersonFilterCpfFilled extends ActionLazyTemplate<PersonInfo, PersonInfo> {
	
	public LazyPersonFilterCpfFilled(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonFilterCpfFilled(option);
	}
