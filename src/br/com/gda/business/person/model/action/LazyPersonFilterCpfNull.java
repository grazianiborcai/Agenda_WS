...
public final class LazyPersonFilterCpfNull extends ActionLazyTemplate<PersonInfo, PersonInfo> {
	
	public LazyPersonFilterCpfNull(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonFilterCpfNull(option);
	}
