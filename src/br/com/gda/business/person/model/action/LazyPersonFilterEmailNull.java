...
public final class LazyPersonFilterEmailNull extends ActionLazyTemplate<PersonInfo, PersonInfo> {
	
	public LazyPersonFilterEmailNull(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonFilterEmailNull(option);
	}
