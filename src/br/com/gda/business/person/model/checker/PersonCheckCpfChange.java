...
import br.com.gda.business.person.model.action.StdPersonEnforceCpfChange;
...
public final class PersonCheckCpfChange extends ModelCheckerTemplateAction_<PersonInfo> {
	
	public PersonCheckCpfChange(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected ActionStd<PersonInfo> buildActionHook(PersonInfo recordInfo, Connection conn, String schemaName) {
		...
		ActionStd<PersonInfo> actionSelect = new StdPersonEnforceCpfChange(option);
	...
	@Override protected String makeFailExplanationHook(boolean checkerResult) {		
		if (makeFailCodeHook(checkerResult) == SystemCode.PERSON_CPF_NOT_CHANGED)
