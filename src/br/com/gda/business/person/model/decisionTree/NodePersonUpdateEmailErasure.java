...
import br.com.gda.business.person.model.checker.PersonCheckEmailErasure;
...
public final class NodePersonUpdateEmailErasure extends DeciTreeWriteTemplate<PersonInfo> {
	
	public NodePersonUpdateEmailErasure(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected ModelChecker<PersonInfo> buildDecisionCheckerHook(DeciTreeOption<PersonInfo> option) {
		...
		checker = new PersonCheckEmailErasure(checkerOption);
		queue.add(checker);
