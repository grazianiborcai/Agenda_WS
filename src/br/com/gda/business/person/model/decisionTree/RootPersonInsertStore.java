...
import br.com.gda.business.person.model.action.StdPersonEnforceCategStore;
...
public final class RootPersonInsertStore extends DeciTreeWriteTemplate<PersonInfo> {
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> enforceCategStore = new StdPersonEnforceCategStore(option);	
