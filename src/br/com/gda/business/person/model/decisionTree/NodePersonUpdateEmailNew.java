...
public final class NodePersonUpdateEmailNew extends DeciTreeWriteTemplate<PersonInfo> {
	
	public NodePersonUpdateEmailNew(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnFailedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> nodeEmail = new NodePersonUpdateEmailOld(option).toAction();	
		actions.add(nodeEmail);	
		return actions;
	}
}
