...
public final class MatSnapInsertTextSingle implements DaoStmt<MatSnapInfo> {
	private DaoStmt<MatSnapInfo> stmtSql;
	private DaoStmtOption<MatSnapInfo> stmtOption;
	
	
	
	public MatSnapInsertTextSingle(Connection conn, MatSnapInfo recordInfo, String schemaName) {
	...
	@Override public DaoStmt<MatSnapInfo> getNewInstance() {
		return new MatSnapInsertTextSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
}
