...
final class VisiMatSnapMergeCurrency extends ActionVisitorTemplateMerge<MatSnapInfo, CurrencyInfo> {
	
	public VisiMatSnapMergeCurrency(Connection conn, String schemaName) {
