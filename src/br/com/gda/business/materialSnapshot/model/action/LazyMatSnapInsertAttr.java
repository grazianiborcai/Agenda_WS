...
public final class LazyMatSnapInsertAttr extends ActionLazyTemplate<MatSnapInfo, MatSnapInfo> {
	
	public LazyMatSnapInsertAttr(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<MatSnapInfo> getInstanceOfActionHook(DeciTreeOption<MatSnapInfo> option) {
		return new StdMatSnapInsertAttr(option);
	}
