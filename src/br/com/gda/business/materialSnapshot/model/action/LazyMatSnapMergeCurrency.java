...
public final class LazyMatSnapMergeCurrency extends ActionLazyTemplate<MatSnapInfo, MatSnapInfo> {
	
	public LazyMatSnapMergeCurrency(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatSnapInfo> getInstanceOfActionHook(DeciTreeOption<MatSnapInfo> option) {
		return new StdMatSnapMergeCurrency(option);
	}
