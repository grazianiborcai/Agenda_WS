...
import br.com.gda.business.materialSnapshot.dao.MatSnapInsertText;
...
public final class StdMatSnapInsertText implements ActionStd<MatSnapInfo> {
	private ActionStd<MatSnapInfo> actionHelper;
	
	
	public StdMatSnapInsertText(DeciTreeOption<MatSnapInfo> option) {
	...
	private DaoStmtExec<MatSnapInfo> buildStmtExec(DeciTreeOption<MatSnapInfo> option) {
		...
		return new MatSnapInsertText(stmtExecOptions);
	}
