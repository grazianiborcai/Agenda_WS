...
final class StdPlanMergeWeekday implements ActionStd<PlanInfo> {
	private ActionStd<PlanInfo> actionHelper;	
	
	
	public StdPlanMergeWeekday(DeciTreeOption<PlanInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPlanMergeWeekday(option.conn, option.schemaName));
	}
