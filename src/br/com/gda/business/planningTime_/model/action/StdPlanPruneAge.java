...
final class StdPlanPruneAge implements ActionStd<PlanInfo> {
	private ActionStd<PlanInfo> actionHelper;	
	
	
	public StdPlanPruneAge(DeciTreeOption<PlanInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPlanPruneAge());
	}
