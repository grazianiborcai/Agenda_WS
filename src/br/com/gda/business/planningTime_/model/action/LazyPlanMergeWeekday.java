...
public final class LazyPlanMergeWeekday extends ActionLazyTemplate<PlanInfo, PlanInfo> {

	public LazyPlanMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PlanInfo> getInstanceOfActionHook(DeciTreeOption<PlanInfo> option) {
		return new StdPlanMergeWeekday(option);
	}
