...
public final class LazyEmplevateRootDelete extends ActionLazyTemplate<EmplevateInfo, EmplevateInfo> {
	
	public LazyEmplevateRootDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmplevateInfo> getInstanceOfActionHook(DeciTreeOption<EmplevateInfo> option) {
		return new RootEmplevateDelete(option).toAction();
	}
