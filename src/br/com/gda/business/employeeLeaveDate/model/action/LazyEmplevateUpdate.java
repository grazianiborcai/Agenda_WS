...
public final class LazyEmplevateUpdate extends ActionLazyTemplate<EmplevateInfo, EmplevateInfo> {
	
	public LazyEmplevateUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmplevateInfo> getInstanceOfActionHook(DeciTreeOption<EmplevateInfo> option) {
		return new StdEmplevateUpdate(option);
	}
