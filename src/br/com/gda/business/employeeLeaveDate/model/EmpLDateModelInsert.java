...
import br.com.gda.business.employeeLeaveDate.model.decisionTree.RootEmpLDateInsert;
...
public final class EmpLDateModelInsert implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public EmpLDateModelInsert(String incomingData, HttpServletRequest request) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<EmpLDateInfo> {		
		@Override public DeciTree<EmpLDateInfo> getInstance(DeciTreeOption<EmpLDateInfo> option) {
			return new RootEmpLDateInsert(option);
		}			
	}
}
