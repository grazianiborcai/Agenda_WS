...
import br.com.gda.business.employeeLeaveDate.model.decisionTree.RootEmpLDateDelete;
...
public final class EmpLDateModelDelete implements Model {	
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public EmpLDateModelDelete(EmpLDateInfo recordInfo) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<EmpLDateInfo> {		
		@Override public DeciTree<EmpLDateInfo> getInstance(DeciTreeOption<EmpLDateInfo> option) {
			return new RootEmpLDateDelete(option);
		}		
	}
}
