...
public final class StdUserMergeToSelect implements ActionStd<UserInfo> {
	private ActionStd<UserInfo> actionHelper;	
	
	
	public StdUserMergeToSelect(DeciTreeOption<UserInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiUserMergeToSelect(option.conn, option.schemaName));
	}
