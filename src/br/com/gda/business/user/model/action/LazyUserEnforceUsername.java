...
public final class LazyUserEnforceUsername extends ActionLazyTemplate<UserInfo, UserInfo> {
	
	public LazyUserEnforceUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceUsername(option);
	}
