...
public final class LazyStorimeEnforceStowotmKey extends ActionLazyTemplate<StorimeInfo, StorimeInfo> {
	
	public LazyStorimeEnforceStowotmKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorimeInfo> getInstanceOfActionHook(DeciTreeOption<StorimeInfo> option) {
		return new StdStorimeEnforceStowotmKey(option);
	}
