...
public final class StdStoreEnforceKey implements ActionStd<StorapInfo> {
	private ActionStd<StorapInfo> actionHelper;	
	
	
	public StdStoreEnforceKey(DeciTreeOption<StorapInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiStoreEnforceKey());
	}
