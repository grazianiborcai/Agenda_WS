...
public final class LazyStoreEnforceAddressKey extends ActionLazyTemplate<StorapInfo, StorapInfo> {
	
	public LazyStoreEnforceAddressKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStoreEnforceAddressKey(option);
	}
