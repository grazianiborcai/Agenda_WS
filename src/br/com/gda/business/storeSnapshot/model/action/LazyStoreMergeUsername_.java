...
public final class LazyStoreMergeUsername_ extends ActionLazyTemplate<StorapInfo, StorapInfo> {
	
	public LazyStoreMergeUsername_(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStoreMergeUsername(option);
	}
