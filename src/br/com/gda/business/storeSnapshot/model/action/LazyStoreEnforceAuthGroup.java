...
public final class LazyStoreEnforceAuthGroup extends ActionLazyTemplate<StorapInfo, StorapInfo> {
	
	public LazyStoreEnforceAuthGroup(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStoreEnforceAuthGroup(option);
	}
