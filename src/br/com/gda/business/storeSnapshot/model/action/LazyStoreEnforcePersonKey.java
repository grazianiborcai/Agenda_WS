...
public final class LazyStoreEnforcePersonKey extends ActionLazyTemplate<StorapInfo, StorapInfo> {
	
	public LazyStoreEnforcePersonKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStoreEnforcePersonKey(option);
	}
