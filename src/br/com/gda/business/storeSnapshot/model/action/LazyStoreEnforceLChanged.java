...
public final class LazyStoreEnforceLChanged extends ActionLazyTemplate<StorapInfo, StorapInfo> {
	
	public LazyStoreEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStoreEnforceLChanged_(option);
	}
