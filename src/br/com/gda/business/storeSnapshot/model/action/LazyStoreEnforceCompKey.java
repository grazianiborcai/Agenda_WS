...
public final class LazyStoreEnforceCompKey extends ActionLazyTemplate<StorapInfo, StorapInfo> {
	
	public LazyStoreEnforceCompKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStoreEnforceCompKey(option);
	}
