...
public final class LazyCartSnapInsertHdr extends ActionLazyTemplate<CartSnapInfo, CartSnapInfo> {
	
	public LazyCartSnapInsertHdr(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartSnapInfo> getInstanceOfActionHook(DeciTreeOption<CartSnapInfo> option) {
		return new StdCartSnapInsertHdr(option);
	}
