...
public final class LazyCartSnapInsertMatSnap extends ActionLazyTemplate<CartSnapInfo, CartSnapInfo> {
	
	public LazyCartSnapInsertMatSnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartSnapInfo> getInstanceOfActionHook(DeciTreeOption<CartSnapInfo> option) {
		return new StdCartSnapInsertMatSnap(option);
	}
