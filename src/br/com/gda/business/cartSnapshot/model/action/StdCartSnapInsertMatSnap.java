...
public final class StdCartSnapInsertMatSnap implements ActionStd<CartSnapInfo> {
	private ActionStd<CartSnapInfo> actionHelper;	
	
	
	public StdCartSnapInsertMatSnap(DeciTreeOption<CartSnapInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiCartSnapInsertMatSnap(option.conn, option.schemaName));
	}
