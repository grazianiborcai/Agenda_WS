...
import br.com.gda.business.snapshot_.dao.SnapSelect;
...
public final class StdSnapSelect implements ActionStd<SnapInfo> {
	private ActionStd<SnapInfo> actionHelper;
	
	
	public StdSnapSelect(DeciTreeOption<SnapInfo> option) {
	...
	private DaoStmtExec<SnapInfo> buildStmtExec(DeciTreeOption<SnapInfo> option) {
		...
		return new SnapSelect(stmtExecOptions);
	}
