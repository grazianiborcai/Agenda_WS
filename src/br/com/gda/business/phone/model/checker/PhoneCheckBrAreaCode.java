...
public final class PhoneCheckBrAreaCode extends ModelCheckerTemplateSimple<PhoneInfo> {

	public PhoneCheckBrAreaCode() {
		super();
	}
	...
	@Override protected boolean checkHook(PhoneInfo recordInfo, Connection conn, String schemaName) {	
		int areaCode = getAreaCode(recordInfo.phoneNumber);
