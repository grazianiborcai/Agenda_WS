...
import br.com.gda.business.phone.model.decisionTree.NodePhoneUpsertdelL3;
import br.com.gda.model.action.ActionLazyTemplate;
import br.com.gda.model.decisionTree.DeciResult;
import br.com.gda.model.decisionTree.DeciTreeOption;

public final class LazyPhoneNodeUpsertdelL3 extends ActionLazyTemplate<PhoneInfo, PhoneInfo> {

	public LazyPhoneNodeUpsertdelL3(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new NodePhoneUpsertdelL3(option).toAction();
	}
