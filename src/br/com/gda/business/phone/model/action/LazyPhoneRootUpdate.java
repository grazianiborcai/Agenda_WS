...
public final class LazyPhoneRootUpdate extends ActionLazyTemplate<PhoneInfo, PhoneInfo> {

	public LazyPhoneRootUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new RootPhoneUpdate(option).toAction();
	}
