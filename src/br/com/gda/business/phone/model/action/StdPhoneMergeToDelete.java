...
public final class StdPhoneMergeToDelete implements ActionStd<PhoneInfo> {
	private ActionStd<PhoneInfo> actionHelper;	
	
	
	public StdPhoneMergeToDelete(DeciTreeOption<PhoneInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPhoneMergeToDelete(option.conn, option.schemaName));
	}
