...
public final class LazyPhoneFilterNew extends ActionLazyTemplate<PhoneInfo, PhoneInfo> {
	
	public LazyPhoneFilterNew(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new StdPhoneFilterNew(option);
	}
