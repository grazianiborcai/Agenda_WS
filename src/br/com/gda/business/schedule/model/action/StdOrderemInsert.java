...
import br.com.gda.business.schedule.dao.ScheduInsert;
...
public final class StdOrderemInsert implements ActionStd<ScheduInfo> {
	private ActionStd<ScheduInfo> actionHelper;
	
	
	public StdOrderemInsert(DeciTreeOption<ScheduInfo> option) {
	...
	private DaoStmtExec<ScheduInfo> buildStmtExec(DeciTreeOption<ScheduInfo> option) {
		...
		return new ScheduInsert(stmtExecOptions);
	}
