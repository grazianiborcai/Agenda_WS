...
public final class LazyScheduInsert extends ActionLazyTemplate<ScheduInfo, ScheduInfo> {
	
	public LazyScheduInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<ScheduInfo> getInstanceOfActionHook(DeciTreeOption<ScheduInfo> option) {
		return new StdScheduInsert(option);
	}
