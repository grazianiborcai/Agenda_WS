...
final class VisiOrderemMergeStolis extends ActionVisitorTemplateMergeV2<ScheduInfo, StolisInfo> {
	...
	@Override protected List<ScheduInfo> mergeHook(List<ScheduInfo> recordInfos, List<StolisInfo> selectedInfos) {	
