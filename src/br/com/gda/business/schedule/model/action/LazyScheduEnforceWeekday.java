...
public final class LazyScheduEnforceWeekday extends ActionLazyTemplate<ScheduInfo, ScheduInfo> {

	public LazyScheduEnforceWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<ScheduInfo> getInstanceOfActionHook(DeciTreeOption<ScheduInfo> option) {
		return new StdScheduEnforceWeekday(option);
	}
