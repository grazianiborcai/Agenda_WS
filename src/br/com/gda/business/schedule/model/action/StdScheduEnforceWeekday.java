...
public final class StdScheduEnforceWeekday implements ActionStd<ScheduInfo> {
	private ActionStd<ScheduInfo> actionHelper;	
	
	
	public StdScheduEnforceWeekday(DeciTreeOption<ScheduInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiScheduEnforceWeekday());
	}
