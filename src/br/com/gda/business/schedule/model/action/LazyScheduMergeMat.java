...
public final class LazyScheduMergeMat extends ActionLazyTemplate<ScheduInfo, ScheduInfo> {
	
	public LazyScheduMergeMat(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<ScheduInfo> getInstanceOfActionHook(DeciTreeOption<ScheduInfo> option) {
		return new StdScheduMergeMat(option);
	}
