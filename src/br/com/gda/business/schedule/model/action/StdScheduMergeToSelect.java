...
public final class StdScheduMergeToSelect implements ActionStd<ScheduInfo> {
	private ActionStd<ScheduInfo> actionHelper;	
	
	
	public StdScheduMergeToSelect(DeciTreeOption<ScheduInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiScheduMergeToSelect(option.conn, option.schemaName));
	}
