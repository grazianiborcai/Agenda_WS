...
public final class LazyScheduSelect extends ActionLazyTemplate<ScheduInfo, ScheduInfo> {

	public LazyScheduSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<ScheduInfo> getInstanceOfActionHook(DeciTreeOption<ScheduInfo> option) {
		return new StdScheduSelect(option);
	}
