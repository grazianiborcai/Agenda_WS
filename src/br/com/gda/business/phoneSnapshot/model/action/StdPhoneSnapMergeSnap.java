...
public final class StdPhoneSnapMergeSnap implements ActionStd<PhoneSnapInfo> {
	private ActionStd<PhoneSnapInfo> actionHelper;	
	
	
	public StdPhoneSnapMergeSnap(DeciTreeOption<PhoneSnapInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPhoneSnapMergeSnap(option.conn, option.schemaName));
	}
