...
public final class LazyPhoneSnapInsert extends ActionLazyTemplate<PhoneSnapInfo, PhoneSnapInfo> {

	public LazyPhoneSnapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PhoneSnapInfo> getInstanceOfActionHook(DeciTreeOption<PhoneSnapInfo> option) {
		return new StdPhoneSnapInsert(option);
	}
