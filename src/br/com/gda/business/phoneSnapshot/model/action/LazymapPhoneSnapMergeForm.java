...
public final class LazymapPhoneSnapMergeForm extends ActionLazyTemplate<PhoneSnapInfo, PhoneSnapInfo> {

	public LazymapPhoneSnapMergeForm(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PhoneSnapInfo> getInstanceOfActionHook(DeciTreeOption<PhoneSnapInfo> option) {
		return new MapPhoneSnapMergeForm(option);
	}
