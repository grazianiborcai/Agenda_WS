...
public final class StdPhoneSnapMergePhone implements ActionStd<PhoneSnapInfo> {
	private ActionStd<PhoneSnapInfo> actionHelper;	
	
	
	public StdPhoneSnapMergePhone(DeciTreeOption<PhoneSnapInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPhoneSnapMergePhone(option.conn, option.schemaName));
	}
