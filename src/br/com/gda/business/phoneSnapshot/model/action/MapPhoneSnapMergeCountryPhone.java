...
public final class MapPhoneSnapMergeCountryPhone implements ActionStd<PhoneSnapInfo> {
	private ActionStd<PhoneSnapInfo> actionHelper;	
	
	
	public MapPhoneSnapMergeCountryPhone(DeciTreeOption<PhoneSnapInfo> option) {			
	...
	private ActionMapOption<PhoneSnapInfo, CountryPhoneInfo> buildOption(DeciTreeOption<PhoneSnapInfo> treeOption) {
		...
		optionMap.visitorAction = VisimapPhoneSnapMergeCountryPhone.class;
