...
import br.com.gda.business.phoneSnapshot.dao.PhoneSnapSelect;
...
public final class StdPhoneSnapSelect implements ActionStd<PhoneSnapInfo> {
	private ActionStd<PhoneSnapInfo> actionHelper;
	
	
	public StdPhoneSnapSelect(DeciTreeOption<PhoneSnapInfo> option) {
	...
	private DaoStmtExec<PhoneSnapInfo> buildStmtExec(DeciTreeOption<PhoneSnapInfo> option) {
		...
		return new PhoneSnapSelect(stmtExecOptions);
	}
