...
public final class MatEmpDeleteSingle implements DaoStmt<MatEmpInfo> {
	private DaoStmt<MatEmpInfo> stmtSql;
	private DaoStmtOption<MatEmpInfo> stmtOption;	
	
	
	public MatEmpDeleteSingle(Connection conn, MatEmpInfo recordInfo, String schemaName) {
	...
	@Override public DaoStmt<MatEmpInfo> getNewInstance() {
		return new MatEmpDeleteSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	...
	private class ResultParser implements DaoResultParser<MatEmpInfo> {
		@Override public List<MatEmpInfo> parseResult(ResultSet stmtResult, long lastId) throws SQLException {
			...
			MatEmpInfo emptyInfo = new MatEmpInfo();
