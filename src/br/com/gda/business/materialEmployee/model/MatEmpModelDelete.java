...
import br.com.gda.business.materialEmployee.model.decisionTree.RootMatEmpDelete;
...
public final class MatEmpModelDelete implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public MatEmpModelDelete(MatEmpInfo recordInfo) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<MatEmpInfo> {		
		@Override public DeciTree<MatEmpInfo> getInstance(DeciTreeOption<MatEmpInfo> option) {
			return new RootMatEmpDelete(option);
		}			
	}
}
