...
import br.com.gda.business.materialEmployee.dao.MatEmpDelete;
...
final class ActionMatEmpDelete implements ActionStd<MatEmpInfo> {
	...
	private DaoStmtExec<MatEmpInfo> buildStmtExec(DeciTreeOption<MatEmpInfo> option) {
		...
		return new MatEmpDelete(stmtExecOptions);
	}
