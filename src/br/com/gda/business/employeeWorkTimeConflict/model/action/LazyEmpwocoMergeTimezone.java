...
public final class LazyEmpwocoMergeTimezone extends ActionLazyTemplate<EmpwocoInfo, EmpwocoInfo> {
	
	public LazyEmpwocoMergeTimezone(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpwocoInfo> getInstanceOfActionHook(DeciTreeOption<EmpwocoInfo> option) {
		return new StdEmpwocoMergeTimezone(option);
	}
