...
public final class LazyCartEnforceItmNum extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartEnforceItmNum(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartEnforceItmNum(option);
	}
