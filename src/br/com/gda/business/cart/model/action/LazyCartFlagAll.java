...
public final class LazyCartFlagAll extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartFlagAll(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartFlagAll(option);
	}
