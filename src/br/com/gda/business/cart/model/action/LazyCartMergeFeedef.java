...
public final class LazyCartMergeFeedef extends ActionLazyTemplate<CartInfo, CartInfo> {

	public LazyCartMergeFeedef(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeFeedef(option);
	}
