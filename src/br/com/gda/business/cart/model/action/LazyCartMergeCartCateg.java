...
public final class LazyCartMergeCartCateg extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeCartCateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeCartCateg(option);
	}
