...
public final class LazyCartMergeFee extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeFee(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeFee(option);
	}
