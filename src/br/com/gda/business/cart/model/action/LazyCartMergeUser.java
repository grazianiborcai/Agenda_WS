...
public final class LazyCartMergeUser extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeUser(option);
	}
