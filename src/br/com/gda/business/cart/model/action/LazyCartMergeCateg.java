...
public final class LazyCartMergeCateg extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeCateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeCateg(option);
	}
