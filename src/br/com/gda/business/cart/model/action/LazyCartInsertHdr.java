...
public final class LazyCartInsertHdr extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartInsertHdr(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartInsertHdr(option);
	}
