...
public final class LazyCartEnforceItmCategTotal extends ActionLazyTemplate<CartInfo, CartInfo> {

	public LazyCartEnforceItmCategTotal(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartEnforceItmCategTotal(option);
	}
