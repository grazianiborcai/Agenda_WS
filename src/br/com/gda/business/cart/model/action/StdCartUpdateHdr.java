...
import br.com.gda.business.cart.dao.CartUpdateHdr;
...
public final class StdCartUpdateHdr implements ActionStd<CartInfo> {
	private ActionStd<CartInfo> actionHelper;
	
	
	public StdCartUpdateHdr(DeciTreeOption<CartInfo> option) {
	...
	private DaoStmtExec<CartInfo> buildStmtExec(DeciTreeOption<CartInfo> option) {
		...
		return new CartUpdateHdr(stmtExecOptions);
	}
