...
public final class LazyCartMergeFeetore extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeFeetore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeFeetore(option);
	}
