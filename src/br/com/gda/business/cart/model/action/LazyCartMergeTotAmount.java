...
public final class LazyCartMergeTotAmount extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeTotAmount(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeTotAmount(option);
	}
