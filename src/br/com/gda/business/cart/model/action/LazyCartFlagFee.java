...
public final class LazyCartFlagFee extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartFlagFee(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartFlagFee(option);
	}
