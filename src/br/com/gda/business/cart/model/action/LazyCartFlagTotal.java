...
public final class LazyCartFlagTotal extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartFlagTotal(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartFlagTotal(option);
	}
