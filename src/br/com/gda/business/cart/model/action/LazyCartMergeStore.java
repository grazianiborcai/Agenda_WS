...
public final class LazyCartMergeStore extends ActionLazyTemplate<CartInfo, CartInfo> {
	
	public LazyCartMergeStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeStore(option);
	}
