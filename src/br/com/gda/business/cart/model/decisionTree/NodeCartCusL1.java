...
public final class NodeCartCusL1 implements DeciTree<CartInfo> {
	private DeciTree<CartInfo> tree;
	
	
	public NodeCartCusL1(DeciTreeOption<CartInfo> option) {
	...
	private List<ActionStd<CartInfo>> buildActionsOnPassed(DeciTreeOption<CartInfo> option) {
		...
		ActionStd<CartInfo> nodeL2 = new NodeCartCusL2(option).toAction();
		actions.add(nodeL2);
		return actions;
	}
