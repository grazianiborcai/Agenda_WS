...
final class HandlerCartEnforceKey extends DeciActionHandlerTemplate<CartInfo, CartInfo> {

	public HandlerCartEnforceKey(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new ActionCartEnforceKey(option);
	}
