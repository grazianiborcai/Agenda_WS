...
import br.com.gda.business.cart.dao.CartDeleteItm;
...
public final class ActionCartDeleteItm implements DeciAction<CartInfo> {
	private DeciAction<CartInfo> actionHelper;
	
	
	public ActionCartDeleteItm(DeciTreeOption<CartInfo> option) {
	...
	private DaoStmtExec<CartInfo> buildStmtExec(DeciTreeOption<CartInfo> option) {
		...
		return new CartDeleteItm(stmtExecOptions);
	}
