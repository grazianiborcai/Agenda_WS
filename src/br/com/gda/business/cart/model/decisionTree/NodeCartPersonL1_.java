...
public final class NodeCartPersonL1_ implements DeciTree<CartInfo> {
	private DeciTree<CartInfo> tree;
	
	
	public NodeCartPersonL1_(DeciTreeOption<CartInfo> option) {
	...
	private List<ActionStd<CartInfo>> buildActionsOnPassed(DeciTreeOption<CartInfo> option) {
		...
		ActionStd<CartInfo> nodeL2 = new NodeCartPersonL2_(option).toAction();
		actions.add(nodeL2);
		return actions;
	}
