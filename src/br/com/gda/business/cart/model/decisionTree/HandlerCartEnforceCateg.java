...
final class HandlerCartEnforceCateg extends DeciActionHandlerTemplate<CartInfo, CartInfo> {

	public HandlerCartEnforceCateg(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new ActionCartEnforceCateg(option);
	}
