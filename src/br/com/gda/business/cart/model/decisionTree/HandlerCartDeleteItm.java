...
final class HandlerCartDeleteItm extends DeciActionHandlerTemplate<CartInfo, CartInfo> {
	
	public HandlerCartDeleteItm(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new ActionCartDeleteItm(option);
	}
