...
final class HandlerCartUpdateHdr extends DeciActionHandlerTemplate<CartInfo, CartInfo> {

	public HandlerCartUpdateHdr(Connection conn, String schemaName) {
	...
	@Override protected DeciAction<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new ActionCartUpdateHdr(option);
	}
