...
public final class CartUpdateSingle implements DaoStmt<CartInfo> {
	private DaoStmt<CartInfo> stmtSql;
	private DaoStmtOption<CartInfo> stmtOption;
	
	
	public CartUpdateSingle(Connection conn, CartInfo recordInfo, String schemaName) {
	...
	@Override public DaoStmt<CartInfo> getNewInstance() {
		return new CartUpdateSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
