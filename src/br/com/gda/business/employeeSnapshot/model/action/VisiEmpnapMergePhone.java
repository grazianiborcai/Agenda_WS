...
final class VisiEmpnapMergePhone extends ActionVisitorTemplateMergeV2<EmpnapInfo, PhoneInfo> {
	
	public VisiEmpnapMergePhone(Connection conn, String schemaName) {
	...
	@Override protected List<EmpnapInfo> mergeHook(List<EmpnapInfo> recordInfos, List<PhoneInfo> selectedInfos) {	
		return EmpnapMerger.mergeWithPhone(selectedInfos, recordInfos);
	}
