...
public final class LazyEmpnapMergeAddress extends ActionLazyTemplate<EmpnapInfo, EmpnapInfo> {
	
	public LazyEmpnapMergeAddress(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpnapInfo> getInstanceOfActionHook(DeciTreeOption<EmpnapInfo> option) {
		return new StdEmpnapMergeAddress(option);
	}
