...
public final class EmpPositionStmtWhere {
	private String whereClause;	
	
	
	public EmpPositionStmtWhere(SqlWhereBuilderOption whereOption, String tableName, EmpPositionInfo recordInfo) {
		generateWhereClause(whereOption, tableName, recordInfo);
	}
	
	
	
	private void generateWhereClause(SqlWhereBuilderOption whereOption, String tableName, EmpPositionInfo recordInfo) {
