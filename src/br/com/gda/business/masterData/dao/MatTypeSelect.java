...
public final class MatTypeSelect implements SqlStmt<MatTypeInfo> {
	...
	public MatTypeSelect(Connection conn, MatTypeInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<MatTypeInfo> getNewInstance() {
		return new MatTypeSelect(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	...
	private class ResultParser implements SqlResultParser<MatTypeInfo> {
		...
		@Override public List<MatTypeInfo> parseResult(ResultSet stmtResult) throws SQLException {
