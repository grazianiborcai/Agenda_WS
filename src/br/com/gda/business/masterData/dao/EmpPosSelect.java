...
public final class EmpPosSelect implements SqlStmt<EmpPosInfo> {
	...
	public EmpPosSelect(Connection conn, EmpPosInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<EmpPosInfo> getNewInstance() {
		return new EmpPosSelect(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
