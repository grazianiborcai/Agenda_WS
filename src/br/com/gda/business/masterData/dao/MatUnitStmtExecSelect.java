...
public final class MatUnitStmtExecSelect implements SqlStmtExec<MatUnitInfo> {
	private List<SqlStmt<MatUnitInfo>> sqlStatements;
	private SqlStmtExec<MatUnitInfo> helper;
	
	public MatUnitStmtExecSelect(List<SqlStmtExecOption<MatUnitInfo>> options) {
		if (options == null) 
	...
	private void prepareStatement(List<SqlStmtExecOption<MatUnitInfo>> options) {
		...
		for (SqlStmtExecOption<MatUnitInfo> eachOption : options) {
			SqlStmt<MatUnitInfo> sqlStatement = new MatUnitStmtSelect(eachOption.conn, eachOption.recordInfo, eachOption.schemaName);
