...
public final class LanguSelect implements SqlStmt<LanguInfo> {
	...
	public LanguSelect(Connection conn, LanguInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<LanguInfo> getNewInstance() {
		return new LanguSelect(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
