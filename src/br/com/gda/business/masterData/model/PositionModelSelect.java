...
public final class PositionModelSelect implements Model {
	...
	private void buildHelper(PositionInfo recordInfo) {
		ModelOption_<PositionInfo> helperOption = new ModelOption_<>();
	...
	private static class TreeFactory implements DeciTreeFactory<PositionInfo> {		
		@Override public DeciTree<PositionInfo> getInstance(DeciTreeOption<PositionInfo> option) {
