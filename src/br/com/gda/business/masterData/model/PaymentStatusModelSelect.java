...
public final class PaymentStatusModelSelect implements Model {
	...
	private void buildHelper(PaymentStatusInfo recordInfo) {
		ModelOption_<PaymentStatusInfo> helperOption = new ModelOption_<>();
	...
	private static class TreeFactory implements DeciTreeFactory<PaymentStatusInfo> {		
		@Override public DeciTree<PaymentStatusInfo> getInstance(DeciTreeOption<PaymentStatusInfo> option) {
