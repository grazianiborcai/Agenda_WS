...
public final class StateModelSelect implements Model {
	...
	private void buildHelper(StateInfo recordInfo) {
		ModelOption_<StateInfo> helperOption = new ModelOption_<>();
	...
	private static class TreeFactory implements DeciTreeFactory<StateInfo> {		
		@Override public DeciTree<StateInfo> getInstance(DeciTreeOption<StateInfo> option) {
