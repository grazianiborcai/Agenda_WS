...
public final class StdMatmovMergeUsername implements ActionStd<MatmovInfo> {
	private ActionStd<MatmovInfo> actionHelper;	
	
	
	public StdMatmovMergeUsername(DeciTreeOption<MatmovInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiMatmovMergeUsername(option.conn, option.schemaName));
	}
