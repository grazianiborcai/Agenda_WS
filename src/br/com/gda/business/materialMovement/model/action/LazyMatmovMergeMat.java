...
public final class LazyMatmovMergeMat extends ActionLazyTemplate<MatmovInfo, MatmovInfo> {
	
	public LazyMatmovMergeMat(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatmovInfo> getInstanceOfActionHook(DeciTreeOption<MatmovInfo> option) {
		return new StdMatmovMergeMat(option);
	}
