...
public final class StdMatmovMergeToDelete implements ActionStd<MatmovInfo> {
	private ActionStd<MatmovInfo> actionHelper;	
	
	
	public StdMatmovMergeToDelete(DeciTreeOption<MatmovInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiMatmovMergeToDelete(option.conn, option.schemaName));
	}
