...
public final class RootMatmovUpdate implements DeciTree<MatmovInfo> {
	private DeciTree<MatmovInfo> tree;
	
	
	public RootMatmovUpdate(DeciTreeOption<MatmovInfo> option) {
	...
	private List<ActionStd<MatmovInfo>> buildActionsOnPassed(DeciTreeOption<MatmovInfo> option) {
		...
		ActionStd<MatmovInfo> select = new RootMatmovSelect(option).toAction();		
