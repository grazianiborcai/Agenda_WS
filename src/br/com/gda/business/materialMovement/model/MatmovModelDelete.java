...
import br.com.gda.business.materialMovement.model.decisionTree.RootMatmovDelete;
...
public final class MatmovModelDelete implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public MatmovModelDelete(MatmovInfo recordInfo) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<MatmovInfo> {		
		@Override public DeciTree<MatmovInfo> getInstance(DeciTreeOption<MatmovInfo> option) {
			return new RootMatmovDelete(option);
		}		
	}
}
