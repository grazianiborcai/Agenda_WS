...
import br.com.gda.business.personSnapshot.dao.PersonSnapSelect;
...
public final class StdPersonSnapSelect implements ActionStd<PersonSnapInfo> {
	ActionStd<PersonSnapInfo> actionHelper;
	
	
	public StdPersonSnapSelect(DeciTreeOption<PersonSnapInfo> option) {
	...
	private DaoStmtExec<PersonSnapInfo> buildStmtExec(DeciTreeOption<PersonSnapInfo> option) {
		...
		return new PersonSnapSelect(stmtExecOptions);
	}
