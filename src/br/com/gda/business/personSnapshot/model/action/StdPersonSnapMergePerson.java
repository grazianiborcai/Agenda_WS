...
public final class StdPersonSnapMergePerson implements ActionStd<PersonSnapInfo> {
	private ActionStd<PersonSnapInfo> actionHelper;	
	
	
	public StdPersonSnapMergePerson(DeciTreeOption<PersonSnapInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPersonSnapMergePerson(option.conn, option.schemaName));
	}
