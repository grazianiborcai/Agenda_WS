...
public final class LazyPersonSnapMergeGender extends ActionLazyTemplate<PersonSnapInfo, PersonSnapInfo> {
	
	public LazyPersonSnapMergeGender(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonSnapInfo> getInstanceOfActionHook(DeciTreeOption<PersonSnapInfo> option) {
		return new StdPersonSnapMergeGender(option);
	}
