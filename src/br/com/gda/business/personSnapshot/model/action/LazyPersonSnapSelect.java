...
public final class LazyPersonSnapSelect extends ActionLazyTemplate<PersonSnapInfo, PersonSnapInfo> {
	
	public LazyPersonSnapSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonSnapInfo> getInstanceOfActionHook(DeciTreeOption<PersonSnapInfo> option) {
		return new StdPersonSnapSelect(option);
	}
