...
public final class LazyPersonSnapInsert extends ActionLazyTemplate<PersonSnapInfo, PersonSnapInfo> {
	
	public LazyPersonSnapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonSnapInfo> getInstanceOfActionHook(DeciTreeOption<PersonSnapInfo> option) {
		return new StdPersonSnapInsert(option);
	}
