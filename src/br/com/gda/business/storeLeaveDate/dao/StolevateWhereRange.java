...
final class StolevateWhereRange implements DaoStmtWhere {
	private String whereClause;	
	
	
	public StolevateWhereRange(DaoWhereBuilderOption whereOption, String tableName, StolevateInfo recordInfo) {
	...
	private DaoWhereBuilder whereClausePartOne(DaoWhereBuilderOption whereOption, String tableName, StolevateInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				...
				case StolevateDbTableColumn.COL_DT_VALID_TO :
				...
				case StolevateDbTableColumn.COL_TM_VALID_TO :
	...
	private DaoWhereBuilder whereClausePartTwo(DaoWhereBuilderOption whereOption, String tableName, StolevateInfo recordInfo) {
		DaoWhereBuilder builder = DaoWhereBuilder.factory(whereOption);
