...
public final class StolevateWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public StolevateWhere(DaoWhereBuilderOption whereOption, String tableName, StolevateInfo recordInfo) {
