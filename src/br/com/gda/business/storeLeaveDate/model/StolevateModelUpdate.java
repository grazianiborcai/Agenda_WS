...
import br.com.gda.business.storeLeaveDate.model.decisionTree.RootStolevateUpdate;
...
public final class StolevateModelUpdate implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public StolevateModelUpdate(String incomingData, HttpServletRequest request) {
		initialize();
	...
	private void buildHelper(String incomingData, HttpServletRequest request) {
		ModelOption_<StolevateInfo> helperOption = new ModelOption_<>();
	...
	private static class TreeFactory implements DeciTreeFactory<StolevateInfo> {		
		@Override public DeciTree<StolevateInfo> getInstance(DeciTreeOption<StolevateInfo> option) {
			return new RootStolevateUpdate(option);
		}			
	}
}
