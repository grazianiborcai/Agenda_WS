...
import br.com.gda.business.storeLeaveDate.model.decisionTree.RootStolevateInsert;
...
public final class StolevateModelInsert implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public StolevateModelInsert(String incomingData, HttpServletRequest request) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<StolevateInfo> {		
		@Override public DeciTree<StolevateInfo> getInstance(DeciTreeOption<StolevateInfo> option) {
			return new RootStolevateInsert(option);
		}			
	}
}
