...
import br.com.gda.business.storeLeaveDate.model.decisionTree.RootStoreLDateInsert;
...
public final class StoreLDateModelInsert implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public StoreLDateModelInsert(String incomingData, HttpServletRequest request) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<StoreLDateInfo> {		
		@Override public DeciTree<StoreLDateInfo> getInstance(DeciTreeOption<StoreLDateInfo> option) {
			return new RootStoreLDateInsert(option);
		}			
	}
}
