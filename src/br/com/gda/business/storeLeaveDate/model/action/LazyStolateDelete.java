...
public final class LazyStolevateDelete extends ActionLazyTemplate<StolevateInfo, StolevateInfo> {
	
	public LazyStolevateDelete(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<StolevateInfo> getInstanceOfActionHook(DeciTreeOption<StolevateInfo> option) {
		return new StdStolevateDelete(option);
	}
