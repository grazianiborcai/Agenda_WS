...
public final class LazyStolevateInsert extends ActionLazyTemplate<StolevateInfo, StolevateInfo> {
	
	public LazyStolevateInsert(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<StolevateInfo> getInstanceOfActionHook(DeciTreeOption<StolevateInfo> option) {
		return new StdStolevateInsert(option);
	}
