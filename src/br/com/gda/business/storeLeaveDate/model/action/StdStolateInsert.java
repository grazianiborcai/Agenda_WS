...
import br.com.gda.business.storeLeaveDate.dao.StolevateInsert;
...
public final class StdStolevateInsert implements ActionStd<StolevateInfo> {
	private ActionStd<StolevateInfo> actionHelper;
	
	
	public StdStolevateInsert(DeciTreeOption<StolevateInfo> option) {
	...
	private DaoStmtExec<StolevateInfo> buildStmtExec(DeciTreeOption<StolevateInfo> option) {
		...
		return new StolevateInsert(stmtExecOptions);
	}
