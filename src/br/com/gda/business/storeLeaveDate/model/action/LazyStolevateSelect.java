...
public final class LazyStolevateSelect extends ActionLazyTemplate<StolevateInfo, StolevateInfo> {
	
	public LazyStolevateSelect(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<StolevateInfo> getInstanceOfActionHook(DeciTreeOption<StolevateInfo> option) {
		return new StdStolevateSelect(option);
	}
