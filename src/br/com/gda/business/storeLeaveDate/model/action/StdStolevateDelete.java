...
import br.com.gda.business.storeLeaveDate.dao.StolevateDelete;
...
public final class StdStolevateDelete implements ActionStd<StolevateInfo> {
	private ActionStd<StolevateInfo> actionHelper;
	
	
	public StdStolevateDelete(DeciTreeOption<StolevateInfo> option) {
	...
	private DaoStmtExec<StolevateInfo> buildStmtExec(DeciTreeOption<StolevateInfo> option) {
		...
		return new StolevateDelete(stmtExecOptions);
	}
