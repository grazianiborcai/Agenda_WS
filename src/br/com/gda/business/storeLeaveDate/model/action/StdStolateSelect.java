...
import br.com.gda.business.storeLeaveDate.dao.StolevateSelect;
...
public final class StdStolevateSelect implements ActionStd<StolevateInfo> {
	private ActionStd<StolevateInfo> actionHelper;
	
	
	public StdStolevateSelect(DeciTreeOption<StolevateInfo> option) {
	...
	private DaoStmtExec<StolevateInfo> buildStmtExec(DeciTreeOption<StolevateInfo> option) {
		...
		return new StolevateSelect(stmtExecOptions);
	}
