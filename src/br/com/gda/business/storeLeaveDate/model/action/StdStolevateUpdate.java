...
import br.com.gda.business.storeLeaveDate.dao.StolevateUpdate;
...
public final class StdStolevateUpdate implements ActionStd<StolevateInfo> {
	private ActionStd<StolevateInfo> actionHelper;
	
	
	public StdStolevateUpdate(DeciTreeOption<StolevateInfo> option) {
	...
	private DaoStmtExec<StolevateInfo> buildStmtExec(DeciTreeOption<StolevateInfo> option) {
		...
		return new StolevateUpdate(stmtExecOptions);
	}
