...
public final class LazyStolevateMergeToDelete extends ActionLazyTemplate<StolevateInfo, StolevateInfo> {
	
	public LazyStolevateMergeToDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StolevateInfo> getInstanceOfActionHook(DeciTreeOption<StolevateInfo> option) {
		return new StdStolevateMergeToDelete(option);
	}
