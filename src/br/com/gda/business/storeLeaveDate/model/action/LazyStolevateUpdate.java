...
public final class LazyStolevateUpdate extends ActionLazyTemplate<StolevateInfo, StolevateInfo> {
	
	public LazyStolevateUpdate(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<StolevateInfo> getInstanceOfActionHook(DeciTreeOption<StolevateInfo> option) {
		return new StdStolevateUpdate(option);
	}
