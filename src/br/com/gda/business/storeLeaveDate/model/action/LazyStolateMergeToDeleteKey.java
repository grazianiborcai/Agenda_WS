...
public final class LazyStolevateMergeToDeleteKey extends ActionLazyTemplate<StolevateInfo, StolevateInfo> {
	
	public LazyStolevateMergeToDeleteKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StolevateInfo> getInstanceOfActionHook(DeciTreeOption<StolevateInfo> option) {
		return new StdStolevateMergeToDeleteKey(option);
	}
