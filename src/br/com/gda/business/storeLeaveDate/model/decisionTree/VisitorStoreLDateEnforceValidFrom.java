...
final class VisitorStoreLDateEnforceValidFrom implements DeciActionTransVisitor<StoreLDateInfo> {
	...
	private StoreLDateInfo enforce(StoreLDateInfo recordInfo) {
		...
		enforcedInfo.timeValidTo = enforcedInfo.timeValidFrom;
		enforcedInfo.dateValidTo = enforcedInfo.dateValidFrom;
		return enforcedInfo;
	}
