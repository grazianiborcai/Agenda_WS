...
final class VisitorStoreLDateEnforceValidTo implements DeciActionTransVisitor<StoreLDateInfo> {
	...
	private StoreLDateInfo enforce(StoreLDateInfo recordInfo) {
		...
		enforcedInfo.timeValidFrom = enforcedInfo.timeValidTo;
		enforcedInfo.dateValidFrom = enforcedInfo.dateValidTo;
		return enforcedInfo;
	}
