...
public final class StdEmpwoutMergeStolis implements ActionStd<EmpwoutInfo> {
	private ActionStd<EmpwoutInfo> actionHelper;	
	
	
	public StdEmpwoutMergeStolis(DeciTreeOption<EmpwoutInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmpwoutMergeStolis(option.conn, option.schemaName));
	}
