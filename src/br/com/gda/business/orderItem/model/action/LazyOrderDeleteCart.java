...
public final class LazyOrderDeleteCart extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderDeleteCart(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderDeleteCart(option);
	}
