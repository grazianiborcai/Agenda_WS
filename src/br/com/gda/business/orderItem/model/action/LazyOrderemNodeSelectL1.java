...
import br.com.gda.business.orderItem.model.decisionTree.NodeOrderemSelectL1;
import br.com.gda.model.action.ActionStd;
import br.com.gda.model.action.ActionLazyTemplate;
import br.com.gda.model.decisionTree.DeciResult;
import br.com.gda.model.decisionTree.DeciTreeOption;

public final class LazyOrderemNodeSelectL1 extends ActionLazyTemplate<OrderemInfo, OrderemInfo> {
	
	public LazyOrderemNodeSelectL1(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new NodeOrderemSelectL1(option).toAction();
	}
