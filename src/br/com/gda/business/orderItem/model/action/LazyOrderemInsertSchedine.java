...
public final class LazyOrderemInsertSchedine extends ActionLazyTemplate<OrderemInfo, OrderemInfo> {

	public LazyOrderemInsertSchedine(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemInsertSchedine(option);
	}
