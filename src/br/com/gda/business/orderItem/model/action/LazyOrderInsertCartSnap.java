...
public final class LazyOrderInsertCartSnap extends ActionLazyTemplate<OrderInfo, OrderInfo> {
	
	public LazyOrderInsertCartSnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderInsertCartSnap(option);
	}
