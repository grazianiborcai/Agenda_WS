...
import br.com.gda.business.orderItem.model.action.LazyOrderemNodeSelectL1;
...
public final class RootOrderemSelect extends DeciTreeWriteTemplate<OrderemInfo> {
	...
	@Override protected List<ActionStd<OrderemInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderemInfo> option) {
		...
		ActionLazy<OrderemInfo> nodeL1 = new LazyOrderemNodeSelectL1(option.conn, option.schemaName);		
