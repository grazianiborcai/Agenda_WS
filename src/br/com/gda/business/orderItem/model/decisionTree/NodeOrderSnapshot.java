...
import br.com.gda.business.orderItem.model.action.LazyOrderInsertCartSnap;
import br.com.gda.business.orderItem.model.action.StdOrderMergeSnap;
import br.com.gda.business.orderItem.model.checker.OrderCheckWriteSnap;
...
public final class NodeOrderSnapshot implements DeciTree<OrderInfo> {
	...
	private List<ActionStd<OrderInfo>> buildActionsOnPassed(DeciTreeOption<OrderInfo> option) {
		...
		ActionLazy<OrderInfo> insertCartSnap = new LazyOrderInsertCartSnap(option.conn, option.schemaName);
		
		mergeSnap.addPostAction(insertCartSnap);
