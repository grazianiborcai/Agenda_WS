...
public final class HandlerMatStoreSelect extends ActionLazyTemplate<MatStoreInfo, MatStoreInfo> {
	...
	@Override protected  ActionStd<MatStoreInfo> getInstanceOfActionHook(DeciTreeOption<MatStoreInfo> option) {
