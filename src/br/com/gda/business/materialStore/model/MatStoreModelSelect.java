...
import br.com.gda.business.materialStore.model.decisionTree.RootMatStoreSelect;
...
public final class MatStoreModelSelect implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public MatStoreModelSelect(MatStoreInfo recordInfo) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<MatStoreInfo> {		
		@Override public DeciTree<MatStoreInfo> getInstance(DeciTreeOption<MatStoreInfo> option) {
			return new RootMatStoreSelect(option);
		}	
	}
}
