...
public final class MatoreCheckPriceProduct extends ModelCheckerTemplateSimple_<MatoreInfo> {

	public MatoreCheckPriceProduct() {
		super();
	}
	...
	private boolean shouldCheck(int codCategory) {
		if (MatCateg.PRODUCT.getCodMatCateg() == codCategory)
			return true;
