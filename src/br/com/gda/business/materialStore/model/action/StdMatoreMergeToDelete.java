...
public final class StdMatoreMergeToDelete implements ActionStd<MatoreInfo> {
	private ActionStd<MatoreInfo> actionHelper;	
	
	
	public StdMatoreMergeToDelete(DeciTreeOption<MatoreInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiMatoreMergeToDelete(option.conn, option.schemaName));
	}
