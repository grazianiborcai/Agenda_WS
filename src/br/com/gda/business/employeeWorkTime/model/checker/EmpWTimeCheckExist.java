...
public class EmpWTimeCheckExist extends ModelCheckerTemplate<EmpWTimeInfo> {
	...
	@Override protected String makeFailureExplanationHook(boolean checkerResult) {		
		if (makeFailureCodeHook(checkerResult) == SystemCode.EMPLOYEE_WORK_TIME_ALREADY_EXIST)
			return SystemMessage.EMPLOYEE_WORK_TIME_ALREALDY_EXIST;
		
		return SystemMessage.EMPLOYEE_WORK_TIME_NOT_FOUND;
	}
	...
	@Override protected int makeFailureCodeHook(boolean checkerResult) {
		if (checkerResult == RECORD_EXIST)
			return SystemCode.EMPLOYEE_WORK_TIME_ALREADY_EXIST;	
			
		return SystemCode.EMPLOYEE_WORK_TIME_NOT_FOUND;
	}
}
