...
import br.com.gda.business.employeeWorkTime.dao.EmpWTimeSelectRange;
...
public final class ActionEmpWTimeSelectRange implements DeciAction<EmpWTimeInfo> {
	private DeciAction<EmpWTimeInfo> actionHelper;
	
	
	public ActionEmpWTimeSelectRange(DeciTreeOption<EmpWTimeInfo> option) {
	...
	private DaoStmtExec<EmpWTimeInfo> buildStmtExec(DeciTreeOption<EmpWTimeInfo> option) {
		...
		return new EmpWTimeSelectRange(stmtExecOptions);
	}
