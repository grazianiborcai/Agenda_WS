...
import br.com.gda.business.employeeWorkTime.model.decisionTree.RootEmpWTimeUpdate;
...
public final class EmpWTimeModelUpdate implements Model {	
	...
	public EmpWTimeModelUpdate(String incomingData, HttpServletRequest request) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<EmpWTimeInfo> {		
		@Override public DeciTree<EmpWTimeInfo> getInstance(DeciTreeOption<EmpWTimeInfo> option) {
			return new RootEmpWTimeUpdate(option);
		}			
	}
}
