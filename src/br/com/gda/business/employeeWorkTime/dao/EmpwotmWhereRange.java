...
final class EmpwotmWhereRange implements DaoStmtWhere {
	private String whereClause;	
	
	
	public EmpwotmWhereRange(DaoWhereBuilderOption whereOption, String tableName, EmpwotmInfo recordInfo) {
