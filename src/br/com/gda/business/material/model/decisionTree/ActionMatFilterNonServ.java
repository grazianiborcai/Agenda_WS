...
public final class ActionMatFilterNonServ implements DeciAction<MatInfo> {
	private DeciAction<MatInfo> actionHelper;	
	
	
	public ActionMatFilterNonServ(DeciTreeOption<MatInfo> option) {			
		actionHelper = new DeciActionHelperTrans<>(option.recordInfos, new VisitorMatFilterNonServ());
	}
