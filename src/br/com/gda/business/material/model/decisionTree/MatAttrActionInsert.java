...
import br.com.gda.business.material.dao.MatAttrInsertExec;
...
public final class MatAttrActionInsert implements DeciAction<MatInfo> {
	DeciAction<MatInfo> actionHelper;
	
	
	public MatAttrActionInsert(DeciTreeOption<MatInfo> option) {
	...
	private SqlStmtExec<MatInfo> buildStmtExec(DeciTreeOption<MatInfo> option) {
		...
		return new MatAttrInsertExec(stmtExecOptions);
	}
