...
import br.com.gda.business.material.dao.MatStmtExecSelect;
...
public final class MatActionSelect implements DeciAction<MatInfo> {
	DeciAction<MatInfo> actionHelper;
	
	
	public MatActionSelect(DeciTreeOption<MatInfo> option) {
	...
	private SqlStmtExec<MatInfo> buildStmtExec(DeciTreeOption<MatInfo> option) {
		...
		return new MatStmtExecSelect(stmtExecOptions);
	}
