...
import br.com.gda.business.material.dao.MatUpdateAttrExec;
...
public final class ActionMatUpdateAttr implements DeciAction<MatInfo> {
	...
	private SqlStmtExec<MatInfo> buildStmtExec(DeciTreeOption<MatInfo> option) {
		...
		return new MatUpdateAttrExec(stmtExecOptions);
	}
