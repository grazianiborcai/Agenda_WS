...
import br.com.gda.business.material.dao.MatAttrUpdateExec;
...
public final class MatAttrActionUpdate implements DeciAction<MatInfo> {
	DeciAction<MatInfo> actionHelper;
	
	
	public MatAttrActionUpdate(DeciTreeOption<MatInfo> option) {
	...
	private SqlStmtExec<MatInfo> buildStmtExec(DeciTreeOption<MatInfo> option) {
		...
		return new MatAttrUpdateExec(stmtExecOptions);
	}
