...
import br.com.gda.business.material.dao.MatTextInsertExec;
...
public final class MatTextActionInsert implements DeciAction<MatInfo> {
	DeciAction<MatInfo> actionHelper;
	
	
	public MatTextActionInsert(DeciTreeOption<MatInfo> option) {
	...
	private SqlStmtExec<MatInfo> buildStmtExec(DeciTreeOption<MatInfo> option) {
		...
		return new MatTextInsertExec(stmtExecOptions);
	}
