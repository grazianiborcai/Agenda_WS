...
public final class StdMatInsertMatextsnap implements ActionStd<MatInfo> {
	private ActionStd<MatInfo> actionHelper;	
	
	
	public StdMatInsertMatextsnap(DeciTreeOption<MatInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiMatInsertMatextsnap(option.conn, option.schemaName));
	}
