...
public final class LazyMatInsertAttr extends ActionLazyTemplate<MatInfo, MatInfo> {
	
	public LazyMatInsertAttr(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatInsertAttr(option);
	}
