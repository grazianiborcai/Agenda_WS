...
public final class LazyMatFilterNonServ extends ActionLazyTemplate<MatInfo, MatInfo> {
	
	public LazyMatFilterNonServ(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatFilterNonServ(option);
	}
