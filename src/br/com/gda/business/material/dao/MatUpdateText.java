...
public final class MatUpdateText implements SqlStmt<MatInfo> {
	private SqlStmt<MatInfo> stmtSql;
	private SqlStmtOption<MatInfo> stmtOption;
	
	
	public MatUpdateText(Connection conn, MatInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<MatInfo> getNewInstance() {
		return new MatUpdateText(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
