...
public final class MatUpdateAttr implements SqlStmt<MatInfo> {
	private SqlStmt<MatInfo> stmtSql;
	private SqlStmtOption<MatInfo> stmtOption;
	
	
	public MatUpdateAttr(Connection conn, MatInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<MatInfo> getNewInstance() {
		return new MatUpdateAttr(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
