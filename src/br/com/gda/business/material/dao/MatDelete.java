...
public final class MatDelete implements SqlStmt<MatInfo> {
	private SqlStmt<MatInfo> stmtSql;
	private SqlStmtOption<MatInfo> stmtOption;	
	
	
	public MatDelete(Connection conn, MatInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<MatInfo> getNewInstance() {
		return new MatDelete(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
