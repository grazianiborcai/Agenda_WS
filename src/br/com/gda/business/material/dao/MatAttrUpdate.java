...
public final class MatAttrUpdate implements SqlStmt<MatInfo> {
	private SqlStmt<MatInfo> stmtSql;
	private SqlStmtOption<MatInfo> stmtOption;
	
	
	public MatAttrUpdate(Connection conn, MatInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<MatInfo> getNewInstance() {
		return new MatAttrUpdate(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
