...
public final class MatInsertAttr implements SqlStmt<MatInfo> {
	private SqlStmt<MatInfo> stmtSql;
	private SqlStmtOption<MatInfo> stmtOption;
	
	
	
	public MatInsertAttr(Connection conn, MatInfo recordInfo, String schemaName) {
	...
	@Override public SqlStmt<MatInfo> getNewInstance() {
		return new MatInsertAttr(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
