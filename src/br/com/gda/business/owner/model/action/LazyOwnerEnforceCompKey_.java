...
public final class LazyOwnerEnforceCompKey_ extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerEnforceCompKey_(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerEnforceCompKey(option);
	}
