...
public final class LazyOwnerEnforcePersonKey extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerEnforcePersonKey(Connection conn, String schemaName) {
