...
public final class LazyOwnerKeeperOwner extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerKeeperOwner(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerKeeperOwner(option);
	}
