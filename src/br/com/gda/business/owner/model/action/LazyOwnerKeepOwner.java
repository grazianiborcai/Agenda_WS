...
public final class LazyOwnerKeepOwner extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerKeepOwner(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerKeepOwner(option);
	}
