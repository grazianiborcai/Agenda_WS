...
public final class LazyOwnerEnforceEntityCateg extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerEnforceEntityCateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerEnforceEntityCateg(option);
	}
