...
public final class LazyOwnerEnforceAddressKey extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerEnforceAddressKey(Connection conn, String schemaName) {
