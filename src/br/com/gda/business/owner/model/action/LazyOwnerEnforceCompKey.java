...
public final class LazyOwnerEnforceCompKey extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerEnforceCompKey(Connection conn, String schemaName) {
