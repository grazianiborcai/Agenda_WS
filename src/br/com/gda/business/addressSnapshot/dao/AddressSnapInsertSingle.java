...
public final class AddressSnapInsertSingle implements DaoStmt<AddressSnapInfo> {
	...
	public AddressSnapInsertSingle(Connection conn, AddressSnapInfo recordInfo, String schemaName) {
	...
	private class ParamTranslator implements DaoStmtParamTranslator<AddressSnapInfo> {		
		@Override public PreparedStatement translateStmtParam(PreparedStatement stmt, AddressSnapInfo recordInfo) throws SQLException {
	...
	@Override public DaoStmt<AddressSnapInfo> getNewInstance() {
		return new AddressSnapInsertSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
}
