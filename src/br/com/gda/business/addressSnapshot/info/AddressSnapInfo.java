...
public final class AddressSnapInfo extends InfoRecord implements Cloneable {
	...
	public static AddressSnapInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, AddressSnapInfo.class);
	}
	
	
	
	public static List<AddressSnapInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, AddressSnapInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof AddressSnapInfo))
			return false;
		
		
		AddressSnapInfo obj = (AddressSnapInfo) o;		
