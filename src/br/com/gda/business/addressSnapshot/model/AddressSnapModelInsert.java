...
public final class AddressSnapModelInsert implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public AddressSnapModelInsert(String incomingData, HttpServletRequest request) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<AddressSnapInfo> {		
		@Override public DeciTree<AddressSnapInfo> getInstance(DeciTreeOption<AddressSnapInfo> option) {
			return new RootAddressSnapInsert(option);
		}			
	}
}
