...
public final class StdAddressSnapMergeAddress implements ActionStd<AddressSnapInfo> {
	private ActionStd<AddressSnapInfo> actionHelper;	
	
	
	public StdAddressSnapMergeAddress(DeciTreeOption<AddressSnapInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiAddressSnapMergeAddress(option.conn, option.schemaName));
	}
