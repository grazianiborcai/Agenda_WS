...
public final class LazyAddressSnapInsert extends ActionLazyTemplate<AddressSnapInfo, AddressSnapInfo> {

	public LazyAddressSnapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<AddressSnapInfo> getInstanceOfActionHook(DeciTreeOption<AddressSnapInfo> option) {
		return new StdAddressSnapInsert(option);
	}
