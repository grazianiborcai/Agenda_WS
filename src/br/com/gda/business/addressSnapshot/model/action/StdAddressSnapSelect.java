...
import br.com.gda.business.addressSnapshot.dao.AddressSnapSelect;
...
public final class StdAddressSnapSelect implements ActionStd<AddressSnapInfo> {
	private ActionStd<AddressSnapInfo> actionHelper;
	
	
	public StdAddressSnapSelect(DeciTreeOption<AddressSnapInfo> option) {
	...
	private DaoStmtExec<AddressSnapInfo> buildStmtExec(DeciTreeOption<AddressSnapInfo> option) {
		...
		return new AddressSnapSelect(stmtExecOptions);
	}
