package br.com.gda.business.userSnapshot_.model;
...
public final class UserSnapModelSelect implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public UserSnapModelSelect(UserSnapInfo recordInfo) {
		initialize();
	...
	private void buildHelper(UserSnapInfo recordInfo) {
	...
	private static class TreeFactory implements DeciTreeFactory<UserSnapInfo> {		
		@Override public DeciTree<UserSnapInfo> getInstance(DeciTreeOption<UserSnapInfo> option) {
			return new RootUserSnapSelect(option);
		}		
	}
}
