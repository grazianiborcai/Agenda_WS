...
final class StdUserSnapMergePersonSnap implements ActionStd<UserSnapInfo> {
	private ActionStd<UserSnapInfo> actionHelper;	
	
	
	public StdUserSnapMergePersonSnap(DeciTreeOption<UserSnapInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiUserSnapMergePersonSnap(option.conn, option.schemaName));
	}
