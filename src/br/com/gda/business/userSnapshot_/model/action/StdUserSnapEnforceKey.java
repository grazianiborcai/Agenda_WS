...
public final class StdUserSnapEnforceKey implements ActionStd<UserSnapInfo> {
	private ActionStd<UserSnapInfo> actionHelper;	
	
	
	public StdUserSnapEnforceKey(DeciTreeOption<UserSnapInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiUserSnapEnforceKey());
	}
