...
public final class LazyUserSnapInsert extends ActionLazyTemplate<UserSnapInfo, UserSnapInfo> {
	
	public LazyUserSnapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UserSnapInfo> getInstanceOfActionHook(DeciTreeOption<UserSnapInfo> option) {
		return new StdUserSnapInsert(option);
	}
