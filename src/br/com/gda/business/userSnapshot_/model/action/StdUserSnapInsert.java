...
import br.com.gda.business.userSnapshot_.dao.UserSnapInsert;
...
public final class StdUserSnapInsert implements ActionStd<UserSnapInfo> {
	private ActionStd<UserSnapInfo> actionHelper;
	
	
	public StdUserSnapInsert(DeciTreeOption<UserSnapInfo> option) {
	...
	private DaoStmtExec<UserSnapInfo> buildStmtExec(DeciTreeOption<UserSnapInfo> option) {
		...
		return new UserSnapInsert(stmtExecOptions);
	}
