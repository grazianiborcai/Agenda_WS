...
public final class LazyUserSnapMergePhoneSnap extends ActionLazyTemplate<UserSnapInfo, UserSnapInfo> {
	
	public LazyUserSnapMergePhoneSnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UserSnapInfo> getInstanceOfActionHook(DeciTreeOption<UserSnapInfo> option) {
		return new StdUserSnapMergePhoneSnap(option);
	}
