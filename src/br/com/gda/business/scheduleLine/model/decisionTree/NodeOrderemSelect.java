...
public final class NodeOrderemSelect extends DeciTreeWriteTemplate<SchedineInfo> {
	
	public NodeOrderemSelect(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> selectService = new NodeOrderemSelectService(option).toAction();
