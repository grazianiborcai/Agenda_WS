...
public final class LazyMatextSelectDefault extends ActionLazyTemplate<MatextInfo, MatextInfo> {

	public LazyMatextSelectDefault(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextSelectDefault(option);
	}
