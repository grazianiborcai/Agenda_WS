...
public final class LazyPlanataPruneEmplevate extends ActionLazyTemplate<PlanataInfo, PlanataInfo> {
	
	public LazyPlanataPruneEmplevate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PlanataInfo> getInstanceOfActionHook(DeciTreeOption<PlanataInfo> option) {
		return new StdPlanataPruneEmplevate(option);
	}
