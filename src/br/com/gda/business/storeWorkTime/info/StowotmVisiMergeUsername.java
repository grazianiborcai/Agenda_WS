...
final class StowotmVisiMergeUsername implements InfoMergerVisitor_<StowotmInfo, UsernameInfo, StowotmInfo> {
	...
	private void checkArgument(UsernameInfo sourceOne, StowotmInfo sourceTwo) {
	...
	private StowotmInfo merge(UsernameInfo sourceOne, StowotmInfo sourceTwo) {
	...
	@Override public boolean shouldWrite(UsernameInfo sourceOne, StowotmInfo sourceTwo) {
