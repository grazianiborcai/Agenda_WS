...
public final class StoreWTimeModelInsert implements Model {
	private Model helper;
	private Connection conn;
	private String schemaName;
	
	
	public StoreWTimeModelInsert(String incomingData, HttpServletRequest request) {
		initialize();
	...
	private static class TreeFactory implements DeciTreeFactory<StoreWTimeInfo> {		
		@Override public DeciTree<StoreWTimeInfo> getInstance(DeciTreeOption<StoreWTimeInfo> option) {
			return new RootStoreWTimeInsert(option);
		}			
	}
}
