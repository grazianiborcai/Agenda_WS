...
import br.com.gda.business.storeWorkTime.model.checker.StoreWTimeCheckSWTC;
...
public final class RootStoreWTimeUpdate implements DeciTree<StoreWTimeInfo> {
	private DeciTree<StoreWTimeInfo> tree;
	
	
	public RootStoreWTimeUpdate(DeciTreeOption<StoreWTimeInfo> option) {
	...
	private ModelChecker<StoreWTimeInfo> buildDecisionChecker(DeciTreeOption<StoreWTimeInfo> option) {
		...
		checker = new StoreWTimeCheckSWTC(checkerOption);
		queue.add(checker);	
