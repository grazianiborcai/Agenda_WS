...
import br.com.gda.business.storeWorkTime.dao.StoreWTimeInsert;
...
public final class ActionStoreWTimeInsert implements DeciAction<StoreWTimeInfo> {
	...
	private SqlStmtExec<StoreWTimeInfo> buildStmtExec(DeciTreeOption<StoreWTimeInfo> option) {
		...
		return new StoreWTimeInsert(stmtExecOptions);
	}
