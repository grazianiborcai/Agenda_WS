...
import br.com.gda.business.storeWorkTime.dao.StowotmSelect;
...
public final class StdStowotmSelect implements ActionStd<StowotmInfo> {
	...
	private DaoStmtExec<StowotmInfo> buildStmtExec(DeciTreeOption<StowotmInfo> option) {
		...
		return new StowotmSelect(stmtExecOptions);
	}
