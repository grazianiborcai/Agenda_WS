...
public final class StdUserSnapInsertAddressSnap implements ActionStd<UserSnapInfo> {
	private ActionStd<UserSnapInfo> actionHelper;	
	
	
	public StdUserSnapInsertAddressSnap(DeciTreeOption<UserSnapInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiUserSnapInsertAddressSnap(option.conn, option.schemaName));
	}
