...
public final class LazyUserSnapMergeAddressSnap extends ActionLazyTemplate<UserSnapInfo, UserSnapInfo> {
	
	public LazyUserSnapMergeAddressSnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UserSnapInfo> getInstanceOfActionHook(DeciTreeOption<UserSnapInfo> option) {
		return new StdUserSnapMergeAddressSnap(option);
	}
