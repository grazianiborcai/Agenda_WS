...
public final class LazyUserSnapInsertPhoneSnap extends ActionLazyTemplate<UserSnapInfo, UserSnapInfo> {
	
	public LazyUserSnapInsertPhoneSnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UserSnapInfo> getInstanceOfActionHook(DeciTreeOption<UserSnapInfo> option) {
		return new StdUserSnapInsertPhoneSnap(option);
	}
