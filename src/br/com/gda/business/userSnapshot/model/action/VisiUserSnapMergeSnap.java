...
final class VisiUserSnapMergeSnap extends ActionVisitorTemplateMerge_<UserSnapInfo, SnapInfo> {
	
	public VisiUserSnapMergeSnap(Connection conn, String schemaName) {
