...
public final class SchedyeratCheckExist extends ModelCheckerTemplateActionV2<SchedyeratInfo, SchedyeratInfo> {
	...
	@Override protected ActionStdV1<SchedyeratInfo> buildActionHook(DeciTreeOption<SchedyeratInfo> option) {
		ActionStdV1<SchedyeratInfo> select = new StdSchedyeratDaoSelect(option);
		return select;
	}
