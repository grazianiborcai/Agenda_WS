...
import br.com.mind5.business.scheduleAuthorization.model.checker.SchedauthCheckInsert;
...
public final class RootSchedauthInsert extends DeciTreeTemplateWriteV2<SchedauthInfo> {
	
	public RootSchedauthInsert(DeciTreeOption<SchedauthInfo> option) {
		super(option);
	}
