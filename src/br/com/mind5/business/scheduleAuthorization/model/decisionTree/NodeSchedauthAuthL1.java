...
import br.com.mind5.business.scheduleAuthorization.model.checker.SchedauthCheckAuthOwner;
...
public final class NodeSchedauthAuthL1 extends DeciTreeTemplateWriteV2<SchedauthInfo> {
	
	public NodeSchedauthAuthL1(DeciTreeOption<SchedauthInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<SchedauthInfo>> buildActionsOnFailedHook(DeciTreeOption<SchedauthInfo> option) {
		...
		ActionStdV1<SchedauthInfo> nodeL2 = new NodeSchedauthAuthL2(option).toAction();	
