...
public final class NodeSchedauthInsertL3 extends DeciTreeTemplateWriteV2<SchedauthInfo> {
	
	public NodeSchedauthInsertL3(DeciTreeOption<SchedauthInfo> option) {
		super(option);
	}
