...
public final class NodeSchedauthMoveL1 extends DeciTreeTemplateWriteV2<SchedauthInfo> {
	
	public NodeSchedauthMoveL1(DeciTreeOption<SchedauthInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<SchedauthInfo>> buildActionsOnFailedHook(DeciTreeOption<SchedauthInfo> option) {
		...
		ActionStdV1<SchedauthInfo> nodeL2 = new NodeSchedauthMoveL2(option).toAction();	
