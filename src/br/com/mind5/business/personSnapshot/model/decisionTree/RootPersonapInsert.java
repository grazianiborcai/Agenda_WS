...
public final class RootPersonapInsert extends DeciTreeTemplateWriteV1<PersonapInfo> {
	...
	@Override protected List<ActionStdV1<PersonapInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonapInfo> option) {
		...
		ActionStdV1<PersonapInfo> insert = new StdPersonapInsert(option);	
		ActionLazyV1<PersonapInfo> select = new LazyPersonapRootSelect(option.conn, option.schemaName);	
