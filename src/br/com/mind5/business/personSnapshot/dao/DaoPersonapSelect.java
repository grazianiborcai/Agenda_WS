...
public final class DaoPersonapSelect implements DaoStmtExecV2<PersonapInfo> {
	private DaoStmtExecV2<PersonapInfo> helper;
	
	
	public DaoPersonapSelect(List<DaoStmtExecOption<PersonapInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoPersonapSelectSingle.class, PersonapInfo.class);
	}
