...
public final class PhonarchCheckReadCusPhone extends ModelCheckerTemplateSimple<PhonarchInfo> {

	public PhonarchCheckReadCusPhone(ModelCheckerOption option) {
		super(option);
	}
