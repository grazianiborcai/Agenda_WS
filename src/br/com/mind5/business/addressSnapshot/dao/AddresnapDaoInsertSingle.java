...
public final class AddresnapDaoInsertSingle extends DaoStmtTemplate<AddresnapInfo> {
	private final String MAIN_TABLE = DaoDbTable.ADDRESS_SNAPSHOT_TABLE;	
	
	
	public AddresnapDaoInsertSingle(Connection conn, AddresnapInfo recordInfo, String schemaName) {
