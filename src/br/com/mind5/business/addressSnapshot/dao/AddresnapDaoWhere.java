...
final class AddresnapDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public AddresnapDaoWhere(DaoWhereBuilderOption whereOption, String tableName, AddresnapInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, AddresnapInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case AddresnapDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case AddresnapDaoDbTableColumn.COL_COD_SNAPSHOT :
