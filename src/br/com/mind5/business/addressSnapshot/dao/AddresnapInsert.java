...
public final class AddresnapInsert implements DaoStmtExec_<AddresnapInfo> {
	private DaoStmtExec_<AddresnapInfo> helper;
	
	
	public AddresnapInsert(List<DaoStmtExecOption<AddresnapInfo>> options) {
		helper = new DaoStmtExecHelper_<>(options, AddresnapInsertSingle.class, AddresnapInfo.class);
	}
