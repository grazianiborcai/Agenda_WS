...
import br.com.mind5.business.addressSnapshot.model.action.AddresnapVisiMergeStolis;
...
public final class AddresnapNodeStolis extends DeciTreeTemplateWrite<AddresnapInfo> {
	
	public AddresnapNodeStolis(DeciTreeOption<AddresnapInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddresnapInfo>> buildActionsOnPassedHook(DeciTreeOption<AddresnapInfo> option) {
		...
		ActionStd<AddresnapInfo> mergeStolis = new ActionStdCommom<AddresnapInfo>(option, AddresnapVisiMergeStolis.class);	
