...
import br.com.mind5.business.addressSnapshot.model.action.AddresnapVisiMergeEmplis;
...
public final class AddresnapNodeEmplis extends DeciTreeTemplateWrite<AddresnapInfo> {
	
	public AddresnapNodeEmplis(DeciTreeOption<AddresnapInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddresnapInfo>> buildActionsOnPassedHook(DeciTreeOption<AddresnapInfo> option) {
		...
		ActionStd<AddresnapInfo> mergeEmplis = new ActionStdCommom<AddresnapInfo>(option, AddresnapVisiMergeEmplis.class);	
	...
	@Override protected List<ActionStd<AddresnapInfo>> buildActionsOnFailedHook(DeciTreeOption<AddresnapInfo> option) {
		...
		ActionStd<AddresnapInfo> nodeCuslis = new AddresnapNodeCuslis(option).toAction();	
