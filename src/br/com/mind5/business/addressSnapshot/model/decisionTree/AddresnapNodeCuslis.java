...
import br.com.mind5.business.addressSnapshot.model.action.AddresnapVisiMergeCuslis;
...
public final class AddresnapNodeCuslis extends DeciTreeTemplateWrite<AddresnapInfo> {
	
	public AddresnapNodeCuslis(DeciTreeOption<AddresnapInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddresnapInfo>> buildActionsOnPassedHook(DeciTreeOption<AddresnapInfo> option) {
		...
		ActionStd<AddresnapInfo> mergeCuslis = new ActionStdCommom<AddresnapInfo>(option, AddresnapVisiMergeCuslis.class);	
	...
	@Override protected List<ActionStd<AddresnapInfo>> buildActionsOnFailedHook(DeciTreeOption<AddresnapInfo> option) {
		...
		ActionStd<AddresnapInfo> nodeStolis = new AddresnapNodeStolis(option).toAction();	
