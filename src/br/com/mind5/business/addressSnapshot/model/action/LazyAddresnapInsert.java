...
public final class LazyAddresnapInsert extends ActionLazyTemplateV1<AddresnapInfo, AddresnapInfo> {
	
	public LazyAddresnapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddresnapInfo> getInstanceOfActionHook(DeciTreeOption<AddresnapInfo> option) {
		return new StdAddresnapInsert(option);
	}
