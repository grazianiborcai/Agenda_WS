...
public final class StdAddresnapMergeCountry implements ActionStdV1<AddresnapInfo> {
	private ActionStdV1<AddresnapInfo> actionHelper;	
	
	
	public StdAddresnapMergeCountry(DeciTreeOption<AddresnapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiAddresnapMergeCountry(option.conn, option.schemaName));
	}
