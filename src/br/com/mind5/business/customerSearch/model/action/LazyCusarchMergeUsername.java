...
public final class LazyCusarchMergeUsername extends ActionLazyTemplate<CusarchInfo, CusarchInfo> {
	
	public LazyCusarchMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusarchInfo> getInstanceOfActionHook(DeciTreeOption<CusarchInfo> option) {
		return new StdCusarchMergeUsername(option);
	}
