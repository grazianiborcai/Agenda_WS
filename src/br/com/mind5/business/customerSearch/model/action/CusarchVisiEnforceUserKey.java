...
final class VisiCusarchEnforceUserKey extends ActionVisitorTemplateEnforce<CusarchInfo> {
	
	public VisiCusarchEnforceUserKey(DeciTreeOption<CusarchInfo> option) {
		super(option);
	}
