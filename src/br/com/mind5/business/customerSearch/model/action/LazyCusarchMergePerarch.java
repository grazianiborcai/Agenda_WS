...
public final class LazyCusarchMergePerarch extends ActionLazyTemplate<CusarchInfo, CusarchInfo> {
	
	public LazyCusarchMergePerarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusarchInfo> getInstanceOfActionHook(DeciTreeOption<CusarchInfo> option) {
		return new StdCusarchMergePerarch(option);
	}
