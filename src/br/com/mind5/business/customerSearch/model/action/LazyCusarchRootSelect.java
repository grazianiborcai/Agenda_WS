...
public final class LazyCusarchRootSelect extends ActionLazyTemplate<CusarchInfo, CusarchInfo> {
	
	public LazyCusarchRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusarchInfo> getInstanceOfActionHook(DeciTreeOption<CusarchInfo> option) {
		return new RootCusarchSelect(option).toAction();
	}
