...
import br.com.mind5.business.customerSearch.model.action.CusarchVisiRootSelectAuth;
import br.com.mind5.business.customerSearch.model.action.CusarchVisiEnforceUserKey;
...
public final class CusarchRootSelectUserAuth extends DeciTreeTemplateRead<CusarchInfo> {
	
	public CusarchRootSelectUserAuth(DeciTreeOption<CusarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CusarchInfo>> buildActionsOnPassedHook(DeciTreeOption<CusarchInfo> option) {
		...
		ActionStd<CusarchInfo> enforceUserKey = new ActionStdCommom<CusarchInfo>(option, CusarchVisiEnforceUserKey.class);
		ActionLazy<CusarchInfo> select = new ActionLazyCommom<CusarchInfo>(option, CusarchVisiRootSelectAuth.class);
