...
public final class LazyPlanimeMergeStolis extends ActionLazyTemplateV1<PlanimeInfo, PlanimeInfo> {

	public LazyPlanimeMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PlanimeInfo> getInstanceOfActionHook(DeciTreeOption<PlanimeInfo> option) {
		return new StdPlanimeMergeStolis(option);
	}
