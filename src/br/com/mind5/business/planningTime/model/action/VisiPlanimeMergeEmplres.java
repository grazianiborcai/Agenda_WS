...
final class VisiPlanimeMergeEmplres extends ActionVisitorTemplateMerge<PlanimeInfo, EmplresInfo> {
	
	public VisiPlanimeMergeEmplres(DeciTreeOption<PlanimeInfo> option) {
