...
public final class LazyPlanimePruneMoonase extends ActionLazyTemplate<PlanimeInfo, PlanimeInfo> {
	
	public LazyPlanimePruneMoonase(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PlanimeInfo> getInstanceOfActionHook(DeciTreeOption<PlanimeInfo> option) {
		return new StdPlanimePruneMoonase(option);
	}
