...
public final class LazyPlanimeMergeDaypart extends ActionLazyTemplateV2<PlanimeInfo, PlanimeInfo> {

	public LazyPlanimeMergeDaypart(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PlanimeInfo> getInstanceOfActionHook(DeciTreeOption<PlanimeInfo> option) {
		return new StdPlanimeMergeDaypart(option);
	}
