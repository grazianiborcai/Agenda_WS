...
public final class PlanataVisiPruneStoplis extends ActionVisitorTemplatePrune<PlanataInfo, StoplisInfo> {
	
	public PlanataVisiPruneStoplis(DeciTreeOption<PlanataInfo> option) {
	...
	@Override protected Class<? extends DeciTree<StoplisInfo>> getTreeClassHook() {
		return StoplisRootSearch.class;
	}
