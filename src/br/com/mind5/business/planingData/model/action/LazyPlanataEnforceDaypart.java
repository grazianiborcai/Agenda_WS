...
public final class LazyPlanataEnforceDaypart extends ActionLazyTemplateV2<PlanataInfo, PlanataInfo> {
	
	public LazyPlanataEnforceDaypart(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PlanataInfo> getInstanceOfActionHook(DeciTreeOption<PlanataInfo> option) {
		return new StdPlanataEnforceDaypart(option);
	}
