...
public final class LazyPlanataPruneAged extends ActionLazyTemplateV2<PlanataInfo, PlanataInfo> {
	
	public LazyPlanataPruneAged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PlanataInfo> getInstanceOfActionHook(DeciTreeOption<PlanataInfo> option) {
		return new StdPlanataPruneAged(option);
	}
