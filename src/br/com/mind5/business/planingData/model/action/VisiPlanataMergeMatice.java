...
final class VisiPlanataMergeMatice extends ActionVisitorTemplateMerge<PlanataInfo, MaticeInfo> {
	
	public VisiPlanataMergeMatice(DeciTreeOption<PlanataInfo> option) {
