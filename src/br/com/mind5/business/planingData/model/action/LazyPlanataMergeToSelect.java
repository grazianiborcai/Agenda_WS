...
public final class LazyPlanataMergeToSelect extends ActionLazyTemplateV1<PlanataInfo, PlanataInfo> {
	
	public LazyPlanataMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PlanataInfo> getInstanceOfActionHook(DeciTreeOption<PlanataInfo> option) {
		return new StdPlanataMergeToSelect(option);
	}
