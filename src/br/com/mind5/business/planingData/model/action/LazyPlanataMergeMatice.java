...
public final class LazyPlanataMergeMatice extends ActionLazyTemplate<PlanataInfo, PlanataInfo> {
	
	public LazyPlanataMergeMatice(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PlanataInfo> getInstanceOfActionHook(DeciTreeOption<PlanataInfo> option) {
		return new StdPlanataMergeMatice(option);
	}
