...
public final class EmplateDaoInsertSingle extends DaoStmtTemplate<EmplateInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMP_LD_TABLE;	
	
	
	public EmplateDaoInsertSingle(Connection conn, EmplateInfo recordInfo, String schemaName) {
