...
public final class EmplateDaoUpdateSingle extends DaoStmtTemplate<EmplateInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMP_LD_TABLE;	
	
	
	public EmplateDaoUpdateSingle(Connection conn, EmplateInfo recordInfo, String schemaName) {
