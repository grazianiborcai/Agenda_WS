...
public final class DaoEmplateSelect implements DaoStmtExec<EmplateInfo> {
	private DaoStmtExec<EmplateInfo> helper;
	
	
	public DaoEmplateSelect(List<DaoStmtExecOption<EmplateInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoEmplateSelectSingle.class, EmplateInfo.class);
	}
