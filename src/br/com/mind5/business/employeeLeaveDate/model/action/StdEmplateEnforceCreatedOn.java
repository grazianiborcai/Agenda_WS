...
public final class StdEmplateEnforceCreatedOn implements ActionStdV1<EmplateInfo> {
	private ActionStdV1<EmplateInfo> actionHelper;	
	
	
	public StdEmplateEnforceCreatedOn(DeciTreeOption<EmplateInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiEmplateEnforceCreatedOn());
	}
