...
public final class StdEmplateEnforceValidTo implements ActionStdV1<EmplateInfo> {
	private ActionStdV1<EmplateInfo> actionHelper;	
	
	
	public StdEmplateEnforceValidTo(DeciTreeOption<EmplateInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiEmplateEnforceValidTo());
	}
