...
public final class LazyEmplateEnforceCreatedBy extends ActionLazyTemplateV1<EmplateInfo, EmplateInfo> {
	
	public LazyEmplateEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmplateInfo> getInstanceOfActionHook(DeciTreeOption<EmplateInfo> option) {
		return new StdEmplateEnforceCreatedBy(option);
	}
