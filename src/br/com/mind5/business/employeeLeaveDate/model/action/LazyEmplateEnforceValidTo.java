...
public final class LazyEmplateEnforceValidTo extends ActionLazyTemplateV1<EmplateInfo, EmplateInfo> {

	public LazyEmplateEnforceValidTo(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmplateInfo> getInstanceOfActionHook(DeciTreeOption<EmplateInfo> option) {
		return new StdEmplateEnforceValidTo(option);
	}
