...
public final class LazyEmplevateDelete extends ActionLazyTemplate<EmplevateInfo, EmplevateInfo> {
	
	public LazyEmplevateDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmplevateInfo> getInstanceOfActionHook(DeciTreeOption<EmplevateInfo> option) {
		return new StdEmplevateDelete(option);
	}
