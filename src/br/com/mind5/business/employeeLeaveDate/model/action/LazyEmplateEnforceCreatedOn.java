...
public final class LazyEmplateEnforceCreatedOn extends ActionLazyTemplateV2<EmplateInfo, EmplateInfo> {
	
	public LazyEmplateEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmplateInfo> getInstanceOfActionHook(DeciTreeOption<EmplateInfo> option) {
		return new StdEmplateEnforceCreatedOn(option);
	}
