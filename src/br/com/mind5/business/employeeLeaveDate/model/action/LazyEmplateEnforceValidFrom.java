...
public final class LazyEmplateEnforceValidFrom extends ActionLazyTemplateV1<EmplateInfo, EmplateInfo> {

	public LazyEmplateEnforceValidFrom(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmplateInfo> getInstanceOfActionHook(DeciTreeOption<EmplateInfo> option) {
		return new StdEmplateEnforceValidFrom(option);
	}
