...
public final class LazyEmplevateEnforceLChanged extends ActionLazyTemplate<EmplevateInfo, EmplevateInfo> {

	public LazyEmplevateEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<EmplevateInfo> getInstanceOfActionHook(DeciTreeOption<EmplevateInfo> option) {
		return new StdEmplevateEnforceLChanged(option);
	}
