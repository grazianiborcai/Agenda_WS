...
public final class StdEmplateMergeUsername implements ActionStdV1<EmplateInfo> {
	private ActionStdV1<EmplateInfo> actionHelper;	
	
	
	public StdEmplateMergeUsername(DeciTreeOption<EmplateInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmplateMergeUsername(option.conn, option.schemaName));
	}
