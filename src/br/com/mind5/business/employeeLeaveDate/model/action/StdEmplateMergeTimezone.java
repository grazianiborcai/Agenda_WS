...
public final class StdEmplateMergeTimezone implements ActionStdV1<EmplateInfo> {
	private ActionStdV1<EmplateInfo> actionHelper;	
	
	
	public StdEmplateMergeTimezone(DeciTreeOption<EmplateInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmplateMergeTimezone(option.conn, option.schemaName));
	}
