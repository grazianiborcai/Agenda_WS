...
import br.com.mind5.business.employeeLeaveDate.dao.EmplevateDelete;
...
public final class StdEmplevateDelete implements ActionStd<EmplevateInfo> {
	ActionStd<EmplevateInfo> actionHelper;
	
	
	public StdEmplevateDelete(DeciTreeOption<EmplevateInfo> option) {
	...
	private DaoStmtExec<EmplevateInfo> buildStmtExec(DeciTreeOption<EmplevateInfo> option) {
		...
		return new EmplevateDelete(stmtExecOptions);
	}
