...
import br.com.mind5.business.employeeLeaveDate.dao.EmplevateSelectRange;
...
public final class StdEmplevateSelectRange implements ActionStd<EmplevateInfo> {
	private ActionStd<EmplevateInfo> actionHelper;
	
	
	public StdEmplevateSelectRange(DeciTreeOption<EmplevateInfo> option) {
	...
	private DaoStmtExec<EmplevateInfo> buildStmtExec(DeciTreeOption<EmplevateInfo> option) {
		...
		return new EmplevateSelectRange(stmtExecOptions);
	}
