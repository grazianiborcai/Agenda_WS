...
public final class LazyEmplateDaoSelect extends ActionLazyTemplateV2<EmplateInfo, EmplateInfo> {
	
	public LazyEmplateDaoSelect(Connection conn, String schemaName) {
