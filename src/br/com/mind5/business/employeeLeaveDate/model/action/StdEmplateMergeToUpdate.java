...
public final class StdEmplateMergeToUpdate implements ActionStdV1<EmplateInfo> {
	private ActionStdV1<EmplateInfo> actionHelper;	
	
	
	public StdEmplateMergeToUpdate(DeciTreeOption<EmplateInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmplateMergeToUpdate(option.conn, option.schemaName));
	}
