...
public final class LazyEmplateMergeTimezone extends ActionLazyTemplateV1<EmplateInfo, EmplateInfo> {
	
	public LazyEmplateMergeTimezone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmplateInfo> getInstanceOfActionHook(DeciTreeOption<EmplateInfo> option) {
		return new StdEmplateMergeTimezone(option);
	}
