...
import br.com.mind5.business.employeeLeaveDate.dao.EmplevateInsert;
...
public final class StdEmplevateInsert implements ActionStd<EmplevateInfo> {
	ActionStd<EmplevateInfo> actionHelper;
	
	
	public StdEmplevateInsert(DeciTreeOption<EmplevateInfo> option) {
	...
	private DaoStmtExec<EmplevateInfo> buildStmtExec(DeciTreeOption<EmplevateInfo> option) {
		...
		return new EmplevateInsert(stmtExecOptions);
	}
