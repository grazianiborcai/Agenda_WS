...
public final class EmplateVisiMergeToUpdate extends ActionVisitorTemplateMerge<EmplateInfo, EmplateInfo> {
	
	public EmplateVisiMergeToUpdate(DeciTreeOption<EmplateInfo> option) {
