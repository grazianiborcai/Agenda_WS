...
public final class EmplateVisiMergeToDelete extends ActionVisitorTemplateMerge<EmplateInfo, EmplateInfo> {
	
	public EmplateVisiMergeToDelete(DeciTreeOption<EmplateInfo> option) {
