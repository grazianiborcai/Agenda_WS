...
public final class LazyEmplateMergeToDelete extends ActionLazyTemplateV2<EmplateInfo, EmplateInfo> {
	
	public LazyEmplateMergeToDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmplateInfo> getInstanceOfActionHook(DeciTreeOption<EmplateInfo> option) {
		return new StdEmplateMergeToDelete(option);
	}
