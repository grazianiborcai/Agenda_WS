...
public final class LazyEmplevateRootSelect extends ActionLazyTemplate<EmplevateInfo, EmplevateInfo> {
	
	public LazyEmplevateRootSelect(Connection conn, String schemaName) {
