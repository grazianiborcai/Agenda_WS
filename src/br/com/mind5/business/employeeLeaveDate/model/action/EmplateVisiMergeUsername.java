...
public final class EmplateVisiMergeUsername extends ActionVisitorTemplateMerge<EmplateInfo, UsernameInfo> {
	
	public EmplateVisiMergeUsername(DeciTreeOption<EmplateInfo> option) {
