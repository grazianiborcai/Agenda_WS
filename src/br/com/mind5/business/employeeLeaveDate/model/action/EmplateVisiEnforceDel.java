...
public final class EmplateVisiEnforceDel extends ActionVisitorTemplateEnforce<EmplateInfo> {
	
	public EmplateVisiEnforceDel(DeciTreeOption<EmplateInfo> option) {
		super(option);
	}
