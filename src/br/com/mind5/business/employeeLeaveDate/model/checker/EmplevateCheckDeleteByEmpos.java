...
public final class EmplevateCheckDeleteByEmpos extends ModelCheckerTemplateSimpleV2<EmplevateInfo> {

	public EmplevateCheckDeleteByEmpos(ModelCheckerOption option) {
		super(option);
	}
