...
public final class EmplateCheckDeleteFromEmpos extends ModelCheckerTemplateSimple<EmplateInfo> {

	public EmplateCheckDeleteFromEmpos(ModelCheckerOption option) {
		super(option);
	}
