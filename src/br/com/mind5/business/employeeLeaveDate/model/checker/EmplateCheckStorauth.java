...
public final class EmplateCheckStorauth extends ModelCheckerTemplateForwardV2<EmplateInfo, StorauthInfo> {
	...
	@Override protected StorauthInfo toForwardClass(EmplateInfo baseRecord) {
