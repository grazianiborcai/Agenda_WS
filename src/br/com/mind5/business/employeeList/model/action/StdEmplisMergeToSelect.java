...
public final class StdEmplisMergeToSelect implements ActionStdV1<EmplisInfo> {
	private ActionStdV1<EmplisInfo> actionHelper;	
	
	
	public StdEmplisMergeToSelect(DeciTreeOption<EmplisInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmplisMergeToSelect(option.conn, option.schemaName));
	}
