...
public final class EmplisVisiMergeFimist extends ActionVisitorTemplateMerge<EmplisInfo, FimistInfo> {
	
	public EmplisVisiMergeFimist(DeciTreeOption<EmplisInfo> option) {
