...
public final class BookiceSetterSymsgL12 extends InfoSetterTemplate<BookiceInfo> {
	...
	@Override protected BookiceInfo setAttrHook(BookiceInfo recordInfo) {
		...
		recordInfo.symsgData.codMsg = SystemCode.CART_RESERVE_CONFLICT_ALREADY_EXIST;
