...
final class VisiBookiceEnforceSymsgL09 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public VisiBookiceEnforceSymsgL09(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
