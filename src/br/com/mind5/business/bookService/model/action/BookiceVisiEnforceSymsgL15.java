...
public final class BookiceVisiEnforceSymsgL15 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL15(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
