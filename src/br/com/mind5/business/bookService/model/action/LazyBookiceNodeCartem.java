...
import br.com.mind5.business.bookService.model.decisionTree.NodeBookiceCartem;
import br.com.mind5.model.action.ActionLazyTemplateV2;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyBookiceNodeCartem extends ActionLazyTemplateV2<BookiceInfo, BookiceInfo> {
	
	public LazyBookiceNodeCartem(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<BookiceInfo> getInstanceOfActionHook(DeciTreeOption<BookiceInfo> option) {
		return new NodeBookiceCartem(option).toAction();
	}
