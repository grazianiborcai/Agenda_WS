...
public final class BookiceVisiEnforceSymsgL16 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL16(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
