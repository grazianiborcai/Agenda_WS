...
public final class BookiceVisiEnforceSymsgL02 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL02(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
