...
public final class BookiceVisiEnforceSymsgL01 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL01(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
