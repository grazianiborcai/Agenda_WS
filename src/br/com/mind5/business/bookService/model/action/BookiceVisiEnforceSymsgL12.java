...
public final class BookiceVisiEnforceSymsgL12 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL12(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
