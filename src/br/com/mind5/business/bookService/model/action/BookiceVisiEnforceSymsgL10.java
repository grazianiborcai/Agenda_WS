...
public final class BookiceVisiEnforceSymsgL10 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL10(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
