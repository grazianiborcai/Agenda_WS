...
public final class BookiceVisiEnforceSymsgL05 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL05(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
