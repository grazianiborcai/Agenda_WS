...
public final class BookiceVisiEnforceSymsgL11 extends ActionVisitorTemplateEnforce<BookiceInfo> {
	
	public BookiceVisiEnforceSymsgL11(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
