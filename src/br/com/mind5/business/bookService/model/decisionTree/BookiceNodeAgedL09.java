...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL09;
...
public final class BookiceNodeAgedL09 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL09(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL10 = new BookiceNodeAgedL10(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL09.class);	
