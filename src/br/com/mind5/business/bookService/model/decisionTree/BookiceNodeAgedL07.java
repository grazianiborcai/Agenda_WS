...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL07;
...
public final class BookiceNodeAgedL07 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL07(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL08 = new BookiceNodeAgedL08(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL07.class);	
