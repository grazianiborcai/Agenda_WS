...
public final class NodeBookiceAgedL10 extends DeciTreeTemplateWrite<BookiceInfo> {
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL11 = new NodeBookiceAgedL11(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL10(option);	
