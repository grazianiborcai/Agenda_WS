...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL13;
...
public final class BookiceNodeAgedL13 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL13(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL14 = new BookiceNodeAgedL14(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL13.class);	
