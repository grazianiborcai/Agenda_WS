...
public final class RootBookiceSchedine extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public RootBookiceSchedine(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL1 = new NodeBookiceSchedineL1(option).toAction();
