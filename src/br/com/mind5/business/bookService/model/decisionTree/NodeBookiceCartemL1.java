...
import br.com.mind5.business.bookService.model.action.LazyBookiceNodeCartemL2;
...
public final class NodeBookiceCartemL1 extends DeciTreeTemplateWriteV2<BookiceInfo> {
	
	public NodeBookiceCartemL1(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionLazyV1<BookiceInfo> nodeL2 = new LazyBookiceNodeCartemL2(option.conn, option.schemaName);
