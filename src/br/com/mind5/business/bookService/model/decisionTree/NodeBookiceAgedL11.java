...
import br.com.mind5.business.bookService.model.action.StdBookiceEnforceSymsgL11;
...
public final class NodeBookiceAgedL11 extends DeciTreeTemplateWriteV2<BookiceInfo> {
	
	public NodeBookiceAgedL11(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> nodeL12 = new NodeBookiceAgedL12(option).toAction();	
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL11(option);	
