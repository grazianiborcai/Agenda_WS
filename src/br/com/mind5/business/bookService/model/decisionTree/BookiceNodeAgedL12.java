...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL12;
...
public final class BookiceNodeAgedL12 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL12(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL13 = new BookiceNodeAgedL13(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL12.class);	
