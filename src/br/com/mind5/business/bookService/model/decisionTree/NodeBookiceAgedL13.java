...
public final class NodeBookiceAgedL13 extends DeciTreeTemplateWriteV2<BookiceInfo> {
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> nodeL14 = new NodeBookiceAgedL14(option).toAction();	
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL13(option);	
