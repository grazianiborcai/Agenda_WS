...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL03;
...
public final class BookiceNodeAgedL03 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL03(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL04 = new BookiceNodeAgedL04(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL03.class);	
