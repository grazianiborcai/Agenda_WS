...
import br.com.mind5.business.bookService.model.action.StdBookiceEnforceSymsgL05;
...
public final class NodeBookiceAgedL05 extends DeciTreeTemplateWriteV2<BookiceInfo> {
	
	public NodeBookiceAgedL05(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV2<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV2<BookiceInfo> nodeL06 = new NodeBookiceAgedL07(option).toAction();	
	...
	@Override protected List<ActionStdV2<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV2<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL05(option);	
