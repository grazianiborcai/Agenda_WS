...
public final class NodeBookiceAgedL05 extends DeciTreeTemplateWrite<BookiceInfo> {
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL06 = new NodeBookiceAgedL07(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL05(option);	
