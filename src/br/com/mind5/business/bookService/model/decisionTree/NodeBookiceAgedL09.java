...
public final class NodeBookiceAgedL09 extends DeciTreeTemplateWriteV2<BookiceInfo> {
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> nodeL10 = new NodeBookiceAgedL10(option).toAction();	
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL09(option);	
