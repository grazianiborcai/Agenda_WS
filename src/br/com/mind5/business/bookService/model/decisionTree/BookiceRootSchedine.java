...
public final class BookiceRootSchedine extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceRootSchedine(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL1 = new BookiceNodeSchedineL1(option).toAction();
