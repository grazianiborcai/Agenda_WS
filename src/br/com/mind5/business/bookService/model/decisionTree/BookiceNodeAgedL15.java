...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL15;
...
public final class BookiceNodeAgedL15 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL15(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL15 = new BookiceNodeAgedL16(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL15.class);	
