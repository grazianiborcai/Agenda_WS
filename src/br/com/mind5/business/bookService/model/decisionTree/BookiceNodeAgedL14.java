...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL14;
...
public final class BookiceNodeAgedL14 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL14(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL15 = new BookiceNodeAgedL15(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL14.class);	
