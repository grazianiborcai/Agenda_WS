...
import br.com.mind5.business.bookService.model.action.StdBookiceEnforceSymsgL07;
...
public final class NodeBookiceAgedL07 extends DeciTreeTemplateWriteV2<BookiceInfo> {
	
	public NodeBookiceAgedL07(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> nodeL08 = new NodeBookiceAgedL08(option).toAction();	
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL07(option);	
