...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL10;
...
public final class BookiceNodeAgedL10 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL10(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL11 = new BookiceNodeAgedL11(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL10.class);	
