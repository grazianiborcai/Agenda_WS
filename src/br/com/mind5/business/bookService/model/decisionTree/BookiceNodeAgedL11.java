...
import br.com.mind5.business.bookService.model.action.BookiceVisiEnforceSymsgL11;
...
public final class BookiceNodeAgedL11 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceNodeAgedL11(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL12 = new BookiceNodeAgedL12(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new ActionStdCommom<BookiceInfo>(option, BookiceVisiEnforceSymsgL11.class);	
