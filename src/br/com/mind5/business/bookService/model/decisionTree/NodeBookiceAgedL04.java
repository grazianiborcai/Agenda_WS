...
public final class NodeBookiceAgedL04 extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public NodeBookiceAgedL04(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL05 = new NodeBookiceAgedL05(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL04(option);	
