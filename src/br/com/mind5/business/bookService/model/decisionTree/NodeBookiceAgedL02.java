...
public final class NodeBookiceAgedL02 extends DeciTreeTemplateWriteV2<BookiceInfo> {
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> nodeL03 = new NodeBookiceAgedL03(option).toAction();	
	...
	@Override protected List<ActionStdV1<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStdV1<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL02(option);	
