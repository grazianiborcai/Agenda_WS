...
public final class BookiceRootAged extends DeciTreeTemplateWrite<BookiceInfo> {
	
	public BookiceRootAged(DeciTreeOption<BookiceInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL1 = new BookiceNodeAgedL01(option).toAction();
