...
public final class NodeBookiceAgedL15 extends DeciTreeTemplateWrite<BookiceInfo> {
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnPassedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> nodeL15 = new NodeBookiceAgedL16(option).toAction();	
	...
	@Override protected List<ActionStd<BookiceInfo>> buildActionsOnFailedHook(DeciTreeOption<BookiceInfo> option) {
		...
		ActionStd<BookiceInfo> enforceSymsg = new StdBookiceEnforceSymsgL15(option);	
