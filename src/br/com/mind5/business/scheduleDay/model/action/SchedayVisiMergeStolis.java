...
public final class SchedayVisiMergeStolis extends ActionVisitorTemplateMerge<SchedayInfo, StolisInfo> {
	
	public SchedayVisiMergeStolis(DeciTreeOption<SchedayInfo> option) {
