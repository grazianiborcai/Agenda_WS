...
final class VisiSchedayMergePrevious extends ActionVisitorTemplateMergeV2<SchedayInfo, CalateInfo> {
	
	public VisiSchedayMergePrevious(DeciTreeOption<SchedayInfo> option) {
