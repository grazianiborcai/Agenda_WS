...
public final class LazySchedayMergeCalimore extends ActionLazyTemplate<SchedayInfo, SchedayInfo> {
	
	public LazySchedayMergeCalimore(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV2<SchedayInfo> getInstanceOfActionHook(DeciTreeOption<SchedayInfo> option) {
		return new StdSchedayMergeCalimore(option);
	}
