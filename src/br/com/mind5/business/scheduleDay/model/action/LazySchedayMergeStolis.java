...
public final class LazySchedayMergeStolis extends ActionLazyTemplateV2<SchedayInfo, SchedayInfo> {
	
	public LazySchedayMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedayInfo> getInstanceOfActionHook(DeciTreeOption<SchedayInfo> option) {
		return new StdSchedayMergeStolis(option);
	}
