...
public final class SchedayVisiMergeEmplres extends ActionVisitorTemplateMerge<SchedayInfo, EmplresInfo> {
	
	public SchedayVisiMergeEmplres(DeciTreeOption<SchedayInfo> option) {
