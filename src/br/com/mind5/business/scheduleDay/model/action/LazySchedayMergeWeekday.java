...
public final class LazySchedayMergeWeekday extends ActionLazyTemplateV2<SchedayInfo, SchedayInfo> {
	
	public LazySchedayMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedayInfo> getInstanceOfActionHook(DeciTreeOption<SchedayInfo> option) {
		return new StdSchedayMergeWeekday(option);
	}
