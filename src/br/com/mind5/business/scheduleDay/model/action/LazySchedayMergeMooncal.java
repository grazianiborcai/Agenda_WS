...
public final class LazySchedayMergeMooncal extends ActionLazyTemplateV2<SchedayInfo, SchedayInfo> {
	
	public LazySchedayMergeMooncal(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedayInfo> getInstanceOfActionHook(DeciTreeOption<SchedayInfo> option) {
		return new StdSchedayMergeMooncal(option);
	}
