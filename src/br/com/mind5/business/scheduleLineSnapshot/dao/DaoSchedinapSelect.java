...
public final class DaoSchedinapSelect implements DaoStmtExecV2<SchedinapInfo> {
	private DaoStmtExecV2<SchedinapInfo> helper;
	
	
	public DaoSchedinapSelect(List<DaoStmtExecOption<SchedinapInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoSchedinapSelectSingle.class, SchedinapInfo.class);
	}
