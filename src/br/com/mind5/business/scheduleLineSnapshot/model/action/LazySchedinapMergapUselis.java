...
public final class LazySchedinapMergapUselis extends ActionLazyTemplateV2<SchedinapInfo, SchedinapInfo> {
	
	public LazySchedinapMergapUselis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedinapInfo> getInstanceOfActionHook(DeciTreeOption<SchedinapInfo> option) {
		return new StdSchedinapMergeUselis(option);
	}
