...
public final class StdSchedinapMergeEmplis implements ActionStdV1<SchedinapInfo> {
	private ActionStdV1<SchedinapInfo> actionHelper;	
	
	
	public StdSchedinapMergeEmplis(DeciTreeOption<SchedinapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiSchedinapMergeEmplis(option.conn, option.schemaName));
	}
