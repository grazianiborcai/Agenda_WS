...
public final class SchedinapVisiMergeCuslis extends ActionVisitorTemplateMerge<SchedinapInfo, CuslisInfo> {
	
	public SchedinapVisiMergeCuslis(DeciTreeOption<SchedinapInfo> option) {
