...
public final class SchedinapVisiMergePetlis extends ActionVisitorTemplateMerge<SchedinapInfo, PetlisInfo> {
	
	public SchedinapVisiMergePetlis(DeciTreeOption<SchedinapInfo> option) {
