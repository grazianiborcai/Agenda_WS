...
public final class SchedinapVisiMergeMatlis extends ActionVisitorTemplateMerge<SchedinapInfo, MatlisInfo> {
	
	public SchedinapVisiMergeMatlis(DeciTreeOption<SchedinapInfo> option) {
