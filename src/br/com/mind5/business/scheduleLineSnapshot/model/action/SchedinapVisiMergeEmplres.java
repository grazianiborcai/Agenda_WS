...
public final class SchedinapVisiMergeEmplres extends ActionVisitorTemplateMerge<SchedinapInfo, EmplresInfo> {
	
	public SchedinapVisiMergeEmplres(DeciTreeOption<SchedinapInfo> option) {
