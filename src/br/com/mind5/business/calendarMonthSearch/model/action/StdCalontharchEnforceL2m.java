...
public final class StdCalontharchEnforceL2m extends ActionStdTemplate<CalontharchInfo> {

	public StdCalontharchEnforceL2m(DeciTreeOption<CalontharchInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<CalontharchInfo> buildVisitorHook(DeciTreeOption<CalontharchInfo> option) {
		return new VisiCalontharchEnforceL2m(option);
	}
}
