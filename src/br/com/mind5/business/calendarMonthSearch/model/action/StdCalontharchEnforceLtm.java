...
public final class StdCalontharchEnforceLtm extends ActionStdTemplate<CalontharchInfo> {

	public StdCalontharchEnforceLtm(DeciTreeOption<CalontharchInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<CalontharchInfo> buildVisitorHook(DeciTreeOption<CalontharchInfo> option) {
		return new VisiCalontharchEnforceLtm(option);
	}
}
