...
final class StdStolisMergeTimezone implements ActionStdV1<StolisInfo> {
	private ActionStdV1<StolisInfo> actionHelper;	
	
	
	public StdStolisMergeTimezone(DeciTreeOption<StolisInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiStolisMergeTimezone(option.conn, option.schemaName));
	}
