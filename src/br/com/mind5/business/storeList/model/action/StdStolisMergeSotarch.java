...
public final class StdStolisMergeSotarch implements ActionStdV1<StolisInfo> {
	private ActionStdV1<StolisInfo> actionHelper;	
	
	
	public StdStolisMergeSotarch(DeciTreeOption<StolisInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiStolisMergeSotarch(option.conn, option.schemaName));
	}
