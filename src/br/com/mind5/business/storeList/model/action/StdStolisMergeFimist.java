...
public final class StdStolisMergeFimist implements ActionStdV1<StolisInfo> {
	private ActionStdV1<StolisInfo> actionHelper;	
	
	
	public StdStolisMergeFimist(DeciTreeOption<StolisInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiStolisMergeFimist(option.conn, option.schemaName));
	}
