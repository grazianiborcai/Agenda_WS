...
import br.com.mind5.business.company.model.action.CompVisiEnforceCategOwner;
...
public final class CompRootOwnerInsert extends DeciTreeTemplateWrite<CompInfo> {
	
	public CompRootOwnerInsert(DeciTreeOption<CompInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CompInfo>> buildActionsOnPassedHook(DeciTreeOption<CompInfo> option) {
		...
		ActionStd<CompInfo> enforceCategOwner = new ActionStdCommom<CompInfo>(option, CompVisiEnforceCategOwner.class);
