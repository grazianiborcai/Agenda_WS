...
import br.com.mind5.business.company.model.action.CompVisiNodeInsert;
...
public final class CompRootInsert extends DeciTreeTemplateWrite<CompInfo> {
	
	public CompRootInsert(DeciTreeOption<CompInfo> option) {
		super(option);
	}
