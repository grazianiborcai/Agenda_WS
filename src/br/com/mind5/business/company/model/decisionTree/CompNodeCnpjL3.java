...
public final class CompNodeCnpjL3 extends DeciTreeTemplateWrite<CompInfo> {
	
	public CompNodeCnpjL3(DeciTreeOption<CompInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CompInfo>> buildActionsOnPassedHook(DeciTreeOption<CompInfo> option) {
		...
		ActionStd<CompInfo> nodeL4 = new CompNodeCnpjL4(option).toAction();
	...
	@Override protected List<ActionStd<CompInfo>> buildActionsOnFailedHook(DeciTreeOption<CompInfo> option) {
		...
		ActionStd<CompInfo> nodeL5 = new CompNodeCnpjL5(option).toAction();
