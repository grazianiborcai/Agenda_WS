...
public final class CompCheckSafeInscrEst extends ModelCheckerTemplateSimple<CompInfo> {

	public CompCheckSafeInscrEst(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(CompInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.inscrEst == null)
			return super.SUCCESS;
		
		if (StringValidator.validateCodeNumber(recordInfo.inscrEst) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.COMPANY_INSCRICAO_ESTADUAL);
