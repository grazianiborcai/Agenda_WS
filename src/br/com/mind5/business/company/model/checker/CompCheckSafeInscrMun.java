...
public final class CompCheckSafeInscrMun extends ModelCheckerTemplateSimple<CompInfo> {

	public CompCheckSafeInscrMun(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(CompInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.inscrMun == null)
			return super.SUCCESS;
		
		if (StringValidator.validateCodeNumber(recordInfo.inscrMun) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.COMPANY_INSCRICAO_MUNICIPAL);
