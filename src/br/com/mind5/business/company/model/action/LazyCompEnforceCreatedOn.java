...
public final class LazyCompEnforceCreatedOn extends ActionLazyTemplateV2<CompInfo, CompInfo> {

	public LazyCompEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompEnforceCreatedOn(option);
	}
