...
import br.com.mind5.business.company.model.decisionTree.NodeCompCnpjL1;
import br.com.mind5.model.action.ActionLazyTemplateV1;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyCompNodeCnpjL1 extends ActionLazyTemplateV1<CompInfo, CompInfo> {
	
	public LazyCompNodeCnpjL1(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new NodeCompCnpjL1(option).toAction();
	}
