...
public final class CompVisiEnforceCategStore extends ActionVisitorTemplateEnforce<CompInfo> {
	
	public CompVisiEnforceCategStore(DeciTreeOption<CompInfo> option) {
		super(option);	
	}
