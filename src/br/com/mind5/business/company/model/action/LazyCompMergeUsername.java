...
public final class LazyCompMergeUsername extends ActionLazyTemplateV2<CompInfo, CompInfo> {
	
	public LazyCompMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompMergeUsername(option);
	}
