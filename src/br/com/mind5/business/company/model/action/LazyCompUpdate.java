...
public final class LazyCompUpdate extends ActionLazyTemplateV1<CompInfo, CompInfo> {
	
	public LazyCompUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompUpdate(option);
	}
