...
public final class LazyCompDaoInsert extends ActionLazyTemplateV2<CompInfo, CompInfo> {
	
	public LazyCompDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompDaoInsert(option);
	}
