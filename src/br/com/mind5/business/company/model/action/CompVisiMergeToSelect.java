...
public final class CompVisiMergeToSelect extends ActionVisitorTemplateMerge<CompInfo, CompInfo> {
	
	public CompVisiMergeToSelect(DeciTreeOption<CompInfo> option) {
