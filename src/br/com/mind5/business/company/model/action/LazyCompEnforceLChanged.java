...
public final class LazyCompEnforceLChanged extends ActionLazyTemplateV1<CompInfo, CompInfo> {
	
	public LazyCompEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompEnforceLChanged(option);
	}
