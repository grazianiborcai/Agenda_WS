...
public final class LazyCompEnforceNameSearch extends ActionLazyTemplateV2<CompInfo, CompInfo> {

	public LazyCompEnforceNameSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompEnforceNameSearch(option);
	}
