...
public final class LazyCompDaoDelete extends ActionLazyTemplateV2<CompInfo, CompInfo> {
	
	public LazyCompDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompDaoDelete(option);
	}
