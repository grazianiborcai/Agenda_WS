...
public final class LazyCompEnforceCreatedBy extends ActionLazyTemplateV1<CompInfo, CompInfo> {

	public LazyCompEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompEnforceCreatedBy(option);
	}
