...
public final class LazyCompInsert extends ActionLazyTemplateV1<CompInfo, CompInfo> {
	
	public LazyCompInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompInsert(option);
	}
