...
public final class StdCompEnforceCategStore implements ActionStdV1<CompInfo> {
	private ActionStdV1<CompInfo> actionHelper;	
	
	
	public StdCompEnforceCategStore(DeciTreeOption<CompInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiCompEnforceCategStore());
	}
