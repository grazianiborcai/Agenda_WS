...
public final class CompVisiMergeUsername extends ActionVisitorTemplateMerge<CompInfo, UsernameInfo> {
	
	public CompVisiMergeUsername(DeciTreeOption<CompInfo> option) {
