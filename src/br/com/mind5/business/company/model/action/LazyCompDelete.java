...
public final class LazyCompDelete extends ActionLazyTemplateV1<CompInfo, CompInfo> {
	
	public LazyCompDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CompInfo> getInstanceOfActionHook(DeciTreeOption<CompInfo> option) {
		return new StdCompDelete(option);
	}
