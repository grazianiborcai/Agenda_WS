...
public final class CompVisiMergeToUpdate extends ActionVisitorTemplateMerge<CompInfo, CompInfo> {
	
	public CompVisiMergeToUpdate(DeciTreeOption<CompInfo> option) {
