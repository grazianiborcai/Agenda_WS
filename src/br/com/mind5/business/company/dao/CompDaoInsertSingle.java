...
public final class CompDaoInsertSingle extends DaoStmtTemplate<CompInfo> {	
	private final String MAIN_TABLE = DaoDbTable.COMP_TABLE;	
	
	
	public CompDaoInsertSingle(Connection conn, CompInfo recordInfo, String schemaName) {
