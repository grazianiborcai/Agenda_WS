...
public final class CompDaoDeleteSingle extends DaoStmtTemplate<CompInfo> {
	private final String MAIN_TABLE = DaoDbTable.COMP_TABLE;		
	
	
	public CompDaoDeleteSingle(Connection conn, CompInfo recordInfo, String schemaName) {
