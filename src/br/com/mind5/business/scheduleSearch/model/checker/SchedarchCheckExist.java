...
public final class SchedarchCheckExist extends ModelCheckerTemplateActionV2<SchedarchInfo, SchedarchInfo> {
	...
	@Override protected ActionStdV2<SchedarchInfo> buildActionHook(DeciTreeOption<SchedarchInfo> option) {
		ActionStdV2<SchedarchInfo> select = new RootSchedarchSelect(option).toAction();
		return select;
	}
