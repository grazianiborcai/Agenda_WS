...
public final class LazyCusMergeFimist extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusMergeFimist(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusMergeFimist(option);
	}
