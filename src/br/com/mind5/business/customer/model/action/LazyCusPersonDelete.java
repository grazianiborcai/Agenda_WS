...
public final class LazyCusPersonDelete extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusPersonDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusPersonDelete(option);
	}
