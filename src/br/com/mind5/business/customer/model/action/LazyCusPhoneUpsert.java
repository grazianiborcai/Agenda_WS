...
public final class LazyCusPhoneUpsert extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusPhoneUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusPhoneUpsert(option);
	}
