...
public final class LazyCusUpdate extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusUpdate(option);
	}
