...
public final class LazyCusMergeSytotauh extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusMergeSytotauh(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusMergeSytotauh(option);
	}
