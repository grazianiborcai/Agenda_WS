...
public final class LazyCusUpsertPhone extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusUpsertPhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusUpsertPhone(option);
	}
