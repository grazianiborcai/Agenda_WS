...
public final class LazyCusPersonUpdate extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusPersonUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusPersonUpdate(option);
	}
