...
public final class LazyCusMergeUsername extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusMergeUsername(option);
	}
