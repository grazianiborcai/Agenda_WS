...
import br.com.mind5.business.customer.dao.CusSelect;
...
public final class StdCusSelect implements ActionStdV1<CusInfo> {
	private ActionStdV1<CusInfo> actionHelper;
	
	
	public StdCusSelect(DeciTreeOption<CusInfo> option) {
