...
public final class LazyCusAddressUpsert extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusAddressUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusAddressUpsert(option);
	}
