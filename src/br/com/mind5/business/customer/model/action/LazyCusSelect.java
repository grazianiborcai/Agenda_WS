...
public final class LazyCusSelect extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusSelect(option);
	}
