...
import br.com.mind5.business.customer.model.decisionTree.NodeCusInsert;
import br.com.mind5.model.action.ActionLazyTemplateV2;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyCusNodeInsert extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusNodeInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new NodeCusInsert(option).toAction();
	}
