...
public final class StdCusEnforcePersonKey implements ActionStdV1<CusInfo> {
	private ActionStdV1<CusInfo> actionHelper;	
	
	
	public StdCusEnforcePersonKey(DeciTreeOption<CusInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiCusEnforcePersonKey());
	}
