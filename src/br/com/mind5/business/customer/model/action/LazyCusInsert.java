...
public final class LazyCusInsert extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusInsert(option);
	}
