...
public final class LazyCusEnforceLChanged extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusEnforceLChanged(option);
	}
