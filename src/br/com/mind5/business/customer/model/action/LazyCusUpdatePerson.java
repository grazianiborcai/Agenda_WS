...
public final class LazyCusUpdatePerson extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusUpdatePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusUpdatePerson(option);
	}
