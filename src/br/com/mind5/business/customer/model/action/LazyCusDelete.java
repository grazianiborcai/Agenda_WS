...
public final class LazyCusDelete extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusDelete(option);
	}
