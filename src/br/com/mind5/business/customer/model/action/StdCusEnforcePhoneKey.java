...
public final class StdCusEnforcePhoneKey implements ActionStdV1<CusInfo> {
	private ActionStdV1<CusInfo> actionHelper;	
	
	
	public StdCusEnforcePhoneKey(DeciTreeOption<CusInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiCusEnforcePhoneKey());
	}
