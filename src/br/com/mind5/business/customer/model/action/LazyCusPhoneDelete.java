...
public final class LazyCusPhoneDelete extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusPhoneDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusPhoneDelete(option);
	}
