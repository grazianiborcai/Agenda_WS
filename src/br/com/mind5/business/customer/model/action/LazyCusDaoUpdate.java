...
public final class LazyCusDaoUpdate extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusDaoUpdate(option);
	}
