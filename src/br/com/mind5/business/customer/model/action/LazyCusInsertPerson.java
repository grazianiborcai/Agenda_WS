...
public final class LazyCusInsertPerson extends ActionLazyTemplateV1<CusInfo, CusInfo> {
	
	public LazyCusInsertPerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusInsertPerson(option);
	}
