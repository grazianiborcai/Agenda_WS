...
public final class LazyCusEnforceCreatedBy extends ActionLazyTemplateV2<CusInfo, CusInfo> {
	
	public LazyCusEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusInfo> getInstanceOfActionHook(DeciTreeOption<CusInfo> option) {
		return new StdCusEnforceCreatedBy(option);
	}
