...
import br.com.mind5.business.customer.model.action.CusVisiAddressUpsert;
import br.com.mind5.business.customer.model.action.CusVisiEnforceAddressKey;
...
public final class CusNodeAddressUpsert extends DeciTreeTemplateWrite<CusInfo> {
	
	public CusNodeAddressUpsert(DeciTreeOption<CusInfo> option) {
		super(option);
	}
