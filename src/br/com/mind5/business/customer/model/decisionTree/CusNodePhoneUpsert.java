...
import br.com.mind5.business.customer.model.action.CusVisiEnforcePhoneKey;
import br.com.mind5.business.customer.model.action.CusVisiPhoneUpsert;
...
public final class CusNodePhoneUpsert extends DeciTreeTemplateWrite<CusInfo> {
	
	public CusNodePhoneUpsert(DeciTreeOption<CusInfo> option) {
		super(option);
	}
