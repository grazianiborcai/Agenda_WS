...
import br.com.mind5.business.customer.model.action.CusVisiPersonUpdate;
...
public final class CusNodePersonUpdate extends DeciTreeTemplateWrite<CusInfo> {
	
	public CusNodePersonUpdate(DeciTreeOption<CusInfo> option) {
		super(option);
	}
