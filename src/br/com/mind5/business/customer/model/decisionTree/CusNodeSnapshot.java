...
import br.com.mind5.business.customer.model.action.CusVisiCusnapInsert;
...
public final class CusNodeSnapshot extends DeciTreeTemplateWrite<CusInfo> {
	
	public CusNodeSnapshot(DeciTreeOption<CusInfo> option) {
		super(option);
	}
