...
import br.com.mind5.business.customer.model.action.CusVisiAddressDelete;
...
public final class CusNodeAddressDelete extends DeciTreeTemplateWrite<CusInfo> {
	
	public CusNodeAddressDelete(DeciTreeOption<CusInfo> option) {
		super(option);
	}
