...
public final class StolargCheckOwner extends ModelCheckerTemplateForward<StolargInfo, OwnerInfo> {
	...
	@Override protected OwnerInfo toForwardClass(StolargInfo baseRecord) {
