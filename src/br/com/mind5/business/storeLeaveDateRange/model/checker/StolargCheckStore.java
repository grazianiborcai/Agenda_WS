...
public final class StolargCheckStore extends ModelCheckerTemplateForward<StolargInfo, StoreInfo> {
	...
	@Override protected StoreInfo toForwardClass(StolargInfo baseRecord) {
