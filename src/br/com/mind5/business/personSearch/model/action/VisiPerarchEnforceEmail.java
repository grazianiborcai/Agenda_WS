...
final class VisiPerarchEnforceEmail extends ActionVisitorTemplateEnforceV2<PerarchInfo> {
	
	public VisiPerarchEnforceEmail(DeciTreeOption<PerarchInfo> option) {
		super(option);
	}
