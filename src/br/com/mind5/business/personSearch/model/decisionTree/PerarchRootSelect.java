...
import br.com.mind5.business.personSearch.model.action.PerarchVisiEnforceNameSearch;
import br.com.mind5.business.personSearch.model.action.PerarchVisiMergeToSelect;
...
public final class PerarchRootSelect extends DeciTreeTemplateRead<PerarchInfo> {
	
	public PerarchRootSelect(DeciTreeOption<PerarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PerarchInfo> option) {
		...
		ActionStd<PerarchInfo> enforceNameSearch = new ActionStdCommom<PerarchInfo>(option, PerarchVisiEnforceNameSearch.class);
		ActionLazy<PerarchInfo> select = new ActionLazyCommom<PerarchInfo>(option, PerarchVisiMergeToSelect.class);		
