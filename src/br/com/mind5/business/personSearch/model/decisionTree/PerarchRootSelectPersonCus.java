...
import br.com.mind5.business.personSearch.model.action.PerarchVisiEnforceCategCus;
...
public final class PerarchRootSelectPersonCus extends DeciTreeTemplateRead<PerarchInfo> {
	
	public PerarchRootSelectPersonCus(DeciTreeOption<PerarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PerarchInfo> option) {
		...
		ActionStd<PerarchInfo> enforceCateg = new ActionStdCommom<PerarchInfo>(option, PerarchVisiEnforceCategCus.class);	
