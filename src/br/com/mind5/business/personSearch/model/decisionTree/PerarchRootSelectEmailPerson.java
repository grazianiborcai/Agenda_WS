...
import br.com.mind5.business.personSearch.model.action.PerarchVisiEnforceEmailPerson;
...
public final class PerarchRootSelectEmailPerson extends DeciTreeTemplateRead<PerarchInfo> {
	
	public PerarchRootSelectEmailPerson(DeciTreeOption<PerarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PerarchInfo> option) {
		...
		ActionStd<PerarchInfo> enforceEmailPerson = new ActionStdCommom<PerarchInfo>(option, PerarchVisiEnforceEmailPerson.class);	
