...
public final class StuntmarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public StuntmarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STORE_LT_TABLE;
		...
		results.put(DaoDbTable.STORE_LTIME_SEARCH_VIEW, columns);
		return results;
	}
}
