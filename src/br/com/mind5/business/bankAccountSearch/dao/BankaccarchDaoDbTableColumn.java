...
public final class BankaccarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	public static final String COL_ACCOUNT_CHECK_DIGIT   = DaoDbField.COL_ACCOUNT_CHECK_DIGIT;
	public static final String COL_ACCOUNT_NUMBER        = DaoDbField.COL_ACCOUNT_NUMBER;
	public static final String COL_BRANCH_CHECK_DIGIT    = DaoDbField.COL_BRANCH_CHECK_DIGIT;
	public static final String COL_BRANCH_NUMBER         = DaoDbField.COL_BRANCH_NUMBER;
	...
	public static final String COL_HOLDER_DOCUMENT       = DaoDbField.COL_HOLDER_DOCUMENT;
	public static final String COL_HOLDER_NAME           = DaoDbField.COL_HOLDER_NAME;
	public static final String COL_LAST_CHANGED          = DaoDbField.COL_LAST_CHANGED;
	public static final String COL_LAST_CHANGED_BY       = DaoDbField.COL_LAST_CHANGED_BY;
	public static final String COL_RECORD_MODE           = DaoDbField.COL_RECORD_MODE;
	
	
	public BankaccarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.BANK_ACCOUNT_TABLE;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_ACCOUNT_NUMBER;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_BRANCH_CHECK_DIGIT;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_COD_BANK_HOLDER_TYPE;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_COD_BANK_ACCOUNT_TYPE;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_BRANCH_NUMBER;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_ACCOUNT_CHECK_DIGIT;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_HOLDER_NAME;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		results.put(DaoDbTable.BANK_ACCOUNT_SEARCH_VIEW, columns);
		return results;
	}
}
