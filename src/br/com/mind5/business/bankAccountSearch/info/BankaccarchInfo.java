...
public final class BankaccarchInfo extends InfoRecord implements Cloneable {
	...
	public static BankaccarchInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, BankaccarchInfo.class);
	}
	
	
	
	public static List<BankaccarchInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, BankaccarchInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof BankaccarchInfo))
			return false;
		
		
		BankaccarchInfo obj = (BankaccarchInfo) o;		
