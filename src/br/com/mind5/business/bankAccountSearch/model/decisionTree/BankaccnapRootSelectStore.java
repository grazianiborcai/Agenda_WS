...
public final class BankaccnapRootSelectStore extends DeciTreeTemplateRead<BankaccarchInfo> {
	
	public BankaccnapRootSelectStore(DeciTreeOption<BankaccarchInfo> option) {
		super(option);
	}
