...
import br.com.mind5.business.storeSnapshot.model.action.StorapVisiMergePersolis;
...
public final class StorapNodePerson extends DeciTreeTemplateWrite<StorapInfo> {
	
	public StorapNodePerson(DeciTreeOption<StorapInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorapInfo>> buildActionsOnPassedHook(DeciTreeOption<StorapInfo> option) {
		...
		ActionStd<StorapInfo> mergePersolis = new ActionStdCommom<StorapInfo>(option, StorapVisiMergePersolis.class);
