...
import br.com.mind5.business.storeSnapshot.model.action.StdStorapMergeAddress;
import br.com.mind5.business.storeSnapshot.model.action.StdStorapSuccess;
import br.com.mind5.business.storeSnapshot.model.checker.StorapCheckHasAddress;
...
public final class NodeStorapAddress extends DeciTreeTemplateWriteV2<StorapInfo> {
	
	public NodeStorapAddress(DeciTreeOption<StorapInfo> option) {
		super(option);
	}
	...
	@Override protected ModelCheckerV1<StorapInfo> buildCheckerHook(DeciTreeOption<StorapInfo> option) {		
		...
		checker = new StorapCheckHasAddress(checkerOption);
		queue.add(checker);		
	...
	@Override protected List<ActionStdV1<StorapInfo>> buildActionsOnPassedHook(DeciTreeOption<StorapInfo> option) {
		...
		ActionStdV1<StorapInfo> mergeAddress = new StdStorapMergeAddress(option);
