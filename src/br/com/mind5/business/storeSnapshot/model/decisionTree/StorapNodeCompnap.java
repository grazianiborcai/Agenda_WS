...
import br.com.mind5.business.storeSnapshot.model.action.StorapVisiMergeCompnap;
...
public final class StorapNodeCompnap extends DeciTreeTemplateWrite<StorapInfo> {
	
	public StorapNodeCompnap(DeciTreeOption<StorapInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorapInfo>> buildActionsOnPassedHook(DeciTreeOption<StorapInfo> option) {
		...
		ActionStd<StorapInfo> mergeCompnap = new ActionStdCommom<StorapInfo>(option, StorapVisiMergeCompnap.class);
