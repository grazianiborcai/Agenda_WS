...
public final class StorapVisiMergePersonap extends ActionVisitorTemplateMerge<StorapInfo, PersonapInfo> {
	
	public StorapVisiMergePersonap(DeciTreeOption<StorapInfo> option) {
