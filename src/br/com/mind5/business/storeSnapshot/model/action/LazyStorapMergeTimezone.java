...
public final class LazyStorapMergeTimezone extends ActionLazyTemplateV1<StorapInfo, StorapInfo> {
	
	public LazyStorapMergeTimezone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStorapMergeTimezone(option);
	}
