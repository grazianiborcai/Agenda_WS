...
public final class LazyStorextsnapInsert extends ActionLazyTemplateV2<StorapInfo, StorapInfo> {

	public LazyStorextsnapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStorextsnapInsert(option);
	}
