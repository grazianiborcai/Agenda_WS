...
public final class LazyStorapMergeCurrency extends ActionLazyTemplateV1<StorapInfo, StorapInfo> {
	
	public LazyStorapMergeCurrency(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorapInfo> getInstanceOfActionHook(DeciTreeOption<StorapInfo> option) {
		return new StdStorapMergeCurrency(option);
	}
