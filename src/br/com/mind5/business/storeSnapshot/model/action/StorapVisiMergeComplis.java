...
public final class StorapVisiMergeComplis extends ActionVisitorTemplateMerge<StorapInfo, ComplisInfo> {
	
	public StorapVisiMergeComplis(DeciTreeOption<StorapInfo> option) {
