...
public final class StorapDaoDbTableColumn extends DaoDbTableColumnTemplate {
	public static final String COL_COD_BANK_ACCOUNT = DaoDbField.COL_COD_BANK_ACCOUNT;
	public static final String COL_COD_BANK_ACCOUNT_SNAPSHOT = DaoDbField.COL_COD_BANK_ACCOUNT_SNAPSHOT;
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_COD_BANK_ACCOUNT_SNAPSHOT;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
