...
public final class StorapDaoInsertSingle extends DaoStmtTemplate<StorapInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_SNAPSHOT_TABLE;		
	
	
	public StorapDaoInsertSingle(Connection conn, StorapInfo recordInfo, String schemaName) {
