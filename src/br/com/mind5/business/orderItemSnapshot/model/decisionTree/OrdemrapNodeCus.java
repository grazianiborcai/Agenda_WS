...
import br.com.mind5.business.orderItemSnapshot.model.action.OrdemrapVisiMergeCuslis;
...
public final class OrdemrapNodeCus extends DeciTreeTemplateWrite<OrdemrapInfo> {
	
	public OrdemrapNodeCus(DeciTreeOption<OrdemrapInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrdemrapInfo>> buildActionsOnPassedHook(DeciTreeOption<OrdemrapInfo> option) {
		...
		ActionStd<OrdemrapInfo> mergeCuslis = new ActionStdCommom<OrdemrapInfo>(option, OrdemrapVisiMergeCuslis.class);
