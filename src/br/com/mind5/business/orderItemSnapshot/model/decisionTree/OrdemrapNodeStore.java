...
import br.com.mind5.business.orderItemSnapshot.model.action.OrdemrapVisiMergeStolis;
...
public final class OrdemrapNodeStore extends DeciTreeTemplateWrite<OrdemrapInfo> {
	
	public OrdemrapNodeStore(DeciTreeOption<OrdemrapInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrdemrapInfo>> buildActionsOnPassedHook(DeciTreeOption<OrdemrapInfo> option) {
		...
		ActionStd<OrdemrapInfo> mergeStolis = new ActionStdCommom<OrdemrapInfo>(option, OrdemrapVisiMergeStolis.class);
