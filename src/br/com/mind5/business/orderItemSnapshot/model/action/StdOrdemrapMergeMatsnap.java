...
public final class StdOrdemrapMergeMatsnap implements ActionStdV1<OrdemrapInfo> {
	private ActionStdV1<OrdemrapInfo> actionHelper;	
	
	
	public StdOrdemrapMergeMatsnap(DeciTreeOption<OrdemrapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiOrdemrapMergeMatsnap(option.conn, option.schemaName));
	}
