...
public final class LazyOrdemrapSelect extends ActionLazyTemplateV1<OrdemrapInfo, OrdemrapInfo> {

	public LazyOrdemrapSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdemrapInfo> getInstanceOfActionHook(DeciTreeOption<OrdemrapInfo> option) {
		return new StdOrdemrapSelect(option);
	}
