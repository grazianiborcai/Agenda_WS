...
final class VisiOrdemrapMergeCuslis extends ActionVisitorTemplateMerge<OrdemrapInfo, CuslisInfo> {
	
	public VisiOrdemrapMergeCuslis(DeciTreeOption<OrdemrapInfo> option) {
