...
public final class LazyOrdemrapMergeWeekday extends ActionLazyTemplateV2<OrdemrapInfo, OrdemrapInfo> {
	
	public LazyOrdemrapMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdemrapInfo> getInstanceOfActionHook(DeciTreeOption<OrdemrapInfo> option) {
		return new StdOrdemrapMergeWeekday(option);
	}
