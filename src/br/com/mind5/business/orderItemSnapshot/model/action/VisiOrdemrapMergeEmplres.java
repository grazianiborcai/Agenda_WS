...
final class VisiOrdemrapMergeEmplres extends ActionVisitorTemplateMerge<OrdemrapInfo, EmplresInfo> {
	
	public VisiOrdemrapMergeEmplres(DeciTreeOption<OrdemrapInfo> option) {
