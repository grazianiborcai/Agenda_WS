...
public final class OrdemrapVisiMergeMat extends ActionVisitorTemplateMerge<OrdemrapInfo, MatInfo> {
	
	public OrdemrapVisiMergeMat(DeciTreeOption<OrdemrapInfo> option) {
