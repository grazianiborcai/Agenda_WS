...
public final class MatDaoWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public MatDaoWhere(DaoWhereBuilderOption whereOption, String tableName, MatInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, MatInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case MatDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case MatDaoDbTableColumn.COL_COD_MATERIAL :
				...
				case MatDbTableColumn.COL_COD_CATEGORY :
					...
					break;
					*/
				case MatDaoDbTableColumn.COL_RECORD_MODE :
