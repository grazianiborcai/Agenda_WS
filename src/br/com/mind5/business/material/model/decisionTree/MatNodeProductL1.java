...
public final class MatNodeProductL1 extends DeciTreeTemplateWrite<MatInfo> {
	
	public MatNodeProductL1(DeciTreeOption<MatInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatInfo>> buildActionsOnPassedHook(DeciTreeOption<MatInfo> option) {
		...
		ActionStd<MatInfo> nodeL2 = new MatNodeProductL2(option).toAction();	
