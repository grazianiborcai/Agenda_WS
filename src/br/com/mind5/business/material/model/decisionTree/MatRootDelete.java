...
public final class MatRootDelete extends DeciTreeTemplateWrite<MatInfo> {
	
	public MatRootDelete(DeciTreeOption<MatInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatInfo>> buildActionsOnPassedHook(DeciTreeOption<MatInfo> option) {
		...
		ActionStd<MatInfo> nodeL1 = new MatNodeDeleteL1(option).toAction();
