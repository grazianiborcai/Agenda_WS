...
public final class LazyMatMergeFimist extends ActionLazyTemplateV2<MatInfo, MatInfo> {
	
	public LazyMatMergeFimist(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatMergeFimist(option);
	}
