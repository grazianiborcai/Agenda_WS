...
public final class LazyMatDaoUpdate extends ActionLazyTemplateV2<MatInfo, MatInfo> {
	
	public LazyMatDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatDaoUpdate(option);
	}
