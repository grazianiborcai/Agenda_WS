...
public final class LazyMatEnforceCreatedOn extends ActionLazyTemplateV2<MatInfo, MatInfo> {
	
	public LazyMatEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatEnforceCreatedOn(option);
	}
