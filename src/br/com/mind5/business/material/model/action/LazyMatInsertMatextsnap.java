...
public final class LazyMatInsertMatextsnap extends ActionLazyTemplate<MatInfo, MatInfo> {

	public LazyMatInsertMatextsnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatInsertMatextsnap(option);
	}
