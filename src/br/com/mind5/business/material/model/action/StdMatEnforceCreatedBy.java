...
public final class StdMatEnforceCreatedBy implements ActionStdV1<MatInfo> {
	private ActionStdV1<MatInfo> actionHelper;	
	
	
	public StdMatEnforceCreatedBy(DeciTreeOption<MatInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiMatEnforceCreatedBy());
	}
