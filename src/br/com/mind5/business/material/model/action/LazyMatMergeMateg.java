...
public final class LazyMatMergeMateg extends ActionLazyTemplateV1<MatInfo, MatInfo> {
	
	public LazyMatMergeMateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatMergeMateg(option);
	}
