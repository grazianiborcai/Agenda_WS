...
public final class MatVisiMergeUsername extends ActionVisitorTemplateMerge<MatInfo, UsernameInfo> {
	
	public MatVisiMergeUsername(DeciTreeOption<MatInfo> option) {
