...
public final class LazyMatMergeUsername extends ActionLazyTemplateV2<MatInfo, MatInfo> {
	
	public LazyMatMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatMergeUsername(option);
	}
