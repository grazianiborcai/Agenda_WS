...
public final class StdMatMergeMatUnit implements ActionStdV1<MatInfo> {
	private ActionStdV1<MatInfo> actionHelper;	
	
	
	public StdMatMergeMatUnit(DeciTreeOption<MatInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatMergeMatUnit(option.conn, option.schemaName));
	}
