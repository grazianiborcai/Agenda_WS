...
public final class LazyMatMatextUpsert extends ActionLazyTemplateV2<MatInfo, MatInfo> {
	
	public LazyMatMatextUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatMatextUpsert(option);
	}
