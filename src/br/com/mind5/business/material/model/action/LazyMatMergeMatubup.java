...
public final class LazyMatMergeMatubup extends ActionLazyTemplateV2<MatInfo, MatInfo> {
	
	public LazyMatMergeMatubup(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatMergeMatubup(option);
	}
