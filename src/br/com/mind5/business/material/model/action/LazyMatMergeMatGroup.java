...
public final class LazyMatMergeMatGroup extends ActionLazyTemplateV1<MatInfo, MatInfo> {
	
	public LazyMatMergeMatGroup(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatMergeMatGroup(option);
	}
