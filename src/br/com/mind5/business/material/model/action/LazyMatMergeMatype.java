...
public final class LazyMatMergeMatype extends ActionLazyTemplateV1<MatInfo, MatInfo> {
	
	public LazyMatMergeMatype(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new StdMatMergeMatype(option);
	}
