...
import br.com.mind5.business.material.model.decisionTree.RootMatDelete;
import br.com.mind5.model.action.ActionLazyTemplateV1;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyMatRootDelete extends ActionLazyTemplateV1<MatInfo, MatInfo> {
	
	public LazyMatRootDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatInfo> getInstanceOfActionHook(DeciTreeOption<MatInfo> option) {
		return new RootMatDelete(option).toAction();
	}
