...
public final class StoprosVisiMergeToUpdate extends ActionVisitorTemplateMerge<StoprosInfo, StoprosInfo> {
	
	public StoprosVisiMergeToUpdate(DeciTreeOption<StoprosInfo> option) {
