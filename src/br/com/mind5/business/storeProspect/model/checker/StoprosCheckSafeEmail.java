...
public final class StoprosCheckSafeEmail extends ModelCheckerTemplateSimple<StoprosInfo> {

	public StoprosCheckSafeEmail(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(StoprosInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.prospectEmail == null)
			return super.SUCCESS;
		
		if (StringValidator.validateEmail(recordInfo.prospectEmail) == super.SUCCESS)
			return super.SUCCESS;
