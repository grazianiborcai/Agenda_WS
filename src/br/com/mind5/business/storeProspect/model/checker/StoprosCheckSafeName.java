...
public final class StoprosCheckSafeName extends ModelCheckerTemplateSimple<StoprosInfo> {

	public StoprosCheckSafeName(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(StoprosInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.prospectName == null)
			return super.SUCCESS;
		
		if (StringValidator.validateSafe(recordInfo.prospectName) == super.SUCCESS)
			return super.SUCCESS;
