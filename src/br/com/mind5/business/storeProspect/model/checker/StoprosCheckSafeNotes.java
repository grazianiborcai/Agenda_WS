...
public final class StoprosCheckSafeNotes extends ModelCheckerTemplateSimple<StoprosInfo> {

	public StoprosCheckSafeNotes(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(StoprosInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.notes == null)
			return super.SUCCESS;
		
		if (StringValidator.validateSafe(recordInfo.notes) == super.SUCCESS)
			return super.SUCCESS;
