...
import br.com.mind5.business.storeProspect.model.action.StoprosVisiMergeStoprarch;
...
public final class StoprosRootSearch extends DeciTreeTemplateRead<StoprosInfo> {
	
	public StoprosRootSearch(DeciTreeOption<StoprosInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoprosInfo>> buildActionsOnPassedHook(DeciTreeOption<StoprosInfo> option) {
		...
		ActionStd<StoprosInfo> mergeStoprarch = new ActionStdCommom<StoprosInfo>(option, StoprosVisiMergeStoprarch.class);
