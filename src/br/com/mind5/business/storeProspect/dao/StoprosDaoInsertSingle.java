...
public final class StoprosDaoInsertSingle extends DaoStmtTemplate<StoprosInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_PROSPECT_TABLE;		
	
	
	public StoprosDaoInsertSingle(Connection conn, StoprosInfo recordInfo, String schemaName) {
