...
public final class StoprosDaoUpdateSingle extends DaoStmtTemplate<StoprosInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_PROSPECT_TABLE;	
	
	
	public StoprosDaoUpdateSingle(Connection conn, StoprosInfo recordInfo, String schemaName) {
