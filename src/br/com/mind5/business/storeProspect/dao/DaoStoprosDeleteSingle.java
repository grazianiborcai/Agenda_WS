...
public final class DaoStoprosDeleteSingle extends DaoStmtTemplate<StoprosInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_PROSPECT_TABLE;	
	
	
	public DaoStoprosDeleteSingle(Connection conn, StoprosInfo recordInfo, String schemaName) {
