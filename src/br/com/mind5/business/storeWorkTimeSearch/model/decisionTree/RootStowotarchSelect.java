...
public final class RootStowotarchSelect extends DeciTreeReadTemplate<StowotarchInfo> {
	...
	@Override protected ModelChecker<StowotarchInfo> buildDecisionCheckerHook(DeciTreeOption<StowotarchInfo> option) {
