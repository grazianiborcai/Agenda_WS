...
public final class StowotarchSelectSingle implements DaoStmt<StowotarchInfo> {
	...
	private DaoStmtOption<StowotarchInfo> stmtOption;
	...
	private void buildStmtOption(Connection conn, StowotarchInfo recordInfo, String schemaName) {
		this.stmtOption = new DaoStmtOption<>();
		this.stmtOption.conn = conn;
		this.stmtOption.recordInfo = recordInfo;
		this.stmtOption.schemaName = schemaName;
		this.stmtOption.tableName = LT_STORE_WORK_TIME;
		this.stmtOption.columns = DaoDbTableColumnAll.getTableColumnsAsList(DaoDbTable.STORE_WTIME_SEARCH_VIEW);
	...
	private String buildWhereClause() {
		...
		DaoStmtWhere whereClause = new StowotarchWhere(whereOption, stmtOption.tableName, stmtOption.recordInfo);
	...
	@Override public DaoStmt<StowotarchInfo> getNewInstance() {
		return new StowotarchSelectSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	...
	private static class ResultParser implements DaoResultParser<StowotarchInfo> {
		private final boolean EMPTY_RESULT_SET = false;
		
		@Override public List<StowotarchInfo> parseResult(ResultSet stmtResult, long lastId) throws SQLException {
