...
import br.com.mind5.business.employee.model.action.EmpVisiFimgCopy;
...
public final class EmpNodeUserInsertL2 extends DeciTreeTemplateWrite<EmpInfo> {
	
	public EmpNodeUserInsertL2(DeciTreeOption<EmpInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpInfo> option) {
		...
		ActionStd<EmpInfo> copyFimg = new ActionStdCommom<EmpInfo>(option, EmpVisiFimgCopy.class);
