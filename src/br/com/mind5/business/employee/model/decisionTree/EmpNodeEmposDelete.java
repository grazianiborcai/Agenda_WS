...
import br.com.mind5.business.employee.model.action.EmpVisiEmposDelete;
...
public final class EmpNodeEmposDelete extends DeciTreeTemplateWrite<EmpInfo> {
	
	public EmpNodeEmposDelete(DeciTreeOption<EmpInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpInfo> option) {
		...
		ActionStd<EmpInfo> deleteEmpos = new ActionStdCommom<EmpInfo>(option, EmpVisiEmposDelete.class);
