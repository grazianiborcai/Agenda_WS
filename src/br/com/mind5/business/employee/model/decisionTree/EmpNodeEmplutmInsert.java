...
import br.com.mind5.business.employee.model.action.EmpVisiEmplutmInsert;
...
public final class EmpNodeEmplutmInsert extends DeciTreeTemplateWrite<EmpInfo> {
	
	public EmpNodeEmplutmInsert(DeciTreeOption<EmpInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpInfo> option) {
		...
		ActionLazy<EmpInfo> insertEmplutm = new  ActionLazyCommom<EmpInfo>(option, EmpVisiEmplutmInsert.class);	
		
		enforceEmplutmKey.addPostAction(insertEmplutm);
