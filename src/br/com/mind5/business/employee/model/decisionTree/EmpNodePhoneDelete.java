...
import br.com.mind5.business.employee.model.action.EmpVisiPhoneDelete;
...
public final class EmpNodePhoneDelete extends DeciTreeTemplateWrite<EmpInfo> {
	
	public EmpNodePhoneDelete(DeciTreeOption<EmpInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpInfo> option) {
		...
		ActionStd<EmpInfo> deletePhone = new ActionStdCommom<EmpInfo>(option, EmpVisiPhoneDelete.class);
