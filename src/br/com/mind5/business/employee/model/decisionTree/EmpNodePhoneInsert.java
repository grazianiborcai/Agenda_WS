...
import br.com.mind5.business.employee.model.action.EmpVisiEnforcePhoneCod;
...
public final class EmpNodePhoneInsert extends DeciTreeTemplateWrite<EmpInfo> {
	
	public EmpNodePhoneInsert(DeciTreeOption<EmpInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpInfo> option) {
		...
		ActionStd<EmpInfo> enforcePhoneCod = new ActionStdCommom<EmpInfo>(option, EmpVisiEnforcePhoneCod.class);
