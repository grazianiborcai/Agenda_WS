...
public final class EmpNodeEmpwotmInsert extends DeciTreeTemplateWrite<EmpInfo> {
	
	public EmpNodeEmpwotmInsert(DeciTreeOption<EmpInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpInfo> option) {
		...
		enforceEmpwotmKey.addPostAction(insertEmpwotm);
