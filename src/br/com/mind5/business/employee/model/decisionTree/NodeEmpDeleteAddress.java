...
import br.com.mind5.business.employee.model.action.StdEmpAddressDelete;
...
public final class NodeEmpDeleteAddress extends DeciTreeTemplateWriteV2<EmpInfo> {
	...
	@Override protected List<ActionStdV1<EmpInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpInfo> option) {
		...
		ActionStdV1<EmpInfo> deleteAddress = new StdEmpAddressDelete(option);
