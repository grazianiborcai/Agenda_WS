...
public final class EmpCheckHasFimist extends ModelCheckerTemplateSimple<EmpInfo> {
	
	public EmpCheckHasFimist(ModelCheckerOption option) {
		super(option);
	}
