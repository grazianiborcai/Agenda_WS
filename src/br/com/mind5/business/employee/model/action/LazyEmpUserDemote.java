...
public final class LazyEmpUserDemote extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpUserDemote(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpUserDemote(option);
	}
