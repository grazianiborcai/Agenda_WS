...
public final class LazyEmpEnforcePersonKey extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforcePersonKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEnforcePersonKey(option);
	}
