...
public final class EmpVisiMergeSytotauh extends ActionVisitorTemplateMerge<EmpInfo, SytotauhInfo> {
	
	public EmpVisiMergeSytotauh(DeciTreeOption<EmpInfo> option) {
