...
public final class LazyEmpMergeUselis extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpMergeUselis(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpMergeUselis(option);
	}
