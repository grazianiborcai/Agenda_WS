...
public final class LazyEmpMergeFimist extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpMergeFimist(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpMergeFimist(option);
	}
