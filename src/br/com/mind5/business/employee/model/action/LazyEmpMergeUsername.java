...
public final class LazyEmpMergeUsername extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {
	
	public LazyEmpMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpMergeUsername(option);
	}
