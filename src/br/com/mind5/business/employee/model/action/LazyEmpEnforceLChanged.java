...
public final class LazyEmpEnforceLChanged extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEnforceLChanged(option);
	}
