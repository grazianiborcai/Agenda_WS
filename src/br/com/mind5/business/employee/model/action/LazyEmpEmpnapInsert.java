...
public final class LazyEmpEmpnapInsert extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {
	
	public LazyEmpEmpnapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEmpnapInsert(option);
	}
