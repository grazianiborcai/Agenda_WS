...
public final class LazyEmpEnforceCreatedOn extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEnforceCreatedOn(option);
	}
