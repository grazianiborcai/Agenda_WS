...
public final class LazyEmpUpsertAddress extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpUpsertAddress(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpUpsertAddress(option);
	}
