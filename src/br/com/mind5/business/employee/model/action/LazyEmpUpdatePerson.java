...
public final class LazyEmpUpdatePerson extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpUpdatePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpUpdatePerson(option);
	}
