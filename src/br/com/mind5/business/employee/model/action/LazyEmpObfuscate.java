...
public final class LazyEmpObfuscate extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpObfuscate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpObfuscate(option);
	}
