...
public final class LazyEmpSelect extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpSelect(option);
	}
