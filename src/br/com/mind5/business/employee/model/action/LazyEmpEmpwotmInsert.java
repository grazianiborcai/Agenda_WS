...
public final class LazyEmpEmpwotmInsert extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpEmpwotmInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEmpwotmInsert(option);
	}
