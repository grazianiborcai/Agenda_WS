...
public final class StdEmpDeletePhone implements ActionStdV1<EmpInfo> {
	private ActionStdV1<EmpInfo> actionHelper;	
	
	
	public StdEmpDeletePhone(DeciTreeOption<EmpInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiEmpDeletePhone(option.conn, option.schemaName));
	}
