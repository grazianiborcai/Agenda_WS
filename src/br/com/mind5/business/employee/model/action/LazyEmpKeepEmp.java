...
public final class LazyEmpKeepEmp extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpKeepEmp(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpKeepEmp(option);
	}
