...
public final class LazyEmpMergePerarch extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {
	
	public LazyEmpMergePerarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpMergePerarch(option);
	}
