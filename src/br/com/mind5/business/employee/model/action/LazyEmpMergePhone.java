...
public final class LazyEmpMergePhone extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpMergePhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpMergePhone(option);
	}
