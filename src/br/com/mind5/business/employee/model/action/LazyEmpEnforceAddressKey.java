...
public final class LazyEmpEnforceAddressKey extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforceAddressKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEnforceAddressKey(option);
	}
