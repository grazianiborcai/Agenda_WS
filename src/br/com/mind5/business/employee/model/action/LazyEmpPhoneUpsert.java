...
public final class LazyEmpPhoneUpsert extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {
	
	public LazyEmpPhoneUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpPhoneUpsert(option);
	}
