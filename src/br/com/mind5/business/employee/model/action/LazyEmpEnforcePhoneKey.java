...
public final class LazyEmpEnforcePhoneKey extends ActionLazyTemplate<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforcePhoneKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEnforcePhoneKey(option);
	}
