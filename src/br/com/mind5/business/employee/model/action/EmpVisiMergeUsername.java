...
public final class EmpVisiMergeUsername extends ActionVisitorTemplateMerge<EmpInfo, UsernameInfo> {
	
	public EmpVisiMergeUsername(DeciTreeOption<EmpInfo> option) {
