...
public final class LazyEmpMergeEmparch extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpMergeEmparch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpMergeEmparch(option);
	}
