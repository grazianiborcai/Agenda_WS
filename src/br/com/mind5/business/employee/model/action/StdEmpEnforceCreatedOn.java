...
public final class StdEmpEnforceCreatedOn implements ActionStdV1<EmpInfo> {
	private ActionStdV1<EmpInfo> actionHelper;	
	
	
	public StdEmpEnforceCreatedOn(DeciTreeOption<EmpInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiEmpEnforceCreatedOn());
	}
