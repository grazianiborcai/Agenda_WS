...
public final class LazyEmpUserPromote extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {
	
	public LazyEmpUserPromote(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpUserPromote(option);
	}
