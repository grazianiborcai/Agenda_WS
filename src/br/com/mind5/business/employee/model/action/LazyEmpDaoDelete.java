...
public final class LazyEmpDaoDelete extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {

	public LazyEmpDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpDaoDelete(option);
	}
