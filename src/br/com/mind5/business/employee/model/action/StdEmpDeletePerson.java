...
public final class StdEmpDeletePerson implements ActionStdV1<EmpInfo> {
	private ActionStdV1<EmpInfo> actionHelper;	
	
	
	public StdEmpDeletePerson(DeciTreeOption<EmpInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiEmpDeletePerson(option.conn, option.schemaName));
	}
