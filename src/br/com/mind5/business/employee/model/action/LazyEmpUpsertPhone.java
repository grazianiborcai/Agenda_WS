...
public final class LazyEmpUpsertPhone extends ActionLazyTemplateV1<EmpInfo, EmpInfo> {
	
	public LazyEmpUpsertPhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpUpsertPhone(option);
	}
