...
public final class LazyEmpDaoUpdate extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {

	public LazyEmpDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpDaoUpdate(option);
	}
