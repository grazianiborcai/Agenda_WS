...
public final class LazyEmpEnforceCreatedBy extends ActionLazyTemplateV2<EmpInfo, EmpInfo> {
	
	public LazyEmpEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpInfo> getInstanceOfActionHook(DeciTreeOption<EmpInfo> option) {
		return new StdEmpEnforceCreatedBy(option);
	}
