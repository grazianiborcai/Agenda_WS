...
public final class StdSchedonthatMergeToSelect implements ActionStdV1<SchedonthatInfo> {
	private ActionStdV1<SchedonthatInfo> actionHelper;	
	
	
	public StdSchedonthatMergeToSelect(DeciTreeOption<SchedonthatInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiSchedonthatMergeToSelect(option.conn, option.schemaName));
	}
