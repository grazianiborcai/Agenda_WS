...
public final class LazyPersonEnforceStore extends ActionLazyTemplateV2<PersonInfo, PersonInfo> {

	public LazyPersonEnforceStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonEnforceStore(option);
	}
