...
public final class PersonVisiEnforceNameSearch extends ActionVisitorTemplateEnforce<PersonInfo> {
	
	public PersonVisiEnforceNameSearch(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
