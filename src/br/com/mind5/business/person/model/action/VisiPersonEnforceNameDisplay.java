...
final class VisiPersonEnforceNameDisplay extends ActionVisitorTemplateEnforceV2<PersonInfo> {
	
	public VisiPersonEnforceNameDisplay(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
