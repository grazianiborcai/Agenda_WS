...
public final class LazyPersonEnforceCreatedOn extends ActionLazyTemplateV2<PersonInfo, PersonInfo> {

	public LazyPersonEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonEnforceCreatedOn(option);
	}
