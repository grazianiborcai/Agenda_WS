...
public final class LazyPersonEnforceNameSearch extends ActionLazyTemplateV2<PersonInfo, PersonInfo> {
	
	public LazyPersonEnforceNameSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonEnforceNameSearch(option);
	}
