...
final class VisiPersonEnforceNameSearch extends ActionVisitorTemplateEnforceV2<PersonInfo> {
	
	public VisiPersonEnforceNameSearch(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
