...
import br.com.mind5.business.person.model.decisionTree.NodePersonEmailL1;
import br.com.mind5.model.action.ActionLazyTemplateV2;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyPersonNodeEmailL1 extends ActionLazyTemplateV2<PersonInfo, PersonInfo> {

	public LazyPersonNodeEmailL1(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new NodePersonEmailL1(option).toAction();
	}
