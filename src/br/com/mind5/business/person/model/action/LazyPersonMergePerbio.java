...
public final class LazyPersonMergePerbio extends ActionLazyTemplate<PersonInfo, PersonInfo> {
	
	public LazyPersonMergePerbio(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonMergePerbio(option);
	}
