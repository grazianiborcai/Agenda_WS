...
public final class PersonVisiEnforceCreatedOn extends ActionVisitorTemplateEnforce<PersonInfo> {
	
	public PersonVisiEnforceCreatedOn(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
