...
public final class PersonVisiEnforceLChanged extends ActionVisitorTemplateEnforce<PersonInfo> {
	
	public PersonVisiEnforceLChanged(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
