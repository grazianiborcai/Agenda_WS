...
final class VisiPersonEnforceCategEmp extends ActionVisitorTemplateEnforce<PersonInfo> {
	
	public VisiPersonEnforceCategEmp(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
