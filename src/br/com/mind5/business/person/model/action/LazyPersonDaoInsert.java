...
public final class LazyPersonDaoInsert extends ActionLazyTemplateV2<PersonInfo, PersonInfo> {
	
	public LazyPersonDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonDaoInsert(option);
	}
