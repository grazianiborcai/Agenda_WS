...
public final class StdPersonEnforceCreatedOn implements ActionStdV1<PersonInfo> {
	private ActionStdV1<PersonInfo> actionHelper;	
	
	
	public StdPersonEnforceCreatedOn(DeciTreeOption<PersonInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPersonEnforceCreatedOn());
	}
