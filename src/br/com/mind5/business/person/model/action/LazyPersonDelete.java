...
public final class LazyPersonDelete extends ActionLazyTemplateV1<PersonInfo, PersonInfo> {
	
	public LazyPersonDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonDelete(option);
	}
