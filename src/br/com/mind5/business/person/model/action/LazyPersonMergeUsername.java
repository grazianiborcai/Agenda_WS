...
public final class LazyPersonMergeUsername extends ActionLazyTemplateV1<PersonInfo, PersonInfo> {
	
	public LazyPersonMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PersonInfo> getInstanceOfActionHook(DeciTreeOption<PersonInfo> option) {
		return new StdPersonMergeUsername(option);
	}
