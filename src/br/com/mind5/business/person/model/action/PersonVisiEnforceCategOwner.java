...
public final class PersonVisiEnforceCategOwner extends ActionVisitorTemplateEnforce<PersonInfo> {
	
	public PersonVisiEnforceCategOwner(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
