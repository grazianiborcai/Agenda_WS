...
final class VisiPersonEnforceBirthdate extends ActionVisitorTemplateEnforceV2<PersonInfo> {
	
	public VisiPersonEnforceBirthdate(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
