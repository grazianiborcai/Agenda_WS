...
final class VisiPersonEnforceCategUser extends ActionVisitorTemplateEnforceV2<PersonInfo> {
	
	public VisiPersonEnforceCategUser(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
