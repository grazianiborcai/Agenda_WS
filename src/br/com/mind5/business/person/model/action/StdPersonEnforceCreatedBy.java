...
public final class StdPersonEnforceCreatedBy implements ActionStdV1<PersonInfo> {
	private ActionStdV1<PersonInfo> actionHelper;	
	
	
	public StdPersonEnforceCreatedBy(DeciTreeOption<PersonInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiPersonEnforceCreatedBy());
	}
