...
public final class PersonVisiMergeToSelect extends ActionVisitorTemplateMerge<PersonInfo, PersonInfo> {
	
	public PersonVisiMergeToSelect(DeciTreeOption<PersonInfo> option) {
