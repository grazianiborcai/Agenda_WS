...
public final class PersonRootUpdateEmp extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonRootUpdateEmp(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> update = new PersonRootUpdate(option).toAction();
