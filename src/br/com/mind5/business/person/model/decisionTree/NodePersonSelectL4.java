...
import br.com.mind5.business.person.model.checker.PersonCheckStorauth;
...
public final class NodePersonSelectL4 extends DeciTreeTemplateReadV2<PersonInfo> {
	
	public NodePersonSelectL4(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected ModelCheckerV1<PersonInfo> buildCheckerHook(DeciTreeOption<PersonInfo> option) {
		...
		checker = new PersonCheckStorauth(checkerOption);
		queue.add(checker);	
