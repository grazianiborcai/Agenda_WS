...
import br.com.mind5.business.person.model.checker.PersonCheckIsCategCus;
...
public final class NodePersonSelectL3 extends DeciTreeTemplateReadV2<PersonInfo> {
	
	public NodePersonSelectL3(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected ModelCheckerV1<PersonInfo> buildCheckerHook(DeciTreeOption<PersonInfo> option) {
		...
		checker = new PersonCheckIsCategCus(checkerOption);
		queue.add(checker);	
	...
	@Override protected List<ActionStdV1<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStdV1<PersonInfo> nodeL4 = new NodePersonSelectL4(option).toAction();
