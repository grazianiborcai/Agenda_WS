...
public final class PersonNodeSelectL2 extends DeciTreeTemplateRead<PersonInfo> {
	
	public PersonNodeSelectL2(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> nodeL3 = new PersonNodeSelectL3(option).toAction();
