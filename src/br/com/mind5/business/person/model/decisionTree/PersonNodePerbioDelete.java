...
public final class PersonNodePerbioDelete extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonNodePerbioDelete(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionLazy<PersonInfo> perbioDelete = new ActionLazyCommom<PersonInfo>(option, PersonVisiPerbioDelete.class);
		
		enforcePerbioKey.addPostAction(perbioDelete);
