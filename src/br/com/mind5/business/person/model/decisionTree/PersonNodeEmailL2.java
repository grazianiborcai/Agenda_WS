...
public final class PersonNodeEmailL2 extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonNodeEmailL2(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> nodeL3 = new PersonNodeEmailL3(option).toAction();
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnFailedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> nodeL4 = new PersonNodeEmailL4(option).toAction();
		actions.add(nodeL4);	
