...
public final class PersonNodeCpfL1 extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonNodeCpfL1(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> nodeL2 = new PersonNodeCpfL2(option).toAction();	
