...
import br.com.mind5.business.person.model.action.PersonVisiEnforceCategOwner;
...
public final class PersonRootInsertOwner extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonRootInsertOwner(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> enforceCateg = new ActionStdCommom<PersonInfo>(option, PersonVisiEnforceCategOwner.class);	
