...
import br.com.mind5.business.person.model.action.PersonVisiEnforceCategStore;
...
public final class PersonRootInsertStore extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonRootInsertStore(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> enforceCateg = new ActionStdCommom<PersonInfo>(option, PersonVisiEnforceCategStore.class);	
