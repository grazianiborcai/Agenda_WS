...
public final class RootPersonInsertUser extends DeciTreeTemplateWrite<PersonInfo> {
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> enforceCateg = new StdPersonEnforceCategUser(option);	
