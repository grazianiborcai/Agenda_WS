...
public final class PersonRootDeleteCus extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonRootDeleteCus(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> delete = new PersonRootDelete(option).toAction();
