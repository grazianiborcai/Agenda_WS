...
public final class PersonNodeEmailL3 extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonNodeEmailL3(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnFailedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> nodeL5 = new PersonNodeEmailL5(option).toAction();
