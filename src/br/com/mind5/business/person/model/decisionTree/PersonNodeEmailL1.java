...
public final class PersonNodeEmailL1 extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonNodeEmailL1(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> nodeL2 = new PersonNodeEmailL2(option).toAction();		
