...
import br.com.mind5.business.person.model.action.PersonVisiEnforceCategCus;
...
public final class PersonRootInsertCus extends DeciTreeTemplateWrite<PersonInfo> {
	
	public PersonRootInsertCus(DeciTreeOption<PersonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PersonInfo>> buildActionsOnPassedHook(DeciTreeOption<PersonInfo> option) {
		...
		ActionStd<PersonInfo> enforceCateg = new ActionStdCommom<PersonInfo>(option, PersonVisiEnforceCategCus.class);	
