...
public final class PersonCheckHasNameDisplay extends ModelCheckerTemplateSimpleV2<PersonInfo> {

	public PersonCheckHasNameDisplay(ModelCheckerOption option) {
		super(option);
	}
