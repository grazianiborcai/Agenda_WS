...
public final class PersonDaoInsertSingle extends DaoStmtTemplate<PersonInfo> {	
	private final String MAIN_TABLE = DaoDbTable.PERSON_TABLE;
	
	
	public PersonDaoInsertSingle(Connection conn, PersonInfo recordInfo, String schemaName) {
