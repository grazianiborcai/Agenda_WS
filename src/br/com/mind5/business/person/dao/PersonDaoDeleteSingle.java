...
public final class PersonDaoDeleteSingle extends DaoStmtTemplate<PersonInfo> {
	private final String MAIN_TABLE = DaoDbTable.PERSON_TABLE;
	
	
	public PersonDaoDeleteSingle(Connection conn, PersonInfo recordInfo, String schemaName) {
