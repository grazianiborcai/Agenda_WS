...
public final class PersonDaoUpdateSingle extends DaoStmtTemplate<PersonInfo> {
	private final String MAIN_TABLE = DaoDbTable.PERSON_TABLE;
	
	
	public PersonDaoUpdateSingle(Connection conn, PersonInfo recordInfo, String schemaName) {
