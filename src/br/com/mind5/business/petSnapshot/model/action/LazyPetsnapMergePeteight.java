...
public final class LazyPetsnapMergePeteight extends ActionLazyTemplate<PetsnapInfo, PetsnapInfo> {
	
	public LazyPetsnapMergePeteight(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetsnapInfo> getInstanceOfActionHook(DeciTreeOption<PetsnapInfo> option) {
		return new StdPetsnapMergePeteight(option);
	}
