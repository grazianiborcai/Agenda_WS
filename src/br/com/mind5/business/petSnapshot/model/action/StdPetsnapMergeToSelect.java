...
public final class StdPetsnapMergeToSelect extends ActionStdTemplate<PetsnapInfo> {

	public StdPetsnapMergeToSelect(DeciTreeOption<PetsnapInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<PetsnapInfo> buildVisitorHook(DeciTreeOption<PetsnapInfo> option) {
		return new VisiPetsnapMergeToSelect(option);
	}
}
