...
public final class StdPetsnapMergePeteight extends ActionStdTemplate<PetsnapInfo> {

	public StdPetsnapMergePeteight(DeciTreeOption<PetsnapInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<PetsnapInfo> buildVisitorHook(DeciTreeOption<PetsnapInfo> option) {
		return new VisiPetsnapMergePeteight(option);
	}
}
