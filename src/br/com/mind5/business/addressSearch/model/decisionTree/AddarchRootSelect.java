...
import br.com.mind5.business.addressSearch.model.action.AddarchVisiMergeToSelect;
...
public final class AddarchRootSelect extends DeciTreeTemplateWrite<AddarchInfo> {
	
	public AddarchRootSelect(DeciTreeOption<AddarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddarchInfo>> buildActionsOnPassedHook(DeciTreeOption<AddarchInfo> option) {
		...
		ActionStd<AddarchInfo> select = new ActionStdCommom<AddarchInfo>(option, AddarchVisiMergeToSelect.class);
