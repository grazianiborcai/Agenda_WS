...
public final class AddarchCheckReadUserAddress extends ModelCheckerTemplateSimple<AddarchInfo> {

	public AddarchCheckReadUserAddress(ModelCheckerOption option) {
		super(option);
	}
