...
import br.com.mind5.business.refundPolicyStore.model.action.RefuporeVisiDaoDelete;
...
public final class RefuporeRootDelete extends DeciTreeTemplateWrite<RefuporeInfo> {
	
	public RefuporeRootDelete(DeciTreeOption<RefuporeInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<RefuporeInfo>> buildActionsOnPassedHook(DeciTreeOption<RefuporeInfo> option) {
		...
		ActionStd<RefuporeInfo> delete = new ActionStdCommom<RefuporeInfo>(option, RefuporeVisiDaoDelete.class);
