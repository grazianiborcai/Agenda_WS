...
final class VisiRefuporeMergeRefugroup extends ActionVisitorTemplateMergeV2<RefuporeInfo, RefugroupInfo> {
	
	public VisiRefuporeMergeRefugroup(DeciTreeOption<RefuporeInfo> option) {
