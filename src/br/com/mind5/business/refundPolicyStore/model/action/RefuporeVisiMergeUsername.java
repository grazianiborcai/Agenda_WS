...
public final class RefuporeVisiMergeUsername extends ActionVisitorTemplateMerge<RefuporeInfo, UsernameInfo> {
	
	public RefuporeVisiMergeUsername(DeciTreeOption<RefuporeInfo> option) {
