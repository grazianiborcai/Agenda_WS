...
public final class RefuporeVisiMergeRefupown extends ActionVisitorTemplateMerge<RefuporeInfo, RefupownInfo> {
	
	public RefuporeVisiMergeRefupown(DeciTreeOption<RefuporeInfo> option) {
