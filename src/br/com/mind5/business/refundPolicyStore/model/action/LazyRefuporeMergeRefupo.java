...
public final class LazyRefuporeMergeRefupo extends ActionLazyTemplateV2<RefuporeInfo, RefuporeInfo> {

	public LazyRefuporeMergeRefupo(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<RefuporeInfo> getInstanceOfActionHook(DeciTreeOption<RefuporeInfo> option) {
		return new StdRefuporeMergeRefupo(option);
	}
