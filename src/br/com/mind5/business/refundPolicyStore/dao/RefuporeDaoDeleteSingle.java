...
public final class RefuporeDaoDeleteSingle extends DaoStmtTemplate<RefuporeInfo> {
	private final String MAIN_TABLE = DaoDbTable.REFUND_POLICY_STORE_TABLE;	
	
	
	public RefuporeDaoDeleteSingle(Connection conn, RefuporeInfo recordInfo, String schemaName) {
