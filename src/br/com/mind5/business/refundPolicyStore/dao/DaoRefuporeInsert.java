...
public final class DaoRefuporeInsert implements DaoStmtExecV2<RefuporeInfo> {
	private DaoStmtExecV2<RefuporeInfo> helper;
	
	
	public DaoRefuporeInsert(List<DaoStmtExecOption<RefuporeInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoRefuporeInsertSingle.class, RefuporeInfo.class);
	}
