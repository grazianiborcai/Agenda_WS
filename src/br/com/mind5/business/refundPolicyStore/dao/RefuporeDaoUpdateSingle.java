...
public final class RefuporeDaoUpdateSingle extends DaoStmtTemplate<RefuporeInfo> {
	private final String MAIN_TABLE = DaoDbTable.REFUND_POLICY_STORE_TABLE;
	
	
	public RefuporeDaoUpdateSingle(Connection conn, RefuporeInfo recordInfo, String schemaName) {
