...
public final class RefuporeDaoInsertSingle extends DaoStmtTemplate<RefuporeInfo> {
	private final String MAIN_TABLE = DaoDbTable.REFUND_POLICY_STORE_TABLE;
	
	
	public RefuporeDaoInsertSingle(Connection conn, RefuporeInfo recordInfo, String schemaName) {
