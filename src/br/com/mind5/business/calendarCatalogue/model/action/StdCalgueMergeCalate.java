...
public final class StdCalgueMergeCalate extends ActionStdTemplateV2<CalgueInfo> {

	public StdCalgueMergeCalate(DeciTreeOption<CalgueInfo> option) {
		super(option);
	}
	...
	protected ActionVisitorV2<CalgueInfo> buildVisitorHook(DeciTreeOption<CalgueInfo> option) {
		return new VisiCalgueMergeCalate(option);
	}
}
