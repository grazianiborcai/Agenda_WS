...
public final class LazyCalgueMergeDaypart extends ActionLazyTemplateV2<CalgueInfo, CalgueInfo> {
	
	public LazyCalgueMergeDaypart(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CalgueInfo> getInstanceOfActionHook(DeciTreeOption<CalgueInfo> option) {
		return new StdCalgueMergeDaypart(option);
	}
