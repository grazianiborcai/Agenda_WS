...
public final class LazyCalgueMergeWeekday extends ActionLazyTemplateV2<CalgueInfo, CalgueInfo> {
	
	public LazyCalgueMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CalgueInfo> getInstanceOfActionHook(DeciTreeOption<CalgueInfo> option) {
		return new StdCalgueMergeWeekday(option);
	}
