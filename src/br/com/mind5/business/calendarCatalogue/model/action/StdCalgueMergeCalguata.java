...
public final class StdCalgueMergeCalguata extends ActionStdTemplateV2<CalgueInfo> {

	public StdCalgueMergeCalguata(DeciTreeOption<CalgueInfo> option) {
		super(option);
	}
	...
	protected ActionVisitorV2<CalgueInfo> buildVisitorHook(DeciTreeOption<CalgueInfo> option) {
		return new VisiCalgueMergeCalguata(option);
	}
}
