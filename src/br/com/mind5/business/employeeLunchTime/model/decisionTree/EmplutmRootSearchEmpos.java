...
public final class EmplutmRootSearchEmpos extends DeciTreeTemplateRead<EmplutmInfo> {
	
	public EmplutmRootSearchEmpos(DeciTreeOption<EmplutmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmplutmInfo>> buildActionsOnPassedHook(DeciTreeOption<EmplutmInfo> option) {
		...
		mergeEmplutmarch.addPostAction(select);
