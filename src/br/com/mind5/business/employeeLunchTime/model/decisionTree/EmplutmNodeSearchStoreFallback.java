...
public final class EmplutmNodeSearchStoreFallback extends DeciTreeTemplateWrite<EmplutmInfo> {
	
	public EmplutmNodeSearchStoreFallback(DeciTreeOption<EmplutmInfo> option) {
		super(option);
	}
