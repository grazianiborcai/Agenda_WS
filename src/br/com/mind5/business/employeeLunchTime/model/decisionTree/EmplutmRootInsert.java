...
import br.com.mind5.business.employeeLunchTime.model.action.EmplutmVisiNodeInsert;
import br.com.mind5.business.employeeLunchTime.model.action.EmplutmVisiRootSelect;
...
public final class EmplutmRootInsert extends DeciTreeTemplateWrite<EmplutmInfo> {
	
	public EmplutmRootInsert(DeciTreeOption<EmplutmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmplutmInfo>> buildActionsOnPassedHook(DeciTreeOption<EmplutmInfo> option) {
		...
		ActionLazy<EmplutmInfo> nodeInsert = new ActionLazyCommom<EmplutmInfo>(option, EmplutmVisiNodeInsert.class);
		ActionLazy<EmplutmInfo> select = new ActionLazyCommom<EmplutmInfo>(option, EmplutmVisiRootSelect.class);
