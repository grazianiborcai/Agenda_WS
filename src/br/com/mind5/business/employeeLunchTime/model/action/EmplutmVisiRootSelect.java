...
public final class EmplutmVisiRootSelect extends ActionVisitorTemplateAction<EmplutmInfo, EmplutmInfo> {

	public EmplutmVisiRootSelect(DeciTreeOption<EmplutmInfo> option) {
	...
	@Override protected Class<? extends DeciTree<EmplutmInfo>> getTreeClassHook() {
		return EmplutmRootSelect.class;
	}
