...
public final class EmplutmVisiRootDelete extends ActionVisitorTemplateAction<EmplutmInfo, EmplutmInfo> {

	public EmplutmVisiRootDelete(DeciTreeOption<EmplutmInfo> option) {
	...
	@Override protected Class<? extends DeciTree<EmplutmInfo>> getTreeClassHook() {
		return EmplutmRootDelete.class;
	}
