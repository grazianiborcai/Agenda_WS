...
public final class EmplutmVisiMergeToSelect extends ActionVisitorTemplateMerge<EmplutmInfo, EmplutmInfo> {
	
	public EmplutmVisiMergeToSelect(DeciTreeOption<EmplutmInfo> option) {
	...
	@Override protected List<EmplutmInfo> mergeHook(List<EmplutmInfo> baseInfos, List<EmplutmInfo> selectedInfos) {	
		return EmplutmMerger.mergeToSelect(baseInfos, selectedInfos);
	}
