...
public final class EmplutmCheckDeleteFromEmpos extends ModelCheckerTemplateSimple<EmplutmInfo> {

	public EmplutmCheckDeleteFromEmpos(ModelCheckerOption option) {
		super(option);
	}
