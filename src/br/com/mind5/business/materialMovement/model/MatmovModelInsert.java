...
import br.com.mind5.business.materialMovement.model.decisionTree.MatmovRootInsert;
import br.com.mind5.model.ModelTemplate;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class MatmovModelInsert extends ModelTemplate<MatmovInfo> {	
	...
	@Override protected DeciTree<MatmovInfo> getDecisionTreeHook(DeciTreeOption<MatmovInfo> option) {
		return new MatmovRootInsert(option);
	}
}
