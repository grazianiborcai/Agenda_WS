...
import br.com.mind5.business.materialMovement.model.action.MatmovVisiMergeMatlis;
import br.com.mind5.business.materialMovement.model.action.MatmovVisiMergeToSelect;
...
public final class MatmovRootSelect extends DeciTreeTemplateRead<MatmovInfo> {
	
	public MatmovRootSelect(DeciTreeOption<MatmovInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatmovInfo>> buildActionsOnPassedHook(DeciTreeOption<MatmovInfo> option) {
		...
		ActionStd<MatmovInfo> select = new ActionStdCommom<MatmovInfo>(option, MatmovVisiMergeToSelect.class);
		ActionLazy<MatmovInfo> mergeMatlis = new ActionLazyCommom<MatmovInfo>(option, MatmovVisiMergeMatlis.class);
