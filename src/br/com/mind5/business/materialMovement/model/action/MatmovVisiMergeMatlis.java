...
public final class MatmovVisiMergeMatlis extends ActionVisitorTemplateMerge<MatmovInfo, MatlisInfo> {
	
	public MatmovVisiMergeMatlis(DeciTreeOption<MatmovInfo> option) {
