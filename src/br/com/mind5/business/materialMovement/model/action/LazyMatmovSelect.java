...
public final class LazyMatmovSelect extends ActionLazyTemplate<MatmovInfo, MatmovInfo> {

	public LazyMatmovSelect(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<MatmovInfo> getInstanceOfActionHook(DeciTreeOption<MatmovInfo> option) {
		return new StdMatmovSelect(option);
	}
