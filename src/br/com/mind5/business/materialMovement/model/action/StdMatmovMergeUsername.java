...
public final class StdMatmovMergeUsername implements ActionStdV1<MatmovInfo> {
	private ActionStdV1<MatmovInfo> actionHelper;	
	
	
	public StdMatmovMergeUsername(DeciTreeOption<MatmovInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatmovMergeUsername(option.conn, option.schemaName));
	}
