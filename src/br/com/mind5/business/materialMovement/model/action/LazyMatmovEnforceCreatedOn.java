...
public final class LazyMatmovEnforceCreatedOn extends ActionLazyTemplateV2<MatmovInfo, MatmovInfo> {
	
	public LazyMatmovEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatmovInfo> getInstanceOfActionHook(DeciTreeOption<MatmovInfo> option) {
		return new StdMatmovEnforceCreatedOn(option);
	}
