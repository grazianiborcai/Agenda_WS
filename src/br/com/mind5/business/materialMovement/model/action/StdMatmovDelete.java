...
import br.com.mind5.business.materialMovement.dao.MatmovDelete;
...
public final class StdMatmovDelete implements ActionStd<MatmovInfo> {
	private ActionStd<MatmovInfo> actionHelper;
	
	
	public StdMatmovDelete(DeciTreeOption<MatmovInfo> option) {
	...
	private DaoStmtExec<MatmovInfo> buildStmtExec(DeciTreeOption<MatmovInfo> option) {
		...
		return new MatmovDelete(stmtExecOptions);
	}
