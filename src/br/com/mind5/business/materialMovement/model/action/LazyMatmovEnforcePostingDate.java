...
public final class LazyMatmovEnforcePostingDate extends ActionLazyTemplateV2<MatmovInfo, MatmovInfo> {
	
	public LazyMatmovEnforcePostingDate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatmovInfo> getInstanceOfActionHook(DeciTreeOption<MatmovInfo> option) {
		return new StdMatmovEnforcePostingDate(option);
	}
