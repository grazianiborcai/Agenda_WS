...
public final class MatmovDaoUpdateSingle extends DaoStmtTemplate<MatmovInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_MOVEMENT_TABLE;	
	
	
	public MatmovDaoUpdateSingle(Connection conn, MatmovInfo recordInfo, String schemaName) {
