...
public final class DaoMatmovInsertSingle extends DaoStmtTemplate<MatmovInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_MOVEMENT_TABLE;		
	
	
	public DaoMatmovInsertSingle(Connection conn, MatmovInfo recordInfo, String schemaName) {
