...
public final class LazyCalateMergeMooncal extends ActionLazyTemplateV2<CalateInfo, CalateInfo> {
	
	public LazyCalateMergeMooncal(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CalateInfo> getInstanceOfActionHook(DeciTreeOption<CalateInfo> option) {
		return new StdCalateMergeMooncal(option);
	}
