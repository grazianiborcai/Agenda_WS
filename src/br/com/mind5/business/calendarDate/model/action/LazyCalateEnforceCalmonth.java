...
public final class LazyCalateEnforceCalmonth extends ActionLazyTemplate<CalateInfo, CalateInfo> {
	
	public LazyCalateEnforceCalmonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CalateInfo> getInstanceOfActionHook(DeciTreeOption<CalateInfo> option) {
		return new StdCalateEnforceCalmonth(option);
	}
