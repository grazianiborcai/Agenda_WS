...
public final class LazyCalateRootSearch extends ActionLazyTemplate<CalateInfo, CalateInfo> {
	
	public LazyCalateRootSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CalateInfo> getInstanceOfActionHook(DeciTreeOption<CalateInfo> option) {
		return new RootCalateSearch(option).toAction();
	}
