...
import br.com.mind5.business.calendarDate.model.action.CalateVisiMergeCalatarch;
...
public final class CalateRootSearch extends DeciTreeTemplateRead<CalateInfo> {
	
	public CalateRootSearch(DeciTreeOption<CalateInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CalateInfo>> buildActionsOnPassedHook(DeciTreeOption<CalateInfo> option) {
		...
		ActionStd<CalateInfo> mergeCalatarch = new ActionStdCommom<CalateInfo>(option, CalateVisiMergeCalatarch.class);
