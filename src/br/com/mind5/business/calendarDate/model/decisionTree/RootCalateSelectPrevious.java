...
public final class RootCalateSelectPrevious extends DeciTreeTemplateRead<CalateInfo> {
	...
	@Override protected List<ActionStd<CalateInfo>> buildActionsOnPassedHook(DeciTreeOption<CalateInfo> option) {
		...
		ActionStd<CalateInfo> enforcePrevious = new StdCalateEnforcePrevious(option);
