...
import br.com.mind5.business.companySnapshot.dao.CompnapSelect;
...
public final class StdCompnapSelect implements ActionStdV1<CompnapInfo> {
	ActionStdV1<CompnapInfo> actionHelper;
	
	
	public StdCompnapSelect(DeciTreeOption<CompnapInfo> option) {
	...
	private DaoStmtExec_<CompnapInfo> buildStmtExec(DeciTreeOption<CompnapInfo> option) {
		...
		return new CompnapSelect(stmtExecOptions);
	}
