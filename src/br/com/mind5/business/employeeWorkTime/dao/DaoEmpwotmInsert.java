...
public final class DaoEmpwotmInsert implements DaoStmtExec<EmpwotmInfo> {	
	private DaoStmtExec<EmpwotmInfo> helper;
	
	
	public DaoEmpwotmInsert(List<DaoStmtExecOption<EmpwotmInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoEmpwotmInsertSingle.class, EmpwotmInfo.class);
	}
