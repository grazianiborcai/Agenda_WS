...
public final class EmpwotmDaoUpdateSingle extends DaoStmtTemplate<EmpwotmInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMP_WT_TABLE;	
	
	
	public EmpwotmDaoUpdateSingle(Connection conn, EmpwotmInfo recordInfo, String schemaName) {
