...
public final class EmpwotmDaoDeleteSingle extends DaoStmtTemplate<EmpwotmInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMP_WT_TABLE;	
	
	
	public EmpwotmDaoDeleteSingle(Connection conn, EmpwotmInfo recordInfo, String schemaName) {
