...
public final class EmpwotmDeleteSingle implements DaoStmt<EmpwotmInfo> {
	...
	@Override public DaoStmt<EmpwotmInfo> getNewInstance() {
		return new EmpwotmDeleteSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	
	
	
	private class ResultParser implements DaoResultParser_<EmpwotmInfo> {
