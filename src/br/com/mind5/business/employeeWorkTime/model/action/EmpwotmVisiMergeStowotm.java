...
public final class EmpwotmVisiMergeStowotm extends ActionVisitorTemplateMerge<EmpwotmInfo, StowotmInfo> {
	
	public EmpwotmVisiMergeStowotm(DeciTreeOption<EmpwotmInfo> option) {
