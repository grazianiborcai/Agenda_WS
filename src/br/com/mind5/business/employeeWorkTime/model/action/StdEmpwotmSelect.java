...
import br.com.mind5.business.employeeWorkTime.dao.EmpwotmSelect;
...
public final class StdEmpwotmSelect implements ActionStdV1<EmpwotmInfo> {
	private ActionStdV1<EmpwotmInfo> actionHelper;
	
	
	public StdEmpwotmSelect(DeciTreeOption<EmpwotmInfo> option) {
	...
	private DaoStmtExec_<EmpwotmInfo> buildStmtExec(DeciTreeOption<EmpwotmInfo> option) {
		...
		return new EmpwotmSelect(stmtExecOptions);
	}
