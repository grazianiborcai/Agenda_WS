...
public final class LazyEmpwotmMergeWeekday extends ActionLazyTemplateV2<EmpwotmInfo, EmpwotmInfo> {
	
	public LazyEmpwotmMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpwotmInfo> getInstanceOfActionHook(DeciTreeOption<EmpwotmInfo> option) {
		return new StdEmpwotmMergeWeekday(option);
	}
