...
public final class LazyEmpwotmEnforceLChanged extends ActionLazyTemplateV2<EmpwotmInfo, EmpwotmInfo> {

	public LazyEmpwotmEnforceLChanged(Connection conn, String schemaName) {
