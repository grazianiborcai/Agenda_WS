...
public final class StdEmpwotmMergeEmpwout implements ActionStdV1<EmpwotmInfo> {
	private ActionStdV1<EmpwotmInfo> actionHelper;	
	
	
	public StdEmpwotmMergeEmpwout(DeciTreeOption<EmpwotmInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmpwotmMergeEmpwout(option.conn, option.schemaName));
	}
