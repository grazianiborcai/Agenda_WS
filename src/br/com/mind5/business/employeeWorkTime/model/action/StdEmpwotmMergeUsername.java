...
public final class StdEmpwotmMergeUsername implements ActionStdV1<EmpwotmInfo> {
	private ActionStdV1<EmpwotmInfo> actionHelper;	
	
	
	public StdEmpwotmMergeUsername(DeciTreeOption<EmpwotmInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmpwotmMergeUsername(option.conn, option.schemaName));
	}
