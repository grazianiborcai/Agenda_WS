...
import br.com.mind5.business.employeeWorkTime.dao.EmpwotmSelectRange;
...
public final class StdEmpwotmSelectRange implements ActionStd<EmpwotmInfo> {
	private ActionStd<EmpwotmInfo> actionHelper;
	
	
	public StdEmpwotmSelectRange(DeciTreeOption<EmpwotmInfo> option) {
	...
	private DaoStmtExec<EmpwotmInfo> buildStmtExec(DeciTreeOption<EmpwotmInfo> option) {
		...
		return new EmpwotmSelectRange(stmtExecOptions);
	}
