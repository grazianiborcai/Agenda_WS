...
public final class EmpwotmCheckInsertFromStore extends ModelCheckerTemplateSimpleV2<EmpwotmInfo> {

	public EmpwotmCheckInsertFromStore(ModelCheckerOption option) {
		super(option);
	}
