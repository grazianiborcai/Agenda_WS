...
public final class EmpwotmCheckDeleteFromEmpos extends ModelCheckerTemplateSimple<EmpwotmInfo> {

	public EmpwotmCheckDeleteFromEmpos(ModelCheckerOption option) {
		super(option);
	}
