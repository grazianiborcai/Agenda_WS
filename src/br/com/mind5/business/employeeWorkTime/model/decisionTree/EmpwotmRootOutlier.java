...
import br.com.mind5.business.employeeWorkTime.model.action.EmpwotmVisiMergeEmpwout;
...
public final class EmpwotmRootOutlier extends DeciTreeTemplateRead<EmpwotmInfo> {
	
	public EmpwotmRootOutlier(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpwotmInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpwotmInfo> option) {
		...
		ActionStd<EmpwotmInfo> mergeEmpwout = new ActionStdCommom<EmpwotmInfo>(option, EmpwotmVisiMergeEmpwout.class);
