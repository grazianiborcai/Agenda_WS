...
public final class EmpwotmNodeDeleteIfExist extends DeciTreeTemplateWrite<EmpwotmInfo> {
	
	public EmpwotmNodeDeleteIfExist(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
