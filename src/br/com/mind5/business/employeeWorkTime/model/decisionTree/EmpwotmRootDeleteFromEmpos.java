...
public final class EmpwotmRootDeleteFromEmpos extends DeciTreeTemplateWrite<EmpwotmInfo> {
	
	public EmpwotmRootDeleteFromEmpos(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
