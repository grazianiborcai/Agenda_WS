...
import br.com.mind5.business.employeeWorkTime.model.action.EmpwotmVisiDaoDelete;
...
import br.com.mind5.business.employeeWorkTime.model.action.EmpwotmVisiMergeToDelete;
...
public final class EmpwotmRootDelete extends DeciTreeTemplateWrite<EmpwotmInfo> {
	
	public EmpwotmRootDelete(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpwotmInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpwotmInfo> option) {
		...
		ActionStd<EmpwotmInfo> mergeToDelete = new ActionStdCommom<EmpwotmInfo>(option, EmpwotmVisiMergeToDelete.class);
		ActionLazy<EmpwotmInfo> enforceLChanged = new ActionLazyCommom<EmpwotmInfo>(option, EmpwotmVisiEnforceLChanged.class);
		...
		ActionLazy<EmpwotmInfo> delete = new ActionLazyCommom<EmpwotmInfo>(option, EmpwotmVisiDaoDelete.class);
