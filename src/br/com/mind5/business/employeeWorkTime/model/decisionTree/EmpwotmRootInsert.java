...
import br.com.mind5.business.employeeWorkTime.model.action.EmpwotmVisiNodeInsert;
...
public final class EmpwotmRootInsert extends DeciTreeTemplateWrite<EmpwotmInfo> {
	
	public EmpwotmRootInsert(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpwotmInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpwotmInfo> option) {
		...
		ActionLazy<EmpwotmInfo> nodeInsert = new ActionLazyCommom<EmpwotmInfo>(option, EmpwotmVisiNodeInsert.class);
