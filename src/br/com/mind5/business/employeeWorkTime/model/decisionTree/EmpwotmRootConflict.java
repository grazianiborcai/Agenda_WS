...
import br.com.mind5.business.employeeWorkTime.model.action.EmpwotmVisiMergeEmpwoco;
...
public final class EmpwotmRootConflict extends DeciTreeTemplateRead<EmpwotmInfo> {
	
	public EmpwotmRootConflict(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpwotmInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpwotmInfo> option) {
		...
		ActionStd<EmpwotmInfo> mergeEmpwoco = new ActionStdCommom<EmpwotmInfo>(option, EmpwotmVisiMergeEmpwoco.class);
