...
public final class EmpwotmRootInsertFromStore extends DeciTreeTemplateWrite<EmpwotmInfo> {
	
	public EmpwotmRootInsertFromStore(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmpwotmInfo>> buildActionsOnPassedHook(DeciTreeOption<EmpwotmInfo> option) {
		...
		ActionStd<EmpwotmInfo> nodeL1 = new EmpwotmNodeInsertFromStore(option).toAction();
