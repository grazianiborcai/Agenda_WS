...
public final class EmpwotmNodeSearchStoreFallback extends DeciTreeTemplateWrite<EmpwotmInfo> {
	
	public EmpwotmNodeSearchStoreFallback(DeciTreeOption<EmpwotmInfo> option) {
		super(option);
	}
