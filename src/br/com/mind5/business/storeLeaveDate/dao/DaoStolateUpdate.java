...
public final class DaoStolateUpdate implements DaoStmtExec<StolateInfo> {
	private DaoStmtExec<StolateInfo> helper;
	
	
	public DaoStolateUpdate(List<DaoStmtExecOption<StolateInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoStolateUpdateSingle.class, StolateInfo.class);
	}
