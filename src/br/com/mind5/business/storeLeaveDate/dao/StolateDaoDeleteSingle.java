...
public final class StolateDaoDeleteSingle extends DaoStmtTemplate<StolateInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_LD_TABLE;	
	
	
	public StolateDaoDeleteSingle(Connection conn, StolateInfo recordInfo, String schemaName) {
