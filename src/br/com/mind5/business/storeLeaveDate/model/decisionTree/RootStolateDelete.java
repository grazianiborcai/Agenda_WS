...
public final class RootStolateDelete extends DeciTreeTemplateWrite<StolateInfo> {
	...
	@Override protected List<ActionStd<StolateInfo>> buildActionsOnPassedHook(DeciTreeOption<StolateInfo> option) {
		...
		ActionLazy<StolateInfo> delete = new LazyStolateDaoDelete(option.conn, option.schemaName);
