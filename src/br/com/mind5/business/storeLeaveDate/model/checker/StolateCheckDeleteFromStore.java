...
public final class StolateCheckDeleteFromStore extends ModelCheckerTemplateSimple<StolateInfo> {

	public StolateCheckDeleteFromStore(ModelCheckerOption option) {
		super(option);
	}
