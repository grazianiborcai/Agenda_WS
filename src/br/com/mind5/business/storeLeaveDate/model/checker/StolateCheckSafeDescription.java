...
public final class StolateCheckSafeDescription extends ModelCheckerTemplateSimple<StolateInfo> {

	public StolateCheckSafeDescription(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam01(SystemCode.STORE_LDATE);
