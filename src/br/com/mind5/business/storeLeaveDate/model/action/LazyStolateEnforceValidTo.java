...
public final class LazyStolateEnforceValidTo extends ActionLazyTemplateV1<StolateInfo, StolateInfo> {

	public LazyStolateEnforceValidTo(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateEnforceValidTo(option);
	}
