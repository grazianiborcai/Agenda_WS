...
public final class LazyStolateEnforceMonth extends ActionLazyTemplateV1<StolateInfo, StolateInfo> {
	
	public LazyStolateEnforceMonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateEnforceMonth(option);
	}
