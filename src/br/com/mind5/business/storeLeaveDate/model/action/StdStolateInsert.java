...
import br.com.mind5.business.storeLeaveDate.dao.StolateInsert;
...
public final class StdStolateInsert implements ActionStdV1<StolateInfo> {
	private ActionStdV1<StolateInfo> actionHelper;
	
	
	public StdStolateInsert(DeciTreeOption<StolateInfo> option) {
	...
	private DaoStmtExec_<StolateInfo> buildStmtExec(DeciTreeOption<StolateInfo> option) {
		...
		return new StolateInsert(stmtExecOptions);
	}
