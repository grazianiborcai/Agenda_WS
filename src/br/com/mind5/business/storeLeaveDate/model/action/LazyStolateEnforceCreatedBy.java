...
public final class LazyStolateEnforceCreatedBy extends ActionLazyTemplateV1<StolateInfo, StolateInfo> {
	
	public LazyStolateEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateEnforceCreatedBy(option);
	}
