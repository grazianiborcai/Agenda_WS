...
public final class LazyStolateEnforceValidFrom extends ActionLazyTemplateV2<StolateInfo, StolateInfo> {

	public LazyStolateEnforceValidFrom(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateEnforceValidFrom(option);
	}
