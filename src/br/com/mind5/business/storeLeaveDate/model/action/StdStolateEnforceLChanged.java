...
public final class StdStolateEnforceLChanged implements ActionStdV1<StolateInfo> {
	private ActionStdV1<StolateInfo> actionHelper;	
	
	
	public StdStolateEnforceLChanged(DeciTreeOption<StolateInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiStolateEnforceLChanged());
	}
