...
public final class LazyStolateDaoDelete extends ActionLazyTemplateV2<StolateInfo, StolateInfo> {
	
	public LazyStolateDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateDaoDelete(option);
	}
