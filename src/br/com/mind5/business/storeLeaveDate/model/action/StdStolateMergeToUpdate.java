...
public final class StdStolateMergeToUpdate implements ActionStdV1<StolateInfo> {
	private ActionStdV1<StolateInfo> actionHelper;	
	
	
	public StdStolateMergeToUpdate(DeciTreeOption<StolateInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiStolateMergeToUpdate(option.conn, option.schemaName));
	}
