...
final class VisiStolateEnforceStoreKey extends ActionVisitorTemplateEnforceV2<StolateInfo> {
	
	public VisiStolateEnforceStoreKey(DeciTreeOption<StolateInfo> option) {
		super(option);
	}
