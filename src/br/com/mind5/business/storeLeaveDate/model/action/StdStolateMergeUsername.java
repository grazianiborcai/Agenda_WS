...
public final class StdStolateMergeUsername implements ActionStdV1<StolateInfo> {
	private ActionStdV1<StolateInfo> actionHelper;	
	
	
	public StdStolateMergeUsername(DeciTreeOption<StolateInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiStolateMergeUsername(option.conn, option.schemaName));
	}
