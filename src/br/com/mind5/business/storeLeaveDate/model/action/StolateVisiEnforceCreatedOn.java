...
public final class StolateVisiEnforceCreatedOn extends ActionVisitorTemplateEnforce<StolateInfo> {
	
	public StolateVisiEnforceCreatedOn(DeciTreeOption<StolateInfo> option) {
		super(option);
	}
