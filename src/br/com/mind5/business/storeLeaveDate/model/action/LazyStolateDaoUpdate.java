...
public final class LazyStolateDaoUpdate extends ActionLazyTemplateV2<StolateInfo, StolateInfo> {
	
	public LazyStolateDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateDaoUpdate(option);
	}
