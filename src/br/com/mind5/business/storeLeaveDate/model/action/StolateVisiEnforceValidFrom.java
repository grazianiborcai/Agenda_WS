...
public final class StolateVisiEnforceValidFrom extends ActionVisitorTemplateEnforce<StolateInfo> {
	
	public StolateVisiEnforceValidFrom(DeciTreeOption<StolateInfo> option) {
		super(option);
	}
