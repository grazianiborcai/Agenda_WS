...
public final class StolateVisiEnforceCreatedBy extends ActionVisitorTemplateEnforce<StolateInfo> {
	
	public StolateVisiEnforceCreatedBy(DeciTreeOption<StolateInfo> option) {
		super(option);
	}
