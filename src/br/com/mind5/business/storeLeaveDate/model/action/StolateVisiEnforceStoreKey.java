...
public final class StolateVisiEnforceStoreKey extends ActionVisitorTemplateEnforce<StolateInfo> {
	
	public StolateVisiEnforceStoreKey(DeciTreeOption<StolateInfo> option) {
		super(option);
	}
