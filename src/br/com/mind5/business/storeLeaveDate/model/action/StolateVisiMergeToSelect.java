...
public final class StolateVisiMergeToSelect extends ActionVisitorTemplateMerge<StolateInfo, StolateInfo> {
	
	public StolateVisiMergeToSelect(DeciTreeOption<StolateInfo> option) {
	...
	@Override protected List<StolateInfo> mergeHook(List<StolateInfo> baseInfos, List<StolateInfo> selectedInfos) {	
		return StolateMerger.mergeToSelect(baseInfos, selectedInfos);
	}
