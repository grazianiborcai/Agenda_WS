...
public final class StolateVisiMergeStolis extends ActionVisitorTemplateMerge<StolateInfo, StolisInfo> {
	
	public StolateVisiMergeStolis(DeciTreeOption<StolateInfo> option) {
