...
public final class LazyStolateMergeStolis extends ActionLazyTemplateV2<StolateInfo, StolateInfo> {
	
	public LazyStolateMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateMergeStolis(option);
	}
