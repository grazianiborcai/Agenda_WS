...
public final class LazyStolateMergeToDelete extends ActionLazyTemplateV2<StolateInfo, StolateInfo> {
	
	public LazyStolateMergeToDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StolateInfo> getInstanceOfActionHook(DeciTreeOption<StolateInfo> option) {
		return new StdStolateMergeToDelete(option);
	}
