...
public final class StuntmapDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public StuntmapDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STORE_LT_SNAPSHOT_TABLE;
