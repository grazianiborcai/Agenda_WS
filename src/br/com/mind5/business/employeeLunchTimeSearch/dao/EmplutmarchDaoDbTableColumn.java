...
public final class EmplutmarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public EmplutmarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.EMP_LT_TABLE;
		...
		results.put(DaoDbTable.EMP_LT_SEARCH_VIEW, columns);
		return results;
	}
}
