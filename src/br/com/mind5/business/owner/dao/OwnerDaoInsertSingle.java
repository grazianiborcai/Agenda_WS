...
public final class OwnerDaoInsertSingle extends DaoStmtTemplate<OwnerInfo> {	
	private final String MAIN_TABLE = DaoDbTable.OWNER_TABLE;		
	
	
	public OwnerDaoInsertSingle(Connection conn, OwnerInfo recordInfo, String schemaName) {
