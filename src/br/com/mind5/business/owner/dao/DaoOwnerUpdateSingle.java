...
public final class DaoOwnerUpdateSingle extends DaoStmtTemplate<OwnerInfo> {
	private final String MAIN_TABLE = DaoDbTable.OWNER_TABLE;	
	
	
	public DaoOwnerUpdateSingle(Connection conn, OwnerInfo recordInfo, String schemaName) {
