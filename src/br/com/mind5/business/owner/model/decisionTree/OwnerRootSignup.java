...
public final class OwnerRootSignup extends DeciTreeTemplateWrite<OwnerInfo> {
	
	public OwnerRootSignup(DeciTreeOption<OwnerInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OwnerInfo>> buildActionsOnPassedHook(DeciTreeOption<OwnerInfo> option) {
		...
		ActionStd<OwnerInfo> insert = new OwnerRootInsert(option).toAction();
