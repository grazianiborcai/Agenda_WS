...
import br.com.mind5.business.owner.model.action.OwnerVisiPersonInsert;
...
public final class OwnerNodePersonInsert extends DeciTreeTemplateWrite<OwnerInfo> {
	
	public OwnerNodePersonInsert(DeciTreeOption<OwnerInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OwnerInfo>> buildActionsOnPassedHook(DeciTreeOption<OwnerInfo> option) {
		...
		ActionLazy<OwnerInfo> insertPerson = new ActionLazyCommom<OwnerInfo>(option, OwnerVisiPersonInsert.class);		
