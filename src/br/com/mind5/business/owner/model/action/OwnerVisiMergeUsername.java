...
public final class OwnerVisiMergeUsername extends ActionVisitorTemplateMerge<OwnerInfo, UsernameInfo> {
	
	public OwnerVisiMergeUsername(DeciTreeOption<OwnerInfo> option) {
