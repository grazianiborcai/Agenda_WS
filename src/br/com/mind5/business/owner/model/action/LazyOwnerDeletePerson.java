...
public final class LazyOwnerDeletePerson extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerDeletePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerDeletePerson(option);
	}
