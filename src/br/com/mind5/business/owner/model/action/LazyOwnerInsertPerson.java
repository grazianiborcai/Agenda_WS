...
public final class LazyOwnerInsertPerson extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerInsertPerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerInsertPerson(option);
	}
