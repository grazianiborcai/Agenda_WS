...
public final class OwnerVisiEnforceLChanged extends ActionVisitorTemplateEnforce<OwnerInfo> {
	
	public OwnerVisiEnforceLChanged(DeciTreeOption<OwnerInfo> option) {
		super(option);
	}
