...
public final class OwnerVisiEnforceCompKey extends ActionVisitorTemplateEnforce<OwnerInfo> {
	
	public OwnerVisiEnforceCompKey(DeciTreeOption<OwnerInfo> option) {
		super(option);
	}
