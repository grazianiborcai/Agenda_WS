...
public final class OwnerVisiPhoneUpsert extends ActionVisitorTemplateAction<OwnerInfo, PhoneInfo> {
	
	public OwnerVisiPhoneUpsert(DeciTreeOption<OwnerInfo> option) {
