...
public final class LazyOwnerUserInsertDaemon extends ActionLazyTemplateV2<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerUserInsertDaemon(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerUserInsertDaemon(option);
	}
