...
public final class LazyOwnerRootSelect extends ActionLazyTemplateV2<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new RootOwnerSelect(option).toAction();
	}
