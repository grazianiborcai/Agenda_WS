...
public final class LazyOwnerDeleteMat extends ActionLazyTemplate<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerDeleteMat(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerDeleteMat(option);
	}
