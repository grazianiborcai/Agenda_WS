...
public final class LazyOwnerMergePerson extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerMergePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerMergePerson(option);
	}
