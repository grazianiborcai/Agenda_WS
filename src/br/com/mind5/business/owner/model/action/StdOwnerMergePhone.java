...
public final class StdOwnerMergePhone implements ActionStdV1<OwnerInfo> {
	private ActionStdV1<OwnerInfo> actionHelper;	
	
	
	public StdOwnerMergePhone(DeciTreeOption<OwnerInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiOwnerMergePhone(option.conn, option.schemaName));
	}
