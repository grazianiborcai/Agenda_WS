...
public final class LazyOwnerUserInsertAnonymous extends ActionLazyTemplateV2<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerUserInsertAnonymous(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerUserInsertAnonymous(option);
	}
