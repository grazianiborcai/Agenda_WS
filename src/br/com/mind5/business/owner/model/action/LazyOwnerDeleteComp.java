...
public final class LazyOwnerDeleteComp extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerDeleteComp(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerDeleteComp(option);
	}
