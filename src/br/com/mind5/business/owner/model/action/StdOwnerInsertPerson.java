...
public final class StdOwnerInsertPerson implements ActionStdV1<OwnerInfo> {
	private ActionStdV1<OwnerInfo> actionHelper;	
	
	
	public StdOwnerInsertPerson(DeciTreeOption<OwnerInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiOwnerInsertPerson(option.conn, option.schemaName));
	}
