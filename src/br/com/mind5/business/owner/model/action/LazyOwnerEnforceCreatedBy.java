...
public final class LazyOwnerEnforceCreatedBy extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerEnforceCreatedBy(option);
	}
