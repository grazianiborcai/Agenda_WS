...
public final class LazyOwnerMergeAddress extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerMergeAddress(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerMergeAddress(option);
	}
