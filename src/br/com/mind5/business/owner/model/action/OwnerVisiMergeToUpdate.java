...
public final class OwnerVisiMergeToUpdate extends ActionVisitorTemplateMerge<OwnerInfo, OwnerInfo> {
	
	public OwnerVisiMergeToUpdate(DeciTreeOption<OwnerInfo> option) {
