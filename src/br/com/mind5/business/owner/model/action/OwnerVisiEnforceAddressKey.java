...
public final class OwnerVisiEnforceAddressKey extends ActionVisitorTemplateEnforce<OwnerInfo> {
	
	public OwnerVisiEnforceAddressKey(DeciTreeOption<OwnerInfo> option) {
		super(option);
	}
