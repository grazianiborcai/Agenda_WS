...
public final class LazyOwnerMergeBusarea extends ActionLazyTemplateV2<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerMergeBusarea(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerMergeBusarea(option);
	}
