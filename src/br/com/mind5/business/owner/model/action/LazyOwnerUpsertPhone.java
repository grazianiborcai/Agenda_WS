...
public final class LazyOwnerUpsertPhone extends ActionLazyTemplateV2<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerUpsertPhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerUpsertPhone(option);
	}
