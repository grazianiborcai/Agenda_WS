...
public final class OwnerVisiEnforceLChangedBy extends ActionVisitorTemplateEnforce<OwnerInfo> {
	
	public OwnerVisiEnforceLChangedBy(DeciTreeOption<OwnerInfo> option) {
		super(option);
	}
