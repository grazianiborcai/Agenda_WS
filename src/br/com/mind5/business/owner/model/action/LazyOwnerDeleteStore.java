...
public final class LazyOwnerDeleteStore extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerDeleteStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerDeleteStore(option);
	}
