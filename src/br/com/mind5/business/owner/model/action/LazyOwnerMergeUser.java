...
public final class LazyOwnerMergeUser extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerMergeUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerMergeUser(option);
	}
