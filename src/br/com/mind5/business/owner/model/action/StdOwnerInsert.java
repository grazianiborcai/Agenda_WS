...
import br.com.mind5.business.owner.dao.OwnerInsert;
...
public final class StdOwnerInsert implements ActionStdV1<OwnerInfo> {
	private ActionStdV1<OwnerInfo> actionHelper;
	
	
	public StdOwnerInsert(DeciTreeOption<OwnerInfo> option) {
	...
	private DaoStmtExec_<OwnerInfo> buildStmtExec(DeciTreeOption<OwnerInfo> option) {
		...
		return new OwnerInsert(stmtExecOptions);
	}
