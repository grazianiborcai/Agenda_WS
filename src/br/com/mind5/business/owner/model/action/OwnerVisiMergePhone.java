...
public final class OwnerVisiMergePhone extends ActionVisitorTemplateMerge<OwnerInfo, PhoneInfo> {
	
	public OwnerVisiMergePhone(DeciTreeOption<OwnerInfo> option) {
