...
public final class LazyOwnerEnforceLChangedBy extends ActionLazyTemplateV1<OwnerInfo, OwnerInfo> {
	
	public LazyOwnerEnforceLChangedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OwnerInfo> getInstanceOfActionHook(DeciTreeOption<OwnerInfo> option) {
		return new StdOwnerEnforceLChangedBy(option);
	}
