...
public final class SchedeekVisiMergeNext extends ActionVisitorTemplateMerge<SchedeekInfo, CaleekyInfo> {
	
	public SchedeekVisiMergeNext(DeciTreeOption<SchedeekInfo> option) {
