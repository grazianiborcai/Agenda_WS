...
public final class LazySchedeekMergeCalimemp extends ActionLazyTemplateV2<SchedeekInfo, SchedeekInfo> {
	
	public LazySchedeekMergeCalimemp(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedeekInfo> getInstanceOfActionHook(DeciTreeOption<SchedeekInfo> option) {
		return new StdSchedeekMergeCalimemp(option);
	}
