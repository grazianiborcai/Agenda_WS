...
public final class SchedeekRootSelect extends DeciTreeTemplateWrite<SchedeekInfo> {
	
	public SchedeekRootSelect(DeciTreeOption<SchedeekInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedeekInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedeekInfo> option) {
		...
		ActionStd<SchedeekInfo> select = new SchedeekNodeSelect(option).toAction();
