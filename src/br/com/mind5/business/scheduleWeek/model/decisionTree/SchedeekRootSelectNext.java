...
import br.com.mind5.business.scheduleWeek.model.action.SchedeekVisiMergeNext;
...
public final class SchedeekRootSelectNext extends DeciTreeTemplateWrite<SchedeekInfo> {
	
	public SchedeekRootSelectNext(DeciTreeOption<SchedeekInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedeekInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedeekInfo> option) {
		...
		ActionStd<SchedeekInfo> mergeNext = new ActionStdCommom<SchedeekInfo>(option, SchedeekVisiMergeNext.class);
