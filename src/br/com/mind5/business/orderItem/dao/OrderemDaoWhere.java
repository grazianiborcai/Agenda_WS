...
public final class OrderemDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public OrderemDaoWhere(DaoWhereBuilderOption whereOption, String tableName, OrderemInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, OrderemInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case OrderemDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case OrderemDaoDbTableColumn.COL_COD_ORDER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOrder));
					break;
					
				case OrderemDaoDbTableColumn.COL_COD_ORDER_ITEM :
