...
public final class OrderemDaoUpdateSingle extends DaoStmtTemplate<OrderemInfo> {
	private final String MAIN_TABLE = DaoDbTable.ORDER_ITM_TABLE;	
	
	
	public OrderemDaoUpdateSingle(Connection conn, OrderemInfo recordInfo, String schemaName) {
