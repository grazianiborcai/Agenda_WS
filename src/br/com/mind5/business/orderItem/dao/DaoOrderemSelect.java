...
public final class DaoOrderemSelect implements DaoStmtExec<OrderemInfo> {
	private DaoStmtExec<OrderemInfo> helper;
	
	
	public DaoOrderemSelect(List<DaoStmtExecOption<OrderemInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoOrderemSelectSingle.class, OrderemInfo.class);
	}
