...
public final class DaoOrderemUpdateSingle extends DaoStmtTemplate<OrderemInfo> {
	private final String MAIN_TABLE = DaoDbTable.ORDER_ITM_TABLE;	
	
	
	public DaoOrderemUpdateSingle(Connection conn, OrderemInfo recordInfo, String schemaName) {
