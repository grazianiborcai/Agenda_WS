...
public final class LazyOrderemMergeStolis extends ActionLazyTemplateV1<OrderemInfo, OrderemInfo> {
	
	public LazyOrderemMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemMergeStolis(option);
	}
