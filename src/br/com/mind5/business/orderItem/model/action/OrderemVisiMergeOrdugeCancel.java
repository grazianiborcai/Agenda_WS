...
public final class OrderemVisiMergeOrdugeCancel extends ActionVisitorTemplateMerge<OrderemInfo, OrdugeInfo> {
	
	public OrderemVisiMergeOrdugeCancel(DeciTreeOption<OrderemInfo> option) { 
