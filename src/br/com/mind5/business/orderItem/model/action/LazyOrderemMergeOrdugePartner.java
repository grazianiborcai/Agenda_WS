...
public final class LazyOrderemMergeOrdugePartner extends ActionLazyTemplateV2<OrderemInfo, OrderemInfo> {

	public LazyOrderemMergeOrdugePartner(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemMergeOrdugePartner(option);
	}
