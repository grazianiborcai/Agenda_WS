...
public final class LazyOrderemRefupolEvaluate extends ActionLazyTemplateV2<OrderemInfo, OrderemInfo> {

	public LazyOrderemRefupolEvaluate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemRefupolEvaluate(option);
	}
