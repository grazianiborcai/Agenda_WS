...
public final class LazyOrderemMergeOrdugePlace extends ActionLazyTemplateV2<OrderemInfo, OrderemInfo> {

	public LazyOrderemMergeOrdugePlace(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemMergeOrdugePlace(option);
	}
