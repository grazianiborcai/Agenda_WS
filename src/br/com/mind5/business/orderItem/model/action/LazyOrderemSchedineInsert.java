...
public final class LazyOrderemSchedineInsert extends ActionLazyTemplateV2<OrderemInfo, OrderemInfo> {

	public LazyOrderemSchedineInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemSchedineInsert(option);
	}
