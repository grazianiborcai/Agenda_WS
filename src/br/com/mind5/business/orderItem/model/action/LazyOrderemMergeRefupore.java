...
public final class LazyOrderemMergeRefupore extends ActionLazyTemplateV2<OrderemInfo, OrderemInfo> {
	
	public LazyOrderemMergeRefupore(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemMergeRefupore(option);
	}
