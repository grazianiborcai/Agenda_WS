...
public final class StdOrderemMergeOrdemarch implements ActionStdV1<OrderemInfo> {
	private ActionStdV1<OrderemInfo> actionHelper;	
	
	
	public StdOrderemMergeOrdemarch(DeciTreeOption<OrderemInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiOrderemMergeOrdemarch(option.conn, option.schemaName));
	}
