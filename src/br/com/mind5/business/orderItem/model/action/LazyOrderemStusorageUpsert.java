...
public final class LazyOrderemStusorageUpsert extends ActionLazyTemplate<OrderemInfo, OrderemInfo> {

	public LazyOrderemStusorageUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemStusorageUpsert(option);
	}
