...
public final class OrderemVisiMergeCusarch extends ActionVisitorTemplateMerge<OrderemInfo, CusarchInfo> {
	
	public OrderemVisiMergeCusarch(DeciTreeOption<OrderemInfo> option) { 
