...
public final class LazyOrderemMergeOrdist extends ActionLazyTemplate<OrderemInfo, OrderemInfo> {
	
	public LazyOrderemMergeOrdist(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemMergeOrdist(option);
	}
