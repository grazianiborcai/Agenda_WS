...
public final class LazyOrderemMergeOrdugeRefunding extends ActionLazyTemplateV2<OrderemInfo, OrderemInfo> {

	public LazyOrderemMergeOrdugeRefunding(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemMergeOrdugeRefunding(option);
	}
