...
import br.com.mind5.business.orderItem.model.decisionTree.NodeOrderemCus;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyOrderemNodeCus extends ActionLazyTemplate<OrderemInfo, OrderemInfo> {
	
	public LazyOrderemNodeCus(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new NodeOrderemCus(option).toAction();
	}
