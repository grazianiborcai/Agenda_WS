...
final class VisiOrderemMergeOrdugePay extends ActionVisitorTemplateMergeV2<OrderemInfo, OrdugeInfo> {
	
	public VisiOrderemMergeOrdugePay(DeciTreeOption<OrderemInfo> option) { 
