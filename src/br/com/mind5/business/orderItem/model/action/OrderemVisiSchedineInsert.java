...
public final class OrderemVisiSchedineInsert extends ActionVisitorTemplateAction<OrderemInfo, SchedineInfo> {
	
	public OrderemVisiSchedineInsert(DeciTreeOption<OrderemInfo> option) {
