...
public final class OrderemVisiMergeStolis extends ActionVisitorTemplateMerge<OrderemInfo, StolisInfo> {
	
	public OrderemVisiMergeStolis(DeciTreeOption<OrderemInfo> option) {
