...
final class VisiOrderemMergeOrdugeRefunding extends ActionVisitorTemplateMergeV2<OrderemInfo, OrdugeInfo> {
	
	public VisiOrderemMergeOrdugeRefunding(DeciTreeOption<OrderemInfo> option) { 
