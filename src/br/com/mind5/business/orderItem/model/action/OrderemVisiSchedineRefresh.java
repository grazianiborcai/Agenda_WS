...
public final class OrderemVisiSchedineRefresh extends ActionVisitorTemplateAction<OrderemInfo, SchedineInfo> {
	
	public OrderemVisiSchedineRefresh(DeciTreeOption<OrderemInfo> option) {
