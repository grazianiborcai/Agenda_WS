...
public final class LazyOrderemSchedineRefresh extends ActionLazyTemplateV2<OrderemInfo, OrderemInfo> {

	public LazyOrderemSchedineRefresh(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderemInfo> getInstanceOfActionHook(DeciTreeOption<OrderemInfo> option) {
		return new StdOrderemSchedineRefresh(option);
	}
