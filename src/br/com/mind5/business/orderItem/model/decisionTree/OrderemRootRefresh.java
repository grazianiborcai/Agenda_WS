...
import br.com.mind5.business.orderItem.model.action.OrderemVisiNodeRefresh;
...
public final class OrderemRootRefresh extends DeciTreeTemplateWrite<OrderemInfo> {
	
	public OrderemRootRefresh(DeciTreeOption<OrderemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrderemInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderemInfo> option) {
		...
		ActionLazy<OrderemInfo> nodeRefresh   = new ActionLazyCommom<OrderemInfo>(option, OrderemVisiNodeRefresh.class);
