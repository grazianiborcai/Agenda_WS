...
import br.com.mind5.business.orderItem.model.action.LazyOrderemMergeEmplres;
...
public final class NodeOrderemSelectService extends DeciTreeTemplateWrite<OrderemInfo> {
	...
	@Override protected List<ActionStd<OrderemInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderemInfo> option) {
		...
		ActionLazy<OrderemInfo> mergeEmplres = new LazyOrderemMergeEmplres(option.conn, option.schemaName);
