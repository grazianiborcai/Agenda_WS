...
public final class OrderemNodeSelect extends DeciTreeTemplateWrite<OrderemInfo> {
	
	public OrderemNodeSelect(DeciTreeOption<OrderemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrderemInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderemInfo> option) {
		...
		ActionStd<OrderemInfo> selectService = new OrderemNodeServiceSelect(option).toAction();
