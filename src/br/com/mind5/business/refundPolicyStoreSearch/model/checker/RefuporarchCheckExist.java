...
public final class RefuporarchCheckExist extends ModelCheckerTemplateActionV2<RefuporarchInfo, RefuporarchInfo> {
	...
	@Override protected ActionStdV1<RefuporarchInfo> buildActionHook(DeciTreeOption<RefuporarchInfo> option) {		
		ActionStdV1<RefuporarchInfo> select = new RootRefuporarchSelect(option).toAction();			
		return select;
	}
