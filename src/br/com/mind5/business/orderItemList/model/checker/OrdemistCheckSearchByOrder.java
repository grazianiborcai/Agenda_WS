...
public final class OrdemistCheckSearchByOrder extends ModelCheckerTemplateSimple<OrdemistInfo> {

	public OrdemistCheckSearchByOrder(ModelCheckerOption option) {
		super(option);
	}
