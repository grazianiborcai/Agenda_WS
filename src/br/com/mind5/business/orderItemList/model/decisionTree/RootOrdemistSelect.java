...
public final class RootOrdemistSelect extends DeciTreeTemplateWriteV2<OrdemistInfo> {
	...
	@Override protected List<ActionStdV1<OrdemistInfo>> buildActionsOnPassedHook(DeciTreeOption<OrdemistInfo> option) {
		List<ActionStdV1<OrdemistInfo>> actions = new ArrayList<>();
		
		ActionStdV1<OrdemistInfo> select = new StdOrdemistMergeToSelect(option);
