...
public final class LazyHomeMergeCartou extends ActionLazyTemplate<HomeInfo, HomeInfo> {

	public LazyHomeMergeCartou(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<HomeInfo> getInstanceOfActionHook(DeciTreeOption<HomeInfo> option) {
		return new StdHomeMergeCartou(option);
	}
