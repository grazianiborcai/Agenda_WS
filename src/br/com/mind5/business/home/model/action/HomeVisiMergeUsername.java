...
public final class HomeVisiMergeUsername extends ActionVisitorTemplateMerge<HomeInfo, UsernameInfo> {
	
	public HomeVisiMergeUsername(DeciTreeOption<HomeInfo> option) {
