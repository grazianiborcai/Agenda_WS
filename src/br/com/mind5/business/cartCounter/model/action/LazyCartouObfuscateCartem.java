...
public final class LazyCartouObfuscateCartem extends ActionLazyTemplate<CartouInfo, CartouInfo> {

	public LazyCartouObfuscateCartem(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartouInfo> getInstanceOfActionHook(DeciTreeOption<CartouInfo> option) {
		return new StdCartouObfuscateCartem(option);
	}
