...
final class VisiPetlisMergePetAuth extends ActionVisitorTemplateMerge<PetlisInfo, PetInfo> {
	
	public VisiPetlisMergePetAuth(DeciTreeOption<PetlisInfo> option) {
