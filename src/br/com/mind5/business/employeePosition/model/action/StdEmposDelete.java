...
import br.com.mind5.business.employeePosition.dao.EmposDelete;
...
public final class StdEmposDelete implements ActionStdV1<EmposInfo> {
	private ActionStdV1<EmposInfo> actionHelper;
	
	
	public StdEmposDelete(DeciTreeOption<EmposInfo> option) {
	...
	private DaoStmtExec_<EmposInfo> buildStmtExec(DeciTreeOption<EmposInfo> option) {
		...
		return new EmposDelete(stmtExecOptions);
	}
