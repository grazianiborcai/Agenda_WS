...
public final class EmposVisiMergeUsername extends ActionVisitorTemplateMerge<EmposInfo, UsernameInfo> {
	
	public EmposVisiMergeUsername(DeciTreeOption<EmposInfo> option) {
