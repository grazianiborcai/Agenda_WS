...
public final class LazyEmposEmptify extends ActionLazyTemplateV2<EmposInfo, EmposInfo> {
	
	public LazyEmposEmptify(Connection conn, String schemaName) {
