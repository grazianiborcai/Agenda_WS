...
import br.com.mind5.business.employeePosition.dao.EmposUpdate;
...
public final class StdEmposUpdate implements ActionStdV1<EmposInfo> {
	private ActionStdV1<EmposInfo> actionHelper;
	
	
	public StdEmposUpdate(DeciTreeOption<EmposInfo> option) {
	...
	private DaoStmtExec_<EmposInfo> buildStmtExec(DeciTreeOption<EmposInfo> option) {
		...
		return new EmposUpdate(stmtExecOptions);
	}
