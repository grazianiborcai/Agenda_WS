...
public final class LazyEmposEnforceCreatedOn extends ActionLazyTemplateV2<EmposInfo, EmposInfo> {
	
	public LazyEmposEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmposInfo> getInstanceOfActionHook(DeciTreeOption<EmposInfo> option) {
		return new StdEmposEnforceCreatedOn(option);
	}
