...
public final class LazyEmposMergeEmplis extends ActionLazyTemplateV2<EmposInfo, EmposInfo> {
	
	public LazyEmposMergeEmplis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmposInfo> getInstanceOfActionHook(DeciTreeOption<EmposInfo> option) {
		return new StdEmposMergeEmplis(option);
	}
