...
public final class LazyEmposUpdate extends ActionLazyTemplateV1<EmposInfo, EmposInfo> {
	
	public LazyEmposUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmposInfo> getInstanceOfActionHook(DeciTreeOption<EmposInfo> option) {
		return new StdEmposUpdate(option);
	}
