...
public final class EmposRootDeleteProfessional extends DeciTreeTemplateWrite<EmposInfo> {
	
	public EmposRootDeleteProfessional(DeciTreeOption<EmposInfo> option) {
		super(option);
	}
