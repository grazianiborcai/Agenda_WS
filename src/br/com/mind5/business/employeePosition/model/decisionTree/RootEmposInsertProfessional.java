...
public final class RootEmposInsertProfessional extends DeciTreeTemplateWriteV2<EmposInfo> {
	
	public RootEmposInsertProfessional(DeciTreeOption<EmposInfo> option) {
		super(option);
	}
