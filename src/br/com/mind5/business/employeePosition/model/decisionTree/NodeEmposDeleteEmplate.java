...
public final class NodeEmposDeleteEmplate extends DeciTreeTemplateWriteV2<EmposInfo> {
	...
	@Override protected List<ActionStdV2<EmposInfo>> buildActionsOnPassedHook(DeciTreeOption<EmposInfo> option) {
		...
		ActionStdV2<EmposInfo> deleteEmpwotm = new StdEmposDeleteEmplevate(option);
