...
public final class EmposRootSelectProfessional extends DeciTreeTemplateRead<EmposInfo> {
	
	public EmposRootSelectProfessional(DeciTreeOption<EmposInfo> option) {
		super(option);
	}
