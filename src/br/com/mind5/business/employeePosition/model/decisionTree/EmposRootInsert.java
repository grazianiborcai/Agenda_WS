...
public final class EmposRootInsert extends DeciTreeTemplateWrite<EmposInfo> {
	
	public EmposRootInsert(DeciTreeOption<EmposInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmposInfo>> buildActionsOnPassedHook(DeciTreeOption<EmposInfo> option) {
		...
		ActionStd<EmposInfo> upsert = new EmposNodeUpsert(option).toAction();
