...
public final class EmposDaoUpdateSingle extends DaoStmtTemplate<EmposInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMPOS_TABLE;	
	
	
	public EmposDaoUpdateSingle(Connection conn, EmposInfo recordInfo, String schemaName) {
