...
final class VisiMatorarchMergeToSelect extends ActionVisitorTemplateMergeV1<MatorarchInfo, MatorarchInfo> {
	...
	@Override protected Class<? extends ActionStdV1<MatorarchInfo>> getActionClassHook() {
