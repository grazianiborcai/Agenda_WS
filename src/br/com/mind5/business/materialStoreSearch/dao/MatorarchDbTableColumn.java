...
public class MatorarchDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public MatorarchDbTableColumn() {
		super(MatorarchDbTableColumn.class);
	}
	...
	private void buildListTable() {
		...
		tableColumns.put(DaoDbTable.MAT_STORE_SEARCH_VIEW, columns);
	}
}
