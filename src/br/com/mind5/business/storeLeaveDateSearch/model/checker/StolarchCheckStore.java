...
public final class StolarchCheckStore extends ModelCheckerTemplateForwardV2<StolarchInfo, StoreInfo> {
	...
	@Override protected StoreInfo toForwardClass(StolarchInfo baseRecord) {
