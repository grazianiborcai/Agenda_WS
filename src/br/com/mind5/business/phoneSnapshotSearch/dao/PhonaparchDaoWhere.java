...
final class PhonaparchDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public PhonaparchDaoWhere(DaoWhereBuilderOption whereOption, String tableName, PhonaparchInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, PhonaparchInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case PhonaparchDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case PhonaparchDaoDbTableColumn.COL_COD_SNAPSHOT :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codSnapshot));
					break;
					
				case PhonaparchDaoDbTableColumn.COL_COD_USER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codUser));
					break;
					
				case PhonaparchDaoDbTableColumn.COL_COD_USER_SNAPSHOT :
