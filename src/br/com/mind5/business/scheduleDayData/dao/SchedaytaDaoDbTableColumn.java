...
public final class SchedaytaDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public SchedaytaDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.SCHEDULE_DAY_VIEW, columns);
		return results;
	}
}
