...
public final class SchedaytaCheckExist extends ModelCheckerTemplateActionV2<SchedaytaInfo, SchedaytaInfo> {
	...
	@Override protected ActionStdV1<SchedaytaInfo> buildActionHook(DeciTreeOption<SchedaytaInfo> option) {
		ActionStdV1<SchedaytaInfo> select = new StdSchedaytaDaoSelect(option);
		return select;
	}
