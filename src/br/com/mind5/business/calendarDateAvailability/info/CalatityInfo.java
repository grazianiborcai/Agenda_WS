...
public final class CalatityInfo extends InfoRecord implements Cloneable {
	...
	public static CalatityInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, CalatityInfo.class);
	}
	
	
	
	public static List<CalatityInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, CalatityInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof CalatityInfo))
			return false;
		
		
		CalatityInfo obj = (CalatityInfo) o;		
