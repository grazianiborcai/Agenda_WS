...
public final class CalatityVisiMergeCalate extends ActionVisitorTemplateMerge<CalatityInfo, CalateInfo> {
	
	public CalatityVisiMergeCalate(DeciTreeOption<CalatityInfo> option) {
