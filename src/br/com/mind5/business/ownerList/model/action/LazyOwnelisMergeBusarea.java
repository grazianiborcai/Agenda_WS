...
public final class LazyOwnelisMergeBusarea extends ActionLazyTemplateV2<OwnelisInfo, OwnelisInfo> {
	
	public LazyOwnelisMergeBusarea(Connection conn, String schemaName) {
