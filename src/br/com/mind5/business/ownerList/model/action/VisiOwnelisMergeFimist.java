...
final class VisiOwnelisMergeFimist extends ActionVisitorTemplateMergeV2<OwnelisInfo, FimistInfo> {
	
	public VisiOwnelisMergeFimist(DeciTreeOption<OwnelisInfo> option) {
