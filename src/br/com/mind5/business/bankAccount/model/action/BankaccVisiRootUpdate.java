...
import br.com.mind5.business.bankAccount.model.decisionTree.BankaccRootUpdate;
import br.com.mind5.model.action.ActionVisitorTemplateAction;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class BankaccVisiRootUpdate extends ActionVisitorTemplateAction<BankaccInfo, BankaccInfo> {

	public BankaccVisiRootUpdate(DeciTreeOption<BankaccInfo> option) {
	...
	@Override protected Class<? extends DeciTree<BankaccInfo>> getTreeClassHook() {
		return BankaccRootUpdate.class;
	}
