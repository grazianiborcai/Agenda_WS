...
public final class BankaccVisiMergeToUpdate extends ActionVisitorTemplateMerge<BankaccInfo, BankaccInfo> {
	
	public BankaccVisiMergeToUpdate(DeciTreeOption<BankaccInfo> option) {
	...
	@Override protected List<BankaccInfo> mergeHook(List<BankaccInfo> baseInfos, List<BankaccInfo> selectedInfos) {	
		return BankaccMerger.mergeToUpdate(baseInfos, selectedInfos);
	}
