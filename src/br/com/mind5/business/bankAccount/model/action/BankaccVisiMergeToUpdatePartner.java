...
public final class BankaccVisiMergeToUpdatePartner extends ActionVisitorTemplateMerge<BankaccInfo, BankaccInfo> {
	
	public BankaccVisiMergeToUpdatePartner(DeciTreeOption<BankaccInfo> option) {
	...
	@Override protected List<BankaccInfo> mergeHook(List<BankaccInfo> baseInfos, List<BankaccInfo> selectedInfos) {	
		return BankaccMerger.mergeToUpdatePartner(baseInfos, selectedInfos);
	}
