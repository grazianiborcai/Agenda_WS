...
import br.com.mind5.business.scheduleYear.model.action.SchedyearVisiEnforcePrevious;
...
public final class SchedyearRootSelectPrevious extends DeciTreeTemplateWrite<SchedyearInfo> {
	
	public SchedyearRootSelectPrevious(DeciTreeOption<SchedyearInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedyearInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedyearInfo> option) {
		...
		ActionStd<SchedyearInfo> enforcePrevious = new ActionStdCommom<SchedyearInfo>(option, SchedyearVisiEnforcePrevious.class);
