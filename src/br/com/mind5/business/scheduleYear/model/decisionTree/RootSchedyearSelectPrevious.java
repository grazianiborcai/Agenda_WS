...
public final class RootSchedyearSelectPrevious extends DeciTreeTemplateWrite<SchedyearInfo> {
	...
	@Override protected List<ActionStd<SchedyearInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedyearInfo> option) {
		...
		ActionStd<SchedyearInfo> enforcePrevious = new StdSchedyearEnforcePrevious(option);
