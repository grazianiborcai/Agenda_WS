...
public final class DaoMatorapSelect implements DaoStmtExecV2<MatorapInfo> {
	private DaoStmtExecV2<MatorapInfo> helper;
	
	
	public DaoMatorapSelect(List<DaoStmtExecOption<MatorapInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoMatorapSelectSingle.class, MatorapInfo.class);
	}
