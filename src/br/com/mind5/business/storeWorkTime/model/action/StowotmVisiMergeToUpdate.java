...
public final class StowotmVisiMergeToUpdate extends ActionVisitorTemplateMerge<StowotmInfo, StowotmInfo> {
	
	public StowotmVisiMergeToUpdate(DeciTreeOption<StowotmInfo> option) {
