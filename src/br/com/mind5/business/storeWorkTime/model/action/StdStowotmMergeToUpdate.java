...
public final class StdStowotmMergeToUpdate implements ActionStdV1<StowotmInfo> {
	private ActionStdV1<StowotmInfo> actionHelper;	
	
	
	public StdStowotmMergeToUpdate(DeciTreeOption<StowotmInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiStowotmMergeToUpdate(option.conn, option.schemaName));
	}
