...
public final class LazyStowotmMergeWeekday extends ActionLazyTemplateV2<StowotmInfo, StowotmInfo> {
	
	public LazyStowotmMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StowotmInfo> getInstanceOfActionHook(DeciTreeOption<StowotmInfo> option) {
		return new StdStowotmMergeWeekday(option);
	}
