...
public final class LazyStowotmMergeStowotarch extends ActionLazyTemplateV2<StowotmInfo, StowotmInfo> {
	
	public LazyStowotmMergeStowotarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StowotmInfo> getInstanceOfActionHook(DeciTreeOption<StowotmInfo> option) {
		return new StdStowotmMergeStowotarch(option);
	}
