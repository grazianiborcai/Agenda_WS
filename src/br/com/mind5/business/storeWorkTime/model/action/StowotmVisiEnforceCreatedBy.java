...
public final class StowotmVisiEnforceCreatedBy extends ActionVisitorTemplateEnforce<StowotmInfo> {
	
	public StowotmVisiEnforceCreatedBy(DeciTreeOption<StowotmInfo> option) {
		super(option);
	}
