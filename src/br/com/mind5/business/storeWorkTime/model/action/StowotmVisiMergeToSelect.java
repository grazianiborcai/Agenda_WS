...
public final class StowotmVisiMergeToSelect extends ActionVisitorTemplateMerge<StowotmInfo, StowotmInfo> {
	
	public StowotmVisiMergeToSelect(DeciTreeOption<StowotmInfo> option) {
