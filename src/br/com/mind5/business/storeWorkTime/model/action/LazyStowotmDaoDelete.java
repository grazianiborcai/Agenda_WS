...
public final class LazyStowotmDaoDelete extends ActionLazyTemplateV2<StowotmInfo, StowotmInfo> {
	
	public LazyStowotmDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StowotmInfo> getInstanceOfActionHook(DeciTreeOption<StowotmInfo> option) {
		return new StdStowotmDaoDelete(option);
	}
