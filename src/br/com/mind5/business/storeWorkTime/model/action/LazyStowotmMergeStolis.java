...
public final class LazyStowotmMergeStolis extends ActionLazyTemplateV1<StowotmInfo, StowotmInfo> {
	
	public LazyStowotmMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StowotmInfo> getInstanceOfActionHook(DeciTreeOption<StowotmInfo> option) {
		return new StdStowotmMergeStolis(option);
	}
