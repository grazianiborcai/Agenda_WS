...
public final class LazyStowotmEnforceCreatedOn extends ActionLazyTemplateV2<StowotmInfo, StowotmInfo> {
	
	public LazyStowotmEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StowotmInfo> getInstanceOfActionHook(DeciTreeOption<StowotmInfo> option) {
		return new StdStowotmEnforceCreatedOn(option);
	}
