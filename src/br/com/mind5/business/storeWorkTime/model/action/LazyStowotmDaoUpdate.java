...
public final class LazyStowotmDaoUpdate extends ActionLazyTemplateV2<StowotmInfo, StowotmInfo> {
	
	public LazyStowotmDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StowotmInfo> getInstanceOfActionHook(DeciTreeOption<StowotmInfo> option) {
		return new StdStowotmDaoUpdate(option);
	}
