...
public final class StowotmRootSearch extends DeciTreeTemplateRead<StowotmInfo> {
	
	public StowotmRootSearch(DeciTreeOption<StowotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StowotmInfo>> buildActionsOnPassedHook(DeciTreeOption<StowotmInfo> option) {
		...
		ActionStd<StowotmInfo> mergeStowotarch = new ActionStdCommom<StowotmInfo>(option, StowotmVisiMergeStowotarch.class);
