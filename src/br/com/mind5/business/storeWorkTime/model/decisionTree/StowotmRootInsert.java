...
public final class StowotmRootInsert extends DeciTreeTemplateWrite<StowotmInfo> {
	
	public StowotmRootInsert(DeciTreeOption<StowotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StowotmInfo>> buildActionsOnPassedHook(DeciTreeOption<StowotmInfo> option) {
		...
		ActionStd<StowotmInfo> nodeInsert = new StowotmNodeInsert(option).toAction();
