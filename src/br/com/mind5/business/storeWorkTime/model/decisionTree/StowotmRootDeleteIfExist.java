...
public final class StowotmRootDeleteIfExist extends DeciTreeTemplateWrite<StowotmInfo> {
	
	public StowotmRootDeleteIfExist(DeciTreeOption<StowotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StowotmInfo>> buildActionsOnPassedHook(DeciTreeOption<StowotmInfo> option) {
		...
		ActionStd<StowotmInfo> nodeL1 = new StowotmNodeDeleteIfExist(option).toAction();
