...
import br.com.mind5.business.storeWorkTime.model.action.StowotmVisiMergeToUpdate;
...
public final class StowotmRootUpdate extends DeciTreeTemplateWrite<StowotmInfo> {
		
	public StowotmRootUpdate(DeciTreeOption<StowotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StowotmInfo>> buildActionsOnPassedHook(DeciTreeOption<StowotmInfo> option) {
		...
		ActionStd<StowotmInfo> mergeToUpdate = new ActionStdCommom<StowotmInfo>(option, StowotmVisiMergeToUpdate.class);
