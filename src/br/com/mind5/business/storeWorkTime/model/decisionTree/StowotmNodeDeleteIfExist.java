...
public final class StowotmNodeDeleteIfExist extends DeciTreeTemplateWrite<StowotmInfo> {
	
	public StowotmNodeDeleteIfExist(DeciTreeOption<StowotmInfo> option) {
		super(option);
	}
