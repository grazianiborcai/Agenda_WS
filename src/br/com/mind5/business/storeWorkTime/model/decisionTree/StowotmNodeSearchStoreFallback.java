...
public final class StowotmNodeSearchStoreFallback extends DeciTreeTemplateWrite<StowotmInfo> {
	
	public StowotmNodeSearchStoreFallback(DeciTreeOption<StowotmInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StowotmInfo>> buildActionsOnPassedHook(DeciTreeOption<StowotmInfo> option) {
		...
		ActionStd<StowotmInfo> select = new StowotmRootSelect(option).toAction();
