...
public final class DaoStowotmSelect implements DaoStmtExecV2<StowotmInfo> {
	private DaoStmtExecV2<StowotmInfo> helper;
	
	
	public DaoStowotmSelect(List<DaoStmtExecOption<StowotmInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoStowotmSelectSingle.class, StowotmInfo.class);
	}
