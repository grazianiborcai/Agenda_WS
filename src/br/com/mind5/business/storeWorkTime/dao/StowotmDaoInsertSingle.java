...
public final class StowotmDaoInsertSingle extends DaoStmtTemplate<StowotmInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_WT_TABLE;		
	
	
	public StowotmDaoInsertSingle(Connection conn, StowotmInfo recordInfo, String schemaName) {
