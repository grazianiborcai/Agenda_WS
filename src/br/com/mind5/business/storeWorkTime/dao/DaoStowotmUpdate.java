...
public final class DaoStowotmUpdate implements DaoStmtExecV2<StowotmInfo> {
	private DaoStmtExecV2<StowotmInfo> helper;
	
	
	public DaoStowotmUpdate(List<DaoStmtExecOption<StowotmInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoStowotmUpdateSingle.class, StowotmInfo.class);
	}
