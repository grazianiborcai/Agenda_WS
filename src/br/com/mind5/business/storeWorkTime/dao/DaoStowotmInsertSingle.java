...
public final class DaoStowotmInsertSingle extends DaoStmtTemplate<StowotmInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_WT_TABLE;		
	
	
	public DaoStowotmInsertSingle(Connection conn, StowotmInfo recordInfo, String schemaName) {
