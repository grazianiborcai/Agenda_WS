...
public final class LazyOrdistMergeOrdereou extends ActionLazyTemplate<OrdistInfo, OrdistInfo> {

	public LazyOrdistMergeOrdereou(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrdistInfo> getInstanceOfActionHook(DeciTreeOption<OrdistInfo> option) {
		return new StdOrdistMergeOrdereou(option);
	}
