...
final class VisiOrdistMergeOrdereou extends ActionVisitorTemplateMerge<OrdistInfo, OrdereouInfo> {
	
	public VisiOrdistMergeOrdereou(DeciTreeOption<OrdistInfo> option) {
