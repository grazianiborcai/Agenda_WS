...
public final class MatarchVisiEnforceMatCategService extends ActionVisitorTemplateEnforce<MatarchInfo> {
	
	public MatarchVisiEnforceMatCategService(DeciTreeOption<MatarchInfo> option) {
		super(option);
	}
