...
public final class StoreDeleteSingle implements DaoStmt<StoreInfo> {
	private DaoStmt<StoreInfo> stmtSql;
	private DaoStmtOption_<StoreInfo> stmtOption;	
	
	
	public StoreDeleteSingle(Connection conn, StoreInfo recordInfo, String schemaName) {
	...
	@Override public DaoStmt<StoreInfo> getNewInstance() {
		return new StoreDeleteSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	
	
	
	private class ResultParser implements DaoResultParser_<StoreInfo> {
