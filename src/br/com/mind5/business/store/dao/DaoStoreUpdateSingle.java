...
public final class DaoStoreUpdateSingle extends DaoStmtTemplate<StoreInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_TABLE;	
	
	
	public DaoStoreUpdateSingle(Connection conn, StoreInfo recordInfo, String schemaName) {
