...
import br.com.mind5.business.store.model.action.StoreVisiCompInsert;
...
public final class StoreNodeInsertComp extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeInsertComp(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
