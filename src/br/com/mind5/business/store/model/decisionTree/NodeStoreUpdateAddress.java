...
import br.com.mind5.business.store.model.action.LazyStoreUpdateAddress;
...
public final class NodeStoreUpdateAddress extends DeciTreeTemplateWriteV2<StoreInfo> {
	
	public NodeStoreUpdateAddress(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazyV1<StoreInfo> updateAddress = new LazyStoreUpdateAddress(option.conn, option.schemaName);
