...
import br.com.mind5.business.store.model.action.StoreVisiStowotmDelete;
...
public final class StoreNodeStowotmDelete extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeStowotmDelete(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionStd<StoreInfo> deleteStowotm = new ActionStdCommom<StoreInfo>(option, StoreVisiStowotmDelete.class);
