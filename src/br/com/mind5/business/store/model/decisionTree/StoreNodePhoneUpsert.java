...
import br.com.mind5.business.store.model.action.StoreVisiPhoneUpsertdel;
...
public final class StoreNodePhoneUpsert extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodePhoneUpsert(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> upsertPhone = new ActionLazyCommom<StoreInfo>(option, StoreVisiPhoneUpsertdel.class);	
