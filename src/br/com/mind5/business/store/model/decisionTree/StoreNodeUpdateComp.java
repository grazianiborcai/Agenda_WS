...
import br.com.mind5.business.store.model.action.StoreVisiCompUpdate;
import br.com.mind5.business.store.model.action.StoreVisiEnforceCompKey;
...
public final class StoreNodeUpdateComp extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeUpdateComp(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> updateCompany = new  ActionLazyCommom<StoreInfo>(option.conn, option.schemaName, StoreVisiCompUpdate.class);
