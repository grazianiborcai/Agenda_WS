...
import br.com.mind5.business.store.model.action.StoreVisiPersonUpdate;
...
public final class StoreNodeUpdatePerson extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeUpdatePerson(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
