...
import br.com.mind5.business.store.model.action.StoreVisiStorapInsert;
...
public final class StoreNodeSnapshot extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeSnapshot(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
