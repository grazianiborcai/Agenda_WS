...
import br.com.mind5.business.store.model.action.StoreVisiUserDelete;
...
public final class StoreNodeUserDelete extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeUserDelete(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionStd<StoreInfo> deleteUser = new ActionStdCommom<StoreInfo>(option, StoreVisiUserDelete.class);
