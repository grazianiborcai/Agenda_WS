...
import br.com.mind5.business.store.model.action.LazyStoreStorextUpsert;
...
public final class NodeStoreUpsertStorext extends DeciTreeTemplateWrite<StoreInfo> {
	
	public NodeStoreUpsertStorext(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionStd<StoreInfo> enforceStorextKey = new StdStoreEnforceStorextKey(option);
