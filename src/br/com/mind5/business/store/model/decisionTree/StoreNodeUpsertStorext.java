...
import br.com.mind5.business.store.model.action.StoreVisiStorextUpsert;
...
public final class StoreNodeUpsertStorext extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeUpsertStorext(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> upsertStorext = new ActionLazyCommom<StoreInfo>(option.conn, option.schemaName, StoreVisiStorextUpsert.class);
