...
public final class StoreNodeStorextInsert extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeStorextInsert(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> insertStorext = new  ActionLazyCommom<StoreInfo>(option, StoreVisiStorextInsert.class);	
