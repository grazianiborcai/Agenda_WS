...
import br.com.mind5.business.store.model.action.StoreVisiPhoneInsert;
...
public final class StoreNodePhoneInsert extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodePhoneInsert(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
