...
import br.com.mind5.business.store.model.action.StoreVisiEnforcePhoneKey;
import br.com.mind5.business.store.model.action.StoreVisiPhoneUpsert;
...
public final class StoreNodeUpsertPhone extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeUpsertPhone(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> upsertPhone = new ActionLazyCommom<StoreInfo>(option.conn, option.schemaName, StoreVisiPhoneUpsert.class);	
