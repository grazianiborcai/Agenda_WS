...
import br.com.mind5.business.store.model.action.StoreVisiCompDelete;
...
public final class StoreNodeDeleteComp extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeDeleteComp(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionStd<StoreInfo> deleteCompany = new ActionStdCommom<StoreInfo>(option, StoreVisiCompDelete.class);
