...
import br.com.mind5.business.store.model.action.StoreVisiStuntmInsert;
...
public final class StoreNodeStuntmInsert extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeStuntmInsert(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
