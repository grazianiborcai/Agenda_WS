...
import br.com.mind5.business.store.model.action.StoreVisiEnforceStorextKey;
import br.com.mind5.business.store.model.action.StoreVisiStorextInsert;
...
public final class StoreNodeInsertStorext extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeInsertStorext(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> insertStorext = new  ActionLazyCommom<StoreInfo>(option.conn, option.schemaName, StoreVisiStorextInsert.class);	
