...
import br.com.mind5.business.store.model.action.StoreVisiStowotmInsert;
...
public final class StoreNodeStowotmInsert extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeStowotmInsert(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionLazy<StoreInfo> insertStowotm = new  ActionLazyCommom<StoreInfo>(option, StoreVisiStowotmInsert.class);	
		
		enforceStowotmKey.addPostAction(insertStowotm);
