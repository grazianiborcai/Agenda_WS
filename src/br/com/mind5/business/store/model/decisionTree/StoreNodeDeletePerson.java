...
import br.com.mind5.business.store.model.action.StoreVisiPersonDelete;
...
public final class StoreNodeDeletePerson extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeDeletePerson(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionStd<StoreInfo> deletePerson = new ActionStdCommom<StoreInfo>(option, StoreVisiPersonDelete.class);
