...
import br.com.mind5.business.store.model.action.StoreVisiMatoreDelete;
...
public final class StoreNodeDeleteMatore extends DeciTreeTemplateWrite<StoreInfo> {
	
	public StoreNodeDeleteMatore(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoreInfo>> buildActionsOnPassedHook(DeciTreeOption<StoreInfo> option) {
		...
		ActionStd<StoreInfo> deleteMatore = new ActionStdCommom<StoreInfo>(option, StoreVisiMatoreDelete.class);
