...
public final class StoreCheckInsert extends ModelCheckerTemplateSimple<StoreInfo> {

	public StoreCheckInsert(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(StoreInfo recordInfo, Connection conn, String schemaName) {	
		if ( recordInfo.codOwner 		<= 0 	||
			 recordInfo.userPersonData 	== null ||
			 recordInfo.peregData 		== null ||
