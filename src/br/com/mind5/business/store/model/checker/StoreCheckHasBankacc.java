...
public final class StoreCheckHasBankacc extends ModelCheckerTemplateSimple<StoreInfo> {
	
	public StoreCheckHasBankacc(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(StoreInfo recordInfo, Connection conn, String schemaName) {	
		if (recordInfo.bankaccData == null)			
			return super.FAILED;		
	...
	@Override protected SymsgInfo getSymsgOnResultTrueHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.BANK_ACCOUNT);
