...
public final class StoreCheckHasPereg extends ModelCheckerTemplateSimple<StoreInfo> {
	
	public StoreCheckHasPereg(ModelCheckerOption option) {
		super(option);
	}
