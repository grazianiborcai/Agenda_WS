...
public final class StoreCheckHasPayPartner extends ModelCheckerTemplateSimple<StoreInfo> {
	
	public StoreCheckHasPayPartner(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(StoreInfo recordInfo, Connection conn, String schemaName) {	
		if (recordInfo.storacData == null)			
			return super.FAILED;		
		
		if (recordInfo.storacData.hasPayPartner == false)			
			return super.FAILED;			
