...
public final class LazyStoreDelete extends ActionLazyTemplate<StoreInfo, StoreInfo> {

	public LazyStoreDelete(Connection conn, String schemaName) {
	...
	@Override protected  ActionStd<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreDelete(option);
	}
