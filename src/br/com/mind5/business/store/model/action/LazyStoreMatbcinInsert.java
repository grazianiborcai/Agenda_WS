...
public final class LazyStoreMatbcinInsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreMatbcinInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMatbcinInsert(option);
	}
