...
public final class StdStoreEnforceCreatedBy implements ActionStdV1<StoreInfo> {
	private ActionStdV1<StoreInfo> actionHelper;	
	
	
	public StdStoreEnforceCreatedBy(DeciTreeOption<StoreInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiStoreEnforceCreatedBy());
	}
