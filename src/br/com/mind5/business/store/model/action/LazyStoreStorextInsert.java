...
public final class LazyStoreStorextInsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreStorextInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreStorextInsert(option);
	}
