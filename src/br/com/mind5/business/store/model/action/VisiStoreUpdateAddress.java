...
final class VisiStoreUpdateAddress extends ActionVisitorTemplateActionV2<StoreInfo, AddressInfo> {
	
	public VisiStoreUpdateAddress(DeciTreeOption<StoreInfo> option) {
