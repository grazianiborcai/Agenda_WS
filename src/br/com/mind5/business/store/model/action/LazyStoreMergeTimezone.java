...
public final class LazyStoreMergeTimezone extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreMergeTimezone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMergeTimezone(option);
	}
