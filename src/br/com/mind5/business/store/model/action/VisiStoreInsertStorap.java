...
final class VisiStoreInsertStorap extends ActionVisitorTemplateActionV2<StoreInfo, StorapInfo> {

	public VisiStoreInsertStorap(DeciTreeOption<StoreInfo> option) {
