...
public final class LazyStoreMergeStorext extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreMergeStorext(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMergeStorext(option);
	}
