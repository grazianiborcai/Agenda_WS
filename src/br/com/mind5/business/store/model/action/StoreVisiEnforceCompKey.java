...
public final class StoreVisiEnforceCompKey extends ActionVisitorTemplateEnforce<StoreInfo> {
	
	public StoreVisiEnforceCompKey(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
