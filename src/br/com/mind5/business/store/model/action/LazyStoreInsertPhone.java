...
public final class LazyStoreInsertPhone extends ActionLazyTemplateV1<StoreInfo, StoreInfo> {
	
	public LazyStoreInsertPhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreInsertPhone(option);
	}
