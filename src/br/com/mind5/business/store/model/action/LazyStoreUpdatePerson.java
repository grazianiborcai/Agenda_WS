...
public final class LazyStoreUpdatePerson extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreUpdatePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreUpdatePerson(option);
	}
