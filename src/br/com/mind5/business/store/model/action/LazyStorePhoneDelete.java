...
public final class LazyStorePhoneDelete extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {

	public LazyStorePhoneDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStorePhoneDelete(option);
	}
