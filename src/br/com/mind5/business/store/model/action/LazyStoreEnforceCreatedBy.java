...
public final class LazyStoreEnforceCreatedBy extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreEnforceCreatedBy(option);
	}
