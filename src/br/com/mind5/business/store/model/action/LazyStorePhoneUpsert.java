...
public final class LazyStorePhoneUpsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStorePhoneUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStorePhoneUpsert(option);
	}
