...
public final class StoreVisiEnforceOwnerKey extends ActionVisitorTemplateEnforce<StoreInfo> {
	
	public StoreVisiEnforceOwnerKey(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
