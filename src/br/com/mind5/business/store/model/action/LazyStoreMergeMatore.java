...
public final class LazyStoreMergeMatore extends ActionLazyTemplate<StoreInfo, StoreInfo> {
	
	public LazyStoreMergeMatore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMergeMatore(option);
	}
