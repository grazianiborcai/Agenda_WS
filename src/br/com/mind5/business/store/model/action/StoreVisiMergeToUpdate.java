...
public final class StoreVisiMergeToUpdate extends ActionVisitorTemplateMerge<StoreInfo, StoreInfo> {
	
	public StoreVisiMergeToUpdate(DeciTreeOption<StoreInfo> option) {
