...
public final class LazyStoreMergeUsername extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreMergeUsername(Connection conn, String schemaName) {
