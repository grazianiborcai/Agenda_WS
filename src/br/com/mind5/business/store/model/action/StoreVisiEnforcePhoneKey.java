...
public final class StoreVisiEnforcePhoneKey extends ActionVisitorTemplateEnforce<StoreInfo> {
	
	public StoreVisiEnforcePhoneKey(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
