...
public final class LazyStoreAddressUpsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreAddressUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreAddressUpsert(option);
	}
