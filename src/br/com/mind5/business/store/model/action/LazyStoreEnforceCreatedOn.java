...
public final class LazyStoreEnforceCreatedOn extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreEnforceCreatedOn(option);
	}
