...
final class VisiStoreUpdatePerson extends ActionVisitorTemplateActionV2<StoreInfo, PersonInfo> {
	
	public VisiStoreUpdatePerson(DeciTreeOption<StoreInfo> option) {
