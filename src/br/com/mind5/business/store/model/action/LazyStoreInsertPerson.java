...
public final class LazyStoreInsertPerson extends ActionLazyTemplateV1<StoreInfo, StoreInfo> {
	
	public LazyStoreInsertPerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreInsertPerson(option);
	}
