...
public final class LazyStoreUpsertPhone extends ActionLazyTemplateV1<StoreInfo, StoreInfo> {
	
	public LazyStoreUpsertPhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreUpsertPhone(option);
	}
