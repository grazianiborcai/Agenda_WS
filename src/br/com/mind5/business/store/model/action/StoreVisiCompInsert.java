...
public final class StoreVisiCompInsert extends ActionVisitorTemplateAction<StoreInfo, CompInfo> {
	
	public StoreVisiCompInsert(DeciTreeOption<StoreInfo> option) {
