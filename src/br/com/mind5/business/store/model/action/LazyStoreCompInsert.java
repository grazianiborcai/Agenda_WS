...
public final class LazyStoreCompInsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreCompInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreCompInsert(option);
	}
