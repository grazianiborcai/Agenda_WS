...
public final class LazyStoreInsertUser extends ActionLazyTemplateV1<StoreInfo, StoreInfo> {
	
	public LazyStoreInsertUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreInsertUser(option);
	}
