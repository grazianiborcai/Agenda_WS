...
public final class LazyStoreMergeUser extends ActionLazyTemplateV1<StoreInfo, StoreInfo> {
	
	public LazyStoreMergeUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMergeUser(option);
	}
