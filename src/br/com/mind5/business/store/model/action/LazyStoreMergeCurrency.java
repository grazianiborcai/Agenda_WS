...
public final class LazyStoreMergeCurrency extends ActionLazyTemplateV1<StoreInfo, StoreInfo> {
	
	public LazyStoreMergeCurrency(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMergeCurrency(option);
	}
