...
final class VisiStoreDeleteStowotm extends ActionVisitorTemplateActionV2<StoreInfo, StowotmInfo> {
	
	public VisiStoreDeleteStowotm(DeciTreeOption<StoreInfo> option) {
