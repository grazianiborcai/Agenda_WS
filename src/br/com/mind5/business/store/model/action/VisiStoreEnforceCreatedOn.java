...
final class VisiStoreEnforceCreatedOn extends ActionVisitorTemplateEnforceV2<StoreInfo> {
	
	public VisiStoreEnforceCreatedOn(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
