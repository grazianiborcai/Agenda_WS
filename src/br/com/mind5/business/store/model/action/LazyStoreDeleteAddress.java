...
public final class LazyStoreDeleteAddress extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {

	public LazyStoreDeleteAddress(Connection conn, String schemaName) {
