...
public final class LazyStorePhoneInsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStorePhoneInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStorePhoneInsert(option);
	}
