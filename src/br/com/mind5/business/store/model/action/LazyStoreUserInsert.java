...
public final class LazyStoreUserInsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreUserInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreUserInsert(option);
	}
