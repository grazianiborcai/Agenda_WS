...
public final class LazyStoreMergePerson extends ActionLazyTemplateV1<StoreInfo, StoreInfo> {
	
	public LazyStoreMergePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMergePerson(option);
	}
