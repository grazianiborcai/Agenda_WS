...
public final class StoreVisiEnforcePersonKey extends ActionVisitorTemplateEnforce<StoreInfo> {
	
	public StoreVisiEnforcePersonKey(DeciTreeOption<StoreInfo> option) {
		super(option);
	}
