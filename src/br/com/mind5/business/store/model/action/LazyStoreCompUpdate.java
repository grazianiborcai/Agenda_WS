...
public final class LazyStoreCompUpdate extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreCompUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreCompUpdate(option);
	}
