...
public final class LazyStoreStorextUpsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreStorextUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreStorextUpsert(option);
	}
