...
public final class LazyStorePersonInsert extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStorePersonInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStorePersonInsert(option);
	}
