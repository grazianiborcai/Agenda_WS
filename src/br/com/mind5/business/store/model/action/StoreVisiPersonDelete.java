...
public final class StoreVisiPersonDelete extends ActionVisitorTemplateAction<StoreInfo, PersonInfo> {
	
	public StoreVisiPersonDelete(DeciTreeOption<StoreInfo> option) {
