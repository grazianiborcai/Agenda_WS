...
public final class LazyStoreMergeComp extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreMergeComp(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreMergeComp(option);
	}
