...
public final class LazyStorePersonUpdate extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStorePersonUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStorePersonUpdate(option);
	}
