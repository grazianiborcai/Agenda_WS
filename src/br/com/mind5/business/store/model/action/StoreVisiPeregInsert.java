...
import br.com.mind5.business.personLegal.model.decisionTree.PeregRootInsert;
...
public final class StoreVisiPeregInsert extends ActionVisitorTemplateAction<StoreInfo, PeregInfo> {
	
	public StoreVisiPeregInsert(DeciTreeOption<StoreInfo> option) {
