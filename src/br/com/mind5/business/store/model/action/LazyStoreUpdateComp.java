...
public final class LazyStoreUpdateComp extends ActionLazyTemplateV2<StoreInfo, StoreInfo> {
	
	public LazyStoreUpdateComp(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoreInfo> getInstanceOfActionHook(DeciTreeOption<StoreInfo> option) {
		return new StdStoreUpdateComp(option);
	}
