...
public final class StoreVisiMergeToDelete extends ActionVisitorTemplateMerge<StoreInfo, StoreInfo> {
	
	public StoreVisiMergeToDelete(DeciTreeOption<StoreInfo> option) {
