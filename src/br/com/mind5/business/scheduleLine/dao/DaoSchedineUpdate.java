...
public final class DaoSchedineUpdate implements DaoStmtExec<SchedineInfo> {
	private DaoStmtExec<SchedineInfo> helper;
	
	
	public DaoSchedineUpdate(List<DaoStmtExecOption<SchedineInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoSchedineUpdateSingle.class, SchedineInfo.class);
	}
