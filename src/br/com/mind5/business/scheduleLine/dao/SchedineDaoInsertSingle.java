...
public class SchedineDaoInsertSingle extends DaoStmtTemplate<SchedineInfo> {
	private final String MAIN_TABLE = DaoDbTable.SCHEDULE_TABLE;
	
	
	public SchedineDaoInsertSingle(Connection conn, SchedineInfo recordInfo, String schemaName) {
