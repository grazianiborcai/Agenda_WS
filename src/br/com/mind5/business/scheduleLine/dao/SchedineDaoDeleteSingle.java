...
public final class SchedineDaoDeleteSingle extends DaoStmtTemplate<SchedineInfo> {
	private final String MAIN_TABLE = DaoDbTable.SCHEDULE_TABLE;		
	
	
	public SchedineDaoDeleteSingle(Connection conn, SchedineInfo recordInfo, String schemaName) {
