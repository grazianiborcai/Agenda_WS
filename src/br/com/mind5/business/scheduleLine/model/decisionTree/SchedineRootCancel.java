...
import br.com.mind5.business.scheduleLine.model.action.SchedineVisiNodeCancel;
import br.com.mind5.business.scheduleLine.model.action.SchedineVisiMergeToSelect;
import br.com.mind5.business.scheduleLine.model.action.SchedineVisiObfuscate;
...
public final class SchedineRootCancel extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootCancel(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> mergeToSelect = new ActionStdCommom<SchedineInfo>(option, SchedineVisiMergeToSelect.class);
		ActionLazy<SchedineInfo> cancel = new ActionLazyCommom<SchedineInfo>(option, SchedineVisiNodeCancel.class);
		ActionLazy<SchedineInfo> obfuscate = new ActionLazyCommom<SchedineInfo>(option, SchedineVisiObfuscate.class);
