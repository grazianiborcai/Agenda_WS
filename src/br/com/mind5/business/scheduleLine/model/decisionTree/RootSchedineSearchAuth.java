...
public final class RootSchedineSearchAuth extends DeciTreeTemplateWrite<SchedineInfo> {
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> auth = new NodeSchedineAuthSearch(option).toAction();
