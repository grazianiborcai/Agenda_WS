...
public final class RootSchedineMoveAuth extends DeciTreeTemplateWrite<SchedineInfo> {
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> auth = new NodeSchedineAuthMove(option).toAction();
		ActionStd<SchedineInfo> move = new RootSchedineMove(option).toAction();
