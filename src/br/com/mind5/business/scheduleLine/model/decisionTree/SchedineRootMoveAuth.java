...
public final class SchedineRootMoveAuth extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootMoveAuth(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> auth = new SchedineNodeAuthMove(option).toAction();
		ActionStd<SchedineInfo> move = new SchedineRootMove(option).toAction();
