...
import br.com.mind5.business.scheduleLine.model.action.SchedineVisiEmulonSend;
...
public final class SchedineRootInsertForce extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootInsertForce(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> insert = new SchedineRootInsertSilent(option).toAction();
		ActionLazy<SchedineInfo> sendEmail = new ActionLazyCommom<SchedineInfo>(option, SchedineVisiEmulonSend.class);
