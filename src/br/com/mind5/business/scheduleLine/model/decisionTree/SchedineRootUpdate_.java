...
public final class SchedineRootUpdate_ extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootUpdate_(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> nodeUpdate = new SchedineNodeUpdate_(option).toAction();
