...
public final class NodeSchedineRefreshOrderL2 extends DeciTreeTemplateWriteV2<SchedineInfo> {
	...
	@Override protected List<ActionStdV1<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStdV1<SchedineInfo> nodeL3 = new NodeSchedineRefreshOrderL3(option).toAction();
