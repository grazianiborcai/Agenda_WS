...
import br.com.mind5.business.scheduleLine.model.action.SchedineVisiEmulelSend;
...
public final class SchedineRootCancelForce extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootCancelForce(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionLazy<SchedineInfo> sendEmail = new ActionLazyCommom<SchedineInfo>(option, SchedineVisiEmulelSend.class);
