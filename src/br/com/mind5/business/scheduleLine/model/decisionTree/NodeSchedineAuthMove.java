...
import br.com.mind5.business.scheduleLine.model.action.LazySchedineSchedauthMove;
...
public final class NodeSchedineAuthMove extends DeciTreeTemplateWriteV2<SchedineInfo> {
	
	public NodeSchedineAuthMove(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionLazyV1<SchedineInfo> auth = new LazySchedineSchedauthMove(option.conn, option.schemaName);
