...
import br.com.mind5.business.scheduleLine.model.action.StdSchedineMergePetlis;
...
public final class NodeSchedinePetRead extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public NodeSchedinePetRead(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> mergePetlis = new StdSchedineMergePetlis(option);	
