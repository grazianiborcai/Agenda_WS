...
public final class RootSchedineRefresh extends DeciTreeTemplateWrite<SchedineInfo> {
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> nodeL1 = new NodeSchedineRefreshL1(option).toAction();
