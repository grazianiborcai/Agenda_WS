...
public final class SchedineRootCancelAuth extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootCancelAuth(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> auth = new SchedineNodeAuthCancel(option).toAction();
		ActionStd<SchedineInfo> cancel = new SchedineRootCancel(option).toAction();
