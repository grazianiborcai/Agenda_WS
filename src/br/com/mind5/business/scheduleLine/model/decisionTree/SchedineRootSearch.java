...
import br.com.mind5.business.scheduleLine.model.action.SchedineVisiRootSelect;
...
public final class SchedineRootSearch extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootSearch(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionLazy<SchedineInfo> select = new ActionLazyCommom<SchedineInfo>(option, SchedineVisiRootSelect.class);
