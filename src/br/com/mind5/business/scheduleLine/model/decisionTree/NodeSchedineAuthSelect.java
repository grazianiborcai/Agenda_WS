...
import br.com.mind5.business.scheduleLine.model.action.LazySchedineSchedauthSelect;
...
public final class NodeSchedineAuthSelect extends DeciTreeTemplateWriteV2<SchedineInfo> {
	
	public NodeSchedineAuthSelect(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionLazyV1<SchedineInfo> auth = new LazySchedineSchedauthSelect(option.conn, option.schemaName);
