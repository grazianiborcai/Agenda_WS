...
public final class SchedineRootSelectAuth extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootSelectAuth(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> auth = new SchedineNodeAuthSelect(option).toAction();
		ActionStd<SchedineInfo> move = new SchedineRootSelect(option).toAction();
