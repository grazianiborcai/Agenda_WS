...
public final class SchedineRootRefresh extends DeciTreeTemplateWrite<SchedineInfo> {
	
	public SchedineRootRefresh(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> nodeL1 = new SchedineNodeRefreshL1(option).toAction();
