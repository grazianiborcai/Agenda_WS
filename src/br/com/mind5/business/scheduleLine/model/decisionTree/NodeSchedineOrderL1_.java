...
public final class NodeSchedineOrderL1_ extends DeciTreeTemplateWriteV2<SchedineInfo> {
	
	public NodeSchedineOrderL1_(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStdV1<SchedineInfo> nodeL2 = new NodeSchedineOrderL2_(option).toAction();
