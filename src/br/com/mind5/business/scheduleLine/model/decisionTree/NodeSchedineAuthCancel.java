...
public final class NodeSchedineAuthCancel extends DeciTreeTemplateWriteV2<SchedineInfo> {
	...
	@Override protected List<ActionStdV1<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionLazyV1<SchedineInfo> auth = new LazySchedineSchedauthCancel(option.conn, option.schemaName);
