...
public final class NodeSchedineRefreshL2 extends DeciTreeTemplateWrite<SchedineInfo> {
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> cancel = new RootSchedineCancelForce(option).toAction();
	...
	@Override protected List<ActionStd<SchedineInfo>> buildActionsOnFailedHook(DeciTreeOption<SchedineInfo> option) {
		...
		ActionStd<SchedineInfo> snapshot = new NodeSchedineSnapshot(option).toAction();
