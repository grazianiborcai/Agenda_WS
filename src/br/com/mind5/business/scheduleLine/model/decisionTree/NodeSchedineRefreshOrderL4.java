...
public final class NodeSchedineRefreshOrderL4 extends DeciTreeTemplateWriteV2<SchedineInfo> {
	
	public NodeSchedineRefreshOrderL4(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
