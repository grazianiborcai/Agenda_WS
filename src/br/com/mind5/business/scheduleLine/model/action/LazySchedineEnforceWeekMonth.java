...
public final class LazySchedineEnforceWeekMonth extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineEnforceWeekMonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceWeekMonth(option);
	}
