...
final class VisiSchedineEnforceWeekYear extends ActionVisitorTemplateEnforceV2<SchedineInfo> {
	
	public VisiSchedineEnforceWeekYear(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
