...
public final class LazySchedineInsert extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineInsert(option);
	}
