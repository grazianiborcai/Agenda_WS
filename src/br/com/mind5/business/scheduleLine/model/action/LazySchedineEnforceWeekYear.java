...
public final class LazySchedineEnforceWeekYear extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineEnforceWeekYear(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceWeekYear(option);
	}
