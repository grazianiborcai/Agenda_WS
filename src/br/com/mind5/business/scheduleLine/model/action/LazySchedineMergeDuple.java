...
public final class LazySchedineMergeDuple extends ActionLazyTemplate<SchedineInfo, SchedineInfo> {
	
	public LazySchedineMergeDuple(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineMergeDuple(option);
	}
