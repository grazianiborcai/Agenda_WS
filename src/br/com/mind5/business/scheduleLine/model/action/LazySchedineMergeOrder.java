...
public final class LazySchedineMergeOrder extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineMergeOrder(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineMergeOrder(option);
	}
