...
final class VisiSchedineEnforceDay extends ActionVisitorTemplateEnforceV2<SchedineInfo> {
	
	public VisiSchedineEnforceDay(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
