...
public final class LazySchedineInsertSchedovm extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineInsertSchedovm(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineInsertSchedovm(option);
	}
