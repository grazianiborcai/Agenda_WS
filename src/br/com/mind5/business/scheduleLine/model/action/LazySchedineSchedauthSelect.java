...
public final class LazySchedineSchedauthSelect extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineSchedauthSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineSchedauthSelect(option);
	}
