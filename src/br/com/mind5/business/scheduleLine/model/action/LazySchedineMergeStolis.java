...
public final class LazySchedineMergeStolis extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineMergeStolis(option);
	}
