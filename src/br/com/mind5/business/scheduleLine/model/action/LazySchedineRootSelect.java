...
public final class LazySchedineRootSelect extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineRootSelect(Connection conn, String schemaName) {
