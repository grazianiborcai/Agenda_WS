...
public final class LazySchedineMergeSchedarch extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineMergeSchedarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineMergeSchedarch(option);
	}
