...
final class VisiSchedineEnforceQuarter extends ActionVisitorTemplateEnforceV2<SchedineInfo> {
	
	public VisiSchedineEnforceQuarter(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
