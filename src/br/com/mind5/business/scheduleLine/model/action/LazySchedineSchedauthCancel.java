...
public final class LazySchedineSchedauthCancel extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineSchedauthCancel(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineSchedauthCancel(option);
	}
