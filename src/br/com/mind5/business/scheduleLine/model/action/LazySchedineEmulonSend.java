...
public final class LazySchedineEmulonSend extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {

	public LazySchedineEmulonSend(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEmulonSend(option);
	}
