...
public final class LazySchedineMergeUsername extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineMergeUsername(option);
	}
