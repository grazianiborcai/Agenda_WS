...
public final class LazySchedineDelete extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineDelete(option);
	}
