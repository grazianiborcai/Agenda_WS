...
public final class SchedineVisiObfuscateOrder extends ActionVisitorTemplateEnforce<SchedineInfo> {
	
	public SchedineVisiObfuscateOrder(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
