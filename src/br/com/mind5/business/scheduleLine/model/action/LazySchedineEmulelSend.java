...
public final class LazySchedineEmulelSend extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {

	public LazySchedineEmulelSend(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEmulelSend(option);
	}
