...
public final class LazySchedineMergeWeekday extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineMergeWeekday(option);
	}
