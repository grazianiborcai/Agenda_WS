...
public final class LazySchedineEnforceCancelled extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {

	public LazySchedineEnforceCancelled(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceCancelled(option);
	}
