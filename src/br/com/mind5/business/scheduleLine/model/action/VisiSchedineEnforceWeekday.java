...
final class VisiSchedineEnforceWeekday extends ActionVisitorTemplateEnforceV2<SchedineInfo> {
	
	public VisiSchedineEnforceWeekday(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
