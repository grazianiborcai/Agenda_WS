...
import br.com.mind5.business.scheduleLine.dao.SchedineDelete;
...
public final class StdSchedineDelete implements ActionStdV1<SchedineInfo> {
	private ActionStdV1<SchedineInfo> actionHelper;
	
	
	public StdSchedineDelete(DeciTreeOption<SchedineInfo> option) {
	...
	private DaoStmtExec_<SchedineInfo> buildStmtExec(DeciTreeOption<SchedineInfo> option) {
		...
		return new SchedineDelete(stmtExecOptions);
	}
