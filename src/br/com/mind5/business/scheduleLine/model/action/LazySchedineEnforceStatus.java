...
public final class LazySchedineEnforceStatus extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineEnforceStatus(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceStatus(option);
	}
