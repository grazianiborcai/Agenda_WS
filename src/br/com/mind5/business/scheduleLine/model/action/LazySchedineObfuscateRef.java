...
public final class LazySchedineObfuscateRef extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineObfuscateRef(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineObfuscateRef(option);
	}
