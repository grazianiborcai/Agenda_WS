...
public final class SchedineVisiMergeToUpdate extends ActionVisitorTemplateMerge<SchedineInfo, SchedineInfo> {
	
	public SchedineVisiMergeToUpdate(DeciTreeOption<SchedineInfo> option) {
	...
	@Override protected List<SchedineInfo> mergeHook(List<SchedineInfo> baseInfos, List<SchedineInfo> selectedInfos) {	
		return SchedineMerger.mergeToUpdate(baseInfos, selectedInfos);
	}
