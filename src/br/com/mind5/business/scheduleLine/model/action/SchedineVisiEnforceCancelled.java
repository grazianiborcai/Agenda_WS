...
public final class SchedineVisiEnforceCancelled extends ActionVisitorTemplateEnforce<SchedineInfo> {
	
	public SchedineVisiEnforceCancelled(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
