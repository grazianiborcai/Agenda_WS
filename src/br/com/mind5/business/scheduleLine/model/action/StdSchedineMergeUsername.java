...
final class StdSchedineMergeUsername implements ActionStdV1<SchedineInfo> {
	private ActionStdV1<SchedineInfo> actionHelper;	
	
	
	public StdSchedineMergeUsername(DeciTreeOption<SchedineInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiSchedineMergeUsername(option.conn, option.schemaName));
	}
