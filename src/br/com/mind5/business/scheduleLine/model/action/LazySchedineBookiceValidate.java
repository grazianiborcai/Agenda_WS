...
public final class LazySchedineBookiceValidate extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineBookiceValidate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineBookiceValidate(option);
	}
