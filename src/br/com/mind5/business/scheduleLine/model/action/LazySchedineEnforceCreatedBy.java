...
public final class LazySchedineEnforceCreatedBy extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {

	public LazySchedineEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceCreatedBy(option);
	}
