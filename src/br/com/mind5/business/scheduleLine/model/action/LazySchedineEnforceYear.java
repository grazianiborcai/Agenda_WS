...
public final class LazySchedineEnforceYear extends ActionLazyTemplateV1<SchedineInfo, SchedineInfo> {
	
	public LazySchedineEnforceYear(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceYear(option);
	}
