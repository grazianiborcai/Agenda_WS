...
public final class LazySchedineObfuscate extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineObfuscate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineObfuscate(option);
	}
