...
public final class LazySchedineEnforceDay extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineEnforceDay(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceDay(option);
	}
