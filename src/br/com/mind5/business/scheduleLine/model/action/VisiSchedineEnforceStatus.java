...
final class VisiSchedineEnforceStatus extends ActionVisitorTemplateEnforceV2<SchedineInfo> {
	
	public VisiSchedineEnforceStatus(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
