...
public final class SchedineVisiEnforceCreatedBy extends ActionVisitorTemplateEnforce<SchedineInfo> {
	
	public SchedineVisiEnforceCreatedBy(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
