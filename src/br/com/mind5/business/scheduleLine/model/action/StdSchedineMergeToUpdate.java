...
public final class StdSchedineMergeToUpdate implements ActionStdV1<SchedineInfo> {
	private ActionStdV1<SchedineInfo> actionHelper;	
	
	
	public StdSchedineMergeToUpdate(DeciTreeOption<SchedineInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiSchedineMergeToUpdate(option.conn, option.schemaName));
	}
