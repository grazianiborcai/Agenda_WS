...
public final class LazySchedineDaoInsert extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineDaoInsert(option);
	}
