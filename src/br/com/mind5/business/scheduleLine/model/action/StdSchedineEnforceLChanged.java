...
public final class StdSchedineEnforceLChanged implements ActionStdV1<SchedineInfo> {
	private ActionStdV1<SchedineInfo> actionHelper;	
	
	
	public StdSchedineEnforceLChanged(DeciTreeOption<SchedineInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiSchedineEnforceLChanged());
	}
