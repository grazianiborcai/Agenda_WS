...
final class VisiSchedineEnforceYear extends ActionVisitorTemplateEnforceV2<SchedineInfo> {
	
	public VisiSchedineEnforceYear(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
