...
public final class SchedineVisiEnforceStatus extends ActionVisitorTemplateEnforce<SchedineInfo> {
	
	public SchedineVisiEnforceStatus(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
