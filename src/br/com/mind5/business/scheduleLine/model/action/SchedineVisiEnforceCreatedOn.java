...
public final class SchedineVisiEnforceCreatedOn extends ActionVisitorTemplateEnforce<SchedineInfo> {
	
	public SchedineVisiEnforceCreatedOn(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
