...
public final class LazySchedineRootSearch extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineRootSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new RootSchedineSearch(option).toAction();
	}
