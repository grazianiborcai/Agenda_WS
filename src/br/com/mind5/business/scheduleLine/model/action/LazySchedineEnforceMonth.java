...
public final class LazySchedineEnforceMonth extends ActionLazyTemplateV2<SchedineInfo, SchedineInfo> {
	
	public LazySchedineEnforceMonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedineInfo> getInstanceOfActionHook(DeciTreeOption<SchedineInfo> option) {
		return new StdSchedineEnforceMonth(option);
	}
