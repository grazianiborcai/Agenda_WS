...
final class VisiSchedineObfuscateRef extends ActionVisitorTemplateEnforceV2<SchedineInfo> {
	
	public VisiSchedineObfuscateRef(DeciTreeOption<SchedineInfo> option) {
		super(option);
	}
