...
public final class SchedineCheckHasOrderItem extends ModelCheckerTemplateSimpleV2<SchedineInfo> {

	public SchedineCheckHasOrderItem(ModelCheckerOption option) {
		super(option);
	}
