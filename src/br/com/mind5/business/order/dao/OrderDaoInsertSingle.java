...
public final class OrderDaoInsertSingle extends DaoStmtTemplate<OrderInfo> {
	private final String MAIN_TABLE = DaoDbTable.ORDER_HDR_TABLE;	
	
	
	public OrderDaoInsertSingle(Connection conn, OrderInfo recordInfo, String schemaName) {
