...
public final class OrderDaoUpdateSingle extends DaoStmtTemplate<OrderInfo> {
	private final String MAIN_TABLE = DaoDbTable.ORDER_HDR_TABLE;
	
	
	public OrderDaoUpdateSingle(Connection conn, OrderInfo recordInfo, String schemaName) {
