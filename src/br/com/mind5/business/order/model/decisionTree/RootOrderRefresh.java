...
import br.com.mind5.business.order.model.action.LazyOrderNodeRefresh;
...
public final class RootOrderRefresh extends DeciTreeTemplateWriteV2<OrderInfo> {
	
	public RootOrderRefresh(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV2<OrderInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderInfo> option) {
		...
		ActionStdV2<OrderInfo> mergeToUpdate = new StdOrderMergeToUpdate(option);
