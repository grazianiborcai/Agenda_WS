...
import br.com.mind5.business.order.model.action.OrderVisiNodeOrderem;
...
public final class OrderRootInsert extends DeciTreeTemplateWrite<OrderInfo> {
	
	public OrderRootInsert(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
