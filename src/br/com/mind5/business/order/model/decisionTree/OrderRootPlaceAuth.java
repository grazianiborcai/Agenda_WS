...
public final class OrderRootPlaceAuth extends DeciTreeTemplateRead<OrderInfo> {
	
	public OrderRootPlaceAuth(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrderInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderInfo> option) {
		...
		ActionStd<OrderInfo> place = new OrderRootPlace(option).toAction();
