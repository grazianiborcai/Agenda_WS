...
import br.com.mind5.business.order.model.action.OrderVisiDaoUpdate;
import br.com.mind5.business.order.model.action.OrderVisiOrdnapInsert;
...
public final class OrderNodeSnapshot extends DeciTreeTemplateWrite<OrderInfo> {
	
	public OrderNodeSnapshot(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
