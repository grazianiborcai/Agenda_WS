...
import br.com.mind5.business.order.model.action.OrderVisiNodeRefreshPayord;
...
public final class OrderRootRefreshPayord extends DeciTreeTemplateWrite<OrderInfo> {
	
	public OrderRootRefreshPayord(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrderInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderInfo> option) {
		...
		ActionLazy<OrderInfo> nodeRefreshPayord = new ActionLazyCommom<OrderInfo>(option, OrderVisiNodeRefreshPayord.class);
		ActionLazy<OrderInfo> select            = new ActionLazyCommom<OrderInfo>(option, OrderVisiRootSelect.class);	
		
		mergeToUpdate.addPostAction(nodeRefreshPayord);
		nodeRefreshPayord.addPostAction(select);
