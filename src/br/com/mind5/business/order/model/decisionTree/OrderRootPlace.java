...
import br.com.mind5.business.order.model.action.OrderVisiNodePlace;
...
public final class OrderRootPlace extends DeciTreeTemplateWrite<OrderInfo> {
	
	public OrderRootPlace(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrderInfo>> buildActionsOnPassedHook(DeciTreeOption<OrderInfo> option) {
		...
		ActionLazy<OrderInfo> nodePlace     = new ActionLazyCommom<OrderInfo>(option, OrderVisiNodePlace.class);		
