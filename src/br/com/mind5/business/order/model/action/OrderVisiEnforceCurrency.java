...
public final class OrderVisiEnforceCurrency extends ActionVisitorTemplateEnforce<OrderInfo> {
	
	public OrderVisiEnforceCurrency(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
