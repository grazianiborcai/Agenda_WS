...
public final class OrderVisiMergeOrdugePartner extends ActionVisitorTemplateMerge<OrderInfo, OrdugeInfo> {
	
	public OrderVisiMergeOrdugePartner(DeciTreeOption<OrderInfo> option) { 
