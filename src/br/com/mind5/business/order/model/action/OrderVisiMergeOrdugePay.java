...
public final class OrderVisiMergeOrdugePay extends ActionVisitorTemplateMerge<OrderInfo, OrdugeInfo> {
	
	public OrderVisiMergeOrdugePay(DeciTreeOption<OrderInfo> option) { 
