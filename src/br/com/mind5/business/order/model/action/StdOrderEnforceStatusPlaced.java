...
public final class StdOrderEnforceStatusPlaced implements ActionStdV1<OrderInfo> {
	private ActionStdV1<OrderInfo> actionHelper;	
	
	
	public StdOrderEnforceStatusPlaced(DeciTreeOption<OrderInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiOrderEnforceStatusPlaced());
	}
