...
public final class OrderVisiMergeOrdugeRefunding extends ActionVisitorTemplateMerge<OrderInfo, OrdugeInfo> {
	
	public OrderVisiMergeOrdugeRefunding(DeciTreeOption<OrderInfo> option) { 
