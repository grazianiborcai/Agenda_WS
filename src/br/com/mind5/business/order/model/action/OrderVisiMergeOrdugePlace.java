...
public final class OrderVisiMergeOrdugePlace extends ActionVisitorTemplateMerge<OrderInfo, OrdugeInfo> {
	
	public OrderVisiMergeOrdugePlace(DeciTreeOption<OrderInfo> option) { 
