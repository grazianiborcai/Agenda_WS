...
public final class LazyOrderMergeUsername extends ActionLazyTemplateV1<OrderInfo, OrderInfo> {

	public LazyOrderMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeUsername(option);
	}
