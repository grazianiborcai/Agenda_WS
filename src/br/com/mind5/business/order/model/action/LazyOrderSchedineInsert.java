...
public final class LazyOrderSchedineInsert extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderSchedineInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderSchedineInsert(option);
	}
