...
public final class LazyOrderRefreshSchedine extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderRefreshSchedine(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderRefreshSchedine(option);
	}
