...
public final class LazyOrderEnforceLChanged extends ActionLazyTemplateV1<OrderInfo, OrderInfo> {

	public LazyOrderEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderEnforceLChanged(option);
	}
