...
public final class OrderVisiMergeUsername extends ActionVisitorTemplateMerge<OrderInfo, UsernameInfo> {
	
	public OrderVisiMergeUsername(DeciTreeOption<OrderInfo> option) {
