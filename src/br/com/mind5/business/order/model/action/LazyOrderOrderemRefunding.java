...
public final class LazyOrderOrderemRefunding extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderOrderemRefunding(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderOrderemRefunding(option);
	}
