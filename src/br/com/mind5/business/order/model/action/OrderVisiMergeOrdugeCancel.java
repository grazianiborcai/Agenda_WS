...
public final class OrderVisiMergeOrdugeCancel extends ActionVisitorTemplateMerge<OrderInfo, OrdugeInfo> {
	
	public OrderVisiMergeOrdugeCancel(DeciTreeOption<OrderInfo> option) { 
