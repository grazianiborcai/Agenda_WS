...
public final class LazyOrderMergeFeeCateg extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderMergeFeeCateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeFeeCateg(option);
	}
