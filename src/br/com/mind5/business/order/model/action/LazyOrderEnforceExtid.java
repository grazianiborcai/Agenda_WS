...
public final class LazyOrderEnforceExtid extends ActionLazyTemplateV1<OrderInfo, OrderInfo> {

	public LazyOrderEnforceExtid(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderEnforceExtid(option);
	}
