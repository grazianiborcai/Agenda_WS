...
import br.com.mind5.business.order.model.decisionTree.RootOrderCancel;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyOrderRootCancel extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderRootCancel(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new RootOrderCancel(option).toAction();
	}
