...
public final class LazyOrderMergeCurrency extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderMergeCurrency(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeCurrency(option);
	}
