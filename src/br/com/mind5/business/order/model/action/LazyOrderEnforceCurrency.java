...
public final class LazyOrderEnforceCurrency extends ActionLazyTemplateV1<OrderInfo, OrderInfo> {

	public LazyOrderEnforceCurrency(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderEnforceCurrency(option);
	}
