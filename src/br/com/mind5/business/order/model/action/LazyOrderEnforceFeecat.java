...
public final class LazyOrderEnforceFeecat extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderEnforceFeecat(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderEnforceFeecat(option);
	}
