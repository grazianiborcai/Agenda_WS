...
public final class LazyOrderMergeCusarch extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderMergeCusarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeCusarch(option);
	}
