...
public final class LazyOrderRootPlace extends ActionLazyTemplate<OrderInfo, OrderInfo> {

	public LazyOrderRootPlace(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new RootOrderPlace(option).toAction();
	}
