...
public final class LazyOrderRootSelect extends ActionLazyTemplateV1<OrderInfo, OrderInfo> {

	public LazyOrderRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new RootOrderSelect(option).toAction();
	}
