...
import br.com.mind5.business.order.model.decisionTree.NodeOrderAuthL2;
import br.com.mind5.model.action.ActionLazyTemplateV1;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyOrderNodeAuthL2 extends ActionLazyTemplateV1<OrderInfo, OrderInfo> {
	
	public LazyOrderNodeAuthL2(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new NodeOrderAuthL2(option).toAction();
	}
