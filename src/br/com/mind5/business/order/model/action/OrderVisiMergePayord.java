...
public final class OrderVisiMergePayord extends ActionVisitorTemplateMerge<OrderInfo, PayordInfo> {
	
	public OrderVisiMergePayord(DeciTreeOption<OrderInfo> option) { 
