...
public final class StdOrderRefreshSchedine implements ActionStdV1<OrderInfo> {
	private ActionStdV1<OrderInfo> actionHelper;	
	
	
	public StdOrderRefreshSchedine(DeciTreeOption<OrderInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiOrderRefreshSchedine(option.conn, option.schemaName));
	}
