...
public final class LazyOrderMergeOrdarch extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderMergeOrdarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderMergeOrdarch(option);
	}
