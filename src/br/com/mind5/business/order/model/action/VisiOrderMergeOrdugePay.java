...
final class VisiOrderMergeOrdugePay extends ActionVisitorTemplateMergeV2<OrderInfo, OrdugeInfo> {
	
	public VisiOrderMergeOrdugePay(DeciTreeOption<OrderInfo> option) { 
