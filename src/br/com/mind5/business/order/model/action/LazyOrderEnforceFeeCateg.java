...
public final class LazyOrderEnforceFeeCateg extends ActionLazyTemplateV1<OrderInfo, OrderInfo> {

	public LazyOrderEnforceFeeCateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrderInfo> getInstanceOfActionHook(DeciTreeOption<OrderInfo> option) {
		return new StdOrderEnforceFeeCateg(option);
	}
