...
final class VisiOrderEnforceStatusRefunding extends ActionVisitorTemplateEnforceV2<OrderInfo> {
	
	public VisiOrderEnforceStatusRefunding(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
