...
public final class LazyOrderMergeOrdugeCreate extends ActionLazyTemplateV2<OrderInfo, OrderInfo> {

	public LazyOrderMergeOrdugeCreate(Connection conn, String schemaName) {
