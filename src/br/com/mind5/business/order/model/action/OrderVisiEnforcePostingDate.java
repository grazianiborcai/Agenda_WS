...
public final class OrderVisiEnforcePostingDate extends ActionVisitorTemplateEnforce<OrderInfo> {
	
	public OrderVisiEnforcePostingDate(DeciTreeOption<OrderInfo> option) {
		super(option);
	}
