...
public final class LazyRefupownMergeRefupo extends ActionLazyTemplateV2<RefupownInfo, RefupownInfo> {

	public LazyRefupownMergeRefupo(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<RefupownInfo> getInstanceOfActionHook(DeciTreeOption<RefupownInfo> option) {
		return new StdRefupownMergeRefupo(option);
	}
