...
public final class LazyRefupownRootDelete extends ActionLazyTemplate<RefupownInfo, RefupownInfo> {

	public LazyRefupownRootDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV2<RefupownInfo> getInstanceOfActionHook(DeciTreeOption<RefupownInfo> option) {
		return new RootRefupownDelete(option).toAction();
	}
