...
import br.com.mind5.business.refundPolicyOwner.model.decisionTree.RefupownNodeUpsert;
import br.com.mind5.model.action.ActionVisitorTemplateAction;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class RefupownVisiNodeUpsert extends ActionVisitorTemplateAction<RefupownInfo, RefupownInfo> {

	public RefupownVisiNodeUpsert(DeciTreeOption<RefupownInfo> option) {
	...
	@Override protected Class<? extends DeciTree<RefupownInfo>> getTreeClassHook() {
		return RefupownNodeUpsert.class;
	}
