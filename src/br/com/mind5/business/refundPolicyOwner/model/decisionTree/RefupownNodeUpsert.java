...
public final class RefupownNodeUpsert extends DeciTreeTemplateWrite<RefupownInfo> {
	
	public RefupownNodeUpsert(DeciTreeOption<RefupownInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<RefupownInfo>> buildActionsOnFailedHook(DeciTreeOption<RefupownInfo> option) {
		...
		ActionStd<RefupownInfo> insert = new RefupownNodeInsert(option).toAction();	
