...
public final class DaoRefupownInsertSingle extends DaoStmtTemplate<RefupownInfo> {
	private final String MAIN_TABLE = DaoDbTable.REFUND_POLICY_OWNER_TABLE;
	
	
	public DaoRefupownInsertSingle(Connection conn, RefupownInfo recordInfo, String schemaName) {
