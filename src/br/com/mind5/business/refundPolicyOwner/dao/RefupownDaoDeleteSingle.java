...
public final class RefupownDaoDeleteSingle extends DaoStmtTemplate<RefupownInfo> {
	private final String MAIN_TABLE = DaoDbTable.REFUND_POLICY_OWNER_TABLE;	
	
	
	public RefupownDaoDeleteSingle(Connection conn, RefupownInfo recordInfo, String schemaName) {
