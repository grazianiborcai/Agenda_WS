...
public final class DaoRefupownSelect implements DaoStmtExec<RefupownInfo> {
	private DaoStmtExec<RefupownInfo> helper;
	
	
	public DaoRefupownSelect(List<DaoStmtExecOption<RefupownInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoRefupownSelectSingle.class, RefupownInfo.class);
	}
