...
public final class DaoRefupownUpdateSingle extends DaoStmtTemplate<RefupownInfo> {
	private final String MAIN_TABLE = DaoDbTable.REFUND_POLICY_OWNER_TABLE;
	
	
	public DaoRefupownUpdateSingle(Connection conn, RefupownInfo recordInfo, String schemaName) {
