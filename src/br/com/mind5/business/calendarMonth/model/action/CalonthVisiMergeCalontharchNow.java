...
import br.com.mind5.business.calendarMonthSearch.model.decisionTree.CalontharchRootSelectNow;
import br.com.mind5.model.action.ActionVisitorTemplateMerge;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class CalonthVisiMergeCalontharchNow extends ActionVisitorTemplateMerge<CalonthInfo, CalontharchInfo> {
	
	public CalonthVisiMergeCalontharchNow(DeciTreeOption<CalonthInfo> option) {
	...
	@Override protected Class<? extends DeciTree<CalontharchInfo>> getTreeClassHook() {
		return CalontharchRootSelectNow.class;
	}
