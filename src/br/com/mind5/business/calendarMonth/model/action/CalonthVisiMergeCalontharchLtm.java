...
import br.com.mind5.business.calendarMonthSearch.model.decisionTree.CalontharchRootSelectLtm;
import br.com.mind5.model.action.ActionVisitorTemplateMerge;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class CalonthVisiMergeCalontharchLtm extends ActionVisitorTemplateMerge<CalonthInfo, CalontharchInfo> {
	
	public CalonthVisiMergeCalontharchLtm(DeciTreeOption<CalonthInfo> option) {
	...
	@Override protected Class<? extends DeciTree<CalontharchInfo>> getTreeClassHook() {
		return CalontharchRootSelectLtm.class;
	}
