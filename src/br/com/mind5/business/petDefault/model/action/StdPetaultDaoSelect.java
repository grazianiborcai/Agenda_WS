...
public final class StdPetaultDaoSelect extends ActionStdTemplate<PetaultInfo> {

	public StdPetaultDaoSelect(DeciTreeOption<PetaultInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<PetaultInfo> buildVisitorHook(DeciTreeOption<PetaultInfo> option) {
		return new VisiPetaultDaoSelect(option);
	}
}
