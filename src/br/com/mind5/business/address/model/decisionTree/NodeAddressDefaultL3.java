...
public final class NodeAddressDefaultL3 extends DeciTreeTemplateWrite<AddressInfo> {
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnPassedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> enforceDefaultOn = new StdAddressEnforceDefaultOn(option);
