...
import br.com.mind5.business.address.model.action.AddressVisiEnforceDefaultOn;
...
public final class AddressNodeDefaultL3 extends DeciTreeTemplateWrite<AddressInfo> {
	
	public AddressNodeDefaultL3(DeciTreeOption<AddressInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnPassedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> enforceDefaultOn = new ActionStdCommom<AddressInfo>(option, AddressVisiEnforceDefaultOn.class);
