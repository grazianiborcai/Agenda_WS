...
import br.com.mind5.business.address.model.action.AddressVisiMergeState;
...
public final class AddressNodeState extends DeciTreeTemplateWrite<AddressInfo> {
	
	public AddressNodeState(DeciTreeOption<AddressInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnPassedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> mergeState = new ActionStdCommom<AddressInfo>(option, AddressVisiMergeState.class);	
