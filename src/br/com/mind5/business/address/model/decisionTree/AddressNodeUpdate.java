...
public final class AddressNodeUpdate extends DeciTreeTemplateWrite<AddressInfo> {
	
	public AddressNodeUpdate(DeciTreeOption<AddressInfo> option) {
		super(option);
	}
	...
	@Override protected ModelChecker<AddressInfo> buildCheckerHook(DeciTreeOption<AddressInfo> option) {
		...
		checker = new AddressCheckFormessA01(checkerOption);
		queue.add(checker);
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnPassedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> nodeUpdateA01 = new AddressNodeA01Update(option).toAction();	
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnFailedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> nodeUpdateA00 = new AddressNodeA00Update(option).toAction();	
