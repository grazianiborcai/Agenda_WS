...
public final class AddressNodeDefaultL1 extends DeciTreeTemplateWrite<AddressInfo> {
	
	public AddressNodeDefaultL1(DeciTreeOption<AddressInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnPassedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> nodeL2 = new AddressNodeDefaultL2(option).toAction();
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnFailedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> nodeL3 = new AddressNodeDefaultL3(option).toAction();	
