...
import br.com.mind5.business.address.model.action.AddressVisiGeoshGenerate;
...
public final class AddressNodeGeoL2 extends DeciTreeTemplateWrite<AddressInfo> {
	
	public AddressNodeGeoL2(DeciTreeOption<AddressInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnPassedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> geoshGenerate = new ActionStdCommom<AddressInfo>(option, AddressVisiGeoshGenerate.class);	
