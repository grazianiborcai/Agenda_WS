...
public final class AddressRootUpsertdel extends DeciTreeTemplateWrite<AddressInfo> {
	
	public AddressRootUpsertdel(DeciTreeOption<AddressInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<AddressInfo>> buildActionsOnPassedHook(DeciTreeOption<AddressInfo> option) {
		...
		ActionStd<AddressInfo> update = new AddressNodeUpsertdel(option).toAction();
