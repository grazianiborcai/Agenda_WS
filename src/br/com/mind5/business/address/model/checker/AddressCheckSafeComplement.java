...
public final class AddressCheckSafeComplement extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeComplement(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(AddressInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.complement == null)
			return super.SUCCESS;
		
		if (StringValidator.validatePersonName(recordInfo.complement) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_COMPLEMENT);
