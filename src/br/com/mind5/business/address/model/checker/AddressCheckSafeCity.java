...
public final class AddressCheckSafeCity extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeCity(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(AddressInfo recordInfo, Connection conn, String schemaName) {
		...
		if (StringValidator.validatePersonName(recordInfo.city) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_CITY);
