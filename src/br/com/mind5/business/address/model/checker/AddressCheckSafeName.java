...
public final class AddressCheckSafeName extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeName(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(AddressInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.addressName == null)
			return super.SUCCESS;
		
		if (StringValidator.validatePersonName(recordInfo.addressName) == super.SUCCESS)
			return super.SUCCESS;
