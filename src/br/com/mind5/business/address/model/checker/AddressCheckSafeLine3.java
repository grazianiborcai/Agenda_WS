...
public final class AddressCheckSafeLine3 extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeLine3(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(AddressInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.line3 == null)
			return super.SUCCESS;
		
		if (StringValidator.validatePersonName(recordInfo.line3) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_LINE_3);
