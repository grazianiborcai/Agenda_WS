...
public final class AddressCheckSafePostalCode extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafePostalCode(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_POSTAL_CODE);
