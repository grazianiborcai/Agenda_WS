...
public final class AddressCheckSafeLine5 extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeLine5(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(AddressInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.line5 == null)
			return super.SUCCESS;
		
		if (StringValidator.validatePersonName(recordInfo.line5) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_LINE_5);
