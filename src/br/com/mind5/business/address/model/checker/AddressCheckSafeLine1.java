...
public final class AddressCheckSafeLine1 extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeLine1(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(AddressInfo recordInfo, Connection conn, String schemaName) {
		...
		if (StringValidator.validatePersonName(recordInfo.line1) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_LINE_1);
