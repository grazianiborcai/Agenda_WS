...
public final class AddressCheckSafeLine2 extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeLine2(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(AddressInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.line2 == null)
			return super.SUCCESS;
		
		if (StringValidator.validatePersonName(recordInfo.line2) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_LINE_2);
