...
public final class AddressCheckSafeLine4 extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeLine4(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_LINE_4);
