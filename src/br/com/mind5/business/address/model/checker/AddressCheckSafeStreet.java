...
public final class AddressCheckSafeStreet extends ModelCheckerTemplateSimple<AddressInfo> {

	public AddressCheckSafeStreet(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.ADDRESS_STREET);
