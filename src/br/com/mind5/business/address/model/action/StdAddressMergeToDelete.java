...
public final class StdAddressMergeToDelete implements ActionStdV1<AddressInfo> {
	private ActionStdV1<AddressInfo> actionHelper;	
	
	
	public StdAddressMergeToDelete(DeciTreeOption<AddressInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiAddressMergeToDelete(option.conn, option.schemaName));
	}
