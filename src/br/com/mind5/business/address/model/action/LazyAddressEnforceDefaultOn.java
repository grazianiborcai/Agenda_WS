...
public final class LazyAddressEnforceDefaultOn extends ActionLazyTemplateV2<AddressInfo, AddressInfo> {
	
	public LazyAddressEnforceDefaultOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressEnforceDefaultOn(option);
	}
