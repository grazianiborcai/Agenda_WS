...
import br.com.mind5.business.addressDefault.model.decisionTree.AddaultRootSelectCus;
import br.com.mind5.model.action.ActionVisitorTemplateMerge;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class AddressVisiMergeAddaultCus extends ActionVisitorTemplateMerge<AddressInfo, AddaultInfo> {
	
	public AddressVisiMergeAddaultCus(DeciTreeOption<AddressInfo> option) {
	...
	@Override protected Class<? extends DeciTree<AddaultInfo>> getTreeClassHook() {
		return AddaultRootSelectCus.class;
	}
