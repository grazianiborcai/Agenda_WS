...
public final class LazyAddressGeodeCoding extends ActionLazyTemplateV2<AddressInfo, AddressInfo> {

	public LazyAddressGeodeCoding(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressGeodeCoding(option);
	}
