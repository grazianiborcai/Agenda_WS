...
import br.com.mind5.business.address.model.decisionTree.NodeAddressSnapshot;
import br.com.mind5.model.action.ActionLazyTemplateV1;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyAddressNodeSnapshot extends ActionLazyTemplateV1<AddressInfo, AddressInfo> {

	public LazyAddressNodeSnapshot(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new NodeAddressSnapshot(option).toAction();
	}
