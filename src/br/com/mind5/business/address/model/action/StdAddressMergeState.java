...
public final class StdAddressMergeState implements ActionStdV1<AddressInfo> {
	private ActionStdV1<AddressInfo> actionHelper;	
	
	
	public StdAddressMergeState(DeciTreeOption<AddressInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiAddressMergeState(option.conn, option.schemaName));
	}
