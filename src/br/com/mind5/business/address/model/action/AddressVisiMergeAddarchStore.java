...
public final class AddressVisiMergeAddarchStore extends ActionVisitorTemplateMerge<AddressInfo, AddarchInfo> {
	
	public AddressVisiMergeAddarchStore(DeciTreeOption<AddressInfo> option) {
