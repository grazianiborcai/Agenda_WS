...
public final class LazyAddressEnforceDistrictSearch extends ActionLazyTemplateV2<AddressInfo, AddressInfo> {

	public LazyAddressEnforceDistrictSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressEnforceDistrictSearch(option);
	}
