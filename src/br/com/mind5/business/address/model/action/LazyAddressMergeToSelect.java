...
public final class LazyAddressMergeToSelect extends ActionLazyTemplateV2<AddressInfo, AddressInfo> {

	public LazyAddressMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressMergeToSelect(option);
	}
