...
public final class StdAddressDelete implements ActionStdV1<AddressInfo> {
	private ActionStdV1<AddressInfo> actionHelper;
	
	
	public StdAddressDelete(DeciTreeOption<AddressInfo> option) {
	...
	private DaoStmtExec_<AddressInfo> buildStmtExec(DeciTreeOption<AddressInfo> option) {
		...
		return new AddressDelete(stmtExecOptions);
	}
