...
public final class AddressVisiMergeUsername extends ActionVisitorTemplateMerge<AddressInfo, UsernameInfo> {
	
	public AddressVisiMergeUsername(DeciTreeOption<AddressInfo> option) {
