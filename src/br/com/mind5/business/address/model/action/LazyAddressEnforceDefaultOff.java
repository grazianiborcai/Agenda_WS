...
public final class LazyAddressEnforceDefaultOff extends ActionLazyTemplateV2<AddressInfo, AddressInfo> {
	
	public LazyAddressEnforceDefaultOff(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressEnforceDefaultOff(option);
	}
