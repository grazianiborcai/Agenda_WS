...
public final class LazyAddressEnforceLChanged extends ActionLazyTemplateV2<AddressInfo, AddressInfo> {

	public LazyAddressEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressEnforceLChanged(option);
	}
