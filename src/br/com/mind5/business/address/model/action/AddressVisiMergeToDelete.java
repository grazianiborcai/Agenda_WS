...
public final class AddressVisiMergeToDelete extends ActionVisitorTemplateMerge<AddressInfo, AddressInfo> {
	
	public AddressVisiMergeToDelete(DeciTreeOption<AddressInfo> option) {
