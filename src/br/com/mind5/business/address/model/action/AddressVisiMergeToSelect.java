...
public final class AddressVisiMergeToSelect extends ActionVisitorTemplateMerge<AddressInfo, AddressInfo> {
	
	public AddressVisiMergeToSelect(DeciTreeOption<AddressInfo> option) {
