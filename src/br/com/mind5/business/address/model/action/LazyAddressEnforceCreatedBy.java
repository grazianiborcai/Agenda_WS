...
public final class LazyAddressEnforceCreatedBy extends ActionLazyTemplateV2<AddressInfo, AddressInfo> {

	public LazyAddressEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AddressInfo> getInstanceOfActionHook(DeciTreeOption<AddressInfo> option) {
		return new StdAddressEnforceCreatedBy(option);
	}
