...
public final class AddressDaoUpdateSingle extends DaoStmtTemplate<AddressInfo> {
	private final String MAIN_TABLE = DaoDbTable.ADDRESS_TABLE;
	
	
	public AddressDaoUpdateSingle(Connection conn, AddressInfo recordInfo, String schemaName) {
