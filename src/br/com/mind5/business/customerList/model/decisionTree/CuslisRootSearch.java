...
import br.com.mind5.business.customerList.model.action.CuslisVisiMergeCusarch;
...
public final class CuslisRootSearch extends DeciTreeTemplateRead<CuslisInfo> {
	
	public CuslisRootSearch(DeciTreeOption<CuslisInfo> option) {
		super(option);
	}
