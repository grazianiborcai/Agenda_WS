...
public final class CuslisVisiMergeCusarchAuth extends ActionVisitorTemplateMerge<CuslisInfo, CusarchInfo> {
	
	public CuslisVisiMergeCusarchAuth(DeciTreeOption<CuslisInfo> option) {
