...
final class StdCuslisMergeFimist implements ActionStdV1<CuslisInfo> {
	private ActionStdV1<CuslisInfo> actionHelper;	
	
	
	public StdCuslisMergeFimist(DeciTreeOption<CuslisInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiCuslisMergeFimist(option.conn, option.schemaName));
	}
