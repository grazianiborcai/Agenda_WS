...
public final class PeregDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.LEGAL_PERSON_TABLE;
