...
import br.com.mind5.business.personLegal.model.action.PeregVisiAddressUpdate;
...
public final class PeregNodeAddressUpdate extends DeciTreeTemplateWrite<PeregInfo> {
	
	public PeregNodeAddressUpdate(DeciTreeOption<PeregInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PeregInfo>> buildActionsOnPassedHook(DeciTreeOption<PeregInfo> option) {
		...
		ActionLazy<PeregInfo> updateAddress = new ActionLazyCommom<PeregInfo>(option, PeregVisiAddressUpdate.class);
		
		enforceAddressKey.addPostAction(updateAddress);
