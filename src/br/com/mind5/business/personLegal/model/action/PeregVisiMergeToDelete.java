...
public final class PeregVisiMergeToDelete extends ActionVisitorTemplateMerge<PeregInfo, PeregInfo> {
	
	public PeregVisiMergeToDelete(DeciTreeOption<PeregInfo> option) {
	...
	@Override protected List<PeregInfo> mergeHook(List<PeregInfo> baseInfos, List<PeregInfo> selectedInfos) {	
		return PeregMerger.mergeToDelete(baseInfos, selectedInfos);
	}
