...
public final class PerbioDaoInsertSingle extends DaoStmtTemplate<PerbioInfo> {
	private final String MAIN_TABLE = DaoDbTable.PERSON_BIO_TABLE;	
	
	
	public PerbioDaoInsertSingle(Connection conn, PerbioInfo recordInfo, String schemaName) {
