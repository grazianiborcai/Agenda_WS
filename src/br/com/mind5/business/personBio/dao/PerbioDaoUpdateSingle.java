...
public final class PerbioDaoUpdateSingle extends DaoStmtTemplate<PerbioInfo> {
	private final String MAIN_TABLE = DaoDbTable.PERSON_BIO_TABLE;	
	
	
	public PerbioDaoUpdateSingle(Connection conn, PerbioInfo recordInfo, String schemaName) {
