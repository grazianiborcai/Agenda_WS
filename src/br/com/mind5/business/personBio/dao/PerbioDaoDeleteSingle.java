...
public final class PerbioDaoDeleteSingle extends DaoStmtTemplate<PerbioInfo> {
	private final String MAIN_TABLE = DaoDbTable.PERSON_BIO_TABLE;	
	
	
	public PerbioDaoDeleteSingle(Connection conn, PerbioInfo recordInfo, String schemaName) {
