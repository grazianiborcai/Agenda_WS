...
import br.com.mind5.business.personBio.model.decisionTree.RootPetSearch;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyPetRootSearch extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {

	public LazyPetRootSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new RootPetSearch(option).toAction();
	}
