...
public final class LazyPerbioEnforceLChanged extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {
	
	public LazyPerbioEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new StdPerbioEnforceLChanged(option);
	}
