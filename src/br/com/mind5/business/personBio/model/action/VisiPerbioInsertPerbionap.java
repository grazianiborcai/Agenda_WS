...
import br.com.mind5.business.personBioSnapshot.model.decisionTree.RootPerbionapInsert;
import br.com.mind5.model.action.ActionVisitorTemplateAction;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

final class VisiPerbioInsertPerbionap extends ActionVisitorTemplateAction<PerbioInfo, PerbionapInfo> {

	public VisiPerbioInsertPerbionap(DeciTreeOption<PerbioInfo> option) {
	...
	@Override protected Class<? extends DeciTree<PerbionapInfo>> getTreeClassHook() {
		return RootPerbionapInsert.class;
	}
