...
public final class LazyPerbioDaoDelete extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {

	public LazyPerbioDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new StdPerbioDaoDelete(option);
	}
