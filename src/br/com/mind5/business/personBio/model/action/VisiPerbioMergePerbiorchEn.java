...
final class VisiPerbioMergePerbiorchEn extends ActionVisitorTemplateMerge<PerbioInfo, PerbiorchInfo> {
	
	public VisiPerbioMergePerbiorchEn(DeciTreeOption<PerbioInfo> option) {
