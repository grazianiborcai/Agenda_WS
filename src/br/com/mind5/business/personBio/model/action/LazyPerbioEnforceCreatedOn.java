...
public final class LazyPerbioEnforceCreatedOn extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {
	
	public LazyPerbioEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new StdPerbioEnforceCreatedOn(option);
	}
