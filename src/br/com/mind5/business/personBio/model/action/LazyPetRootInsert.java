...
public final class LazyPetRootInsert extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {

	public LazyPetRootInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new RootPerbioInsert(option).toAction();
	}
