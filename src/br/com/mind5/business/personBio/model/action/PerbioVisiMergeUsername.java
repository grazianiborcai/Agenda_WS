...
public final class PerbioVisiMergeUsername extends ActionVisitorTemplateMerge<PerbioInfo, UsernameInfo> {
	
	public PerbioVisiMergeUsername(DeciTreeOption<PerbioInfo> option) {
