...
public final class LazyPetMergeToUpdate extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {
	
	public LazyPetMergeToUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new StdPerbioMergeToUpdate(option);
	}
