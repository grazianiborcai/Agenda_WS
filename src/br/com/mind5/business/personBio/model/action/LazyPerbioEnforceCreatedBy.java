...
public final class LazyPerbioEnforceCreatedBy extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {
	
	public LazyPerbioEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new StdPerbioEnforceCreatedBy(option);
	}
