...
public final class LazyPerbioDaoInsert extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {
	
	public LazyPerbioDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new StdPerbioDaoInsert(option);
	}
