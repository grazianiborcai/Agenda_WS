...
final class VisiPerbioMergePerbiorchPerson extends ActionVisitorTemplateMerge<PerbioInfo, PerbiorchInfo> {
	
	public VisiPerbioMergePerbiorchPerson(DeciTreeOption<PerbioInfo> option) {
