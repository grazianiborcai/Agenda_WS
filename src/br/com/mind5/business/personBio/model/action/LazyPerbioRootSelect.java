...
public final class LazyPerbioRootSelect extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {

	public LazyPerbioRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new RootPerbioSelect(option).toAction();
	}
