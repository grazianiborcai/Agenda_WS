...
final class VisiPerbioMergeToUpdate extends ActionVisitorTemplateMerge<PerbioInfo, PerbioInfo> {
	
	public VisiPerbioMergeToUpdate(DeciTreeOption<PerbioInfo> option) {
