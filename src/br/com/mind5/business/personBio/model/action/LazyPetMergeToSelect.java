...
public final class LazyPetMergeToSelect extends ActionLazyTemplate<PerbioInfo, PerbioInfo> {
	
	public LazyPetMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PerbioInfo> getInstanceOfActionHook(DeciTreeOption<PerbioInfo> option) {
		return new StdPerbioMergeToSelect(option);
	}
