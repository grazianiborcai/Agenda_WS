...
public final class PerbioVisiMergePerbiorch extends ActionVisitorTemplateMerge<PerbioInfo, PerbiorchInfo> {
	
	public PerbioVisiMergePerbiorch(DeciTreeOption<PerbioInfo> option) {
