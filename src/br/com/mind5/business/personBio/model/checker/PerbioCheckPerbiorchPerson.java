...
public final class PerbioCheckPerbiorchPerson extends ModelCheckerTemplateForward<PerbioInfo, PerbiorchInfo> {
	
	public PerbioCheckPerbiorchPerson(ModelCheckerOption option) {
		super(option);
	}
