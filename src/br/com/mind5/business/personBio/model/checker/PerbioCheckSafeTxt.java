...
public final class PerbioCheckSafeTxt extends ModelCheckerTemplateSimple<PerbioInfo> {

	public PerbioCheckSafeTxt(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(PerbioInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.txtBio == null)
			return super.SUCCESS;
		
		if (StringValidator.validateSafe(recordInfo.txtBio) == super.SUCCESS)
			return super.SUCCESS;
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam01(SystemCode.PERSON_BIO);
