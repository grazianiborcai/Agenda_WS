...
import br.com.mind5.business.personBio.model.action.LazyPerbioEnforceLChanged;
import br.com.mind5.business.personBio.model.action.StdPerbioMergeToUpdate;
...
public final class RootPerbioUpdate extends DeciTreeTemplateWrite<PerbioInfo> {
	
	public RootPerbioUpdate(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnPassedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> mergeToUpdate = new StdPerbioMergeToUpdate(option);
		ActionLazy<PerbioInfo> enforceLChanged = new LazyPerbioEnforceLChanged(option.conn, option.schemaName);	
