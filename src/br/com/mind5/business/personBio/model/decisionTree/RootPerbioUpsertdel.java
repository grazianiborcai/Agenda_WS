...
public final class RootPerbioUpsertdel extends DeciTreeTemplateWrite<PerbioInfo> {
	
	public RootPerbioUpsertdel(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnPassedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> update = new NodePerbioUpsertdelL1(option).toAction();
