...
import br.com.mind5.business.personBio.model.action.PerbioVisiMergePerbiorch;
...
public final class PerbioRootSearch extends DeciTreeTemplateRead<PerbioInfo> {
	
	public PerbioRootSearch(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnPassedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> mergePerbiorch = new ActionStdCommom<PerbioInfo>(option, PerbioVisiMergePerbiorch.class);
