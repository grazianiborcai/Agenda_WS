...
public final class PerbioNodeUpsertdelL1 extends DeciTreeTemplateWrite<PerbioInfo> {
	
	public PerbioNodeUpsertdelL1(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnPassedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> delete = new PerbioRootDelete(option).toAction();
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnFailedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> nodeL2 = new PerbioNodeUpsertdelL2(option).toAction();
