...
import br.com.mind5.business.personBio.model.action.LazyPerbioDaoDelete;
...
public final class RootPerbioDelete extends DeciTreeTemplateWrite<PerbioInfo> {
	
	public RootPerbioDelete(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnPassedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionLazy<PerbioInfo> delete = new LazyPerbioDaoDelete(option.conn, option.schemaName);
