...
public final class PerbioNodeUpsertdelL2 extends DeciTreeTemplateWrite<PerbioInfo> {
	
	public PerbioNodeUpsertdelL2(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnPassedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> update = new PerbioRootUpdate(option).toAction();
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnFailedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> insert = new PerbioRootInsert(option).toAction();
