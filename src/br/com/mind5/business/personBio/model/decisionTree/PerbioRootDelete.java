...
import br.com.mind5.business.personBio.model.action.PerbioVisiDaoDelete;
import br.com.mind5.business.personBio.model.action.PerbioVisiMergeToSelect;
import br.com.mind5.business.personBio.model.checker.PerbioCheckDelete;
...
public final class PerbioRootDelete extends DeciTreeTemplateWrite<PerbioInfo> {
	
	public PerbioRootDelete(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
	...
	@Override protected ModelChecker<PerbioInfo> buildCheckerHook(DeciTreeOption<PerbioInfo> option) {
		...
		checker = new PerbioCheckDelete(checkerOption);
		queue.add(checker);
		...
		return new ModelCheckerHelperQueue<PerbioInfo>(queue);
	}
	...
	@Override protected List<ActionStd<PerbioInfo>> buildActionsOnPassedHook(DeciTreeOption<PerbioInfo> option) {
		...
		ActionStd<PerbioInfo> select = new ActionStdCommom<PerbioInfo>(option, PerbioVisiMergeToSelect.class);
		ActionLazy<PerbioInfo> delete = new ActionLazyCommom<PerbioInfo>(option, PerbioVisiDaoDelete.class);
