...
public final class PerbioRootDeleteFromPerson extends DeciTreeTemplateRead<PerbioInfo> {
	
	public PerbioRootDeleteFromPerson(DeciTreeOption<PerbioInfo> option) {
		super(option);
	}
