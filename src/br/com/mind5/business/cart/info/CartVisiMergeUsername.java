...
final class CartVisiMergeUsername implements InfoMergerVisitor_<CartInfo, UsernameInfo> {
	...
	private void checkArgument(UsernameInfo sourceOne, CartInfo sourceTwo) {
	...
	private CartInfo merge(UsernameInfo sourceOne, CartInfo sourceTwo) {
	...
	@Override public boolean shouldWrite(UsernameInfo sourceOne, CartInfo sourceTwo) {
