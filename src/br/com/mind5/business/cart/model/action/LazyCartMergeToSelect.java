...
public final class LazyCartMergeToSelect extends ActionLazyTemplateV1<CartInfo, CartInfo> {

	public LazyCartMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeToSelect(option);
	}
