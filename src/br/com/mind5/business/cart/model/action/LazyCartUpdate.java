...
public final class LazyCartUpdate extends ActionLazyTemplateV1<CartInfo, CartInfo> {

	public LazyCartUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartUpdate(option);
	}
