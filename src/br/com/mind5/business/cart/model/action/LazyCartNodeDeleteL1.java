...
import br.com.mind5.business.cart.model.decisionTree.NodeCartDeleteL1;
import br.com.mind5.model.action.ActionLazyTemplateV2;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyCartNodeDeleteL1 extends ActionLazyTemplateV2<CartInfo, CartInfo> {
	
	public LazyCartNodeDeleteL1(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new NodeCartDeleteL1(option).toAction();
	}
