...
public final class CartVisiEnforceCartemKey extends ActionVisitorTemplateEnforce<CartInfo> {
	
	public CartVisiEnforceCartemKey(DeciTreeOption<CartInfo> option) {
		super(option);
	}
