...
public final class LazyCartEnforceExpiryOn extends ActionLazyTemplate<CartInfo, CartInfo> {

	public LazyCartEnforceExpiryOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartEnforceExpiryOn(option);
	}
