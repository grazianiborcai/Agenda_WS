...
public final class CartVisiMergeCurrency extends ActionVisitorTemplateMerge<CartInfo, CurrencyInfo> {
	
	public CartVisiMergeCurrency(DeciTreeOption<CartInfo> option) {
