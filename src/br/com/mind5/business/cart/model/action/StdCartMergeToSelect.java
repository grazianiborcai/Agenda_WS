...
public final class StdCartMergeToSelect implements ActionStdV1<CartInfo> {
	private ActionStdV1<CartInfo> actionHelper;	
	
	
	public StdCartMergeToSelect(DeciTreeOption<CartInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiCartMergeToSelect(option.conn, option.schemaName));
	}
