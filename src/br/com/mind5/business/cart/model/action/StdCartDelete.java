...
import br.com.mind5.business.cart.dao.CartDelete;
...
public final class StdCartDelete implements ActionStdV1<CartInfo> {
	private ActionStdV1<CartInfo> actionHelper;
	
	
	public StdCartDelete(DeciTreeOption<CartInfo> option) {
	...
	private DaoStmtExec_<CartInfo> buildStmtExec(DeciTreeOption<CartInfo> option) {
		...
		return new CartDelete(stmtExecOptions);
	}
