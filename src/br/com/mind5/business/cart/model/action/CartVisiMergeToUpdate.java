...
public final class CartVisiMergeToUpdate extends ActionVisitorTemplateMerge<CartInfo, CartInfo> {
	
	public CartVisiMergeToUpdate(DeciTreeOption<CartInfo> option) {
