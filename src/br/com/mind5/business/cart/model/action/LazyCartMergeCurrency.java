...
public final class LazyCartMergeCurrency extends ActionLazyTemplateV1<CartInfo, CartInfo> {

	public LazyCartMergeCurrency(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartMergeCurrency(option);
	}
