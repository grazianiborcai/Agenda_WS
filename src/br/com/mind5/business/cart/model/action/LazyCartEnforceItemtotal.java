...
public final class LazyCartEnforceItemtotal extends ActionLazyTemplateV1<CartInfo, CartInfo> {

	public LazyCartEnforceItemtotal(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CartInfo> getInstanceOfActionHook(DeciTreeOption<CartInfo> option) {
		return new StdCartEnforceItemtotal(option);
	}
