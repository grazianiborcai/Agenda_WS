...
public final class CartNodeHeaderUpsert extends DeciTreeTemplateWrite<CartInfo> {
	
	public CartNodeHeaderUpsert(DeciTreeOption<CartInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartInfo>> buildActionsOnPassedHook(DeciTreeOption<CartInfo> option) {
		...
		ActionStd<CartInfo> update = new CartNodeUpdate(option).toAction();
	...
	@Override protected List<ActionStd<CartInfo>> buildActionsOnFailedHook(DeciTreeOption<CartInfo> option) {
		...
		ActionStd<CartInfo> insert = new CartNodeInsert(option).toAction();
