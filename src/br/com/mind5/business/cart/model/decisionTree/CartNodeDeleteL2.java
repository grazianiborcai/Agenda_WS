...
import br.com.mind5.business.cart.model.action.CartVisiDaoDelete;
...
public final class CartNodeDeleteL2 extends DeciTreeTemplateWrite<CartInfo> {
	
	public CartNodeDeleteL2(DeciTreeOption<CartInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartInfo>> buildActionsOnPassedHook(DeciTreeOption<CartInfo> option) {
		...
		ActionStd<CartInfo> delete = new ActionStdCommom<CartInfo>(option, CartVisiDaoDelete.class);
