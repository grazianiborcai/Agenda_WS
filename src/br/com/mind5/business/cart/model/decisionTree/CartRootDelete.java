...
import br.com.mind5.business.cart.model.action.CartVisiNodeDeleteL1;
...
public final class CartRootDelete extends DeciTreeTemplateWrite<CartInfo> {
	
	public CartRootDelete(DeciTreeOption<CartInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartInfo>> buildActionsOnPassedHook(DeciTreeOption<CartInfo> option) {
		...
		ActionLazy<CartInfo> nodeL1 = new ActionLazyCommom<CartInfo>(option, CartVisiNodeDeleteL1.class);
