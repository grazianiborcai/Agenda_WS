...
import br.com.mind5.business.cart.model.action.CartVisiNodeCheckoutL1;
...
public final class CartRootCheckout extends DeciTreeTemplateWrite<CartInfo> {
	
	public CartRootCheckout(DeciTreeOption<CartInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartInfo>> buildActionsOnPassedHook(DeciTreeOption<CartInfo> option) {
		...
		ActionLazy<CartInfo> checkout = new ActionLazyCommom<CartInfo>(option, CartVisiNodeCheckoutL1.class);
