...
public final class CartDaoInsertSingle extends DaoStmtTemplate<CartInfo> {
	private final String MAIN_TABLE = DaoDbTable.CART_HDR_TABLE;	
	
	
	public CartDaoInsertSingle(Connection conn, CartInfo recordInfo, String schemaName) {
