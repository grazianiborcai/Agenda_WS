...
public final class CartDaoDeleteSingle extends DaoStmtTemplate<CartInfo> {
	private final String MAIN_TABLE = DaoDbTable.CART_HDR_TABLE;	
	
	
	public CartDaoDeleteSingle(Connection conn, CartInfo recordInfo, String schemaName) {
