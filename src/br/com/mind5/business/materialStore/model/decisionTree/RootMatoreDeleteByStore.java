...
public final class RootMatoreDeleteByStore extends DeciTreeTemplateWriteV2<MatoreInfo> {
	...
	@Override protected List<ActionStdV2<MatoreInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoreInfo> option) {
		...
		ActionStdV2<MatoreInfo> enforceStoreKey = new StdMatoreEnforceStoreKey(option);
