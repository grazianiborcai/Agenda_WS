...
public final class NodeMatoreUpsertL2 extends DeciTreeTemplateWriteV2<MatoreInfo> {
	...
	@Override protected List<ActionStdV2<MatoreInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoreInfo> option) {
		...
		ActionStdV2<MatoreInfo> nodeL3 = new NodeMatoreUpsertL3(option).toAction();		
		actions.add(nodeL3);
	...
	@Override protected List<ActionStdV2<MatoreInfo>> buildActionsOnFailedHook(DeciTreeOption<MatoreInfo> option) {
		...
		ActionStdV2<MatoreInfo> nodeL4 = new NodeMatoreUpsertL4(option).toAction();		
		actions.add(nodeL4);
