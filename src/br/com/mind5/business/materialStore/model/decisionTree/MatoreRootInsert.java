...
import br.com.mind5.business.materialStore.model.action.MatoreVisiNodeUpsertL1;
...
public final class MatoreRootInsert extends DeciTreeTemplateWrite<MatoreInfo> {
	
	public MatoreRootInsert(DeciTreeOption<MatoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatoreInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoreInfo> option) {
		...
		ActionStd<MatoreInfo> mergeMatlis = new ActionStdCommom<MatoreInfo>(option, MatoreVisiMergeMatlis.class);
		ActionLazy<MatoreInfo> upsert = new ActionLazyCommom<MatoreInfo>(option, MatoreVisiNodeUpsertL1.class);
