...
public final class NodeMatoreUpsertL3 extends DeciTreeTemplateWriteV2<MatoreInfo> {
	
	public NodeMatoreUpsertL3(DeciTreeOption<MatoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV2<MatoreInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoreInfo> option) {
		...
		ActionStdV2<MatoreInfo> nodeL6 = new NodeMatoreUpsertL6(option).toAction();		
		actions.add(nodeL6);
