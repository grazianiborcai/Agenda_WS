...
public final class MatoreNodeUpsertL4 extends DeciTreeTemplateWrite<MatoreInfo> {
	
	public MatoreNodeUpsertL4(DeciTreeOption<MatoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatoreInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoreInfo> option) {
		...
		ActionStd<MatoreInfo> nodeL5 = new MatoreNodeUpsertL5(option).toAction();		
		actions.add(nodeL5);
