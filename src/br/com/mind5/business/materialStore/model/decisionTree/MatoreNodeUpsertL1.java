...
public final class MatoreNodeUpsertL1 extends DeciTreeTemplateWrite<MatoreInfo> {
	
	public MatoreNodeUpsertL1(DeciTreeOption<MatoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatoreInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoreInfo> option) {
		...
		ActionStd<MatoreInfo> nodeL2 = new MatoreNodeUpsertL2(option).toAction();		
		actions.add(nodeL2);
