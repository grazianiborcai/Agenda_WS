...
public final class MatoreCheckIsProduct extends ModelCheckerTemplateSimpleV2<MatoreInfo> {
	...
	@Override protected boolean checkHook(MatoreInfo recordInfo, Connection conn, String schemaName) {	
		...
		if ( recordInfo.matlisData.codMatCateg == Mateg.PRODUCT.getCodMatCateg() )	
