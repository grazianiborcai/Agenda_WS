...
public final class MatoreCheckDeleteFromStore extends ModelCheckerTemplateSimple<MatoreInfo> {

	public MatoreCheckDeleteFromStore(ModelCheckerOption option) {
		super(option);
	}
