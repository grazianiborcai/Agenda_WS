...
public final class LazyMatoreEnforceRange extends ActionLazyTemplateV2<MatoreInfo, MatoreInfo> {
	
	public LazyMatoreEnforceRange(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatoreInfo> getInstanceOfActionHook(DeciTreeOption<MatoreInfo> option) {
		return new StdMatoreEnforceRange(option);
	}
