...
public final class StdMatoreMergeToUpdate implements ActionStdV1<MatoreInfo> {
	private ActionStdV1<MatoreInfo> actionHelper;	
	
	
	public StdMatoreMergeToUpdate(DeciTreeOption<MatoreInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatoreMergeToUpdate(option.conn, option.schemaName));
	}
