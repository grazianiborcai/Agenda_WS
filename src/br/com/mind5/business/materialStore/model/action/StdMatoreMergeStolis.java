...
public final class StdMatoreMergeStolis implements ActionStdV1<MatoreInfo> {
	private ActionStdV1<MatoreInfo> actionHelper;	
	
	
	public StdMatoreMergeStolis(DeciTreeOption<MatoreInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatoreMergeStolis(option.conn, option.schemaName));
	}
