...
import br.com.mind5.business.materialStoreSearch.model.decisionTree.MatorarchRootSelectStore;
import br.com.mind5.model.action.ActionVisitorTemplateMerge;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class MatoreVisiMergeMatorarchStore extends ActionVisitorTemplateMerge<MatoreInfo, MatorarchInfo> {
	
	public MatoreVisiMergeMatorarchStore(DeciTreeOption<MatoreInfo> option) {
	...
	@Override protected Class<? extends DeciTree<MatorarchInfo>> getTreeClassHook() {
		return MatorarchRootSelectStore.class;
	}
