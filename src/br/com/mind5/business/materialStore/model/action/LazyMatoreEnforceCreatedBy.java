...
public final class LazyMatoreEnforceCreatedBy extends ActionLazyTemplateV2<MatoreInfo, MatoreInfo> {
	
	public LazyMatoreEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatoreInfo> getInstanceOfActionHook(DeciTreeOption<MatoreInfo> option) {
		return new StdMatoreEnforceCreatedBy(option);
	}
