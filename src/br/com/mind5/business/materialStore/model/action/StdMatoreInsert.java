...
import br.com.mind5.business.materialStore.dao.MatoreInsert;
...
public final class StdMatoreInsert implements ActionStdV1<MatoreInfo> {
	private ActionStdV1<MatoreInfo> actionHelper;
	
	
	public StdMatoreInsert(DeciTreeOption<MatoreInfo> option) {
	...
	private DaoStmtExec_<MatoreInfo> buildStmtExec(DeciTreeOption<MatoreInfo> option) {
		...
		return new MatoreInsert(stmtExecOptions);
	}
