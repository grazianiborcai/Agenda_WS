...
import br.com.mind5.business.materialStore.dao.MatoreDelete;
...
public final class StdMatoreDelete implements ActionStdV1<MatoreInfo> {
	private ActionStdV1<MatoreInfo> actionHelper;
	
	
	public StdMatoreDelete(DeciTreeOption<MatoreInfo> option) {
	...
	private DaoStmtExec_<MatoreInfo> buildStmtExec(DeciTreeOption<MatoreInfo> option) {
		...
		return new MatoreDelete(stmtExecOptions);
	}
