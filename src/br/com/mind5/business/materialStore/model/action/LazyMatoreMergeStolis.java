...
public final class LazyMatoreMergeStolis extends ActionLazyTemplateV2<MatoreInfo, MatoreInfo> {
	
	public LazyMatoreMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatoreInfo> getInstanceOfActionHook(DeciTreeOption<MatoreInfo> option) {
		return new StdMatoreMergeStolis(option);
	}
