...
public final class LazyMatoreEnforceMax extends ActionLazyTemplate<MatoreInfo, MatoreInfo> {
	
	public LazyMatoreEnforceMax(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatoreInfo> getInstanceOfActionHook(DeciTreeOption<MatoreInfo> option) {
		return new StdMatoreEnforceMax(option);
	}
