...
public final class MatoreVisiEnforceStoreKey extends ActionVisitorTemplateEnforce<MatoreInfo> {
	
	public MatoreVisiEnforceStoreKey(DeciTreeOption<MatoreInfo> option) {
		super(option);
	}
