...
public final class LazyMatoreDaoSelect extends ActionLazyTemplateV2<MatoreInfo, MatoreInfo> {
	
	public LazyMatoreDaoSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatoreInfo> getInstanceOfActionHook(DeciTreeOption<MatoreInfo> option) {
		return new StdMatoreDaoSelect(option);
	}
