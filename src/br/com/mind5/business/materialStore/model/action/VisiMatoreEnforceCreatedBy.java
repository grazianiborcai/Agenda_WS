...
final class VisiMatoreEnforceCreatedBy extends ActionVisitorTemplateEnforceV2<MatoreInfo> {
	
	public VisiMatoreEnforceCreatedBy(DeciTreeOption<MatoreInfo> option) {
		super(option);
	}
