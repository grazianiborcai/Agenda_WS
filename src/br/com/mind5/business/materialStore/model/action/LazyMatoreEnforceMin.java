...
public final class LazyMatoreEnforceMin extends ActionLazyTemplate<MatoreInfo, MatoreInfo> {
	
	public LazyMatoreEnforceMin(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatoreInfo> getInstanceOfActionHook(DeciTreeOption<MatoreInfo> option) {
		return new StdMatoreEnforceMin(option);
	}
