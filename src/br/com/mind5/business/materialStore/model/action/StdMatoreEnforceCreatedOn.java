...
public final class StdMatoreEnforceCreatedOn implements ActionStdV1<MatoreInfo> {
	private ActionStdV1<MatoreInfo> actionHelper;	
	
	
	public StdMatoreEnforceCreatedOn(DeciTreeOption<MatoreInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiMatoreEnforceCreatedOn());
	}
