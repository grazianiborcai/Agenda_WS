...
public final class MatoreDaoDeleteSingle extends DaoStmtTemplate<MatoreInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_STORE_TABLE;
	
	
	public MatoreDaoDeleteSingle(Connection conn, MatoreInfo recordInfo, String schemaName) {
