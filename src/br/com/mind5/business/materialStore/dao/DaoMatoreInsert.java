...
public final class DaoMatoreInsert implements DaoStmtExecV2<MatoreInfo> {
	private DaoStmtExecV2<MatoreInfo> helper;
	
	
	public DaoMatoreInsert(List<DaoStmtExecOption<MatoreInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoMatoreInsertSingle.class, MatoreInfo.class);
	}
