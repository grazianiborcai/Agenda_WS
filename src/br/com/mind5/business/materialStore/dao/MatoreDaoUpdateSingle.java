...
public final class MatoreDaoUpdateSingle extends DaoStmtTemplate<MatoreInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_STORE_TABLE;	
	
	
	public MatoreDaoUpdateSingle(Connection conn, MatoreInfo recordInfo, String schemaName) {
