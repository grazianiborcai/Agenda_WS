...
public final class PhonaultCheckExist extends ModelCheckerTemplateActionV2<PhonaultInfo, PhonaultInfo> {
	...
	@Override protected ActionStdV1<PhonaultInfo> buildActionHook(DeciTreeOption<PhonaultInfo> option) {
		ActionStdV1<PhonaultInfo> select = new RootPhonaultSelect(option).toAction();
		return select;
	}
