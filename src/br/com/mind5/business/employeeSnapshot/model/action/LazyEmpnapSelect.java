...
public final class LazyEmpnapSelect extends ActionLazyTemplateV1<EmpnapInfo, EmpnapInfo> {
	
	public LazyEmpnapSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpnapInfo> getInstanceOfActionHook(DeciTreeOption<EmpnapInfo> option) {
		return new StdEmpnapSelect(option);
	}
