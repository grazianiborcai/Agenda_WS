...
final class PhonapDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public PhonapDaoWhere(DaoWhereBuilderOption whereOption, String tableName, PhonapInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, PhonapInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case PhonapDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case PhonapDaoDbTableColumn.COL_COD_SNAPSHOT :
