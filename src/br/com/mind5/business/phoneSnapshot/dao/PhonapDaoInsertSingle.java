...
public final class PhonapDaoInsertSingle extends DaoStmtTemplate<PhonapInfo> {
	private final String MAIN_TABLE = DaoDbTable.PHONE_SNAPSHOT_TABLE;
	
	
	public PhonapDaoInsertSingle(Connection conn, PhonapInfo recordInfo, String schemaName) {
