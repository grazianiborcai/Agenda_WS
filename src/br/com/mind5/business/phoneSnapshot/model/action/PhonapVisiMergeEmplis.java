...
public final class PhonapVisiMergeEmplis extends ActionVisitorTemplateMerge<PhonapInfo, EmplisInfo> {
	
	public PhonapVisiMergeEmplis(DeciTreeOption<PhonapInfo> option) {
