...
public final class StdPhonapMergeEmplis implements ActionStdV1<PhonapInfo> {
	private ActionStdV1<PhonapInfo> actionHelper;	
	
	
	public StdPhonapMergeEmplis(DeciTreeOption<PhonapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPhonapMergeEmplis(option.conn, option.schemaName));
	}
