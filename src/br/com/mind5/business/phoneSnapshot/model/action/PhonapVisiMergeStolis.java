...
public final class PhonapVisiMergeStolis extends ActionVisitorTemplateMerge<PhonapInfo, StolisInfo> {
	
	public PhonapVisiMergeStolis(DeciTreeOption<PhonapInfo> option) {
