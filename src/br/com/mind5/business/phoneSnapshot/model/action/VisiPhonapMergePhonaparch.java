...
final class VisiPhonapMergePhonaparch extends ActionVisitorTemplateMerge<PhonapInfo, PhonaparchInfo> {
	
	public VisiPhonapMergePhonaparch(DeciTreeOption<PhonapInfo> option) {
