...
public final class StuntmVisiMergeToDelete extends ActionVisitorTemplateMerge<StuntmInfo, StuntmInfo> {
	
	public StuntmVisiMergeToDelete(DeciTreeOption<StuntmInfo> option) {
	...
	@Override protected List<StuntmInfo> mergeHook(List<StuntmInfo> baseInfos, List<StuntmInfo> selectedInfos) {	
		return StuntmMerger.mergeToDelete(baseInfos, selectedInfos);
	}
