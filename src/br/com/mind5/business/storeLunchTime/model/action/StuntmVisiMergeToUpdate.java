...
public final class StuntmVisiMergeToUpdate extends ActionVisitorTemplateMerge<StuntmInfo, StuntmInfo> {
	
	public StuntmVisiMergeToUpdate(DeciTreeOption<StuntmInfo> option) {
	...
	@Override protected List<StuntmInfo> mergeHook(List<StuntmInfo> baseInfos, List<StuntmInfo> selectedInfos) {	
		return StuntmMerger.mergeToUpdate(baseInfos, selectedInfos);
	}
