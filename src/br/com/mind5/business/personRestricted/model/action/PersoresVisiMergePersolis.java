...
public final class PersoresVisiMergePersolis extends ActionVisitorTemplateMerge<PersoresInfo, PersolisInfo> {
	
	public PersoresVisiMergePersolis(DeciTreeOption<PersoresInfo> option) {
