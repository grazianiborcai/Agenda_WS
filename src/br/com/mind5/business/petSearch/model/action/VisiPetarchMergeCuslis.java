...
final class VisiPetarchMergeCuslis extends ActionVisitorTemplateMerge<PetarchInfo, CuslisInfo> {
	
	public VisiPetarchMergeCuslis(DeciTreeOption<PetarchInfo> option) {
