...
public final class LazyPetarchRootSelectUser extends ActionLazyTemplate<PetarchInfo, PetarchInfo> {

	public LazyPetarchRootSelectUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetarchInfo> getInstanceOfActionHook(DeciTreeOption<PetarchInfo> option) {
		return new RootPetarchSelectUser(option).toAction();
	}
