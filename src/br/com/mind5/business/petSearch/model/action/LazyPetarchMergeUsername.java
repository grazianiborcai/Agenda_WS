...
public final class LazyPetarchMergeUsername extends ActionLazyTemplate<PetarchInfo, PetarchInfo> {
	
	public LazyPetarchMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetarchInfo> getInstanceOfActionHook(DeciTreeOption<PetarchInfo> option) {
		return new StdPetarchMergeUsername(option);
	}
