...
final class VisiPetarchMergeUsername extends ActionVisitorTemplateMerge<PetarchInfo, UsernameInfo> {
	
	public VisiPetarchMergeUsername(DeciTreeOption<PetarchInfo> option) {
