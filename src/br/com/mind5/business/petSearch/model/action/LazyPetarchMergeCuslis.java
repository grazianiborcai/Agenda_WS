...
public final class LazyPetarchMergeCuslis extends ActionLazyTemplate<PetarchInfo, PetarchInfo> {
	
	public LazyPetarchMergeCuslis(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetarchInfo> getInstanceOfActionHook(DeciTreeOption<PetarchInfo> option) {
		return new StdPetarchMergeCuslis(option);
	}
