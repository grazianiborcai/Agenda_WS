...
final class VisiPetarchEnforceUsername extends ActionVisitorTemplateEnforce<PetarchInfo> {
	
	public VisiPetarchEnforceUsername(DeciTreeOption<PetarchInfo> option) {
		super(option);
	}
