...
import br.com.mind5.business.petSearch.model.action.PetarchVisiEnforcePetCus;
...
public final class PetarchRootSelectPetCus extends DeciTreeTemplateRead<PetarchInfo> {
	
	public PetarchRootSelectPetCus(DeciTreeOption<PetarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PetarchInfo> option) {
		...
		ActionStd<PetarchInfo> enforcePetCustomer = new ActionStdCommom<PetarchInfo>(option, PetarchVisiEnforcePetCus.class);
		...
		actions.add(enforcePetCustomer);		
		return actions;
	}
}
