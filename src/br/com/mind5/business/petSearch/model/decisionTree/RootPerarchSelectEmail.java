...
import br.com.mind5.business.petSearch.model.action.StdPerarchEnforceEmail;
import br.com.mind5.business.petSearch.model.checker.PerarchCheckReadEmail;
...
public final class RootPerarchSelectEmail extends DeciTreeTemplateRead<PetarchInfo> {
	
	public RootPerarchSelectEmail(DeciTreeOption<PetarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PetarchInfo> option) {
		...
		ActionStd<PetarchInfo> enforceEmail = new StdPerarchEnforceEmail(option);	
