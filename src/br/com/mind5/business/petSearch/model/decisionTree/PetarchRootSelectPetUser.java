...
import br.com.mind5.business.petSearch.model.action.PetarchVisiEnforcePetUser;
...
public final class PetarchRootSelectPetUser extends DeciTreeTemplateRead<PetarchInfo> {
	
	public PetarchRootSelectPetUser(DeciTreeOption<PetarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PetarchInfo> option) {
		...
		ActionStd<PetarchInfo> enforcePetUser = new ActionStdCommom<PetarchInfo>(option, PetarchVisiEnforcePetUser.class);
