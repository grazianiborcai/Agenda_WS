...
import br.com.mind5.business.petSearch.model.action.PetarchVisiEnforceCus;
import br.com.mind5.business.petSearch.model.action.PetarchVisiMergeCuslis;
...
public final class PetarchRootSelectCus extends DeciTreeTemplateRead<PetarchInfo> {
	
	public PetarchRootSelectCus(DeciTreeOption<PetarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PetarchInfo> option) {
		...
		ActionStd<PetarchInfo> enforceCustomer = new ActionStdCommom<PetarchInfo>(option, PetarchVisiEnforceCus.class);
		ActionLazy<PetarchInfo> mergeCuslis = new ActionLazyCommom<PetarchInfo>(option, PetarchVisiMergeCuslis.class);
