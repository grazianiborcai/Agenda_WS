...
import br.com.mind5.business.petSearch.model.action.PetarchVisiEnforceUser;
...
public final class PetarchRootSelectUser extends DeciTreeTemplateRead<PetarchInfo> {
	
	public PetarchRootSelectUser(DeciTreeOption<PetarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PetarchInfo> option) {
		...
		ActionStd<PetarchInfo> enforceUser = new ActionStdCommom<PetarchInfo>(option, PetarchVisiEnforceUser.class);
