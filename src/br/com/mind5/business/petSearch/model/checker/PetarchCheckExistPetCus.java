...
public final class PetarchCheckExistPetCus extends ModelCheckerTemplateAction<PetarchInfo, PetarchInfo> {
	
	public PetarchCheckExistPetCus(ModelCheckerOption option) {
