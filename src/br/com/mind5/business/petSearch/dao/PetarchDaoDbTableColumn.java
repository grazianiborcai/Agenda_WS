...
public final class PetarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public PetarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.PET_SEARCH_VIEW, columns);
		return results;
	}
}
