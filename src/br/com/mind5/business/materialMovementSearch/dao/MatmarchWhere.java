...
public final class MatmarchWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public MatmarchWhere(DaoWhereBuilderOption whereOption, String tableName, MatmarchInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, MatmarchInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case MatmarchDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case MatmarchDbTableColumn.COL_COD_STORE :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codStore));
					break;
					
				case MatmarchDbTableColumn.COL_COD_MATERIAL :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codMat));
					break;
					
				case MatmarchDbTableColumn.COL_COD_MAT_MOV :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codMatmov));
					break;
					
				case MatmarchDbTableColumn.COL_POSTING_YEAR_MONTH :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.postingYearMonth));
					break;
					
				case MatmarchDbTableColumn.COL_POSTING_YEAR :
