...
public final class LazySchedmonMergeMatlis extends ActionLazyTemplateV2<SchedmonInfo, SchedmonInfo> {
	
	public LazySchedmonMergeMatlis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedmonInfo> getInstanceOfActionHook(DeciTreeOption<SchedmonInfo> option) {
		return new StdSchedmonMergeMatlis(option);
	}
