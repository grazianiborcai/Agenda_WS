...
public final class SchedmonVisiMergeMatlis extends ActionVisitorTemplateMerge<SchedmonInfo, MatlisInfo> {
	
	public SchedmonVisiMergeMatlis(DeciTreeOption<SchedmonInfo> option) {
