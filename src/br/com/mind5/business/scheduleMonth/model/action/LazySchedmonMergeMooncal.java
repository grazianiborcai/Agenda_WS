...
public final class LazySchedmonMergeMooncal extends ActionLazyTemplateV2<SchedmonInfo, SchedmonInfo> {
	
	public LazySchedmonMergeMooncal(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedmonInfo> getInstanceOfActionHook(DeciTreeOption<SchedmonInfo> option) {
		return new StdSchedmonMergeMooncal(option);
	}
