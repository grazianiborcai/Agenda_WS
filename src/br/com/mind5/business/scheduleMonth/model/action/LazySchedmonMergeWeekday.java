...
public final class LazySchedmonMergeWeekday extends ActionLazyTemplateV2<SchedmonInfo, SchedmonInfo> {
	
	public LazySchedmonMergeWeekday(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<SchedmonInfo> getInstanceOfActionHook(DeciTreeOption<SchedmonInfo> option) {
		return new StdSchedmonMergeWeekday(option);
	}
