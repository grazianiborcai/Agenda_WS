...
final class StdSchedmonMergeStolis implements ActionStdV1<SchedmonInfo> {
	private ActionStdV1<SchedmonInfo> actionHelper;	
	
	
	public StdSchedmonMergeStolis(DeciTreeOption<SchedmonInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiSchedmonMergeStolis(option.conn, option.schemaName));
	}
