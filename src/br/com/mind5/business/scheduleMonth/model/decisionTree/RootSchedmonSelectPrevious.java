...
import br.com.mind5.business.scheduleMonth.model.action.StdSchedmonEnforcePrevious;
...
public final class RootSchedmonSelectPrevious extends DeciTreeTemplateWriteV2<SchedmonInfo> {
	
	public RootSchedmonSelectPrevious(DeciTreeOption<SchedmonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV2<SchedmonInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedmonInfo> option) {
		...
		ActionStdV2<SchedmonInfo> enforcePrevious = new StdSchedmonEnforcePrevious(option);
