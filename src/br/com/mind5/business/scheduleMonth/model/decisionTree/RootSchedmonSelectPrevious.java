...
public final class RootSchedmonSelectPrevious extends DeciTreeTemplateWrite<SchedmonInfo> {
	...
	@Override protected List<ActionStd<SchedmonInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedmonInfo> option) {
		...
		ActionStd<SchedmonInfo> enforcePrevious = new StdSchedmonEnforcePrevious(option);
