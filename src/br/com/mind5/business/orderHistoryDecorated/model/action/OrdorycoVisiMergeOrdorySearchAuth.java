...
public final class OrdorycoVisiMergeOrdorySearchAuth extends ActionVisitorTemplateMerge<OrdorycoInfo, OrdoryInfo> {
	
	public OrdorycoVisiMergeOrdorySearchAuth(DeciTreeOption<OrdorycoInfo> option) {
