...
public final class LazyCalguataMergePlanata extends ActionLazyTemplateV2<CalguataInfo, CalguataInfo> {
	
	public LazyCalguataMergePlanata(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CalguataInfo> getInstanceOfActionHook(DeciTreeOption<CalguataInfo> option) {
		return new StdCalguataMergePlanata(option);
	}
