...
public final class LazyNotesDaoInsert extends ActionLazyTemplateV2<NotesInfo, NotesInfo> {
	
	public LazyNotesDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<NotesInfo> getInstanceOfActionHook(DeciTreeOption<NotesInfo> option) {
		return new StdNotesDaoInsert(option);
	}
