...
public final class LazyNotesMergeToSelect extends ActionLazyTemplateV2<NotesInfo, NotesInfo> {
	
	public LazyNotesMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<NotesInfo> getInstanceOfActionHook(DeciTreeOption<NotesInfo> option) {
		return new StdNotesMergeToSelect(option);
	}
