...
public final class LazyNotesMergeUsername extends ActionLazyTemplateV2<NotesInfo, NotesInfo> {
	
	public LazyNotesMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<NotesInfo> getInstanceOfActionHook(DeciTreeOption<NotesInfo> option) {
		return new StdNotesMergeUsername(option);
	}
