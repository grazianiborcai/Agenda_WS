...
public final class LazyNotesDaoDelete extends ActionLazyTemplateV2<NotesInfo, NotesInfo> {

	public LazyNotesDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<NotesInfo> getInstanceOfActionHook(DeciTreeOption<NotesInfo> option) {
		return new StdNotesDaoDelete(option);
	}
