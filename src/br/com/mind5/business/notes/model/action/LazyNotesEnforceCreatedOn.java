...
public final class LazyNotesEnforceCreatedOn extends ActionLazyTemplateV2<NotesInfo, NotesInfo> {
	
	public LazyNotesEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<NotesInfo> getInstanceOfActionHook(DeciTreeOption<NotesInfo> option) {
		return new StdNotesEnforceCreatedOn(option);
	}
