...
public final class NotesVisiMergeToSelect extends ActionVisitorTemplateMerge<NotesInfo, NotesInfo> {
	
	public NotesVisiMergeToSelect(DeciTreeOption<NotesInfo> option) {
