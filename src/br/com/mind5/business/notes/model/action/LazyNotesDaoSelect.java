...
public final class LazyNotesDaoSelect extends ActionLazyTemplateV2<NotesInfo, NotesInfo> {

	public LazyNotesDaoSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<NotesInfo> getInstanceOfActionHook(DeciTreeOption<NotesInfo> option) {
		return new StdNotesDaoSelect(option);
	}
