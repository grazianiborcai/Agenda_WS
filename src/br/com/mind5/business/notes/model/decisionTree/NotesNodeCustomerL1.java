...
public final class NotesNodeCustomerL1 extends DeciTreeTemplateWrite<NotesInfo> {
	
	public NotesNodeCustomerL1(DeciTreeOption<NotesInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<NotesInfo>> buildActionsOnPassedHook(DeciTreeOption<NotesInfo> option) {
		...
		ActionStd<NotesInfo> nodeL2 = new NotesNodeCustomerL2(option).toAction();
