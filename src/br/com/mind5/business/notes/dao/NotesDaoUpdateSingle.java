...
public final class NotesDaoUpdateSingle extends DaoStmtTemplate<NotesInfo> {
	private final String MAIN_TABLE = DaoDbTable.NOTES_TABLE;	
	
	
	public NotesDaoUpdateSingle(Connection conn, NotesInfo recordInfo, String schemaName) {
