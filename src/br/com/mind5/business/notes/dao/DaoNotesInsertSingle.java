...
public final class DaoNotesInsertSingle extends DaoStmtTemplate<NotesInfo> {
	private final String MAIN_TABLE = DaoDbTable.NOTES_TABLE;	
	
	
	public DaoNotesInsertSingle(Connection conn, NotesInfo recordInfo, String schemaName) {
