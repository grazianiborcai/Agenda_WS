...
public final class NotesDaoDeleteSingle extends DaoStmtTemplate<NotesInfo> {
	private final String MAIN_TABLE = DaoDbTable.NOTES_TABLE;	
	
	
	public NotesDaoDeleteSingle(Connection conn, NotesInfo recordInfo, String schemaName) {
