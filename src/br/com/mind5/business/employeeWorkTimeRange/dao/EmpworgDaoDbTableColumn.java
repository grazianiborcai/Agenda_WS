...
public final class EmpworgDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public EmpworgDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.EMP_WTIME_RANGE_VIEW, columns);
		return results;
	}
}
