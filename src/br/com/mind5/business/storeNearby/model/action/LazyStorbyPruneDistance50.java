...
public final class LazyStorbyPruneDistance50 extends ActionLazyTemplateV2<StorbyInfo, StorbyInfo> {
	
	public LazyStorbyPruneDistance50(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorbyInfo> getInstanceOfActionHook(DeciTreeOption<StorbyInfo> option) {
		return new StdStorbyPruneDistance50(option);
	}
