...
public final class LazyStorbyPruneEmpty extends ActionLazyTemplateV2<StorbyInfo, StorbyInfo> {
	
	public LazyStorbyPruneEmpty(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorbyInfo> getInstanceOfActionHook(DeciTreeOption<StorbyInfo> option) {
		return new StdStorbyPruneEmpty(option);
	}
