...
public final class LazyStorbyMergeMatopore extends ActionLazyTemplateV2<StorbyInfo, StorbyInfo> {
	
	public LazyStorbyMergeMatopore(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorbyInfo> getInstanceOfActionHook(DeciTreeOption<StorbyInfo> option) {
		return new StdStorbyMergeMatopore(option);
	}
