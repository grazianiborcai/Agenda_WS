...
public final class StorbyVisiEnforceDistrictSearch extends ActionVisitorTemplateEnforce<StorbyInfo> {
	
	public StorbyVisiEnforceDistrictSearch(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
