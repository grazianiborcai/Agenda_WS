...
public final class StorbyVisiMergeFimeco extends ActionVisitorTemplateMerge<StorbyInfo, FimecoInfo> {
	
	public StorbyVisiMergeFimeco(DeciTreeOption<StorbyInfo> option) {
