...
final class VisiStorbyMergeSysdistr extends ActionVisitorTemplateMerge<StorbyInfo, SysdistrInfo> {
	
	public VisiStorbyMergeSysdistr(DeciTreeOption<StorbyInfo> option) {
