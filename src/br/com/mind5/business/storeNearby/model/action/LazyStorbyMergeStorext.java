...
public final class LazyStorbyMergeStorext extends ActionLazyTemplateV2<StorbyInfo, StorbyInfo> {
	
	public LazyStorbyMergeStorext(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorbyInfo> getInstanceOfActionHook(DeciTreeOption<StorbyInfo> option) {
		return new StdStorbyMergeStorext(option);
	}
