...
public final class LazyStorbyMergeStorite extends ActionLazyTemplateV2<StorbyInfo, StorbyInfo> {
	
	public LazyStorbyMergeStorite(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorbyInfo> getInstanceOfActionHook(DeciTreeOption<StorbyInfo> option) {
		return new StdStorbyMergeStorite(option);
	}
