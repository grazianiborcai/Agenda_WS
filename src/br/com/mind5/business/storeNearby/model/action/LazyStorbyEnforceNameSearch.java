...
public final class LazyStorbyEnforceNameSearch extends ActionLazyTemplateV2<StorbyInfo, StorbyInfo> {
	
	public LazyStorbyEnforceNameSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorbyInfo> getInstanceOfActionHook(DeciTreeOption<StorbyInfo> option) {
		return new StdStorbyEnforceNameSearch(option);
	}
