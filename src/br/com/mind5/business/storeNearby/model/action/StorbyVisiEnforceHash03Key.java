...
public final class StorbyVisiEnforceHash03Key extends ActionVisitorTemplateEnforce<StorbyInfo> {
	
	public StorbyVisiEnforceHash03Key(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
