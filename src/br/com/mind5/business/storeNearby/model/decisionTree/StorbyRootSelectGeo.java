...
public final class StorbyRootSelectGeo extends DeciTreeTemplateRead<StorbyInfo> {
	
	public StorbyRootSelectGeo(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnPassedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> nodeL1 = new StorbyNodeSelectGeoL1(option).toAction();
