...
public final class NodeStorbySelectL1 extends DeciTreeTemplateRead<StorbyInfo> {
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnPassedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> selectDistrict = new RootStorbySelectDistrict(option).toAction();
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnFailedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> selectGeo = new RootStorbySelectGeo(option).toAction();
