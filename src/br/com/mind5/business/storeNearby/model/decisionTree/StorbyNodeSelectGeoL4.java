...
public final class StorbyNodeSelectGeoL4 extends DeciTreeTemplateRead<StorbyInfo> {
	
	public StorbyNodeSelectGeoL4(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnPassedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> selectDistrict = new StorbyRootSelectDistrict(option).toAction();
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnFailedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> success = new ActionStdSuccessCommom<StorbyInfo>(option);
