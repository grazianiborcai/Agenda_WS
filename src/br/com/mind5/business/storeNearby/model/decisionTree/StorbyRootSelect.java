...
public final class StorbyRootSelect extends DeciTreeTemplateRead<StorbyInfo> {
	
	public StorbyRootSelect(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnPassedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> selectName = new StorbyRootSelectName(option).toAction();
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnFailedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> nodeL1 = new StorbyNodeSelectL1(option).toAction();
