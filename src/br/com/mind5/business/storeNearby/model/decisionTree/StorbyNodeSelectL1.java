...
public final class StorbyNodeSelectL1 extends DeciTreeTemplateRead<StorbyInfo> {
	
	public StorbyNodeSelectL1(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnFailedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> selectGeo = new StorbyRootSelectGeo(option).toAction();
