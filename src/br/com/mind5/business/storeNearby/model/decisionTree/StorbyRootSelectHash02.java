...
import br.com.mind5.business.storeNearby.model.action.StorbyVisiEnforceHash02Key;
...
public final class StorbyRootSelectHash02 extends DeciTreeTemplateRead<StorbyInfo> {
	
	public StorbyRootSelectHash02(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnPassedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> enforceHash02Key = new ActionStdCommom<StorbyInfo>(option, StorbyVisiEnforceHash02Key.class);
