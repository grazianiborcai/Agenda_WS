...
public final class RootStorbySelectHash03 extends DeciTreeTemplateRead<StorbyInfo> {
	...
	@Override protected List<ActionStd<StorbyInfo>> buildActionsOnPassedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStd<StorbyInfo> enforceHash03Key = new StdStorbyEnforceHash03Key(option);
