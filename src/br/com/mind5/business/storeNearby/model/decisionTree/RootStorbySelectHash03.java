...
public final class RootStorbySelectHash03 extends DeciTreeTemplateReadV2<StorbyInfo> {
	
	public RootStorbySelectHash03(DeciTreeOption<StorbyInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV2<StorbyInfo>> buildActionsOnPassedHook(DeciTreeOption<StorbyInfo> option) {
		...
		ActionStdV2<StorbyInfo> enforceHash03Key = new StdStorbyEnforceHash03Key(option);
