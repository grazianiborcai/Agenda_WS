...
public final class LazyEmpmatMergeEmplis extends ActionLazyTemplateV1<EmpmatInfo, EmpmatInfo> {
	
	public LazyEmpmatMergeEmplis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpmatInfo> getInstanceOfActionHook(DeciTreeOption<EmpmatInfo> option) {
		return new StdEmpmatMergeEmplis(option);
	}
