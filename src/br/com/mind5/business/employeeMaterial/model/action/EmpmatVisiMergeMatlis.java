...
public final class EmpmatVisiMergeMatlis extends ActionVisitorTemplateMerge<EmpmatInfo, MatlisInfo> {
	
	public EmpmatVisiMergeMatlis(DeciTreeOption<EmpmatInfo> option) {
