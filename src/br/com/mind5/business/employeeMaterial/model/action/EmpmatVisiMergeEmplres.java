...
public final class EmpmatVisiMergeEmplres extends ActionVisitorTemplateMerge<EmpmatInfo, EmplresInfo> {
	
	public EmpmatVisiMergeEmplres(DeciTreeOption<EmpmatInfo> option) {
