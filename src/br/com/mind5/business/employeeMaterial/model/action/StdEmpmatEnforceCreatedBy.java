...
public final class StdEmpmatEnforceCreatedBy implements ActionStdV1<EmpmatInfo> {
	private ActionStdV1<EmpmatInfo> actionHelper;	
	
	
	public StdEmpmatEnforceCreatedBy(DeciTreeOption<EmpmatInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiEmpmatEnforceCreatedBy());
	}
