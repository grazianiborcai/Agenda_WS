...
public final class LazyEmpmatEnforceCreatedBy extends ActionLazyTemplateV1<EmpmatInfo, EmpmatInfo> {
	
	public LazyEmpmatEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpmatInfo> getInstanceOfActionHook(DeciTreeOption<EmpmatInfo> option) {
		return new StdEmpmatEnforceCreatedBy(option);
	}
