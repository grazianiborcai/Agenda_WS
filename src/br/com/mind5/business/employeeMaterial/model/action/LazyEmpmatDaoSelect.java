...
public final class LazyEmpmatDaoSelect extends ActionLazyTemplateV2<EmpmatInfo, EmpmatInfo> {
	
	public LazyEmpmatDaoSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpmatInfo> getInstanceOfActionHook(DeciTreeOption<EmpmatInfo> option) {
		return new StdEmpmatDaoSelect(option);
	}
