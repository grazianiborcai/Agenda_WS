...
public final class StdEmpmatMergeUsername implements ActionStdV1<EmpmatInfo> {
	private ActionStdV1<EmpmatInfo> actionHelper;	
	
	
	public StdEmpmatMergeUsername(DeciTreeOption<EmpmatInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmpmatMergeUsername(option.conn, option.schemaName));
	}
