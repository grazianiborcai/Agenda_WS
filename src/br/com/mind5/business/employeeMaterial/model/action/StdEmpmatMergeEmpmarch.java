...
public final class StdEmpmatMergeEmpmarch implements ActionStdV1<EmpmatInfo> {
	private ActionStdV1<EmpmatInfo> actionHelper;	
	
	
	public StdEmpmatMergeEmpmarch(DeciTreeOption<EmpmatInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiEmpmatMergeEmpmarch(option.conn, option.schemaName));
	}
