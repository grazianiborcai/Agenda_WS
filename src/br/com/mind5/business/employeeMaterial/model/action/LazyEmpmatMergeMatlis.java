...
public final class LazyEmpmatMergeMatlis extends ActionLazyTemplateV2<EmpmatInfo, EmpmatInfo> {
	
	public LazyEmpmatMergeMatlis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmpmatInfo> getInstanceOfActionHook(DeciTreeOption<EmpmatInfo> option) {
		return new StdEmpmatMergeMatlis(option);
	}
