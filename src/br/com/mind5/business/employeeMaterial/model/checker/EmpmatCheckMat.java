...
public final class EmpmatCheckMat extends ModelCheckerTemplateForward<EmpmatInfo, MatInfo> {
	...
	@Override protected MatInfo toForwardClass(EmpmatInfo baseRecord) {
