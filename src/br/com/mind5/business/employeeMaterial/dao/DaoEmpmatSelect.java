...
public final class DaoEmpmatSelect implements DaoStmtExecV2<EmpmatInfo> {
	private DaoStmtExecV2<EmpmatInfo> helper;
	
	
	public DaoEmpmatSelect(List<DaoStmtExecOption<EmpmatInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoEmpmatSelectSingle.class, EmpmatInfo.class);
	}
