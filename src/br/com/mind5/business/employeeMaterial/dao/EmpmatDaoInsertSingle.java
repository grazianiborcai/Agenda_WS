...
public final class EmpmatDaoInsertSingle extends DaoStmtTemplate<EmpmatInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMP_MAT_TABLE;		
	
	
	public EmpmatDaoInsertSingle(Connection conn, EmpmatInfo recordInfo, String schemaName) {
