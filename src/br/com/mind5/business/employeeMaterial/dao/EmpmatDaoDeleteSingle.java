...
public final class EmpmatDaoDeleteSingle extends DaoStmtTemplate<EmpmatInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMP_MAT_TABLE;
	
	
	public EmpmatDaoDeleteSingle(Connection conn, EmpmatInfo recordInfo, String schemaName) {
