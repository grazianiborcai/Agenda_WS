...
public final class EmpmatDaoUpdateSingle extends DaoStmtTemplate<EmpmatInfo> {
	private final String MAIN_TABLE = DaoDbTable.EMP_MAT_TABLE;	
	
	
	public EmpmatDaoUpdateSingle(Connection conn, EmpmatInfo recordInfo, String schemaName) {
