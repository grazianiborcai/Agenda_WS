...
public final class EmpmarchDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public EmpmarchDbTableColumn() {
		super(EmpmarchDbTableColumn.class);
	}
	...
	private void buildEmpmatTable() {
		final String TABLE_NAME = DaoDbTable.EMP_MAT_TABLE;
		...
		tableColumns.put(DaoDbTable.EMP_MAT_SEARCH_VIEW, columns);
	}
}
