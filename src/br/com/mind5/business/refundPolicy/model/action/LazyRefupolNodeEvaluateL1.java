...
import br.com.mind5.business.refundPolicy.model.decisionTree.NodeRefupolEvaluateL1;
import br.com.mind5.model.action.ActionLazyTemplateV2;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyRefupolNodeEvaluateL1 extends ActionLazyTemplateV2<RefupolInfo, RefupolInfo> {
	
	public LazyRefupolNodeEvaluateL1(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<RefupolInfo> getInstanceOfActionHook(DeciTreeOption<RefupolInfo> option) {
		return new NodeRefupolEvaluateL1(option).toAction();
	}
