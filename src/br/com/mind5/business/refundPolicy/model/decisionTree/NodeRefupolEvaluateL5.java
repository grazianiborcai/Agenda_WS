...
import br.com.mind5.business.refundPolicy.model.checker.RefupolCheckHasPassed;
...
public final class NodeRefupolEvaluateL5 extends DeciTreeTemplateWriteV2<RefupolInfo> {
	
	public NodeRefupolEvaluateL5(DeciTreeOption<RefupolInfo> option) {
		super(option);
	}
	...
	@Override protected ModelCheckerV1<RefupolInfo> buildCheckerHook(DeciTreeOption<RefupolInfo> option) {
		...
		checker = new RefupolCheckHasPassed(checkerOption);
		queue.add(checker);
