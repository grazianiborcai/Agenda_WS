...
public final class NodeRefupolEvaluateL1 extends DeciTreeTemplateWrite<RefupolInfo> {
	...
	@Override protected List<ActionStd<RefupolInfo>> buildActionsOnPassedHook(DeciTreeOption<RefupolInfo> option) {
		...
		ActionStd<RefupolInfo> nodeL2 = new NodeRefupolEvaluateL2(option).toAction();
