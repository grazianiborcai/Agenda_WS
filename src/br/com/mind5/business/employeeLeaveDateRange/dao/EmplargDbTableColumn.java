...
public final class EmplargDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public EmplargDbTableColumn() {
		super(EmplargDbTableColumn.class);
	}
	...
	private void buildEmpLeaveDateTable() {
		...
		tableColumns.put(DaoDbTable.EMP_LD_RANGE_VIEW, columns);
	}
}
