...
public final class EmplargDaoWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public EmplargDaoWhere(DaoWhereBuilderOption whereOption, String tableName, EmplargInfo recordInfo) {
