...
final class VisiStorextEnforceCreatedOn extends ActionVisitorTemplateEnforce<StorextInfo> {
	
	public VisiStorextEnforceCreatedOn(DeciTreeOption<StorextInfo> option) {
		super(option);
	}
