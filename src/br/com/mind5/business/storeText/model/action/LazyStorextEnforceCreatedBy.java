...
public final class LazyStorextEnforceCreatedBy extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {
	
	public LazyStorextEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new StdStorextEnforceCreatedBy(option);
	}
