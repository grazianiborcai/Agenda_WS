...
public final class StorextVisiEnforceDefaultOff extends ActionVisitorTemplateEnforce<StorextInfo> {
	
	public StorextVisiEnforceDefaultOff(DeciTreeOption<StorextInfo> option) {
		super(option);
	}
