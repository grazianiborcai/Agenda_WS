...
public final class LazyStorextEnforceCreatedOn extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {
	
	public LazyStorextEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new StdStorextEnforceCreatedOn(option);
	}
