...
public final class StorextVisiMergeToSelect extends ActionVisitorTemplateMerge<StorextInfo, StorextInfo> {
	
	public StorextVisiMergeToSelect(DeciTreeOption<StorextInfo> option) {
