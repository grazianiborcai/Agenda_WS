...
public final class LazyStorextDaoDelete extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {

	public LazyStorextDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new StdStorextDaoDelete(option);
	}
