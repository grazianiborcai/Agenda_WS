...
public final class LazyMatextMergeToDelete extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {
	
	public LazyMatextMergeToDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new StdStorextMergeToDelete(option);
	}
