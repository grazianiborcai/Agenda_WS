...
public final class LazyStorextEnforceLChanged extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {
	
	public LazyStorextEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new StdStorextEnforceLChanged(option);
	}
