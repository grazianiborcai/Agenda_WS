...
import br.com.mind5.business.storeText.model.decisionTree.RootStorextUpdate;
import br.com.mind5.model.action.ActionLazyTemplateV2;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyStorextRootUpdate extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {

	public LazyStorextRootUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new RootStorextUpdate(option).toAction();
	}
