...
public final class StorextVisiMergeToUpdate extends ActionVisitorTemplateMerge<StorextInfo, StorextInfo> {
	
	public StorextVisiMergeToUpdate(DeciTreeOption<StorextInfo> option) {
