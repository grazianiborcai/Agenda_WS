...
public final class StorextVisiMergeUsername extends ActionVisitorTemplateMerge<StorextInfo, UsernameInfo> {
	
	public StorextVisiMergeUsername(DeciTreeOption<StorextInfo> option) {
