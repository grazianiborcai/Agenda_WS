...
public final class LazyStorextDaoSelect extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {

	public LazyStorextDaoSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new StdStorextDaoSelect(option);
	}
