...
public final class LazyStorextEnforceDefaultOff extends ActionLazyTemplateV2<StorextInfo, StorextInfo> {
	
	public LazyStorextEnforceDefaultOff(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StorextInfo> getInstanceOfActionHook(DeciTreeOption<StorextInfo> option) {
		return new StdStorextEnforceDefaultOff(option);
	}
