...
public final class StorextRootUpsertdel extends DeciTreeTemplateWrite<StorextInfo> {
	
	public StorextRootUpsertdel(DeciTreeOption<StorextInfo> option) {
		super(option);
	}	
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnPassedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> nodeL1 = new StorextNodeUpsertdelL1(option).toAction();
