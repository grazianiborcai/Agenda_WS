...
public final class StorextNodeUpsertdelL1 extends DeciTreeTemplateWrite<StorextInfo> {
	
	public StorextNodeUpsertdelL1(DeciTreeOption<StorextInfo> option) {
		super(option);
	}	
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnPassedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> delete = new StorextRootDelete(option).toAction();
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnFailedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> nodeL2 = new StorextNodeUpsertdelL2(option).toAction();
