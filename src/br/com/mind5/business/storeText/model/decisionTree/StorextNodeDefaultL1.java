...
public final class StorextNodeDefaultL1 extends DeciTreeTemplateWrite<StorextInfo> {
	
	public StorextNodeDefaultL1(DeciTreeOption<StorextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnPassedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> nodeL2 = new StorextNodeDefaultL2(option).toAction();
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnFailedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> nodeL3 = new StorextNodeDefaultL3(option).toAction();	
