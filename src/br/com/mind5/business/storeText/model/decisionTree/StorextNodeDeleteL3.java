...
import br.com.mind5.business.storeText.model.action.StorextVisiRootUpdate;
...
public final class StorextNodeDeleteL3 extends DeciTreeTemplateWrite<StorextInfo> {

	public StorextNodeDeleteL3(DeciTreeOption<StorextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnPassedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionLazy<StorextInfo> enforceDefaultOn = new ActionLazyCommom<StorextInfo>(option, StorextVisiEnforceDefaultOn.class); 
		ActionLazy<StorextInfo> update = new ActionLazyCommom<StorextInfo>(option, StorextVisiRootUpdate.class); 
