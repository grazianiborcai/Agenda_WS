...
public final class StorextRootSelect extends DeciTreeTemplateWrite<StorextInfo> {
	
	public StorextRootSelect(DeciTreeOption<StorextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnPassedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> nodeL1 = new StorextNodeSelectL1(option).toAction();
