...
public final class StorextNodeUpsertdelL2 extends DeciTreeTemplateWrite<StorextInfo> {
	
	public StorextNodeUpsertdelL2(DeciTreeOption<StorextInfo> option) {
		super(option);
	}	
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnPassedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> delete = new StorextRootUpdate(option).toAction();
	...
	@Override protected List<ActionStd<StorextInfo>> buildActionsOnFailedHook(DeciTreeOption<StorextInfo> option) {
		...
		ActionStd<StorextInfo> insert = new StorextRootInsert(option).toAction();
