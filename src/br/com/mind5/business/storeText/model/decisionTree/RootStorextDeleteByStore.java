...
import br.com.mind5.business.storeText.model.action.LazyStorextRootDelete;
import br.com.mind5.business.storeText.model.action.StdMatextMergeMatextarch;
import br.com.mind5.business.storeText.model.checker.StorextCheckDeleteByStore;
...
public final class RootStorextDeleteByStore extends DeciTreeTemplateWriteV2<StorextInfo> {
	...
	@Override protected ModelCheckerV1<StorextInfo> buildCheckerHook(DeciTreeOption<StorextInfo> option) {
		...
		checker = new StorextCheckDeleteByStore(checkerOption);
		queue.add(checker);
