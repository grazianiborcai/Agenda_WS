...
public final class StorextCheckDeleteFromStore extends ModelCheckerTemplateSimple<StorextInfo> {

	public StorextCheckDeleteFromStore(ModelCheckerOption option) {
		super(option);
	}
