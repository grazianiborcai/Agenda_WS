...
public final class DaoStorextDelete implements DaoStmtExecV2<StorextInfo> {
	private DaoStmtExecV2<StorextInfo> helper;
	
	
	public DaoStorextDelete(List<DaoStmtExecOption<StorextInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoStorextDeleteSingle.class, StorextInfo.class);
	}
