...
public final class StorextDaoInsertSingle extends DaoStmtTemplate<StorextInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_TEXT_TABLE;	
	
	
	public StorextDaoInsertSingle(Connection conn, StorextInfo recordInfo, String schemaName) {
