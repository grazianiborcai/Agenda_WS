...
public final class DaoStorextUpdateSingle extends DaoStmtTemplate<StorextInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_TEXT_TABLE;	
	
	
	public DaoStorextUpdateSingle(Connection conn, StorextInfo recordInfo, String schemaName) {
