...
public final class DaoStorextDeleteSingle extends DaoStmtTemplate<StorextInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_TEXT_TABLE;	
	
	
	public DaoStorextDeleteSingle(Connection conn, StorextInfo recordInfo, String schemaName) {
