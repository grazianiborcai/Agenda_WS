...
import br.com.mind5.business.storeFavorite.model.decisionTree.StoriteRootSearch;
import br.com.mind5.model.action.ActionVisitorTemplateAction;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class StoriteVisiRootSearch extends ActionVisitorTemplateAction<StoriteInfo, StoriteInfo> {

	public StoriteVisiRootSearch(DeciTreeOption<StoriteInfo> option) {
	...
	@Override protected Class<? extends DeciTree<StoriteInfo>> getTreeClassHook() {
		return StoriteRootSearch.class;
	}
