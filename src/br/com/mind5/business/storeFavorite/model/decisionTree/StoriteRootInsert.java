...
public final class StoriteRootInsert extends DeciTreeTemplateWrite<StoriteInfo> {
	
	public StoriteRootInsert(DeciTreeOption<StoriteInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoriteInfo>> buildActionsOnPassedHook(DeciTreeOption<StoriteInfo> option) {
		...
		ActionStd<StoriteInfo> nodeL1 = new StoriteNodeInsert(option).toAction();
