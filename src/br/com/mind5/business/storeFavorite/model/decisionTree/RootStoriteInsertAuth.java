...
import br.com.mind5.business.storeFavorite.model.action.LazyStoriteRootInsert;
...
public final class RootStoriteInsertAuth extends DeciTreeTemplateWriteV2<StoriteInfo> {
	
	public RootStoriteInsertAuth(DeciTreeOption<StoriteInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<StoriteInfo>> buildActionsOnPassedHook(DeciTreeOption<StoriteInfo> option) {
		...
		ActionLazyV1<StoriteInfo> insert = new LazyStoriteRootInsert(option.conn, option.schemaName);
