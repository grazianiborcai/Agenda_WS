...
import br.com.mind5.business.storeFavorite.model.action.StoriteVisiRootDelete;
...
public final class StoriteRootDeleteAuth extends DeciTreeTemplateWrite<StoriteInfo> {
	
	public StoriteRootDeleteAuth(DeciTreeOption<StoriteInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoriteInfo>> buildActionsOnPassedHook(DeciTreeOption<StoriteInfo> option) {
		...
		ActionLazy<StoriteInfo> delete = new ActionLazyCommom<StoriteInfo>(option, StoriteVisiRootDelete.class);	
