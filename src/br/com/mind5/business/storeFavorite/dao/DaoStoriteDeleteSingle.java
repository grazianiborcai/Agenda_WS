...
public final class DaoStoriteDeleteSingle extends DaoStmtTemplate<StoriteInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_FAVORITE_TABLE;
	
	
	public DaoStoriteDeleteSingle(Connection conn, StoriteInfo recordInfo, String schemaName) {
