...
public final class StoriteDaoInsertSingle extends DaoStmtTemplate<StoriteInfo> {
	private final String MAIN_TABLE = DaoDbTable.STORE_FAVORITE_TABLE;
	
	
	public StoriteDaoInsertSingle(Connection conn, StoriteInfo recordInfo, String schemaName) {
