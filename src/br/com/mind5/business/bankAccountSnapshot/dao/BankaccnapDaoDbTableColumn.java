...
public final class BankaccnapDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public BankaccnapDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.BANK_ACCOUNT_SNAPSHOT_TABLE;
