...
public final class CaleekyCheckExist extends ModelCheckerTemplateActionV2<CaleekyInfo, CaleekyInfo> {
	...
	@Override protected ActionStdV1<CaleekyInfo> buildActionHook(DeciTreeOption<CaleekyInfo> option) {
		ActionStdV1<CaleekyInfo> select = new StdCaleekyDaoSelect(option);
		return select;
	}
