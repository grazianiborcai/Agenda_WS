...
public final class CaleekyVisiMergeNext extends ActionVisitorTemplateMerge<CaleekyInfo, CalateInfo> {
	
	public CaleekyVisiMergeNext(DeciTreeOption<CaleekyInfo> option) {
