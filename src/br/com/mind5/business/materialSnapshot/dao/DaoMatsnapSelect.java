...
public final class DaoMatsnapSelect implements DaoStmtExec<MatsnapInfo> {
	private DaoStmtExec<MatsnapInfo> helper;
	
	
	public DaoMatsnapSelect(List<DaoStmtExecOption<MatsnapInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoMatsnapSelectSingle.class, MatsnapInfo.class);
	}
