...
public final class MatsnapDaoWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public MatsnapDaoWhere(DaoWhereBuilderOption whereOption, String tableName, MatsnapInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, MatsnapInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case MatsnapDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case MatsnapDaoDbTableColumn.COL_COD_SNAPSHOT :
