...
public final class MatsnapDaoInsertSingle extends DaoStmtTemplate<MatsnapInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_SNAPSHOT_TABLE;	
	
	
	public MatsnapDaoInsertSingle(Connection conn, MatsnapInfo recordInfo, String schemaName) {
