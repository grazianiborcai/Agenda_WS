...
public final class LazyMatsnapMergeMatGroup extends ActionLazyTemplateV1<MatsnapInfo, MatsnapInfo> {
	
	public LazyMatsnapMergeMatGroup(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatsnapInfo> getInstanceOfActionHook(DeciTreeOption<MatsnapInfo> option) {
		return new StdMatsnapMergeMatGroup(option);
	}
