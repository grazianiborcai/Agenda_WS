...
public final class StdMatsnapMergeMatoup implements ActionStdV1<MatsnapInfo> {
	private ActionStdV1<MatsnapInfo> actionHelper;	
	
	
	public StdMatsnapMergeMatoup(DeciTreeOption<MatsnapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatsnapMergeMatoup(option.conn, option.schemaName));
	}
