...
public final class StdMatsnapMergeMateg implements ActionStdV1<MatsnapInfo> {
	private ActionStdV1<MatsnapInfo> actionHelper;	
	
	
	public StdMatsnapMergeMateg(DeciTreeOption<MatsnapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatsnapMergeMateg(option.conn, option.schemaName));
	}
