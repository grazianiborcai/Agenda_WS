...
public final class LazyMatsnapSelect extends ActionLazyTemplateV1<MatsnapInfo, MatsnapInfo> {

	public LazyMatsnapSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatsnapInfo> getInstanceOfActionHook(DeciTreeOption<MatsnapInfo> option) {
		return new StdMatsnapSelect(option);
	}
