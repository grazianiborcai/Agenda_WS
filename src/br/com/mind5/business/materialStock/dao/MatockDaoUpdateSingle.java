...
public final class MatockDaoUpdateSingle extends DaoStmtTemplate<MatockInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_STOCK_TABLE;	
	
	
	public MatockDaoUpdateSingle(Connection conn, MatockInfo recordInfo, String schemaName) {
