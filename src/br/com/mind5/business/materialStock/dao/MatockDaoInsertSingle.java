...
public final class MatockDaoInsertSingle extends DaoStmtTemplate<MatockInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_STOCK_TABLE;	
	
	
	public MatockDaoInsertSingle(Connection conn, MatockInfo recordInfo, String schemaName) {
