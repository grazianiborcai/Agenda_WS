...
import br.com.mind5.business.materialStock.model.action.MatockVisiMergeToSelect;
...
public final class MatockRootSelect extends DeciTreeTemplateRead<MatockInfo> {
	
	public MatockRootSelect(DeciTreeOption<MatockInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatockInfo>> buildActionsOnPassedHook(DeciTreeOption<MatockInfo> option) {
		...
		ActionStd<MatockInfo> select = new ActionStdCommom<MatockInfo>(option, MatockVisiMergeToSelect.class);
