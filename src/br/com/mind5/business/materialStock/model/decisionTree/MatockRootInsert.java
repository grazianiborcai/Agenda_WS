...
import br.com.mind5.business.materialStock.model.action.MatockVisiDaoInsert;
...
public final class MatockRootInsert extends DeciTreeTemplateWrite<MatockInfo> {
	
	public MatockRootInsert(DeciTreeOption<MatockInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatockInfo>> buildActionsOnPassedHook(DeciTreeOption<MatockInfo> option) {
		...
		ActionStd<MatockInfo> enforceLChanged = new ActionStdCommom<MatockInfo>(option, MatockVisiEnforceLChanged.class);
		ActionLazy<MatockInfo> balance = new ActionLazyCommom<MatockInfo>(option, MatockVisiNodeBalanceL1.class);
		ActionLazy<MatockInfo> insert = new ActionLazyCommom<MatockInfo>(option, MatockVisiDaoInsert.class);
