...
import br.com.mind5.business.materialStock.dao.MatockUpdate;
...
public final class StdMatockUpdate implements ActionStdV1<MatockInfo> {
	private ActionStdV1<MatockInfo> actionHelper;
	
	
	public StdMatockUpdate(DeciTreeOption<MatockInfo> option) {
	...
	private DaoStmtExec_<MatockInfo> buildStmtExec(DeciTreeOption<MatockInfo> option) {
		...
		return new MatockUpdate(stmtExecOptions);
	}
