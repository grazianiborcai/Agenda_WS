...
public final class LazyMatockInsert extends ActionLazyTemplateV1<MatockInfo, MatockInfo> {

	public LazyMatockInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatockInfo> getInstanceOfActionHook(DeciTreeOption<MatockInfo> option) {
		return new StdMatockInsert(option);
	}
