...
public final class LazyMatockUpdate extends ActionLazyTemplateV1<MatockInfo, MatockInfo> {

	public LazyMatockUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatockInfo> getInstanceOfActionHook(DeciTreeOption<MatockInfo> option) {
		return new StdMatockUpdate(option);
	}
