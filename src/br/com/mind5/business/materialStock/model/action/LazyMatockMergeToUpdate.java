...
public final class LazyMatockMergeToUpdate extends ActionLazyTemplateV1<MatockInfo, MatockInfo> {

	public LazyMatockMergeToUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatockInfo> getInstanceOfActionHook(DeciTreeOption<MatockInfo> option) {
		return new StdMatockMergeToUpdate(option);
	}
