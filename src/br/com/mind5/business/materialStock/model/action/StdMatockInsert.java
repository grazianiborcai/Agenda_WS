...
import br.com.mind5.business.materialStock.dao.MatockInsert;
...
public final class StdMatockInsert implements ActionStdV1<MatockInfo> {
	private ActionStdV1<MatockInfo> actionHelper;
	
	
	public StdMatockInsert(DeciTreeOption<MatockInfo> option) {
	...
	private DaoStmtExec_<MatockInfo> buildStmtExec(DeciTreeOption<MatockInfo> option) {
		...
		return new MatockInsert(stmtExecOptions);
	}
