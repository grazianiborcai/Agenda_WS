...
public final class LazyMatockDaoUpdate extends ActionLazyTemplateV2<MatockInfo, MatockInfo> {

	public LazyMatockDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatockInfo> getInstanceOfActionHook(DeciTreeOption<MatockInfo> option) {
		return new StdMatockDaoUpdate(option);
	}
