...
public final class StdOrdistauMergeUsername implements ActionStd<OrdistauInfo> {
	private ActionStd<OrdistauInfo> actionHelper;	
	
	
	public StdOrdistauMergeUsername(DeciTreeOption<OrdistauInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiOrdistauMergeUsername(option.conn, option.schemaName));
	}
