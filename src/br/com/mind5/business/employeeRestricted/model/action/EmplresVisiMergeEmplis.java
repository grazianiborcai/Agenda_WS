...
public final class EmplresVisiMergeEmplis extends ActionVisitorTemplateMerge<EmplresInfo, EmplisInfo> {
	
	public EmplresVisiMergeEmplis(DeciTreeOption<EmplresInfo> option) {
