...
public final class DaoStoprarchDbTableColumn extends DaoDbTableColumnTemplate {
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STORE_PROSPECT_TABLE;
		...
		oneColumn.columnName = COL_COD_STORE_PROSPECT;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_PROSPECT_NAME;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		results.put(DaoDbTable.STORE_PROSPECT_SEARCH_VIEW, columns);
		return results;
	}
}
