...
public final class LazyMatlisMergeMatType extends ActionLazyTemplateV1<MatlisInfo, MatlisInfo> {
	
	public LazyMatlisMergeMatType(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatlisInfo> getInstanceOfActionHook(DeciTreeOption<MatlisInfo> option) {
		return new StdMatlisMergeMatType(option);
	}
