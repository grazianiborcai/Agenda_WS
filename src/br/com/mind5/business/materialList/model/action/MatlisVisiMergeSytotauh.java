...
public final class MatlisVisiMergeSytotauh extends ActionVisitorTemplateMerge<MatlisInfo, SytotauhInfo> {
	
	public MatlisVisiMergeSytotauh(DeciTreeOption<MatlisInfo> option) {
