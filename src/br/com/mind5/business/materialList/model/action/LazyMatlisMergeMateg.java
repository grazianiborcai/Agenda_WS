...
public final class LazyMatlisMergeMateg extends ActionLazyTemplateV2<MatlisInfo, MatlisInfo> {
	
	public LazyMatlisMergeMateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatlisInfo> getInstanceOfActionHook(DeciTreeOption<MatlisInfo> option) {
		return new StdMatlisMergeMateg(option);
	}
