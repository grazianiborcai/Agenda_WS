...
public final class StdMatlisMergeMatGroup implements ActionStdV1<MatlisInfo> {
	private ActionStdV1<MatlisInfo> actionHelper;	
	
	
	public StdMatlisMergeMatGroup(DeciTreeOption<MatlisInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatlisMergeMatGroup(option.conn, option.schemaName));
	}
