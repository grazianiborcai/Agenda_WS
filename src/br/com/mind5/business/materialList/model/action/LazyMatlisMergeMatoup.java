...
public final class LazyMatlisMergeMatoup extends ActionLazyTemplateV1<MatlisInfo, MatlisInfo> {
	
	public LazyMatlisMergeMatoup(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatlisInfo> getInstanceOfActionHook(DeciTreeOption<MatlisInfo> option) {
		return new StdMatlisMergeMatoup(option);
	}
