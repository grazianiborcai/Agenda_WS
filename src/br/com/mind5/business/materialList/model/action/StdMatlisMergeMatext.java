...
public final class StdMatlisMergeMatext implements ActionStdV1<MatlisInfo> {
	private ActionStdV1<MatlisInfo> actionHelper;	
	
	
	public StdMatlisMergeMatext(DeciTreeOption<MatlisInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatlisMergeMatext(option.conn, option.schemaName));
	}
