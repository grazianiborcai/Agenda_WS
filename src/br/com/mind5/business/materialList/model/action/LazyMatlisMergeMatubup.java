...
public final class LazyMatlisMergeMatubup extends ActionLazyTemplateV2<MatlisInfo, MatlisInfo> {
	
	public LazyMatlisMergeMatubup(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatlisInfo> getInstanceOfActionHook(DeciTreeOption<MatlisInfo> option) {
		return new StdMatlisMergeMatubup(option);
	}
