...
public final class LazyMatlisMergeMatunit extends ActionLazyTemplateV2<MatlisInfo, MatlisInfo> {
	
	public LazyMatlisMergeMatunit(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatlisInfo> getInstanceOfActionHook(DeciTreeOption<MatlisInfo> option) {
		return new StdMatlisMergeMatunit(option);
	}
