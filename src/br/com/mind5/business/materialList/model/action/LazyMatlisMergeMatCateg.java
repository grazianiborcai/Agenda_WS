...
public final class LazyMatlisMergeMatCateg extends ActionLazyTemplateV1<MatlisInfo, MatlisInfo> {
	
	public LazyMatlisMergeMatCateg(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatlisInfo> getInstanceOfActionHook(DeciTreeOption<MatlisInfo> option) {
		return new StdMatlisMergeMatCateg(option);
	}
