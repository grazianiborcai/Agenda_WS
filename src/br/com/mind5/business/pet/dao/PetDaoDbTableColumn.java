...
public final class PetDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public static final String COL_PET_NAME = DaoDbField.COL_PET_NAME;
	public static final String COL_PET_NOTES = DaoDbField.COL_PET_NOTES;
	public static final String COL_RECORD_MODE = DaoDbField.COL_RECORD_MODE;
	
	
	public PetDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.PET_TABLE;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_PET_NAME;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_PET_NOTES;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
