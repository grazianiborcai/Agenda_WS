...
public final class LazyPetMergePetype extends ActionLazyTemplate<PetInfo, PetInfo> {
	
	public LazyPetMergePetype(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new StdPetMergePetype(option);
	}
