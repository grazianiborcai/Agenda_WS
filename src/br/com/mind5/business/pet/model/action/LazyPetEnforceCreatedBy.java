...
public final class LazyPetEnforceCreatedBy extends ActionLazyTemplate<PetInfo, PetInfo> {
	
	public LazyPetEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new StdPetEnforceCreatedBy(option);
	}
