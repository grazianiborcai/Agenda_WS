...
final class VisiPetMergePetault extends ActionVisitorTemplateMerge<PetInfo, PetaultInfo> {
	
	public VisiPetMergePetault(DeciTreeOption<PetInfo> option) {
	...
	@Override protected Class<? extends DeciTree<PetaultInfo>> getTreeClassHook() {
		return RootPetaultSelect.class;
	}
