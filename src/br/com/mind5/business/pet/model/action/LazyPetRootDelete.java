...
public final class LazyPetRootDelete extends ActionLazyTemplate<PetInfo, PetInfo> {

	public LazyPetRootDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new RootPetDelete(option).toAction();
	}
