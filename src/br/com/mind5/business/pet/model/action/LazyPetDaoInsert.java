...
public final class LazyPetDaoInsert extends ActionLazyTemplate<PetInfo, PetInfo> {
	
	public LazyPetDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new StdPetDaoInsert(option);
	}
