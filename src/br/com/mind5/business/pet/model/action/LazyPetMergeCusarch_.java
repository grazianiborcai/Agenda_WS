...
public final class LazyPetMergeCusarch_ extends ActionLazyTemplate<PetInfo, PetInfo> {
	
	public LazyPetMergeCusarch_(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new StdPetMergeCusarchAuth(option);
	}
