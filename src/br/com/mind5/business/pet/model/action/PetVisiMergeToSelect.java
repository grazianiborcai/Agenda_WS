...
public final class PetVisiMergeToSelect extends ActionVisitorTemplateMerge<PetInfo, PetInfo> {
	
	public PetVisiMergeToSelect(DeciTreeOption<PetInfo> option) {
	...
	@Override protected List<PetInfo> mergeHook(List<PetInfo> baseInfos, List<PetInfo> selectedInfos) {	
		return PetMerger.mergeToSelect(baseInfos, selectedInfos);
	}
