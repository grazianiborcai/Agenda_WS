...
public final class LazyPetMergeUsername extends ActionLazyTemplate<PetInfo, PetInfo> {
	
	public LazyPetMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new StdPetMergeUsername(option);
	}
