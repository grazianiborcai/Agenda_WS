...
public final class LazyPetRootSelect extends ActionLazyTemplate<PetInfo, PetInfo> {

	public LazyPetRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new RootPetSelect(option).toAction();
	}
