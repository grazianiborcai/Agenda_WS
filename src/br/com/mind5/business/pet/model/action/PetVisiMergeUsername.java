...
public final class PetVisiMergeUsername extends ActionVisitorTemplateMerge<PetInfo, UsernameInfo> {
	
	public PetVisiMergeUsername(DeciTreeOption<PetInfo> option) {
