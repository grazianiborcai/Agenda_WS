...
final class VisiPetMergePetarchUser extends ActionVisitorTemplateMerge<PetInfo, PetarchInfo> {
	
	public VisiPetMergePetarchUser(DeciTreeOption<PetInfo> option) {
