...
public final class LazyPetMergePeteight extends ActionLazyTemplate<PetInfo, PetInfo> {
	
	public LazyPetMergePeteight(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new StdPetMergePeteight(option);
	}
