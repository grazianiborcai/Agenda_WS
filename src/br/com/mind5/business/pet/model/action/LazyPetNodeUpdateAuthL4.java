...
import br.com.mind5.business.pet.model.decisionTree.NodePetUpdateAuthL4;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyPetNodeUpdateAuthL4 extends ActionLazyTemplate<PetInfo, PetInfo> {

	public LazyPetNodeUpdateAuthL4(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new NodePetUpdateAuthL4(option).toAction();
	}
