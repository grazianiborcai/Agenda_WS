...
public final class LazyPetEnforceUserKey extends ActionLazyTemplate<PetInfo, PetInfo> {
	
	public LazyPetEnforceUserKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PetInfo> getInstanceOfActionHook(DeciTreeOption<PetInfo> option) {
		return new StdPetEnforceUserKey(option);
	}
