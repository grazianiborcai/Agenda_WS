...
public final class PetRootSearchUser extends DeciTreeTemplateRead<PetInfo> {
	
	public PetRootSearchUser(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnPassedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> mergePetarch = new ActionStdCommom<PetInfo>(option, PetVisiMergePetarchUser.class);
