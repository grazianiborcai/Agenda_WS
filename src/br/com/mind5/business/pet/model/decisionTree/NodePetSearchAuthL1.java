...
public final class NodePetSearchAuthL1 extends DeciTreeTemplateWrite<PetInfo> {
	
	public NodePetSearchAuthL1(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnFailedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> nodeL2 = new NodePetSearchAuthL2(option).toAction();
