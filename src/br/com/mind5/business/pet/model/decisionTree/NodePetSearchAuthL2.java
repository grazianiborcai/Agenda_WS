...
public final class NodePetSearchAuthL2 extends DeciTreeTemplateWrite<PetInfo> {
	
	public NodePetSearchAuthL2(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnFailedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> nodeL3 = new NodePetSearchAuthL3(option).toAction();
