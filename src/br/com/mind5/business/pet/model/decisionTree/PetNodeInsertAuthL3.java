...
import br.com.mind5.business.pet.model.action.PetVisiNodeInsertAuthL4;
import br.com.mind5.business.pet.model.action.PetVisiMergeCuslis;
...
public final class PetNodeInsertAuthL3 extends DeciTreeTemplateWrite<PetInfo> {
	
	public PetNodeInsertAuthL3(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnPassedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> mergeCuslis = new ActionStdCommom<PetInfo>(option, PetVisiMergeCuslis.class);
		ActionLazy<PetInfo> nodeL4 = new ActionLazyCommom<PetInfo>(option, PetVisiNodeInsertAuthL4.class);	
