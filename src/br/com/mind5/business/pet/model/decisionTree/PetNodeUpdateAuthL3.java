...
import br.com.mind5.business.pet.model.action.PetVisiNodeUpdateAuthL4;
...
public final class PetNodeUpdateAuthL3 extends DeciTreeTemplateWrite<PetInfo> {
	
	public PetNodeUpdateAuthL3(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnPassedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionLazy<PetInfo> nodeL4 = new ActionLazyCommom<PetInfo>(option, PetVisiNodeUpdateAuthL4.class);	
