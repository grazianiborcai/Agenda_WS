...
public final class PetNodeSearchAuthL1 extends DeciTreeTemplateWrite<PetInfo> {
	
	public PetNodeSearchAuthL1(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnFailedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> nodeL2 = new PetNodeSearchAuthL2(option).toAction();
