...
public final class PetNodeInsertAuthL1 extends DeciTreeTemplateWrite<PetInfo> {
	
	public PetNodeInsertAuthL1(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnFailedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> nodeL2 = new PetNodeInsertAuthL2(option).toAction();
