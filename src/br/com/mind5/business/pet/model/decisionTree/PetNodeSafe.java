...
import br.com.mind5.business.pet.model.checker.PetCheckSafeName;
import br.com.mind5.business.pet.model.checker.PetCheckSafeNote;
...
public final class PetNodeSafe extends DeciTreeTemplateWrite<PetInfo> {
	
	public PetNodeSafe(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected ModelChecker<PetInfo> buildCheckerHook(DeciTreeOption<PetInfo> option) {
		...
		checker = new PetCheckSafeName(checkerOption);
		queue.add(checker);
		...
		checkerOption.schemaName = option.schemaName;
		checkerOption.expectedResult = ModelCheckerOption.SUCCESS;	
		checker = new PetCheckSafeNote(checkerOption);
		queue.add(checker);
