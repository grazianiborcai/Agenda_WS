...
import br.com.mind5.business.pet.model.action.PetVisiMergePetarch;
import br.com.mind5.business.pet.model.checker.PetCheckSearch;
...
public final class PetRootSearch extends DeciTreeTemplateRead<PetInfo> {
	
	public PetRootSearch(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnPassedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> mergePetarch = new ActionStdCommom<PetInfo>(option, PetVisiMergePetarch.class);
