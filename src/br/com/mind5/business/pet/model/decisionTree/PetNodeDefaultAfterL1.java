...
public final class PetNodeDefaultAfterL1 extends DeciTreeTemplateWrite<PetInfo> {
	
	public PetNodeDefaultAfterL1(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnFailedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> nodeL2 = new PetNodeDefaultAfterL2(option).toAction();
