...
import br.com.mind5.business.pet.model.action.StdPetEnforceStoreKey;
...
public final class NodePetInsertAuthL2 extends DeciTreeTemplateWrite<PetInfo> {
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnFailedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionStd<PetInfo> obfuscateStoreKey = new StdPetEnforceStoreKey(option);
		
		actions.add(obfuscateStoreKey);
		return actions;
	}
}
