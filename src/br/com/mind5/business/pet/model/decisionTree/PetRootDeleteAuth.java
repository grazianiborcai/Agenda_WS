...
import br.com.mind5.business.pet.model.action.PetVisiRootDelete;
...
public final class PetRootDeleteAuth extends DeciTreeTemplateWrite<PetInfo> {
	
	public PetRootDeleteAuth(DeciTreeOption<PetInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PetInfo>> buildActionsOnPassedHook(DeciTreeOption<PetInfo> option) {
		...
		ActionLazy<PetInfo> delete = new ActionLazyCommom<PetInfo>(option, PetVisiRootDelete.class);
		
		nodeAuth.addPostAction(delete);	
