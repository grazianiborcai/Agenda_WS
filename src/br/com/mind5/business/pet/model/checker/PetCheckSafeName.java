...
public final class PetCheckSafeName extends ModelCheckerTemplateSimple<PetInfo> {

	public PetCheckSafeName(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(PetInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.petName == null)
			return super.SUCCESS;
		
		if (StringValidator.validateSafe(recordInfo.petName) == super.SUCCESS)
			return super.SUCCESS;
