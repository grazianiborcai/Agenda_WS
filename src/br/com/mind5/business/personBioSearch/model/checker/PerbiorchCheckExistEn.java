...
public final class PerbiorchCheckExistEn extends ModelCheckerTemplateAction<PerbiorchInfo, PerbiorchInfo> {
	
	public PerbiorchCheckExistEn(ModelCheckerOption option) {
	...
	@Override protected ActionStd<PerbiorchInfo> buildActionHook(DeciTreeOption<PerbiorchInfo> option) {		
		ActionStd<PerbiorchInfo> select = new RootPerbiorchSelectEn(option).toAction();			
		return select;
	}
