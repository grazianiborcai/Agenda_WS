...
public final class StdPerbiorchEnforcePt extends ActionStdTemplate<PerbiorchInfo> {

	public StdPerbiorchEnforcePt(DeciTreeOption<PerbiorchInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<PerbiorchInfo> buildVisitorHook(DeciTreeOption<PerbiorchInfo> option) {
		return new VisiPerbiorchEnforcePt(option);
	}
}
