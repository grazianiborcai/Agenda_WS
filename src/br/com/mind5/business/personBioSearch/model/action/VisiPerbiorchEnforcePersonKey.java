...
final class VisiPerbiorchEnforcePersonKey extends ActionVisitorTemplateEnforce<PerbiorchInfo> {
	
	public VisiPerbiorchEnforcePersonKey(DeciTreeOption<PerbiorchInfo> option) {
		super(option);
	}
