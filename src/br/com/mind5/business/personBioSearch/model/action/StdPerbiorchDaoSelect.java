...
public final class StdPerbiorchDaoSelect extends ActionStdTemplate<PerbiorchInfo> {

	public StdPerbiorchDaoSelect(DeciTreeOption<PerbiorchInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<PerbiorchInfo> buildVisitorHook(DeciTreeOption<PerbiorchInfo> option) {
		return new VisiPerbiorchDaoSelect(option);
	}
}
