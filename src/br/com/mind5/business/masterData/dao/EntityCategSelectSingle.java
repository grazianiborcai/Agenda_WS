...
public final class EntityCategSelectSingle implements DaoStmt<EntityCategInfo> {
	private final String LT_ATTR = DaoDbTable.ENTITY_CATEG_TABLE;
	private final String RT_TEXT = DaoDbTable.ENTITY_CATEG_TEXT_TABLE;
	
	private DaoStmt<EntityCategInfo> stmtSql;
	private DaoStmtOption_<EntityCategInfo> stmtOption;
	...
	private void buildStmtOption(Connection conn, EntityCategInfo recordInfo, String schemaName) {
		this.stmtOption = new DaoStmtOption_<>();
		this.stmtOption.conn = conn;
		this.stmtOption.recordInfo = recordInfo;
		this.stmtOption.schemaName = schemaName;
		this.stmtOption.tableName = LT_ATTR;
		this.stmtOption.columns = DaoDbTableColumnAll.getTableColumnsAsList(stmtOption.tableName);
	...
	private String buildWhereClause() {
		...
		DaoStmtWhere whereClause = new EntityCategWhere(whereOption, stmtOption.tableName, stmtOption.recordInfo);
	...
	private DaoJoin buildJoinUnitText() {
		...
		oneColumn.leftColumnName = MasterDataDbTableColumn.COL_COD_ENTITY_CATEG;
		oneColumn.rightColumnName = MasterDataDbTableColumn.COL_COD_ENTITY_CATEG;
	...
	@Override public DaoStmt<EntityCategInfo> getNewInstance() {
		return new EntityCategSelectSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	
	
	
	private class ResultParser implements DaoResultParser_<EntityCategInfo> {
