...
public final class CountryPhoneSelectSingle implements DaoStmt<CountryPhoneInfo> {
	private final String LT_ATTR = DaoDbTable.COUNTRY_PHONE_TABLE;
	private final String RT_TEXT = DaoDbTable.COUNTRY_TEXT_TABLE;
	
	private DaoStmt<CountryPhoneInfo> stmtSql;
	private DaoStmtOption_<CountryPhoneInfo> stmtOption;
	...
	private void buildStmtOption(Connection conn, CountryPhoneInfo recordInfo, String schemaName) {
	...
	private String buildWhereClause() {
		...
		DaoStmtWhere whereClause = new CountryPhoneWhere(whereOption, stmtOption.tableName, stmtOption.recordInfo);
	...
	@Override public DaoStmt<CountryPhoneInfo> getNewInstance() {
		return new CountryPhoneSelectSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	
	
	
	private class ResultParser implements DaoResultParser_<CountryPhoneInfo> {
