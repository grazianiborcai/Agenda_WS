...
public final class PositionSelectSingle implements DaoStmt<PositionInfo> {
	private final String LT_ATTR = DaoDbTable.POSITION_TABLE;
	private final String RT_TEXT = DaoDbTable.POSITION_TEXT_TABLE;
	
	private DaoStmt<PositionInfo> stmtSql;
	private DaoStmtOption_<PositionInfo> stmtOption;
	...
	private String buildWhereClause() {
		...
		DaoStmtWhere whereClause = new PositionWhere(whereOption, stmtOption.tableName, stmtOption.recordInfo);
	...
	@Override public DaoStmt<PositionInfo> getNewInstance() {
		return new PositionSelectSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	
	
	
	private class ResultParser implements DaoResultParser_<PositionInfo> {
