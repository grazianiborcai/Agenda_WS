...
public final class StdCartCategSelect implements ActionStdV1<CartCategInfo> {
	private ActionStdV1<CartCategInfo> actionHelper;
	...
	@Override public void addPostAction(ActionLazyV1<CartCategInfo> actionHandler) {
