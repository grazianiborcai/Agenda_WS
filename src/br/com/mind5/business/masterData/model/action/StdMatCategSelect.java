...
public final class StdMatCategSelect implements ActionStdV1<MatCategInfo> {
	private ActionStdV1<MatCategInfo> actionHelper;
	...
	@Override public void addPostAction(ActionLazyV1<MatCategInfo> actionHandler) {
