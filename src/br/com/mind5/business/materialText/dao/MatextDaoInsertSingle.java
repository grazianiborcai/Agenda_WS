...
public final class MatextDaoInsertSingle extends DaoStmtTemplate<MatextInfo> {
	private final String MAIN_TABLE = DaoDbTable.MAT_TEXT_TABLE;	
	
	
	public MatextDaoInsertSingle(Connection conn, MatextInfo recordInfo, String schemaName) {
