...
public final class DaoMatextUpdate implements DaoStmtExecV2<MatextInfo> {
	private DaoStmtExecV2<MatextInfo> helper;
	
	
	public DaoMatextUpdate(List<DaoStmtExecOption<MatextInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoMatextUpdateSingle.class, MatextInfo.class);
	}
