...
public final class LazyMatextRootUpdate extends ActionLazyTemplateV2<MatextInfo, MatextInfo> {

	public LazyMatextRootUpdate(Connection conn, String schemaName) {
