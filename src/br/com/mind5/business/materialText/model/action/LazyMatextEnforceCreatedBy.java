...
public final class LazyMatextEnforceCreatedBy extends ActionLazyTemplateV2<MatextInfo, MatextInfo> {
	
	public LazyMatextEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextEnforceCreatedBy(option);
	}
