...
public final class LazyMatextEnforceLChanged extends ActionLazyTemplateV2<MatextInfo, MatextInfo> {
	
	public LazyMatextEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextEnforceLChanged(option);
	}
