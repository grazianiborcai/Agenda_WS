...
public final class MatextVisiEnforceCreatedBy extends ActionVisitorTemplateEnforce<MatextInfo> {
	
	public MatextVisiEnforceCreatedBy(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
