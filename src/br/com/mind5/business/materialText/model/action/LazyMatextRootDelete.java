...
public final class LazyMatextRootDelete extends ActionLazyTemplateV2<MatextInfo, MatextInfo> {

	public LazyMatextRootDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new RootMatextDelete(option).toAction();
	}
