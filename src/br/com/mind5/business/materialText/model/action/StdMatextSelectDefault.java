...
import br.com.mind5.business.materialText.dao.MatextSelectDefault;
...
public final class StdMatextSelectDefault implements ActionStd<MatextInfo> {
	private ActionStd<MatextInfo> actionHelper;
	
	
	public StdMatextSelectDefault(DeciTreeOption<MatextInfo> option) {
	...
	private DaoStmtExec<MatextInfo> buildStmtExec(DeciTreeOption<MatextInfo> option) {
		...
		return new MatextSelectDefault(stmtExecOptions);
	}
