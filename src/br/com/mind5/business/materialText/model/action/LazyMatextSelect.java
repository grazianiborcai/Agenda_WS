...
public final class LazyMatextSelect extends ActionLazyTemplateV1<MatextInfo, MatextInfo> {

	public LazyMatextSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextSelect(option);
	}
