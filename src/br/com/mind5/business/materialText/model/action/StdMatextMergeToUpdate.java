...
public final class StdMatextMergeToUpdate implements ActionStdV1<MatextInfo> {
	private ActionStdV1<MatextInfo> actionHelper;	
	
	
	public StdMatextMergeToUpdate(DeciTreeOption<MatextInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiMatextMergeToUpdate(option.conn, option.schemaName));
	}
