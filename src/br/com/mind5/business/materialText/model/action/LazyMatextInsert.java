...
public final class LazyMatextInsert extends ActionLazyTemplate<MatextInfo, MatextInfo> {
	
	public LazyMatextInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextInsert(option);
	}
