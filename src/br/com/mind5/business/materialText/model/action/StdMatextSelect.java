...
import br.com.mind5.business.materialText.dao.MatextSelect;
...
public final class StdMatextSelect implements ActionStdV1<MatextInfo> {
	private ActionStdV1<MatextInfo> actionHelper;
	
	
	public StdMatextSelect(DeciTreeOption<MatextInfo> option) {
	...
	private DaoStmtExec_<MatextInfo> buildStmtExec(DeciTreeOption<MatextInfo> option) {
		...
		return new MatextSelect(stmtExecOptions);
	}
