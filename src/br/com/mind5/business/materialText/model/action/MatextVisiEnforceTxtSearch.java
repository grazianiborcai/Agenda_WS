...
public final class MatextVisiEnforceTxtSearch extends ActionVisitorTemplateEnforce<MatextInfo> {
	
	public MatextVisiEnforceTxtSearch(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
