...
import br.com.mind5.business.materialText.dao.MatextInsert;
...
public final class StdMatextInsert implements ActionStdV1<MatextInfo> {
	private ActionStdV1<MatextInfo> actionHelper;
	
	
	public StdMatextInsert(DeciTreeOption<MatextInfo> option) {
	...
	private DaoStmtExec_<MatextInfo> buildStmtExec(DeciTreeOption<MatextInfo> option) {
		...
		return new MatextInsert(stmtExecOptions);
	}
