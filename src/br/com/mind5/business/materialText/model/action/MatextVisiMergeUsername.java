...
public final class MatextVisiMergeUsername extends ActionVisitorTemplateMerge<MatextInfo, UsernameInfo> {
	
	public MatextVisiMergeUsername(DeciTreeOption<MatextInfo> option) {
