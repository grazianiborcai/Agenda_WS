...
public final class MatextVisiMergeToUpdate extends ActionVisitorTemplateMerge<MatextInfo, MatextInfo> {
	
	public MatextVisiMergeToUpdate(DeciTreeOption<MatextInfo> option) {
