...
public final class LazyMatextEnforceTxtSearch extends ActionLazyTemplateV2<MatextInfo, MatextInfo> {
	
	public LazyMatextEnforceTxtSearch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextEnforceTxtSearch(option);
	}
