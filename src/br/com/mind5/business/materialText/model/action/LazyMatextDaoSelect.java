...
public final class LazyMatextDaoSelect extends ActionLazyTemplateV2<MatextInfo, MatextInfo> {

	public LazyMatextDaoSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextDaoSelect(option);
	}
