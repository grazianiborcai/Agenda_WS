...
public final class LazyMatextEnforceCreatedOn extends ActionLazyTemplateV1<MatextInfo, MatextInfo> {
	
	public LazyMatextEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatextInfo> getInstanceOfActionHook(DeciTreeOption<MatextInfo> option) {
		return new StdMatextEnforceCreatedOn(option);
	}
