...
public final class MatextVisiMergeToSelect extends ActionVisitorTemplateMerge<MatextInfo, MatextInfo> {
	
	public MatextVisiMergeToSelect(DeciTreeOption<MatextInfo> option) {
