...
import br.com.mind5.business.materialText.model.action.MatextVisiDaoInsert;
...
public final class MatextNodeInsert extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextNodeInsert(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> insert = new ActionStdCommom<MatextInfo>(option, MatextVisiDaoInsert.class);
		actions.add(insert);
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnFailedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> update = new ActionStdCommom<MatextInfo>(option, MatextVisiDaoUpdate.class);
		actions.add(update);
