...
public final class MatextNodeDefaultL1 extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextNodeDefaultL1(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> nodeL2 = new MatextNodeDefaultL2(option).toAction();
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnFailedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> nodeL3 = new MatextNodeDefaultL3(option).toAction();	
