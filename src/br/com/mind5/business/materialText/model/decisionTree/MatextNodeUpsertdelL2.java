...
public final class MatextNodeUpsertdelL2 extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextNodeUpsertdelL2(DeciTreeOption<MatextInfo> option) {
		super(option);
	}	
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> delete = new MatextRootUpdate(option).toAction();
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnFailedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> insert = new MatextRootInsert(option).toAction();
