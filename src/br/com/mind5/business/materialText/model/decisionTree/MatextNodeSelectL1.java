...
public final class MatextNodeSelectL1 extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextNodeSelectL1(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> mergeToSelect = new ActionStdCommom<MatextInfo>(option, MatextVisiMergeToSelect.class);
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnFailedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> nodeL2 = new MatextNodeSelectL2(option).toAction();
