...
public final class MatextRootUpsertdel extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextRootUpsertdel(DeciTreeOption<MatextInfo> option) {
		super(option);
	}	
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> nodeL1 = new MatextNodeUpsertdelL1(option).toAction();
