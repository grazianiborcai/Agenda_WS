...
public final class MatextNodeDeleteL2 extends DeciTreeTemplateWrite<MatextInfo> {

	public MatextNodeDeleteL2(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnFailedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> nodeL3 = new MatextNodeDeleteL3(option).toAction();
