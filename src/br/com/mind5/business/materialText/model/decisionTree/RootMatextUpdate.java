...
public final class RootMatextUpdate extends DeciTreeTemplateWrite<MatextInfo> {
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionLazy<MatextInfo> postUpdate = new LazyMatextNodePostUpdate(option.conn, option.schemaName);
