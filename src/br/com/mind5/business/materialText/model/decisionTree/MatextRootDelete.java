...
import br.com.mind5.business.materialText.model.action.MatextVisiNodeDeleteL1;
import br.com.mind5.business.materialText.model.action.MatextVisiNodeDeleteL2;
import br.com.mind5.business.materialText.model.action.MatextVisiMergeToDelete;
...
public final class MatextRootDelete extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextRootDelete(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> mergeToDelete = new ActionStdCommom<MatextInfo>(option, MatextVisiMergeToDelete.class);
		ActionLazy<MatextInfo> nodeL1 = new ActionLazyCommom<MatextInfo>(option, MatextVisiNodeDeleteL1.class);
		ActionLazy<MatextInfo> nodeL2 = new ActionLazyCommom<MatextInfo>(option, MatextVisiNodeDeleteL2.class);
