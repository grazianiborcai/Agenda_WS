...
public final class MatextNodeDefaultL3 extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextNodeDefaultL3(DeciTreeOption<MatextInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> enforceDefaultOn = new ActionStdCommom<MatextInfo>(option, MatextVisiEnforceDefaultOn.class);
