...
public final class MatextNodeUpsertdelL1 extends DeciTreeTemplateWrite<MatextInfo> {
	
	public MatextNodeUpsertdelL1(DeciTreeOption<MatextInfo> option) {
		super(option);
	}	
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnPassedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> delete = new MatextRootDelete(option).toAction();
	...
	@Override protected List<ActionStd<MatextInfo>> buildActionsOnFailedHook(DeciTreeOption<MatextInfo> option) {
		...
		ActionStd<MatextInfo> nodeL2 = new MatextNodeUpsertdelL2(option).toAction();
