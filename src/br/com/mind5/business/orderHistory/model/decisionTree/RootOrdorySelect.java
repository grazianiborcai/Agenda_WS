...
import br.com.mind5.business.orderHistory.model.action.StdOrdoryMergeOrdistSelect;
...
public final class RootOrdorySelect extends DeciTreeTemplateRead<OrdoryInfo> {
	
	public RootOrdorySelect(DeciTreeOption<OrdoryInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<OrdoryInfo>> buildActionsOnPassedHook(DeciTreeOption<OrdoryInfo> option) {
		...
		ActionStd<OrdoryInfo> mergeOrdist = new StdOrdoryMergeOrdistSelect(option);
