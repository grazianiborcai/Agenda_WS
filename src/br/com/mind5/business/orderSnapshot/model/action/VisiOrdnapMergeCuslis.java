...
final class VisiOrdnapMergeCuslis extends ActionVisitorTemplateMergeV2<OrdnapInfo, CuslisInfo> {
	...
	@Override protected List<OrdnapInfo> mergeHook(List<OrdnapInfo> baseInfos, List<CuslisInfo> selectedInfos) {	
		return OrdnapMerger.mergeWithCuslis(baseInfos, selectedInfos);
	}
