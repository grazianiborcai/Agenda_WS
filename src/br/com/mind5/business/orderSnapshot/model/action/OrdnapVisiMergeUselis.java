...
public final class OrdnapVisiMergeUselis extends ActionVisitorTemplateMerge<OrdnapInfo, UselisInfo> {
	
	public OrdnapVisiMergeUselis(DeciTreeOption<OrdnapInfo> option) {
