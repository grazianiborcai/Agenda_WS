...
public final class NodeCartemAgedServiceL07 extends DeciTreeTemplateWriteV2<CartemInfo> {
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> nodeL08 = new NodeCartemAgedServiceL08(option).toAction();	
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL07(option);	
