...
public final class CartemRootUpsert extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemRootUpsert(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> upsertdel = new CartemNodeUpsertdel(option).toAction();
