...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL12;
...
public final class CartemNodeAgedServiceL12 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL12(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL13 = new CartemNodeAgedServiceL13(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL12.class);	
