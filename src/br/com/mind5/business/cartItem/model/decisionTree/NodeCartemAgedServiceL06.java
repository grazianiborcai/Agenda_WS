...
public final class NodeCartemAgedServiceL06 extends DeciTreeTemplateWriteV1<CartemInfo> {
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> nodeL07 = new NodeCartemAgedServiceL07(option).toAction();	
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL06(option);	
