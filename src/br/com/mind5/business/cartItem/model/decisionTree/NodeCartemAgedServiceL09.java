...
public final class NodeCartemAgedServiceL09 extends DeciTreeTemplateWriteV2<CartemInfo> {
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> nodeL10 = new NodeCartemAgedServiceL10(option).toAction();	
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL09(option);	
