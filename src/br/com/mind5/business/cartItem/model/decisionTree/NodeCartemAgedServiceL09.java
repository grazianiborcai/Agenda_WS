...
public final class NodeCartemAgedServiceL09 extends DeciTreeTemplateWriteV1<CartemInfo> {
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> nodeL10 = new NodeCartemAgedServiceL10(option).toAction();	
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL09(option);	
