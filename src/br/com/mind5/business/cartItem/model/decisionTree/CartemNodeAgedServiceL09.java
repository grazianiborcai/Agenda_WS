...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL09;
...
public final class CartemNodeAgedServiceL09 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL09(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL10 = new CartemNodeAgedServiceL10(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL09.class);	
