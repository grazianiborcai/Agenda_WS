...
public final class CartemNodeAged extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAged(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> service = new CartemNodeAgedServiceL01(option).toAction();
