...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL15;
...
public final class CartemNodeAgedServiceL15 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL15(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL15 = new CartemNodeAgedServiceL16(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL15.class);	
