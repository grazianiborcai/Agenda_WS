...
public final class NodeCartemDelete extends DeciTreeTemplateWriteV1<CartemInfo> {
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> deleteService = new NodeCartemDeleteService(option).toAction();
