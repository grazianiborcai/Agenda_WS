...
import br.com.mind5.business.cartItem.model.action.StdCartemEnforceSymsgL05;
...
public final class NodeCartemAgedServiceL05 extends DeciTreeTemplateWriteV2<CartemInfo> {
	
	public NodeCartemAgedServiceL05(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> nodeL06 = new NodeCartemAgedServiceL06(option).toAction();	
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL05(option);	
