...
public final class NodeCartemAgedServiceL05 extends DeciTreeTemplateWriteV1<CartemInfo> {
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> nodeL06 = new NodeCartemAgedServiceL06(option).toAction();	
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL05(option);	
