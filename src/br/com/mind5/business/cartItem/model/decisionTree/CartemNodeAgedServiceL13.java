...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL13;
...
public final class CartemNodeAgedServiceL13 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL13(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL14 = new CartemNodeAgedServiceL14(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL13.class);	
