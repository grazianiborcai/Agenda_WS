...
public final class CartemNodeSelect extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeSelect(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> selectService = new CartemNodeSelectService(option).toAction();
