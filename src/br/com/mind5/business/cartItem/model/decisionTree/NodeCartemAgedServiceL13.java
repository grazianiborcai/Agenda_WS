...
public final class NodeCartemAgedServiceL13 extends DeciTreeTemplateWriteV2<CartemInfo> {
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> nodeL14 = new NodeCartemAgedServiceL14(option).toAction();	
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL13(option);	
