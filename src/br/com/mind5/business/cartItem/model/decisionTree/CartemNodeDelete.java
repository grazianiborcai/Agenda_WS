...
public final class CartemNodeDelete extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeDelete(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> deleteService = new CartemNodeDeleteService(option).toAction();
