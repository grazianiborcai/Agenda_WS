...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL08;
...
public final class CartemNodeAgedServiceL08 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL08(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL09 = new CartemNodeAgedServiceL09(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL08.class);	
