...
public final class NodeCartemSelect extends DeciTreeTemplateWriteV2<CartemInfo> {
	
	public NodeCartemSelect(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> selectService = new NodeCartemSelectService(option).toAction();
