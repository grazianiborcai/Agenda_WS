...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL02;
...
public final class CartemNodeAgedServiceL02 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL02(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL03 = new CartemNodeAgedServiceL03(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL02.class);	
