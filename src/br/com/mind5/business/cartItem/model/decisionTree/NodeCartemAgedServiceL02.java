...
public final class NodeCartemAgedServiceL02 extends DeciTreeTemplateWrite<CartemInfo> {
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL03 = new NodeCartemAgedServiceL03(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL02(option);	
