...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL14;
...
public final class CartemNodeAgedServiceL14 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL14(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL15 = new CartemNodeAgedServiceL15(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL14.class);	
