...
import br.com.mind5.business.cartItem.model.action.CartemVisiNodeMatService;
...
public final class CartemNodeMat extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeMat(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceWeekday = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceWeekday.class);
		ActionLazy<CartemInfo> service = new ActionLazyCommom<CartemInfo>(option, CartemVisiNodeMatService.class);
