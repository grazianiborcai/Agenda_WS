...
public final class NodeCartemAgedServiceL11 extends DeciTreeTemplateWriteV2<CartemInfo> {
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> nodeL12 = new NodeCartemAgedServiceL12(option).toAction();	
	...
	@Override protected List<ActionStdV2<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV2<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL11(option);	
