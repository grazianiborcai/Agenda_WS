...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL03;
...
public final class CartemNodeAgedServiceL03 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL03(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL04 = new CartemNodeAgedServiceL04(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL03.class);	
