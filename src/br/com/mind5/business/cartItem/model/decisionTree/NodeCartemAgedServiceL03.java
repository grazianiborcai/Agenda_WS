...
import br.com.mind5.business.cartItem.model.action.StdCartemEnforceSymsgL03;
...
public final class NodeCartemAgedServiceL03 extends DeciTreeTemplateWriteV2<CartemInfo> {
	
	public NodeCartemAgedServiceL03(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> nodeL04 = new NodeCartemAgedServiceL04(option).toAction();	
	...
	@Override protected List<ActionStdV1<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStdV1<CartemInfo> enforceSymsg = new StdCartemEnforceSymsgL03(option);	
