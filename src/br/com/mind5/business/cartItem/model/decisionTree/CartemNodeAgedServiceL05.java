...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL05;
...
public final class CartemNodeAgedServiceL05 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL05(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL06 = new CartemNodeAgedServiceL06(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL05.class);	
