...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL16;
...
public final class CartemNodeAgedServiceL16 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL16(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL16.class);	
