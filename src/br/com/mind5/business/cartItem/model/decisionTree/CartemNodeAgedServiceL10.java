...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL10;
...
public final class CartemNodeAgedServiceL10 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL10(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL11 = new CartemNodeAgedServiceL11(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL10.class);	
