...
import br.com.mind5.business.cartItem.model.action.CartemVisiEnforceSymsgL07;
...
public final class CartemNodeAgedServiceL07 extends DeciTreeTemplateWrite<CartemInfo> {
	
	public CartemNodeAgedServiceL07(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnPassedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> nodeL08 = new CartemNodeAgedServiceL08(option).toAction();	
	...
	@Override protected List<ActionStd<CartemInfo>> buildActionsOnFailedHook(DeciTreeOption<CartemInfo> option) {
		...
		ActionStd<CartemInfo> enforceSymsg = new ActionStdCommom<CartemInfo>(option, CartemVisiEnforceSymsgL07.class);	
