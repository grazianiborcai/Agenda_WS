...
public final class CartemCheckExistUser extends ModelCheckerTemplateAction<CartemInfo, CartemInfo> {
	
	public CartemCheckExistUser(ModelCheckerOption option) {
	...
	@Override protected ActionStd<CartemInfo> buildActionHook(DeciTreeOption<CartemInfo> option) {
		ActionStd<CartemInfo> select = new RootCartemSearchUser(option).toAction();
		return select;
	}
