...
final class VisiCartemEnforceSymsgL03 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public VisiCartemEnforceSymsgL03(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
