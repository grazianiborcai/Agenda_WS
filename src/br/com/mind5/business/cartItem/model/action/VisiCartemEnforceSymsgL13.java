...
final class VisiCartemEnforceSymsgL13 extends ActionVisitorTemplateEnforceV2<CartemInfo> {
	
	public VisiCartemEnforceSymsgL13(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
