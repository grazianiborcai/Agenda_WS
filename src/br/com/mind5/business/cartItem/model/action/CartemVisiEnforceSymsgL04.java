...
public final class CartemVisiEnforceSymsgL04 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL04(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
