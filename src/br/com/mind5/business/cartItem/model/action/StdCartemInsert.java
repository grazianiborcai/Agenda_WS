...
import br.com.mind5.business.cartItem.dao.CartemInsert;
...
public final class StdCartemInsert implements ActionStdV1<CartemInfo> {
	private ActionStdV1<CartemInfo> actionHelper;
	
	
	public StdCartemInsert(DeciTreeOption<CartemInfo> option) {
	...
	private DaoStmtExec_<CartemInfo> buildStmtExec(DeciTreeOption<CartemInfo> option) {
		...
		return new CartemInsert(stmtExecOptions);
	}
