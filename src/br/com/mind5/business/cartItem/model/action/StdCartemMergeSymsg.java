...
public final class StdCartemMergeSymsg implements ActionStdV1<CartemInfo> {
	private ActionStdV1<CartemInfo> actionHelper;	
	
	
	public StdCartemMergeSymsg(DeciTreeOption<CartemInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiCartemMergeSymsg(option.conn, option.schemaName));
	}
