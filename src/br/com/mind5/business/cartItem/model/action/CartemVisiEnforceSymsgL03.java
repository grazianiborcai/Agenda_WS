...
public final class CartemVisiEnforceSymsgL03 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL03(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
