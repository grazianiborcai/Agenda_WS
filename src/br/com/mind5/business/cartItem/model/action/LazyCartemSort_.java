...
public final class LazyCartemSort_ extends ActionLazyTemplateV2<CartemInfo, CartemInfo> {
	
	public LazyCartemSort_(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CartemInfo> getInstanceOfActionHook(DeciTreeOption<CartemInfo> option) {
		return new StdCartemSort(option);
	}
