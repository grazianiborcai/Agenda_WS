...
public final class CartemVisiEnforceCreatedOn extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceCreatedOn(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
