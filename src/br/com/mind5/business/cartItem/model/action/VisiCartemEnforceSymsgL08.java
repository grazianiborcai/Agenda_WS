...
final class VisiCartemEnforceSymsgL08 extends ActionVisitorTemplateEnforceV2<CartemInfo> {
	
	public VisiCartemEnforceSymsgL08(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
