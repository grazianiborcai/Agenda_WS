...
public final class CartemVisiEnforceSymsgL11 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL11(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
