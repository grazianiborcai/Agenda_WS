...
final class VisiCartemMergeMatice extends ActionVisitorTemplateMerge<CartemInfo, MaticeInfo> {
	
	public VisiCartemMergeMatice(DeciTreeOption<CartemInfo> option) {
