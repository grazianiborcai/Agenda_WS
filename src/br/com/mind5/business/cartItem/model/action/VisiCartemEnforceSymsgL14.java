...
final class VisiCartemEnforceSymsgL14 extends ActionVisitorTemplateEnforceV2<CartemInfo> {
	
	public VisiCartemEnforceSymsgL14(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
