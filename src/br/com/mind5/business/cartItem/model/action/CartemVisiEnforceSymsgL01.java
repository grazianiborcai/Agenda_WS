...
public final class CartemVisiEnforceSymsgL01 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL01(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
