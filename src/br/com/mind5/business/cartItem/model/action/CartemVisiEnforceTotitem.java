...
public final class CartemVisiEnforceTotitem extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceTotitem(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
