...
public final class CartemVisiEnforceSymsgL07 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL07(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
