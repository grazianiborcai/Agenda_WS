...
final class VisiCartemEnforceSymsgL02 extends ActionVisitorTemplateEnforceV2<CartemInfo> {
	
	public VisiCartemEnforceSymsgL02(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
