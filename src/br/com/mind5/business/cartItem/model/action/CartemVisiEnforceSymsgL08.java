...
public final class CartemVisiEnforceSymsgL08 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL08(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
