...
public final class CartemVisiEnforceSymsgL02 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL02(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
