...
public final class CartemVisiEnforceSymsgL14 extends ActionVisitorTemplateEnforce<CartemInfo> {
	
	public CartemVisiEnforceSymsgL14(DeciTreeOption<CartemInfo> option) {
		super(option);
	}
