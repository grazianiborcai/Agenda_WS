...
public final class CartemUpdateSingle implements DaoStmt<CartemInfo> {
	...
	@Override public DaoStmt<CartemInfo> getNewInstance() {
		return new CartemUpdateSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
