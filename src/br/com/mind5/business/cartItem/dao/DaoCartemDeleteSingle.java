...
public final class DaoCartemDeleteSingle extends DaoStmtTemplate<CartemInfo> {
	private final String MAIN_TABLE = DaoDbTable.CART_ITM_TABLE;	
	
	
	public DaoCartemDeleteSingle(Connection conn, CartemInfo recordInfo, String schemaName) {
