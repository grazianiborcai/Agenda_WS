...
public final class CartemDaoUpdateSingle extends DaoStmtTemplate<CartemInfo> {
	private final String MAIN_TABLE = DaoDbTable.CART_ITM_TABLE;	
	
	
	public CartemDaoUpdateSingle(Connection conn, CartemInfo recordInfo, String schemaName) {
