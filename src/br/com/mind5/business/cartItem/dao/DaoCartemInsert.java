...
public final class DaoCartemInsert implements DaoStmtExecV2<CartemInfo> {
	private DaoStmtExecV2<CartemInfo> helper;
	
	
	public DaoCartemInsert(List<DaoStmtExecOption<CartemInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoCartemInsertSingle.class, CartemInfo.class);
	}
