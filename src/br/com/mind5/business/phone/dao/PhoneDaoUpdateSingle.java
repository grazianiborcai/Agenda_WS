...
public final class PhoneDaoUpdateSingle extends DaoStmtTemplate<PhoneInfo> {
	private final String MAIN_TABLE = DaoDbTable.PHONE_TABLE;
	
	
	public PhoneDaoUpdateSingle(Connection conn, PhoneInfo recordInfo, String schemaName) {
