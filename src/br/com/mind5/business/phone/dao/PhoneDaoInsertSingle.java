...
public final class PhoneDaoInsertSingle extends DaoStmtTemplate<PhoneInfo> {
	private final String MAIN_TABLE = DaoDbTable.PHONE_TABLE;
	
	
	public PhoneDaoInsertSingle(Connection conn, PhoneInfo recordInfo, String schemaName) {
