...
public final class LazyPhoneDaoDelete extends ActionLazyTemplateV2<PhoneInfo, PhoneInfo> {

	public LazyPhoneDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new StdPhoneDaoDelete(option);
	}
