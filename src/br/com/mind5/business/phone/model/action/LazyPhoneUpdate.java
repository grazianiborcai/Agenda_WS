...
public final class LazyPhoneUpdate extends ActionLazyTemplateV1<PhoneInfo, PhoneInfo> {

	public LazyPhoneUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new StdPhoneUpdate(option);
	}
