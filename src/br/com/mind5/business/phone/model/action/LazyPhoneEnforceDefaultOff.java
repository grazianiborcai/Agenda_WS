...
public final class LazyPhoneEnforceDefaultOff extends ActionLazyTemplateV2<PhoneInfo, PhoneInfo> {
	
	public LazyPhoneEnforceDefaultOff(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new StdPhoneEnforceDefaultOff(option);
	}
