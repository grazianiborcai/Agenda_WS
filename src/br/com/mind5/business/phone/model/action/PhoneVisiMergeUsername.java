...
public final class PhoneVisiMergeUsername extends ActionVisitorTemplateMerge<PhoneInfo, UsernameInfo> {
	
	public PhoneVisiMergeUsername(DeciTreeOption<PhoneInfo> option) {
