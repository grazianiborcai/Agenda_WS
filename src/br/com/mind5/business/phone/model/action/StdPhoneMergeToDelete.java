...
public final class StdPhoneMergeToDelete implements ActionStdV1<PhoneInfo> {
	private ActionStdV1<PhoneInfo> actionHelper;	
	
	
	public StdPhoneMergeToDelete(DeciTreeOption<PhoneInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPhoneMergeToDelete(option.conn, option.schemaName));
	}
