...
public final class LazyPhoneEnforceDefaultOn extends ActionLazyTemplateV2<PhoneInfo, PhoneInfo> {
	
	public LazyPhoneEnforceDefaultOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new StdPhoneEnforceDefaultOn(option);
	}
