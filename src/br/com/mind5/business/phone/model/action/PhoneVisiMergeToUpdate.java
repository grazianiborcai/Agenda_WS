...
public final class PhoneVisiMergeToUpdate extends ActionVisitorTemplateMerge<PhoneInfo, PhoneInfo> {
	
	public PhoneVisiMergeToUpdate(DeciTreeOption<PhoneInfo> option) {
