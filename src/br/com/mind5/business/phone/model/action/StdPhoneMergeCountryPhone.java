...
public final class StdPhoneMergeCountryPhone implements ActionStdV1<PhoneInfo> {
	private ActionStdV1<PhoneInfo> actionHelper;	
	
	
	public StdPhoneMergeCountryPhone(DeciTreeOption<PhoneInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPhoneMergeCountryPhone(option.conn, option.schemaName));
	}
