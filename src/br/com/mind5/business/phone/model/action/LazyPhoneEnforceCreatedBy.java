...
public final class LazyPhoneEnforceCreatedBy extends ActionLazyTemplateV1<PhoneInfo, PhoneInfo> {

	public LazyPhoneEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PhoneInfo> getInstanceOfActionHook(DeciTreeOption<PhoneInfo> option) {
		return new StdPhoneEnforceCreatedBy(option);
	}
