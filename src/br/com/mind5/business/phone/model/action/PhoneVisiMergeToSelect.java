...
public final class PhoneVisiMergeToSelect extends ActionVisitorTemplateMerge<PhoneInfo, PhoneInfo> {
	
	public PhoneVisiMergeToSelect(DeciTreeOption<PhoneInfo> option) {
