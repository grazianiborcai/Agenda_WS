...
public final class PhoneCheckSafeName extends ModelCheckerTemplateSimple<PhoneInfo> {

	public PhoneCheckSafeName(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(PhoneInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.phoneName == null)
			return super.SUCCESS;
		
		if (StringValidator.validateSafe(recordInfo.phoneName) == super.SUCCESS)
			return super.SUCCESS;
