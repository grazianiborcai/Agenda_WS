...
public final class PhoneCheckSafeComplement extends ModelCheckerTemplateSimple<PhoneInfo> {

	public PhoneCheckSafeComplement(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected SymsgInfo getSymsgOnResultFalseHook(Connection dbConn, String dbSchema, String codLangu) {
		...
		builder.addParam02(SystemCode.GEN_COMPLEMENT);
