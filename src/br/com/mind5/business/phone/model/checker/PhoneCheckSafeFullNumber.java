...
public final class PhoneCheckSafeFullNumber extends ModelCheckerTemplateSimple<PhoneInfo> {

	public PhoneCheckSafeFullNumber(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(PhoneInfo recordInfo, Connection conn, String schemaName) {
		if (recordInfo.fullNumber == null)
			return super.SUCCESS;
		
		if (StringValidator.validateSafe(recordInfo.fullNumber) == super.SUCCESS)
			return super.SUCCESS;
