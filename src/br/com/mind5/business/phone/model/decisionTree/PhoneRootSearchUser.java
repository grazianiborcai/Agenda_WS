...
import br.com.mind5.business.phone.model.action.PhoneVisiMergePhonarchUser;
...
public final class PhoneRootSearchUser extends DeciTreeTemplateWrite<PhoneInfo> {
	
	public PhoneRootSearchUser(DeciTreeOption<PhoneInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PhoneInfo>> buildActionsOnPassedHook(DeciTreeOption<PhoneInfo> option) {
		...
		ActionStd<PhoneInfo> mergePhonarch = new ActionStdCommom<PhoneInfo>(option, PhoneVisiMergePhonarchUser.class);		
