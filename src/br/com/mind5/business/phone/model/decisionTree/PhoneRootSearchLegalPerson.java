...
import br.com.mind5.business.phone.model.action.PhoneVisiRootSearch;
...
public final class PhoneRootSearchLegalPerson extends DeciTreeTemplateWrite<PhoneInfo> {
	
	public PhoneRootSearchLegalPerson(DeciTreeOption<PhoneInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PhoneInfo>> buildActionsOnPassedHook(DeciTreeOption<PhoneInfo> option) {
		...
		ActionLazy<PhoneInfo> search = new ActionLazyCommom<PhoneInfo>(option, PhoneVisiRootSearch.class);
