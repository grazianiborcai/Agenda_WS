...
public final class PhoneNodeUpsertdel extends DeciTreeTemplateWrite<PhoneInfo> {
	
	public PhoneNodeUpsertdel(DeciTreeOption<PhoneInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PhoneInfo>> buildActionsOnPassedHook(DeciTreeOption<PhoneInfo> option) {
		...
		ActionStd<PhoneInfo> delete = new PhoneRootDelete(option).toAction();
	...
	@Override protected List<ActionStd<PhoneInfo>> buildActionsOnFailedHook(DeciTreeOption<PhoneInfo> option) {
		...
		ActionStd<PhoneInfo> update = new PhoneRootUpdate(option).toAction();
