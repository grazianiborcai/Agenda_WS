...
public final class NodePhoneDefaultL1 extends DeciTreeTemplateWrite<PhoneInfo> {
	...
	@Override protected List<ActionStd<PhoneInfo>> buildActionsOnPassedHook(DeciTreeOption<PhoneInfo> option) {
		...
		ActionStd<PhoneInfo> nodeL2 = new NodePhoneDefaultL2(option).toAction();
	...
	@Override protected List<ActionStd<PhoneInfo>> buildActionsOnFailedHook(DeciTreeOption<PhoneInfo> option) {
		...
		ActionStd<PhoneInfo> nodeL3 = new NodePhoneDefaultL3(option).toAction();	
