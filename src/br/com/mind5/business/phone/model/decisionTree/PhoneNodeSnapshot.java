...
import br.com.mind5.business.phone.model.action.PhoneVisiPhonapInsert;
...
public final class PhoneNodeSnapshot extends DeciTreeTemplateWrite<PhoneInfo> {
	
	public PhoneNodeSnapshot(DeciTreeOption<PhoneInfo> option) {
		super(option);
	}
