...
public final class StdOwnerapMergeToSelect implements ActionStdV1<OwnerapInfo> {
	private ActionStdV1<OwnerapInfo> actionHelper;	
	
	
	public StdOwnerapMergeToSelect(DeciTreeOption<OwnerapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiOwnerapMergeToSelect(option.conn, option.schemaName));
	}
