...
public final class OwnerapInsertSingle extends DaoStmtTemplate<OwnerapInfo> {	
	...
	@Override protected DaoResultParserV2<OwnerapInfo> getResultParserHook() {
		return new DaoResultParserV2<OwnerapInfo>() {		
