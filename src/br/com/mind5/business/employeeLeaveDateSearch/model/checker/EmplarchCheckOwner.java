...
public final class EmplarchCheckOwner extends ModelCheckerTemplateForwardV2<EmplarchInfo, OwnerInfo> {
	...
	@Override protected OwnerInfo toForwardClass(EmplarchInfo baseRecord) {
