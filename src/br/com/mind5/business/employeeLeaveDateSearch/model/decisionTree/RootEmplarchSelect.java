...
public class RootEmplarchSelect extends DeciTreeReadTemplate<EmplarchInfo> {
	...
	@Override protected ModelChecker<EmplarchInfo> buildDecisionCheckerHook(DeciTreeOption<EmplarchInfo> option) {
