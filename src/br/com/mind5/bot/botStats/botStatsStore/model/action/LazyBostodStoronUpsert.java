...
public final class LazyBostodStoronUpsert extends ActionLazyTemplate<BostodInfo, BostodInfo> {

	public LazyBostodStoronUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<BostodInfo> getInstanceOfActionHook(DeciTreeOption<BostodInfo> option) {
		return new StdBostodStoronUpsert(option);
	}
