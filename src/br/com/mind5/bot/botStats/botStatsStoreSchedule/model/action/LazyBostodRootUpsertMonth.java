...
import br.com.mind5.bot.botStats.botStatsStoreSchedule.model.decisionTree.RootBostodUpsertMonth;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyBostodRootUpsertMonth extends ActionLazyTemplate<BostodInfo, BostodInfo> {

	public LazyBostodRootUpsertMonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<BostodInfo> getInstanceOfActionHook(DeciTreeOption<BostodInfo> option) {
		return new RootBostodUpsertMonth(option).toAction();
	}
