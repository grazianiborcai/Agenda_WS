...
public final class StdUserapMergeToSelect implements ActionStdV1<UserapInfo> {
	private ActionStdV1<UserapInfo> actionHelper;	
	
	
	public StdUserapMergeToSelect(DeciTreeOption<UserapInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiUserapMergeToSelect(option.conn, option.schemaName));
	}
