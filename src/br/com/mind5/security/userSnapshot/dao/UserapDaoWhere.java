...
public final class UserapDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public UserapDaoWhere(DaoWhereBuilderOption whereOption, String tableName, UserapInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, UserapInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case UserapDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case UserapDaoDbTableColumn.COL_COD_SNAPSHOT :
