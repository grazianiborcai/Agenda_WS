...
public final class DaoOtperasInsertSingle extends DaoStmtTemplate<OtperasInfo> {
	private final String MAIN_TABLE = DaoDbTable.OTP_USER_PASSWORD_TABLE;
	
	
	public DaoOtperasInsertSingle(Connection conn, OtperasInfo recordInfo, String schemaName) {
