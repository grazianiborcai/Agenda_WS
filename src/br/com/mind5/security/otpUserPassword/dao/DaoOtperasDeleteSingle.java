...
public final class DaoOtperasDeleteSingle extends DaoStmtTemplate<OtperasInfo> {
	private final String MAIN_TABLE = DaoDbTable.OTP_USER_PASSWORD_TABLE;
	
	
	public DaoOtperasDeleteSingle(Connection conn, OtperasInfo recordInfo, String schemaName) {
