...
public final class DaoOtperasUpdateSingle extends DaoStmtTemplate<OtperasInfo> {
	private final String MAIN_TABLE = DaoDbTable.OTP_USER_PASSWORD_TABLE;
	
	
	public DaoOtperasUpdateSingle(Connection conn, OtperasInfo recordInfo, String schemaName) {
