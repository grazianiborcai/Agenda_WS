...
public final class OtperasVisiOtpGenerate extends ActionVisitorTemplateAction<OtperasInfo, OtpInfo> {
	
	public OtperasVisiOtpGenerate(DeciTreeOption<OtperasInfo> option) {
