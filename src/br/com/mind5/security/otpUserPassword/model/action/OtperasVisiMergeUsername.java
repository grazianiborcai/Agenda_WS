...
public final class OtperasVisiMergeUsername extends ActionVisitorTemplateMerge<OtperasInfo, UsernameInfo> {
	
	public OtperasVisiMergeUsername(DeciTreeOption<OtperasInfo> option) {
