...
public final class LazyOtperasOptValidate extends ActionLazyTemplateV2<OtperasInfo, OtperasInfo> {
	
	public LazyOtperasOptValidate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OtperasInfo> getInstanceOfActionHook(DeciTreeOption<OtperasInfo> option) {
		return new StdOtperasOtpValidate(option);
	}
