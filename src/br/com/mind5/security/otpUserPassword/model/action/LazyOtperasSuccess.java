...
public final class LazyOtperasSuccess extends ActionLazyTemplateV2<OtperasInfo, OtperasInfo> {
	
	public LazyOtperasSuccess(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OtperasInfo> getInstanceOfActionHook(DeciTreeOption<OtperasInfo> option) {
		return new StdOtperasSuccess(option);
	}
