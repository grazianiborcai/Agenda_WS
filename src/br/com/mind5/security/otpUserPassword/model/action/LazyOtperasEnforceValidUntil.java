...
public final class LazyOtperasEnforceValidUntil extends ActionLazyTemplateV2<OtperasInfo, OtperasInfo> {
	
	public LazyOtperasEnforceValidUntil(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OtperasInfo> getInstanceOfActionHook(DeciTreeOption<OtperasInfo> option) {
		return new StdOtperasEnforceValidUntil(option);
	}
