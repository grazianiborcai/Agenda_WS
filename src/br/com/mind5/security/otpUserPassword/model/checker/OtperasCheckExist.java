...
public final class OtperasCheckExist extends ModelCheckerTemplateActionV2<OtperasInfo, OtperasInfo> {
	...
	@Override protected ActionStdV1<OtperasInfo> buildActionHook(DeciTreeOption<OtperasInfo> option) {
		ActionStdV1<OtperasInfo> select = new StdOtperasDaoSelect(option);
		return select;
	}
