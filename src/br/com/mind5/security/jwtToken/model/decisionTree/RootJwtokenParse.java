...
public final class RootJwtokenParse extends DeciTreeTemplateWriteV2<JwtokenInfo> {
	...
	@Override protected List<ActionStdV1<JwtokenInfo>> buildActionsOnPassedHook(DeciTreeOption<JwtokenInfo> option) {
		...
		ActionLazyV1<JwtokenInfo> parse = new LazyJwtokenParse(option.conn, option.schemaName);
