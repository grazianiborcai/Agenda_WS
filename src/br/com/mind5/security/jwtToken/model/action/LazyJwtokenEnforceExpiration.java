...
public final class LazyJwtokenEnforceExpiration extends ActionLazyTemplateV2<JwtokenInfo, JwtokenInfo> {
	
	public LazyJwtokenEnforceExpiration(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<JwtokenInfo> getInstanceOfActionHook(DeciTreeOption<JwtokenInfo> option) {
		return new StdJwtokenEnforceExpiration(option);
	}
