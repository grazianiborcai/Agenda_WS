...
public final class StdJwtokenEnforceExpiration implements ActionStdV1<JwtokenInfo> {
	private ActionStdV1<JwtokenInfo> actionHelper;	
	
	
	public StdJwtokenEnforceExpiration(DeciTreeOption<JwtokenInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiJwtokenEnforceExpiration());
	}
