...
public final class JwtokenVisiEnforceSecret extends ActionVisitorTemplateEnforce<JwtokenInfo> {
	
	public JwtokenVisiEnforceSecret(DeciTreeOption<JwtokenInfo> option) {
		super(option);
	}
