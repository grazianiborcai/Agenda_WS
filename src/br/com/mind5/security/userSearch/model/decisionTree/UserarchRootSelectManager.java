...
import br.com.mind5.security.userSearch.model.action.UserarchVisiEnforceManager;

public final class UserarchRootSelectManager extends DeciTreeTemplateRead<UserarchInfo> {
	
	public UserarchRootSelectManager(DeciTreeOption<UserarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<UserarchInfo>> buildActionsOnPassedHook(DeciTreeOption<UserarchInfo> option) {
		...
		ActionStd<UserarchInfo> enforceManager = new ActionStdCommom<UserarchInfo>(option, UserarchVisiEnforceManager.class);
