...
public final class UserarchCheckReadUsername extends ModelCheckerTemplateSimpleV2<UserarchInfo> {

	public UserarchCheckReadUsername(ModelCheckerOption option) {
		super(option);
	}
