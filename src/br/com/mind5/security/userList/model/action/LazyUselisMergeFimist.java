...
public final class LazyUselisMergeFimist extends ActionLazyTemplate<UselisInfo, UselisInfo> {
	
	public LazyUselisMergeFimist(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UselisInfo> getInstanceOfActionHook(DeciTreeOption<UselisInfo> option) {
		return new StdUselisMergeFimist(option);
	}
