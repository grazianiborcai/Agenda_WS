...
final class VisiUsomeMergeUsername extends ActionVisitorTemplateMerge<UsomeInfo, UsernameInfo> {
	
	public VisiUsomeMergeUsername(DeciTreeOption<UsomeInfo> option) {
