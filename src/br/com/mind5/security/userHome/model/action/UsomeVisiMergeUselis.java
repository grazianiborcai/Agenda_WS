...
public final class UsomeVisiMergeUselis extends ActionVisitorTemplateMerge<UsomeInfo, UselisInfo> {
	
	public UsomeVisiMergeUselis(DeciTreeOption<UsomeInfo> option) {
	...
	@Override protected List<UsomeInfo> mergeHook(List<UsomeInfo> baseInfos, List<UselisInfo> selectedInfos) {	
		return UsomeMerger.mergeWithUselis(baseInfos, selectedInfos);
	}
