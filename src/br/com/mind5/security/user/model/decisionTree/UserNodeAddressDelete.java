...
import br.com.mind5.security.user.model.action.UserVisiAddressDelete;
...
public final class UserNodeAddressDelete extends DeciTreeTemplateWrite<UserInfo> {
	
	public UserNodeAddressDelete(DeciTreeOption<UserInfo> option) {
		super(option);
	}
