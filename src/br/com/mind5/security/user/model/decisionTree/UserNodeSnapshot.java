...
import br.com.mind5.security.user.model.action.UserVisiUserapInsert;

public final class UserNodeSnapshot extends DeciTreeTemplateWrite<UserInfo> {
	
	public UserNodeSnapshot(DeciTreeOption<UserInfo> option) {
		super(option);
	}
