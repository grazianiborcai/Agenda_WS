...
public final class UserNodePerson extends DeciTreeTemplateWrite<UserInfo> {
	
	public UserNodePerson(DeciTreeOption<UserInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<UserInfo>> buildActionsOnPassedHook(DeciTreeOption<UserInfo> option) {
		...
		ActionStd<UserInfo> mergePerson = new ActionStdCommom<UserInfo>(option, UserVisiMergePerson.class);
