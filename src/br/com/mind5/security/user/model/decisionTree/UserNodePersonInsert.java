...
import br.com.mind5.security.user.model.action.UserVisiPersonInsert;

public final class UserNodePersonInsert extends DeciTreeTemplateWrite<UserInfo> {
	
	public UserNodePersonInsert(DeciTreeOption<UserInfo> option) {
		super(option);
	}
