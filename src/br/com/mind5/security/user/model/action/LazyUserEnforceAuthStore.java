...
public final class LazyUserEnforceAuthStore extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforceAuthStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceAuthStore(option);
	}
