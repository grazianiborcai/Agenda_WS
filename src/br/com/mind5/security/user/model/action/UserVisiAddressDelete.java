...
public final class UserVisiAddressDelete extends ActionVisitorTemplateAction<UserInfo, AddressInfo> {
	
	public UserVisiAddressDelete(DeciTreeOption<UserInfo> option) {
