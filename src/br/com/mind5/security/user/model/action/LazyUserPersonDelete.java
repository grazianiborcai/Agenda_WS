...
public final class LazyUserPersonDelete extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserPersonDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserPersonDelete(option);
	}
