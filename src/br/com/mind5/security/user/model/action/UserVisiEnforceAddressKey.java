...
public final class UserVisiEnforceAddressKey extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceAddressKey(DeciTreeOption<UserInfo> option) {
		super(option);
	}
