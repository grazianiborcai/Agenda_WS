...
public final class LazyUserEnforceCreatedOn extends ActionLazyTemplate<UserInfo, UserInfo> {
	
	public LazyUserEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceCreatedOn(option);
	}
