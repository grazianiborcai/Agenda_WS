...
public final class LazyUserEnforceAuthOwner extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserEnforceAuthOwner(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceAuthOwner(option);
	}
