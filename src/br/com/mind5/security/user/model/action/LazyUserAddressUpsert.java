...
public final class LazyUserAddressUpsert extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserAddressUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserAddressUpsert(option);
	}
