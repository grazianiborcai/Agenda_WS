...
public final class UserVisiEnforceCategOwner extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceCategOwner(DeciTreeOption<UserInfo> option) {
		super(option);
	}
