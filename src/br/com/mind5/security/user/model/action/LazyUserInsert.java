...
public final class LazyUserInsert extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserInsert(option);
	}
