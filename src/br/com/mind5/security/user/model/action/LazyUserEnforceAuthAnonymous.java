...
public final class LazyUserEnforceAuthAnonymous extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforceAuthAnonymous(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceAuthAnonymous(option);
	}
