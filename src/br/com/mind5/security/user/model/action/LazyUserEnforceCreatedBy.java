...
public final class LazyUserEnforceCreatedBy extends ActionLazyTemplate<UserInfo, UserInfo> {
	
	public LazyUserEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceCreatedBy(option);
	}
