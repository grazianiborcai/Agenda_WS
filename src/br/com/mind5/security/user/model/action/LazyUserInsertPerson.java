...
public final class LazyUserInsertPerson extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserInsertPerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserInsertPerson(option);
	}
