...
public final class LazyUserPhoneUpsert extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserPhoneUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserPhoneUpsert(option);
	}
