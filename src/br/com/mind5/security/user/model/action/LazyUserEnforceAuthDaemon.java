...
public final class LazyUserEnforceAuthDaemon extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforceAuthDaemon(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceAuthDaemon(option);
	}
