...
public final class LazyUserUpswdInsertRandom extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserUpswdInsertRandom(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserUpswdInsertRandom(option);
	}
