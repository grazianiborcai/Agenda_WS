...
public final class LazyUserEnforceAuthEmp extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforceAuthEmp(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceAuthEmp(option);
	}
