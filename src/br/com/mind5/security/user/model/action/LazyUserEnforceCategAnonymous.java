...
public final class LazyUserEnforceCategAnonymous extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforceCategAnonymous(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceCategAnonymous(option);
	}
