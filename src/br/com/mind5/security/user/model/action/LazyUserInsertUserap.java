...
public final class LazyUserInsertUserap extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserInsertUserap(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserInsertUserap(option);
	}
