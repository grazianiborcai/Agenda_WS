...
public final class UserVisiMergeToUpdate extends ActionVisitorTemplateMerge<UserInfo, UserInfo> {
	
	public UserVisiMergeToUpdate(DeciTreeOption<UserInfo> option) {
