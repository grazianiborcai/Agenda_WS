...
public final class LazyUserMergePhone extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserMergePhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserMergePhone(option);
	}
