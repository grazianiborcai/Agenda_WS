...
public final class LazyUserUpdate extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserUpdate(option);
	}
