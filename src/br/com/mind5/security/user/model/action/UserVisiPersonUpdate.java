...
public final class UserVisiPersonUpdate extends ActionVisitorTemplateAction<UserInfo, PersonInfo> {
	
	public UserVisiPersonUpdate(DeciTreeOption<UserInfo> option) {
