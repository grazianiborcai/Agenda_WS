...
public final class LazyUserMergeToDelete extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserMergeToDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserMergeToDelete(option);
	}
