...
public final class LazyUserMergeAuthgrole extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserMergeAuthgrole(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserMergeAuthgrole(option);
	}
