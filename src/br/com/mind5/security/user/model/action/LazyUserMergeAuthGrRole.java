...
public final class LazyUserMergeAuthGrRole extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserMergeAuthGrRole(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserMergeAuthGrRole(option);
	}
