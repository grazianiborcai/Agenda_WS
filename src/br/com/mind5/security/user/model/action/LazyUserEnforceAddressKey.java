...
public final class LazyUserEnforceAddressKey extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserEnforceAddressKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceAddressKey(option);
	}
