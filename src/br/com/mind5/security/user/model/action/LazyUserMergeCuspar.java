...
public final class LazyUserMergeCuspar extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserMergeCuspar(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserMergeCuspar(option);
	}
