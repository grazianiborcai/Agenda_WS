...
public final class UserVisiEnforceCategAnonymous extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceCategAnonymous(DeciTreeOption<UserInfo> option) {
		super(option);
	}
