...
public final class UserVisiEnforceUsernameAnonymous extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceUsernameAnonymous(DeciTreeOption<UserInfo> option) {
		super(option);
	}
