...
public final class LazyUserEnforcePersonKey extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforcePersonKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforcePersonKey(option);
	}
