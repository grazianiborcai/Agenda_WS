...
public final class UserVisiEnforceCategDaemon extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceCategDaemon(DeciTreeOption<UserInfo> option) {
		super(option);
	}
