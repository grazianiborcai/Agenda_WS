...
public final class LazyUserMergeUsername extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserMergeUsername(option);
	}
