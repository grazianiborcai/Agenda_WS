...
public final class LazyUserEnforceUsernameAnonymous extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforceUsernameAnonymous(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceUsernameAnonymous(option);
	}
