...
public final class LazyUserUpsertAddress extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserUpsertAddress(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserUpsertAddress(option);
	}
