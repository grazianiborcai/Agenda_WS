...
public final class LazyUserSelect extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserSelect(option);
	}
