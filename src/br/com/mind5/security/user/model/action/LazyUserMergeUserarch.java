...
public final class LazyUserMergeUserarch extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserMergeUserarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserMergeUserarch(option);
	}
