...
public final class UserVisiEnforceAuthAnonymous extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceAuthAnonymous(DeciTreeOption<UserInfo> option) {
		super(option);
	}
