...
public final class LazyUserEnforceAuthCus extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserEnforceAuthCus(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceAuthCus(option);
	}
