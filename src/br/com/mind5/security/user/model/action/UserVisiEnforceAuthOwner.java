...
public final class UserVisiEnforceAuthOwner extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceAuthOwner(DeciTreeOption<UserInfo> option) {
		super(option);
	}
