...
public final class UserVisiEnforceCategStore extends ActionVisitorTemplateEnforce<UserInfo> {
	
	public UserVisiEnforceCategStore(DeciTreeOption<UserInfo> option) {
		super(option);
	}
