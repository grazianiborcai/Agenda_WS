...
public final class LazyUserDaoInsert extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserDaoInsert(option);
	}
