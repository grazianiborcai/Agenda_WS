...
public final class LazyUserDeleteAddress extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserDeleteAddress(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserDeleteAddress(option);
	}
