...
public final class LazyUserUserapInsert extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserUserapInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserUserapInsert(option);
	}
