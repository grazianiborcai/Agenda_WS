...
public final class LazyUserEnforceCategDaemon extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserEnforceCategDaemon(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserEnforceCategDaemon(option);
	}
