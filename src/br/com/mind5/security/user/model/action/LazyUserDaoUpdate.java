...
public final class LazyUserDaoUpdate extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserDaoUpdate(option);
	}
