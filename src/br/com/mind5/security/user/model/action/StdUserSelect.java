...
import br.com.mind5.security.user.dao.UserSelect;
import br.com.mind5.security.user.info.UserInfo;

public final class StdUserSelect implements ActionStdV1<UserInfo> {
	private ActionStdV1<UserInfo> actionHelper;
	
	
	public StdUserSelect(DeciTreeOption<UserInfo> option) {
	...
	private DaoStmtExec_<UserInfo> buildStmtExec(DeciTreeOption<UserInfo> option) {
		...
		return new UserSelect(stmtExecOptions);
	}
