...
public final class LazyUserDeletePerson extends ActionLazyTemplateV1<UserInfo, UserInfo> {
	
	public LazyUserDeletePerson(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserDeletePerson(option);
	}
