...
public final class UserVisiMergeToSelect extends ActionVisitorTemplateMerge<UserInfo, UserInfo> {
	
	public UserVisiMergeToSelect(DeciTreeOption<UserInfo> option) {
