...
public final class LazyUserUpswdInsertAnonymous extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserUpswdInsertAnonymous(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserUpswdInsertAnonymous(option);
	}
