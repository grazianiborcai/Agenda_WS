...
public final class LazyUserAddressDelete extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserAddressDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserAddressDelete(option);
	}
