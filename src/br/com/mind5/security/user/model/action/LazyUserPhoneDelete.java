...
public final class LazyUserPhoneDelete extends ActionLazyTemplateV2<UserInfo, UserInfo> {
	
	public LazyUserPhoneDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UserInfo> getInstanceOfActionHook(DeciTreeOption<UserInfo> option) {
		return new StdUserPhoneDelete(option);
	}
