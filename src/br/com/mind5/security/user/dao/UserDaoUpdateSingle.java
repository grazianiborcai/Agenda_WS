...
public final class UserDaoUpdateSingle extends DaoStmtTemplate<UserInfo> {
	private final String MAIN_TABLE = DaoDbTable.USER_TABLE;	
	
	
	public UserDaoUpdateSingle(Connection conn, UserInfo recordInfo, String schemaName) {
