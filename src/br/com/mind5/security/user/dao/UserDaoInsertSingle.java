...
public final class UserDaoInsertSingle extends DaoStmtTemplate<UserInfo> {	
	private final String MAIN_TABLE = DaoDbTable.USER_TABLE;	
	
	
	public UserDaoInsertSingle(Connection conn, UserInfo recordInfo, String schemaName) {
