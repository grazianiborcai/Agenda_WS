...
public final class UserDeleteSingle implements DaoStmt<UserInfo> {
	...
	@Override public DaoStmt<UserInfo> getNewInstance() {
		return new UserDeleteSingle(stmtOption.conn, stmtOption.recordInfo, stmtOption.schemaName);
	}
	
	
	
	private class ResultParser implements DaoResultParser_<UserInfo> {
