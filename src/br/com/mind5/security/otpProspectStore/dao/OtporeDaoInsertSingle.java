...
public final class OtporeDaoInsertSingle extends DaoStmtTemplate<OtporeInfo> {
	private final String MAIN_TABLE = DaoDbTable.OTP_PROSPECT_STORE_TABLE;
	
	
	public OtporeDaoInsertSingle(Connection conn, OtporeInfo recordInfo, String schemaName) {
