...
public final class OtporeDaoDeleteSingle extends DaoStmtTemplate<OtporeInfo> {
	private final String MAIN_TABLE = DaoDbTable.OTP_PROSPECT_STORE_TABLE;
	
	
	public OtporeDaoDeleteSingle(Connection conn, OtporeInfo recordInfo, String schemaName) {
