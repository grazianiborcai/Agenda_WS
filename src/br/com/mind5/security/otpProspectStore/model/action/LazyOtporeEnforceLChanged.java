...
public final class LazyOtporeEnforceLChanged extends ActionLazyTemplateV2<OtporeInfo, OtporeInfo> {
	
	public LazyOtporeEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OtporeInfo> getInstanceOfActionHook(DeciTreeOption<OtporeInfo> option) {
		return new StdOtporeEnforceLChanged(option);
	}
