...
public final class OtporeVisiOtpGenerate extends ActionVisitorTemplateAction<OtporeInfo, OtpInfo> {
	
	public OtporeVisiOtpGenerate(DeciTreeOption<OtporeInfo> option) {
