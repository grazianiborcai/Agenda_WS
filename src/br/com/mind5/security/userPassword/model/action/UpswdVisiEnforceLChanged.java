...
public final class UpswdVisiEnforceLChanged extends ActionVisitorTemplateEnforce<UpswdInfo> {
	
	public UpswdVisiEnforceLChanged(DeciTreeOption<UpswdInfo> option) {
		super(option);
	}
