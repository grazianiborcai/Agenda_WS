...
public final class LazyUpswdJwtokenGenerate extends ActionLazyTemplate<UpswdInfo, UpswdInfo> {
	
	public LazyUpswdJwtokenGenerate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UpswdInfo> getInstanceOfActionHook(DeciTreeOption<UpswdInfo> option) {
		return new StdUpswdJwtokenGenerate(option);
	}
