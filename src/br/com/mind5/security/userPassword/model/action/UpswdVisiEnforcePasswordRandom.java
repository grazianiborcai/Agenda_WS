...
public final class UpswdVisiEnforcePasswordRandom extends ActionVisitorTemplateEnforce<UpswdInfo> {
	
	public UpswdVisiEnforcePasswordRandom(DeciTreeOption<UpswdInfo> option) {
		super(option);
	}
