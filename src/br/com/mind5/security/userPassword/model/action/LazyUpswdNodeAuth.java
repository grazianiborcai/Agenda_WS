...
import br.com.mind5.security.userPassword.model.decisionTree.NodeUpswdAuth;

public final class LazyUpswdNodeAuth extends ActionLazyTemplateV2<UpswdInfo, UpswdInfo> {
	
	public LazyUpswdNodeAuth(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UpswdInfo> getInstanceOfActionHook(DeciTreeOption<UpswdInfo> option) {
		return new NodeUpswdAuth(option).toAction();
	}
