...
public final class LazyUpswdUpdate extends ActionLazyTemplateV1<UpswdInfo, UpswdInfo> {
	
	public LazyUpswdUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UpswdInfo> getInstanceOfActionHook(DeciTreeOption<UpswdInfo> option) {
		return new StdUpswdUpdate(option);
	}
