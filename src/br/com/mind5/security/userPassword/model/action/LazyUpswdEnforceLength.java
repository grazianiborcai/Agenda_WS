...
public final class LazyUpswdEnforceLength extends ActionLazyTemplateV1<UpswdInfo, UpswdInfo> {
	
	public LazyUpswdEnforceLength(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UpswdInfo> getInstanceOfActionHook(DeciTreeOption<UpswdInfo> option) {
		return new StdUpswdEnforceLength(option);
	}
