...
public final class UpswdVisiJwtokenGenerate extends ActionVisitorTemplateAction<UpswdInfo, JwtokenInfo> {
	
	public UpswdVisiJwtokenGenerate(DeciTreeOption<UpswdInfo> option) {
