...
public final class LazyUpswdEmordeSend extends ActionLazyTemplateV2<UpswdInfo, UpswdInfo> {
	
	public LazyUpswdEmordeSend(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UpswdInfo> getInstanceOfActionHook(DeciTreeOption<UpswdInfo> option) {
		return new StdUpswdEmordeSend(option);
	}
