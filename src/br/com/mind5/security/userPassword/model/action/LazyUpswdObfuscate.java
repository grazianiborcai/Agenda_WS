...
public final class LazyUpswdObfuscate extends ActionLazyTemplateV2<UpswdInfo, UpswdInfo> {
	
	public LazyUpswdObfuscate(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<UpswdInfo> getInstanceOfActionHook(DeciTreeOption<UpswdInfo> option) {
		return new StdUpswdObfuscate(option);
	}
