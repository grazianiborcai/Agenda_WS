...
public final class UpswdVisiEnforceHashToMatch extends ActionVisitorTemplateEnforce<UpswdInfo> {
	
	public UpswdVisiEnforceHashToMatch(DeciTreeOption<UpswdInfo> option) {
		super(option);
	}
