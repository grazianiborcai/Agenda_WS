...
public final class UpswdVisiMergeUsername extends ActionVisitorTemplateMerge<UpswdInfo, UsernameInfo> {
	
	public UpswdVisiMergeUsername(DeciTreeOption<UpswdInfo> option) {
