...
public final class UpswdVisiEnforcePasswordAnonymous extends ActionVisitorTemplateEnforce<UpswdInfo> {
	
	public UpswdVisiEnforcePasswordAnonymous(DeciTreeOption<UpswdInfo> option) {
		super(option);
	}
