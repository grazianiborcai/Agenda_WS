...
public final class UpswdVisiMergeUselis extends ActionVisitorTemplateMerge<UpswdInfo, UselisInfo> {
	
	public UpswdVisiMergeUselis(DeciTreeOption<UpswdInfo> option) {
