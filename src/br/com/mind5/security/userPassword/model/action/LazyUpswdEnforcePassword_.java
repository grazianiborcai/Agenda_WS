...
public final class LazyUpswdEnforcePassword_ extends ActionLazyTemplateV2<UpswdInfo, UpswdInfo> {
	
	public LazyUpswdEnforcePassword_(Connection conn, String schemaName) {
