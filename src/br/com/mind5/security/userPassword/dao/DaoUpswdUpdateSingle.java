...
public final class DaoUpswdUpdateSingle extends DaoStmtTemplate<UpswdInfo> {
	private final String MAIN_TABLE = DaoDbTable.USER_PASSWORD_TABLE;
	
	
	public DaoUpswdUpdateSingle(Connection conn, UpswdInfo recordInfo, String schemaName) {
