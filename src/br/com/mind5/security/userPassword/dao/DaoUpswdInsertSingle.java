...
public final class DaoUpswdInsertSingle extends DaoStmtTemplate<UpswdInfo> {
	private final String MAIN_TABLE = DaoDbTable.USER_PASSWORD_TABLE;
	
	
	public DaoUpswdInsertSingle(Connection conn, UpswdInfo recordInfo, String schemaName) {
