...
public final class UpswdDaoInsertSingle extends DaoStmtTemplate<UpswdInfo> {
	private final String MAIN_TABLE = DaoDbTable.USER_PASSWORD_TABLE;
	
	
	public UpswdDaoInsertSingle(Connection conn, UpswdInfo recordInfo, String schemaName) {
