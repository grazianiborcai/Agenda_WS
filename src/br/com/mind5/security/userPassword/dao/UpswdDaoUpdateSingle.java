...
public final class UpswdDaoUpdateSingle extends DaoStmtTemplate<UpswdInfo> {
	private final String MAIN_TABLE = DaoDbTable.USER_PASSWORD_TABLE;
	
	
	public UpswdDaoUpdateSingle(Connection conn, UpswdInfo recordInfo, String schemaName) {
