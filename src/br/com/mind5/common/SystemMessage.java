...
public final class SystemMessage {
	...
	public static final String AREA_PHONE_MANDATORY_FIELD_EMPTY = "Phone Area: Mandatory field is empty";
	...
	public static final String AUTH_GROUP_MANDATORY_FIELD_EMPTY = "Authorization Group: Mandatory field is empty";
	public static final String AUTH_GROUP_NOT_FOUND = "Authorization Group not found on DB";
	public static final String AUTH_ROLE_MANDATORY_FIELD_EMPTY = "Authorization Role: Mandatory field is empty";
	public static final String BUSINESS_MANDATORY_FIELD_EMPTY = "Business: Mandatory field is empty";
	public static final String CART_CATEG_MANDATORY_FIELD_EMPTY = "Cart Category: Mandatory field is empty";
	public static final String COUNTRY_ALREADY_EXIST = "Country already exist on DB";
	public static final String COUNTRY_MANDATORY_FIELD_EMPTY = "Country: Mandatory field is empty";
	...
	public static final String COUNTRY_LEGAL_MANDATORY_FIELD_EMPTY = "Legal Country: Mandatory field is empty";
	...
	public static final String COUNTRY_PHONE_MANDATORY_FIELD_EMPTY = "Phone Country: Mandatory field is empty";
	...
	public static final String CURRENCY_MANDATORY_FIELD_EMPTY = "Currency: Mandatory field is empty";
	...
	public static final String ENTITY_CATEG_MANDATORY_FIELD_EMPTY = "Entity Category: Mandatory field is empty";
	...
	public static final String FEE_CATEG_MANDATORY_FIELD_EMPTY = "Fee Category: Mandatory field is empty";
	...
	public static final String GENDER_MANDATORY_FIELD_EMPTY = "Gender: Mandatory field is empty";
	...
	public static final String MAT_CATEG_MANDATORY_FIELD_EMPTY = "Category: Mandatory field is empty";
	...
	public static final String MAT_GROUP_MANDATORY_FIELD_EMPTY = "Material Group: Mandatory field is empty";
	...
	public static final String MAT_MOV_TYPE_MANDATORY_FIELD_EMPTY = "Material Movement Type: Mandatory field is empty";
	...
	public static final String PAY_PARTNER_MANDATORY_FIELD_EMPTY = "Payment partner: Mandatory field is empty";
	...
	public static final String PAYMENT_STATUS_MANDATORY_FIELD_EMPTY = "Payment Status: Mandatory field is empty";
	public static final String PAYMENT_STATUS_NOT_FOUND = "Payment Status not found on DB";
	public static final String POSITION_ALREADY_EXIST = "Position already exist on DB";
	public static final String POSITION_MANDATORY_FIELD_EMPTY = "Position: Mandatory field is empty";
	public static final String POSITION_NOT_FOUND = "Position not found on DB";	
	public static final String SCHEDULE_STATUS_ALREADY_EXIST = "Schedule Status already exist on DB";	
	public static final String SCHEDULE_STATUS_MANDATORY_FIELD_EMPTY = "Schedule Status: Mandatory field is empty";
	public static final String SCHEDULE_STATUS_NOT_FOUND = "Schedule Status not found on DB";
	public static final String STATE_ALREADY_EXIST = "State already exist on DB";
	public static final String STATE_MANDATORY_FIELD_EMPTY = "State: Mandatory field is empty";
	...
	public static final String TIMEZONE_MANDATORY_FIELD_EMPTY = "Timezone: Mandatory field is empty";
	...
	public static final String UNIT_MANDATORY_FIELD_EMPTY = "Unit: Mandatory field is empty";
	...
	public static final String USER_CATEG_MANDATORY_FIELD_EMPTY = "User Category: Mandatory field is empty";
	...
	public static final String WEEKDAY_MANDATORY_FIELD_EMPTY = "Weekday: Mandatory field is empty";
	...
	public static final String OWNER_TECH_FIELD_SHOULD_BE_EMPTY_ = "Owner: technical fields shouldn't be filled";
	...
	public static final String ORDER_STATUS_CHANGE_NOT_ALLOWED = "Order: Illegal operation. Invalid Status change";	
	...
	// Schedule Month Data
	public static final String SCHEDULE_MONTH_DATA_FIELD_EMPTY = "Schedule-Month-Data: Mandatory field is empty";
	...
	// Schedule Week
	public static final String SCHEDULE_WEEK_FIELD_EMPTY = "Schedule-Week: Mandatory field is empty";	
