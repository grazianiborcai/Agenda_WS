...
import br.com.mind5.authorization.customerAuthorization.model.action.StdCusauthMergeStorauth;
import br.com.mind5.authorization.customerAuthorization.model.checker.CusauthCheckAuthManager;
...
public final class NodeCusauthSelectL4 extends DeciTreeTemplateWriteV2<CusauthInfo> {
	
	public NodeCusauthSelectL4(DeciTreeOption<CusauthInfo> option) {
		super(option);
	}
	...
	@Override protected ModelCheckerV1<CusauthInfo> buildCheckerHook(DeciTreeOption<CusauthInfo> option) {
		...
		checker = new CusauthCheckAuthManager(checkerOption);
		queue.add(checker);
	...
	@Override protected List<ActionStdV1<CusauthInfo>> buildActionsOnPassedHook(DeciTreeOption<CusauthInfo> option) {
		...
		ActionStdV1<CusauthInfo> mergeStorauth = new StdCusauthMergeStorauth(option);
