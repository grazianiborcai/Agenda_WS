...
import br.com.mind5.authorization.customerAuthorization.model.action.StdCusauthSuccess;
import br.com.mind5.authorization.customerAuthorization.model.checker.CusauthCheckAuthOwner;
...
public final class NodeCusauthSelectL3 extends DeciTreeTemplateWriteV2<CusauthInfo> {
	
	public NodeCusauthSelectL3(DeciTreeOption<CusauthInfo> option) {
		super(option);
	}
	...
	@Override protected ModelCheckerV1<CusauthInfo> buildCheckerHook(DeciTreeOption<CusauthInfo> option) {
		...
		checker = new CusauthCheckAuthOwner(checkerOption);
		queue.add(checker);
	...
	@Override protected List<ActionStdV1<CusauthInfo>> buildActionsOnPassedHook(DeciTreeOption<CusauthInfo> option) {
		...
		ActionStdV1<CusauthInfo> success = new StdCusauthSuccess(option);
	...
	@Override protected List<ActionStdV1<CusauthInfo>> buildActionsOnFailedHook(DeciTreeOption<CusauthInfo> option) {
		...
		ActionStdV1<CusauthInfo> nodeL4 = new NodeCusauthSelectL4(option).toAction();
