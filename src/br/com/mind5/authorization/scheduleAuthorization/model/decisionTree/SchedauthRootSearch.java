...
public final class SchedauthRootSearch extends DeciTreeTemplateWrite<SchedauthInfo> {
	
	public SchedauthRootSearch(DeciTreeOption<SchedauthInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedauthInfo>> buildActionsOnPassedHook(DeciTreeOption<SchedauthInfo> option) {
		...
		ActionStd<SchedauthInfo> nodeL1 = new SchedauthNodeSearchL1(option).toAction();
