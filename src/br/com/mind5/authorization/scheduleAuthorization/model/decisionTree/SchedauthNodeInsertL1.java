...
public final class SchedauthNodeInsertL1 extends DeciTreeTemplateWrite<SchedauthInfo> {
	
	public SchedauthNodeInsertL1(DeciTreeOption<SchedauthInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SchedauthInfo>> buildActionsOnFailedHook(DeciTreeOption<SchedauthInfo> option) {
		...
		ActionStd<SchedauthInfo> nodeL2 = new SchedauthNodeInsertL2(option).toAction();	
