...
public final class StorauthNodeSelectL1 extends DeciTreeTemplateWrite<StorauthInfo> {
	
	public StorauthNodeSelectL1(DeciTreeOption<StorauthInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorauthInfo>> buildActionsOnFailedHook(DeciTreeOption<StorauthInfo> option) {
		...
		ActionStd<StorauthInfo> nodeL2 = new StorauthNodeSelectL2(option).toAction();
