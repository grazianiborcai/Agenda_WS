...
public final class StorauthNodeSelectL3 extends DeciTreeTemplateWrite<StorauthInfo> {
	
	public StorauthNodeSelectL3(DeciTreeOption<StorauthInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StorauthInfo>> buildActionsOnFailedHook(DeciTreeOption<StorauthInfo> option) {
		...
		ActionStd<StorauthInfo> nodeL4 = new StorauthNodeSelectL4(option).toAction();
