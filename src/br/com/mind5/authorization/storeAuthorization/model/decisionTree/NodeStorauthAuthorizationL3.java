...
public final class NodeStorauthAuthorizationL3 extends DeciTreeTemplateWrite<StorauthInfo> {
	
	public NodeStorauthAuthorizationL3(DeciTreeOption<StorauthInfo> option) {
		super(option);
	}
