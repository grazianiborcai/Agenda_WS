...
import br.com.mind5.authorization.storeAuthorization.model.action.StorauthVisiNodeAuthorizationL1;
...
public final class StorauthRootAuthorization extends DeciTreeTemplateWrite<StorauthInfo> {
	...
	@Override protected List<ActionStd<StorauthInfo>> buildActionsOnPassedHook(DeciTreeOption<StorauthInfo> option) {
		...
		ActionLazy<StorauthInfo> nodeL1 = new ActionLazyCommom<StorauthInfo>(option, StorauthVisiNodeAuthorizationL1.class);	
