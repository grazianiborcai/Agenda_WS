...
public final class SytotauhCheckExist extends ModelCheckerTemplateActionV2<SytotauhInfo, SytotauhInfo> {
	...
	@Override protected ActionStdV1<SytotauhInfo> buildActionHook(DeciTreeOption<SytotauhInfo> option) {
		ActionStdV1<SytotauhInfo> select = new RootSytotauhAuth(option).toAction();
		return select;
	}
