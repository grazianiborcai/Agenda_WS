...
public final class SytotauhNodeAuthL1 extends DeciTreeTemplateWrite<SytotauhInfo> {
	
	public SytotauhNodeAuthL1(DeciTreeOption<SytotauhInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SytotauhInfo>> buildActionsOnPassedHook(DeciTreeOption<SytotauhInfo> option) {
		...
		ActionStd<SytotauhInfo> nodeL2 = new SytotauhNodeAuthL2(option).toAction();
