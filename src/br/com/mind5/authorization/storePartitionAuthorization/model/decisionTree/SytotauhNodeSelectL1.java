...
public final class SytotauhNodeSelectL1 extends DeciTreeTemplateWrite<SytotauhInfo> {
	
	public SytotauhNodeSelectL1(DeciTreeOption<SytotauhInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SytotauhInfo>> buildActionsOnPassedHook(DeciTreeOption<SytotauhInfo> option) {
		...
		ActionStd<SytotauhInfo> nodeL2 = new SytotauhNodeSelectL2(option).toAction();
