...
public final class LazyMatbcinNodeInsertL2 extends ActionLazyTemplateV2<MatbcinInfo, MatbcinInfo> {
	...
	@Override protected ActionStdV1<MatbcinInfo> getInstanceOfActionHook(DeciTreeOption<MatbcinInfo> option) {
