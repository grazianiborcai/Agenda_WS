...
import br.com.mind5.businessContent.material.petShop.model.decisionTree.NodeMatbcetInsertL07;
import br.com.mind5.model.action.ActionLazyTemplateV2;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyMatbcetNodeInsertL07 extends ActionLazyTemplateV2<MatbcetInfo, MatbcetInfo> {
	
	public LazyMatbcetNodeInsertL07(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MatbcetInfo> getInstanceOfActionHook(DeciTreeOption<MatbcetInfo> option) {
		return new NodeMatbcetInsertL07(option).toAction();
	}
