...
public final class NodeMatbcetInsertL05 extends DeciTreeTemplateWrite<MatbcetInfo> {
	...
	@Override protected List<ActionStd<MatbcetInfo>> buildActionsOnPassedHook(DeciTreeOption<MatbcetInfo> option) {
		...
		ActionStd<MatbcetInfo> enforceDogHaircutScissor = new StdMatbcetEnforceDogHaircutScissor(option);	
