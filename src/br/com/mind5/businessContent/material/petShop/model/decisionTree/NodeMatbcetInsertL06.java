...
public final class NodeMatbcetInsertL06 extends DeciTreeTemplateWrite<MatbcetInfo> {
	...
	@Override protected List<ActionStd<MatbcetInfo>> buildActionsOnPassedHook(DeciTreeOption<MatbcetInfo> option) {
		...
		ActionStd<MatbcetInfo> enforceCatHaircutScissor = new StdMatbcetEnforceCatHaircutScissor(option);	
