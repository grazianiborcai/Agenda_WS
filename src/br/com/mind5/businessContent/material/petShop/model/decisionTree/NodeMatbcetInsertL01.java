...
public final class NodeMatbcetInsertL01 extends DeciTreeTemplateWrite<MatbcetInfo> {
	...
	@Override protected List<ActionStd<MatbcetInfo>> buildActionsOnPassedHook(DeciTreeOption<MatbcetInfo> option) {
		...
		ActionStd<MatbcetInfo> enforceDogBathing = new StdMatbcetEnforceDogBathing(option);	
