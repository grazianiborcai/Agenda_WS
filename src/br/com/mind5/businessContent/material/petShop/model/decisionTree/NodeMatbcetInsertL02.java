...
public final class NodeMatbcetInsertL02 extends DeciTreeTemplateWrite<MatbcetInfo> {
	...
	@Override protected List<ActionStd<MatbcetInfo>> buildActionsOnPassedHook(DeciTreeOption<MatbcetInfo> option) {
		...
		ActionStd<MatbcetInfo> enforceCatBathing = new StdMatbcetEnforceCatBathing(option);	
