...
public final class NodeMatbcetInsertL04 extends DeciTreeTemplateWrite<MatbcetInfo> {
	...
	@Override protected List<ActionStd<MatbcetInfo>> buildActionsOnPassedHook(DeciTreeOption<MatbcetInfo> option) {
		...
		ActionStd<MatbcetInfo> enforceCatHaircut = new StdMatbcetEnforceCatHaircut(option);	
		ActionLazy<MatbcetInfo> insertMat = new LazyMatbcetMatInsert(option.conn, option.schemaName);	
		ActionLazy<MatbcetInfo> nodeL05 = new LazyMatbcetNodeInsertL05(option.conn, option.schemaName);
