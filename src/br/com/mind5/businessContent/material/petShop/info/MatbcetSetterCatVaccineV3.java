...
public final class MatbcetSetterCatVaccineV3 extends InfoSetterTemplate<MatbcetInfo> {
	...
	private MatextInfo getTextPt(MatbcetInfo recordInfo) {
		...
		result.description = "Combate Calicevirus, panleucopenia felina e rinotrqueite. Primeira dose com 45 dias, segunda com 75 dias e terceira com 105 dias. Demais reforços anualmente.";
	...
	private MatextInfo getTextEn(MatbcetInfo recordInfo) {
		...
		result.description = "Prevents Calicevirus, panleukopenia, and rhinotracheitis of cats. First dose can be administered as early as 45 days, second dose as 75 days, third dose as 105 days. Subsequent doses annually.";
