...
public final class MatbcetSetterDogWalkShort extends InfoSetterTemplate<MatbcetInfo> {
	...
	private MatextInfo getTextPt(MatbcetInfo recordInfo) {
		...
		result.description = "Passeio rápido para ajuda a manter a saúde do seu cão em dia e a combater ansiedade e depressão.";
	...
	private MatextInfo getTextEn(MatbcetInfo recordInfo) {
		...
		result.description = "Quick walk to help keep your dog healthy and fight anxiety and depression.";
