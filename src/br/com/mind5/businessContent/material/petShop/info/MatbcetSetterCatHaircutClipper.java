...
public final class MatbcetSetterCatHaircutClipper extends InfoSetterTemplate<MatbcetInfo> {
	...
	private MatextInfo getTextPt(MatbcetInfo recordInfo) {
		...
		result.txtMat = "Tosa Felina na Máquina";
	...
	private MatextInfo getTextEn(MatbcetInfo recordInfo) {
		...
		result.codOwner = recordInfo.codOwner;
		result.txtMat = "Cat Haircut with Clippers Only";
