...
public final class MatbcetSetterCatVaccineV5 extends InfoSetterTemplate<MatbcetInfo> {
	...
	private MatextInfo getTextPt(MatbcetInfo recordInfo) {
		...
		result.description = "Combate Calicevirus, panleucopenia felina, rinotrqueite, clamidiose e leucemia felina. Primeira dose com 45 dias, segunda com 75 dias e terceira com 105 dias. Demais reforços anualmente.";
	...
	private MatextInfo getTextEn(MatbcetInfo recordInfo) {
		...
		result.description = "Prevents Calicevirus, panleukopenia, rhinotracheitis, chlamydiosis, and leukemia of cats. First dose can be administered as early as 45 days, second dose as 75 days, third dose as 105 days. Subsequent doses annually.";
