...
public final class MatbcetSetterDogVaccineV8 extends InfoSetterTemplate<MatbcetInfo> {
	...
	private MatextInfo getTextPt(MatbcetInfo recordInfo) {
		...
		result.txtMat = "Vacina V8";
		result.description = "Combate Cinomose, Parvirose e Coronavirose, hepatite, leptospirose e parainlfuenza. Primeira dose com 45 dias, segunda com 75 dias e terceira com 105 dias. Demais reforços anualmente.";
