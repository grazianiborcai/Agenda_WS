package br.com.mind5.json.webhook.moipRefund;
...
public class JwokefumoipBodyParser<T> extends JsonBodyParserTemplate<T> {
	
	public JwokefumoipBodyParser(Class<T> tClazz) {
		super(JwokefumoipBodyParser.class, tClazz);
	}
    ...
    private String getSection(String incomingData) {
		...
		return object.getAsJsonObject("resource").get("refund")
	                 .getAsJsonObject().get("_links")
	                 .getAsJsonObject().get("payment")
	                 .toString();
    }
}
