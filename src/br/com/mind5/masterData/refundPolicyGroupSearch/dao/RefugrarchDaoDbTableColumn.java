...
public final class RefugrarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public RefugrarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.REFUND_POLICY_GROUP_HEADER_TABLE;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = DaoDbTable.REFUND_POLICY_GROUP_TEXT_TABLE;
		...
		results.put(DaoDbTable.REFUND_POLICY_GROUP_HEADER_SEARCH_VIEW, columns);
		return results;
	}
}
