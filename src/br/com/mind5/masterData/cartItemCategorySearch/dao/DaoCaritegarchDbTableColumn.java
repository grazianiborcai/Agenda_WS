...
public final class DaoCaritegarchDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public DaoCaritegarchDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.CART_ITM_CATEG_SEARCH_VIEW, columns);
		return results;
	}
}
