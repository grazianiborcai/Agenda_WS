...
import br.com.mind5.masterData.materialGroup.model.action.MatoupVisiMergeMatouparch;
...
public final class MatoupRootSearch extends DeciTreeTemplateRead<MatoupInfo> {
	
	public MatoupRootSearch(DeciTreeOption<MatoupInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatoupInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoupInfo> option) {
		...
		ActionStd<MatoupInfo> mergeMatouparch = new ActionStdCommom<MatoupInfo>(option, MatoupVisiMergeMatouparch.class);
