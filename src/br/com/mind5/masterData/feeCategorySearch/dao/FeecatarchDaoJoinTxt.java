...
public final class FeecatarchDaoJoinTxt implements DaoJoinBuilder {
	private final String leftTable;
	
	
	public FeecatarchDaoJoinTxt(String leftTableName) {
	...
	@Override public DaoJoin build() {
		...
		helper.addColumn(DaoDbField.COL_COD_FEE_CATEG);	
		helper.addJoinType(DaoJoinType.LEFT_OUTER_JOIN);		
		helper.addLeftTable(leftTable);
		helper.addRightTable(DaoDbTable.FEE_CATEG_TEXT_TABLE);
