...
public final class PayparultDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public PayparultDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.PAY_PARTNER_DEFAULT_VIEW, columns);
		return results;
	}
}
