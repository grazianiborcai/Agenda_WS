...
public final class DaoOrderatarchDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public DaoOrderatarchDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.ORDER_STATUS_SEARCH_VIEW, columns);
		return results;
	}
}
