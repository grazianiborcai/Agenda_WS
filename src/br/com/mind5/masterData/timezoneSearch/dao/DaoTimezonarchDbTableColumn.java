...
public final class DaoTimezonarchDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public DaoTimezonarchDbTableColumn() {
		super(DaoTimezonarchDbTableColumn.class);
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.TIMEZONE_SEARCH_VIEW, columns);
		return results;
	}
}
