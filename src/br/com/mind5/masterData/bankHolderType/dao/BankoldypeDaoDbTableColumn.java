...
public final class BankoldypeDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public BankoldypeDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.BANK_HOLDER_TYPE_TABLE;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = DaoDbTable.BANK_HOLDER_TYPE_TEXT_TABLE;
