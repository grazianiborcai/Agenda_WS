...
public final class BankacyperchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public BankacyperchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.BANK_ACCOUNT_TYPE_SEARCH_VIEW, columns);
		return results;
	}
}
