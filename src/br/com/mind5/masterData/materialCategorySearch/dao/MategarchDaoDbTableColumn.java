...
public final class MategarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public MategarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.MAT_CATEG_SEARCH_VIEW, columns);
		return results;
	}
}
