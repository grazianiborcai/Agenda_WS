...
public final class DaoProstarchDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public DaoProstarchDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.PROSPECT_STATUS_TABLE;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = DaoDbTable.PROSPECT_STATUS_TEXT_TABLE;
		...
		results.put(DaoDbTable.PROSPECT_STATUS_SEARCH_VIEW, columns);
		return results;
	}
}
