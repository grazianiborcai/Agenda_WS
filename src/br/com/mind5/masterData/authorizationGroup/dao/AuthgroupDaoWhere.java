...
public final class AuthgroupDaoWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public AuthgroupDaoWhere(DaoWhereBuilderOption whereOption, String tableName, AuthgroupInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, AuthgroupInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case AuthgroupDaoDbTableColumn.COL_COD_AUTH_GROUP :
