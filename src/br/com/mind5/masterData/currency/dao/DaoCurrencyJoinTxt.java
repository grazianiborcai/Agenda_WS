...
public final class DaoCurrencyJoinTxt implements DaoJoinBuilder {
	private final String leftTable;
	
	
	public DaoCurrencyJoinTxt(String leftTableName) {
	...
	@Override public DaoJoin build() {
		...
		helper.addColumn(DaoDbField.COL_COD_CURRENCY);	
		helper.addJoinType(DaoJoinType.LEFT_OUTER_JOIN);		
		helper.addLeftTable(leftTable);
		helper.addRightTable(DaoDbTable.CURRENCY_TEXT_TABLE);
