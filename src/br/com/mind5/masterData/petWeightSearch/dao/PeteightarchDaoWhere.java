...
final class PeteightarchDaoWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public PeteightarchDaoWhere(DaoWhereBuilderOption whereOption, String tableName, PeteightarchInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, PeteightarchInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {
			switch(eachColumn.columnName) {
				case PeteightarchDaoDbTableColumn.COL_COD_PET_WEIGHT :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codPeteight));
					break;
					
					
				case PeteightarchDaoDbTableColumn.COL_COD_LANGUAGE :
