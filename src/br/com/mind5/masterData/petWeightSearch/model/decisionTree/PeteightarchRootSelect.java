...
import br.com.mind5.masterData.petWeightSearch.model.action.PeteightarchVisiDaoSelect;
...
public final class PeteightarchRootSelect extends DeciTreeTemplateWrite<PeteightarchInfo> {
	
	public PeteightarchRootSelect(DeciTreeOption<PeteightarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PeteightarchInfo>> buildActionsOnPassedHook(DeciTreeOption<PeteightarchInfo> option) {
		...
		ActionStd<PeteightarchInfo> select = new ActionStdCommom<PeteightarchInfo>(option, PeteightarchVisiDaoSelect.class);
