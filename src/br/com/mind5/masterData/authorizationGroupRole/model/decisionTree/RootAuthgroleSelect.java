...
public final class RootAuthgroleSelect extends DeciTreeTemplateReadV2<AuthgroleInfo> {
	...
	@Override protected List<ActionStdV2<AuthgroleInfo>> buildActionsOnPassedHook(DeciTreeOption<AuthgroleInfo> option) {
		List<ActionStdV2<AuthgroleInfo>> actions = new ArrayList<>();
		
		ActionStdV2<AuthgroleInfo> select = new StdAuthgroleDaoSelect(option);
