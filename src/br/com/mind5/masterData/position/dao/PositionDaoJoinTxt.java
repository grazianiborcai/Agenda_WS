...
public final class PositionDaoJoinTxt implements DaoJoinBuilder {
	private final String leftTable;
	
	
	public PositionDaoJoinTxt(String leftTableName) {
	...
	@Override public DaoJoin build() {
		...
		helper.addColumn(DaoDbField.COL_COD_POSITION);	
		helper.addJoinType(DaoJoinType.INNER_JOIN);		
		helper.addLeftTable(leftTable);
		helper.addRightTable(DaoDbTable.POSITION_TEXT_TABLE);
