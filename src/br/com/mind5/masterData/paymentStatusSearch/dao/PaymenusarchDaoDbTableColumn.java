...
public final class PaymenusarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public PaymenusarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.PAYMENT_STATUS_SEARCH_VIEW, columns);
		return results;
	}
}
