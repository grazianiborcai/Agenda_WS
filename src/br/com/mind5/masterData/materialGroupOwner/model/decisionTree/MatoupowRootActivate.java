...
public final class MatoupowRootActivate extends DeciTreeTemplateWrite<MatoupowInfo> {
	
	public MatoupowRootActivate(DeciTreeOption<MatoupowInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatoupowInfo>> buildActionsOnPassedHook(DeciTreeOption<MatoupowInfo> option) {
		...
		ActionStd<MatoupowInfo> nodeL1 = new MatoupowNodeActivate(option).toAction();
