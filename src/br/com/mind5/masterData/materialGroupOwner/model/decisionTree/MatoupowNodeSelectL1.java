...
import br.com.mind5.masterData.materialGroupOwner.model.action.MatoupowVisiNodeSelectL2;
...
public final class MatoupowNodeSelectL1 extends DeciTreeTemplateRead<MatoupowInfo> {
	
	public MatoupowNodeSelectL1(DeciTreeOption<MatoupowInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<MatoupowInfo>> buildActionsOnFailedHook(DeciTreeOption<MatoupowInfo> option) {
		...
		ActionStd<MatoupowInfo> nodeL2 = new ActionStdCommom<MatoupowInfo>(option, MatoupowVisiNodeSelectL2.class);
