...
public final class MatoupowVisiMergeToSelect extends ActionVisitorTemplateMerge<MatoupowInfo, MatoupowInfo> {
	
	public MatoupowVisiMergeToSelect(DeciTreeOption<MatoupowInfo> option) {
	...
	@Override protected List<MatoupowInfo> mergeHook(List<MatoupowInfo> baseInfos, List<MatoupowInfo> selectedInfos) {	
		return MatoupowMerger.mergeToSelect(baseInfos, selectedInfos);
	}
