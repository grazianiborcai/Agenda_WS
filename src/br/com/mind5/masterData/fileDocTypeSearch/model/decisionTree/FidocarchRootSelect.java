...
import br.com.mind5.masterData.fileDocTypeSearch.model.action.FidocarchVisiDaoSelect;
...
public final class FidocarchRootSelect extends DeciTreeTemplateRead<FidocarchInfo> {
	
	public FidocarchRootSelect(DeciTreeOption<FidocarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FidocarchInfo>> buildActionsOnPassedHook(DeciTreeOption<FidocarchInfo> option) {
		...
		ActionStd<FidocarchInfo> select = new ActionStdCommom<FidocarchInfo>(option, FidocarchVisiDaoSelect.class);
