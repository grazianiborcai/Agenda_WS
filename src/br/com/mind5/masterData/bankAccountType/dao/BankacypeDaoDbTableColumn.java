...
public final class BankacypeDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public BankacypeDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.BANK_ACCOUNT_TYPE_TABLE;
