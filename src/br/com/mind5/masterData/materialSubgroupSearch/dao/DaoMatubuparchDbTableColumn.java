...
public final class DaoMatubuparchDbTableColumn extends DaoDbTableColumnTemplate {	
	...
	public DaoMatubuparchDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.MAT_SUBGROUP_TABLE;
		...
		oneColumn.columnName = COL_COD_MAT_SUBGROUP;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = DaoDbTable.MAT_SUBGROUP_TEXT_TABLE;
		...
		results.put(DaoDbTable.MAT_SUBGROUP_SEARCH_VIEW, columns);
		return results;
	}
}
