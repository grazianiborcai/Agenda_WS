...
final class BusarearchDaoWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public BusarearchDaoWhere(DaoWhereBuilderOption whereOption, String tableName, BusarearchInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, BusarearchInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {
			switch(eachColumn.columnName) {
				case BusarearchDaoDbTableColumn.COL_COD_BUSINESS :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codBusiness));
					break;
					
				case BusarearchDaoDbTableColumn.COL_COD_LANGUAGE :
