...
public final class LangarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public LangarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.LANGUAGE_SEARCH_VIEW, columns);
		return results;
	}
}
