...
public final class EmulonInfo extends InfoRecord implements Cloneable {
	...
	public static EmulonInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, EmulonInfo.class);
	}
	
	
	
	public static List<EmulonInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, EmulonInfo.class);
	}	
	
	
	
	@Override public Object clone() throws CloneNotSupportedException {
		EmulonInfo deepCopy = (EmulonInfo) super.clone();
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof EmulonInfo))
			return false;
		
		
		EmulonInfo obj = (EmulonInfo) o;		
