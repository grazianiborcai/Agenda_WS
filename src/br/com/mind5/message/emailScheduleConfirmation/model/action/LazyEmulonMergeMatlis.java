...
public final class LazyEmulonMergeMatlis extends ActionLazyTemplateV2<EmulonInfo, EmulonInfo> {

	public LazyEmulonMergeMatlis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmulonInfo> getInstanceOfActionHook(DeciTreeOption<EmulonInfo> option) {
		return new StdEmulonMergeMatlis(option);
	}
