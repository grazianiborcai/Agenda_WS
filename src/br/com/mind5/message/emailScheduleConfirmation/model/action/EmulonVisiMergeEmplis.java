...
public final class EmulonVisiMergeEmplis extends ActionVisitorTemplateMerge<EmulonInfo, EmplisInfo> {
	
	public EmulonVisiMergeEmplis(DeciTreeOption<EmulonInfo> option) {
