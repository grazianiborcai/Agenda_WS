...
public final class EmaproreVisiSendEmail extends ActionVisitorTemplateAction<EmaproreInfo, EmailInfo> {
	
	public EmaproreVisiSendEmail(DeciTreeOption<EmaproreInfo> option) {
