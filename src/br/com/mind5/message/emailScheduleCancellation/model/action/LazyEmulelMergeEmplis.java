...
public final class LazyEmulelMergeEmplis extends ActionLazyTemplateV2<EmulelInfo, EmulelInfo> {

	public LazyEmulelMergeEmplis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmulelInfo> getInstanceOfActionHook(DeciTreeOption<EmulelInfo> option) {
		return new StdEmulelMergeEmplis(option);
	}
