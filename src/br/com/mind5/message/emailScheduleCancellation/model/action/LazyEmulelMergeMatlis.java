...
public final class LazyEmulelMergeMatlis extends ActionLazyTemplateV2<EmulelInfo, EmulelInfo> {

	public LazyEmulelMergeMatlis(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmulelInfo> getInstanceOfActionHook(DeciTreeOption<EmulelInfo> option) {
		return new StdEmulelMergeMatlis(option);
	}
