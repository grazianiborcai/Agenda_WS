...
public final class EmulelVisiMergeStolis extends ActionVisitorTemplateMerge<EmulelInfo, StolisInfo> {
	
	public EmulelVisiMergeStolis(DeciTreeOption<EmulelInfo> option) {
