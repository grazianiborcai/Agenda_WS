...
final class EmailDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public EmailDaoWhere(DaoWhereBuilderOption whereOption, String tableName, EmailInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, EmailInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case EmailDaoDbTableColumn.COL_SMTP_HOST_NAME :
