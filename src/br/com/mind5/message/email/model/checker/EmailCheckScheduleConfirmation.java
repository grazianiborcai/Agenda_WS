...
public final class EmailCheckScheduleConfirmation extends ModelCheckerTemplateSimpleV2<EmailInfo> {

	public EmailCheckScheduleConfirmation(ModelCheckerOption option) {
		super(option);
	}
