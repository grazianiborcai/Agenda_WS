...
public final class RootEmailProspectStore extends DeciTreeTemplateWriteV2<EmailInfo> {
	...
	@Override protected List<ActionStdV1<EmailInfo>> buildActionsOnPassedHook(DeciTreeOption<EmailInfo> option) {
		...
		ActionLazyV1<EmailInfo> enforceProspectStore = new LazyEmailEnforceProspectStore(option.conn, option.schemaName);
