...
import br.com.mind5.message.email.model.action.EmailVisiEnforcePasswordChange;
...
public final class EmailRootPasswordChange extends DeciTreeTemplateWrite<EmailInfo> {
	
	public EmailRootPasswordChange(DeciTreeOption<EmailInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmailInfo>> buildActionsOnPassedHook(DeciTreeOption<EmailInfo> option) {
		...
		ActionLazy<EmailInfo> enforceWelcome = new ActionLazyCommom<EmailInfo>(option, EmailVisiEnforcePasswordChange.class);
