...
import br.com.mind5.message.email.model.action.EmailVisiEnforceUserOtp;
...
public final class EmailRootUserOtp extends DeciTreeTemplateWrite<EmailInfo> {
	
	public EmailRootUserOtp(DeciTreeOption<EmailInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<EmailInfo>> buildActionsOnPassedHook(DeciTreeOption<EmailInfo> option) {
		...
		ActionLazy<EmailInfo> enforceUserOtp = new ActionLazyCommom<EmailInfo>(option, EmailVisiEnforceUserOtp.class);
