...
public final class EmailVisiEnforceUserOtp extends ActionVisitorTemplateEnforce<EmailInfo> {
	
	public EmailVisiEnforceUserOtp(DeciTreeOption<EmailInfo> option) {
		super(option);
	}
