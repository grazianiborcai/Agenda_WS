...
public final class LazyEmailEnforceProspectStore extends ActionLazyTemplateV2<EmailInfo, EmailInfo> {

	public LazyEmailEnforceProspectStore(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmailInfo> getInstanceOfActionHook(DeciTreeOption<EmailInfo> option) {
		return new StdEmailEnforceProspectStore(option);
	}
