...
public final class LazyEmailSendMessage extends ActionLazyTemplateV2<EmailInfo, EmailInfo> {

	public LazyEmailSendMessage(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmailInfo> getInstanceOfActionHook(DeciTreeOption<EmailInfo> option) {
		return new StdEmailSendMessage(option);
	}
