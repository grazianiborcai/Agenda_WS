...
public final class LazyEmailEnforceWelcome extends ActionLazyTemplateV2<EmailInfo, EmailInfo> {

	public LazyEmailEnforceWelcome(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<EmailInfo> getInstanceOfActionHook(DeciTreeOption<EmailInfo> option) {
		return new StdEmailEnforceWelcome(option);
	}
