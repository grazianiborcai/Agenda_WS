...
public final class TokemoipCheckUsername extends ModelCheckerTemplateForwardV2<TokemoipInfo, UsernameInfo> {
	...
	@Override protected UsernameInfo toForwardClass(TokemoipInfo baseRecord) {
		return UsernameCopier.copyFromTokemoip(baseRecord);
	}
}
