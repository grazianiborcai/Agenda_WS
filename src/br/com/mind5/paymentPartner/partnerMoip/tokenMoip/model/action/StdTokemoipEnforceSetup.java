...
public final class StdTokemoipEnforceSetup implements ActionStdV1<TokemoipInfo> {
	private ActionStdV1<TokemoipInfo> actionHelper;	
	
	
	public StdTokemoipEnforceSetup(DeciTreeOption<TokemoipInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiTokemoipEnforceSetup());
	}
