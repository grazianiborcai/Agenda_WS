...
public final class StdRefumoipMergePayordemist implements ActionStdV1<RefumoipInfo> {
	private ActionStdV1<RefumoipInfo> actionHelper;	
	
	
	public StdRefumoipMergePayordemist(DeciTreeOption<RefumoipInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiRefumoipMergePayordemist(option.conn, option.schemaName));
	}
