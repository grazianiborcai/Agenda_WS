...
public final class RefumoipVisiEnforceSetupNonsys extends ActionVisitorTemplateEnforce<RefumoipInfo> {
	
	public RefumoipVisiEnforceSetupNonsys(DeciTreeOption<RefumoipInfo> option) {
		super(option);
	}
