...
public final class LazyAccemoipEnforceScopes extends ActionLazyTemplateV2<AccemoipInfo, AccemoipInfo> {
	
	public LazyAccemoipEnforceScopes(Connection conn, String schemaName) {
