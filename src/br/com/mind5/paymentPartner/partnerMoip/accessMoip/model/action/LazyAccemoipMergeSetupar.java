...
public final class LazyAccemoipMergeSetupar extends ActionLazyTemplateV2<AccemoipInfo, AccemoipInfo> {
	
	public LazyAccemoipMergeSetupar(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AccemoipInfo> getInstanceOfActionHook(DeciTreeOption<AccemoipInfo> option) {
		return new StdAccemoipMergeSetupar(option);
	}
