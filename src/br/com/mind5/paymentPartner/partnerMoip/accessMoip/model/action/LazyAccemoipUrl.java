...
public final class LazyAccemoipUrl extends ActionLazyTemplateV2<AccemoipInfo, AccemoipInfo> {

	public LazyAccemoipUrl(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AccemoipInfo> getInstanceOfActionHook(DeciTreeOption<AccemoipInfo> option) {
		return new StdAccemoipUrl(option);
	}
