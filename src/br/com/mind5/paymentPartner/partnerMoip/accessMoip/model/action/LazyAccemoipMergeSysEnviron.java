...
public final class LazyAccemoipMergeSysEnviron extends ActionLazyTemplateV1<AccemoipInfo, AccemoipInfo> {
	
	public LazyAccemoipMergeSysEnviron(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<AccemoipInfo> getInstanceOfActionHook(DeciTreeOption<AccemoipInfo> option) {
		return new StdAccemoipMergeSysEnviron(option);
	}
