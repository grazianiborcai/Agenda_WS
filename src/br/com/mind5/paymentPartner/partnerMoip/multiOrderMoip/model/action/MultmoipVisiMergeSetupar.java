...
public final class MultmoipVisiMergeSetupar extends ActionVisitorTemplateMerge<MultmoipInfo, SetuparInfo> {
	
	public MultmoipVisiMergeSetupar(DeciTreeOption<MultmoipInfo> option) {
