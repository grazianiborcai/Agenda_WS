...
public final class LazyMultmoipMergeSysEnviron extends ActionLazyTemplateV1<MultmoipInfo, MultmoipInfo> {

	public LazyMultmoipMergeSysEnviron(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<MultmoipInfo> getInstanceOfActionHook(DeciTreeOption<MultmoipInfo> option) {
		return new StdMultmoipMergeSysEnviron(option);
	}
