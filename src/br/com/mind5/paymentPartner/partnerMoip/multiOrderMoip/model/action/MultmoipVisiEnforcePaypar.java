...
public final class MultmoipVisiEnforcePaypar extends ActionVisitorTemplateEnforce<MultmoipInfo> {
	
	public MultmoipVisiEnforcePaypar(DeciTreeOption<MultmoipInfo> option) {
		super(option);
	}
