...
public final class MultmoipVisiEnforceSetup extends ActionVisitorTemplateEnforce<MultmoipInfo> {
	
	public MultmoipVisiEnforceSetup(DeciTreeOption<MultmoipInfo> option) {
		super(option);
	}
