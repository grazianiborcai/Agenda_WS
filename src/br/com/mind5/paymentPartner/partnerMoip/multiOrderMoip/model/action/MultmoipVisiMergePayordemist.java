...
public final class MultmoipVisiMergePayordemist extends ActionVisitorTemplateMerge<MultmoipInfo, PayordemistInfo> {
	
	public MultmoipVisiMergePayordemist(DeciTreeOption<MultmoipInfo> option) {
