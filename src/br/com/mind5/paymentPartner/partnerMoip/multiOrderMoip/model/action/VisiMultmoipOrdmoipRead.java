...
final class VisiMultmoipOrdmoipRead extends ActionVisitorTemplateActionV2<MultmoipInfo, OrdmoipInfo> {

	public VisiMultmoipOrdmoipRead(DeciTreeOption<MultmoipInfo> option) {
