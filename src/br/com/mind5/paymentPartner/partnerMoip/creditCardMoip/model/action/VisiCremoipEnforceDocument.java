...
final class VisiCremoipEnforceDocument extends ActionVisitorTemplateEnforceV2<CremoipInfo> {
	
	public VisiCremoipEnforceDocument(DeciTreeOption<CremoipInfo> option) {
		super(option);
	}
