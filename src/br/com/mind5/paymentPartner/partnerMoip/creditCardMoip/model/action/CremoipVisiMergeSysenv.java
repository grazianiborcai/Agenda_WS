...
public final class CremoipVisiMergeSysenv extends ActionVisitorTemplateMerge<CremoipInfo, SysenvInfo> {
	
	public CremoipVisiMergeSysenv(DeciTreeOption<CremoipInfo> option) {
