...
public final class LazyCremoipDelete extends ActionLazyTemplateV1<CremoipInfo, CremoipInfo> {

	public LazyCremoipDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CremoipInfo> getInstanceOfActionHook(DeciTreeOption<CremoipInfo> option) {
		return new StdCremoipDelete(option);
	}
