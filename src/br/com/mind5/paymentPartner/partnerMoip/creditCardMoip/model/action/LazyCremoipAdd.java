...
public final class LazyCremoipAdd extends ActionLazyTemplateV2<CremoipInfo, CremoipInfo> {

	public LazyCremoipAdd(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CremoipInfo> getInstanceOfActionHook(DeciTreeOption<CremoipInfo> option) {
		return new StdCremoipAdd(option);
	}
