...
final class VisiCremoipMergeAddresnap extends ActionVisitorTemplateMergeV1<CremoipInfo, AddresnapInfo> {
	
	public VisiCremoipMergeAddresnap(Connection conn, String schemaName) {
