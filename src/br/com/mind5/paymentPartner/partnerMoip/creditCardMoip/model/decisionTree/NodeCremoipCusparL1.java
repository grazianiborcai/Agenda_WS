...
public final class NodeCremoipCusparL1 extends DeciTreeTemplateWriteV2<CremoipInfo> {
	...
	@Override protected List<ActionStdV2<CremoipInfo>> buildActionsOnPassedHook(DeciTreeOption<CremoipInfo> option) {
		...
		ActionStdV2<CremoipInfo> mergeCuspar = new StdCremoipMergeCuspar(option);
