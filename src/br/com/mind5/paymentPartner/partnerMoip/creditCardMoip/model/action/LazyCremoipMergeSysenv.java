...
public final class LazyCremoipMergeSysenv extends ActionLazyTemplateV2<CremoipInfo, CremoipInfo> {

	public LazyCremoipMergeSysenv(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CremoipInfo> getInstanceOfActionHook(DeciTreeOption<CremoipInfo> option) {
		return new StdCremoipMergeSysenv(option);
	}
