...
public final class StdCremoipMergeCuspar implements ActionStdV1<CremoipInfo> {
	private ActionStdV1<CremoipInfo> actionHelper;	
	
	
	public StdCremoipMergeCuspar(DeciTreeOption<CremoipInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiCremoipMergeCuspar(option.conn, option.schemaName));
	}
