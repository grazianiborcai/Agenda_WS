...
public final class NodeCremoipSetuparL1 extends DeciTreeTemplateWriteV2<CremoipInfo> {
	...
	@Override protected List<ActionStdV2<CremoipInfo>> buildActionsOnPassedHook(DeciTreeOption<CremoipInfo> option) {
		...
		ActionStdV2<CremoipInfo> enforcePaypar = new StdCremoipEnforcePaypar(option);
