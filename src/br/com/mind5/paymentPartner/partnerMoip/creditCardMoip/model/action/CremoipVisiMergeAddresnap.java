...
public final class CremoipVisiMergeAddresnap extends ActionVisitorTemplateMerge<CremoipInfo, AddresnapInfo> {
	
	public CremoipVisiMergeAddresnap(DeciTreeOption<CremoipInfo> option) {
