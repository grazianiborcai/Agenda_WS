...
import br.com.mind5.paymentPartner.partnerMoip.creditCardMoip.model.action.CremoipVisiEnforceAddress;
...
public final class CremoipNodeAddressL2 extends DeciTreeTemplateWrite<CremoipInfo> {
	
	public CremoipNodeAddressL2(DeciTreeOption<CremoipInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CremoipInfo>> buildActionsOnPassedHook(DeciTreeOption<CremoipInfo> option) {
		...
		ActionStd<CremoipInfo> enforceAddress = new ActionStdCommom<CremoipInfo>(option, CremoipVisiEnforceAddress.class);
