...
public final class LazyCremoipMergeSysEnviron extends ActionLazyTemplateV2<CremoipInfo, CremoipInfo> {

	public LazyCremoipMergeSysEnviron(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CremoipInfo> getInstanceOfActionHook(DeciTreeOption<CremoipInfo> option) {
		return new StdCremoipMergeSysEnviron(option);
	}
