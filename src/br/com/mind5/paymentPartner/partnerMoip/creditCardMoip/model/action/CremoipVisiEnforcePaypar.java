...
public final class CremoipVisiEnforcePaypar extends ActionVisitorTemplateEnforce<CremoipInfo> {
	
	public CremoipVisiEnforcePaypar(DeciTreeOption<CremoipInfo> option) {
		super(option);
	}
