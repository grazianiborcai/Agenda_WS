...
import br.com.mind5.paymentPartner.partnerMoip.creditCardMoip.model.action.CremoipVisiEnforcePhone;
...
public final class CremoipNodePhoneL2 extends DeciTreeTemplateWrite<CremoipInfo> {
	
	public CremoipNodePhoneL2(DeciTreeOption<CremoipInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CremoipInfo>> buildActionsOnPassedHook(DeciTreeOption<CremoipInfo> option) {
		...
		ActionStd<CremoipInfo> enforcePhone = new ActionStdCommom<CremoipInfo>(option, CremoipVisiEnforcePhone.class);
