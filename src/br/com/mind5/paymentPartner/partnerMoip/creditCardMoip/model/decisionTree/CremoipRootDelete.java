...
import br.com.mind5.paymentPartner.partnerMoip.creditCardMoip.model.action.CremoipVisiDelete;
...
public final class CremoipRootDelete extends DeciTreeTemplateWrite<CremoipInfo> {
	
	public CremoipRootDelete(DeciTreeOption<CremoipInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CremoipInfo>> buildActionsOnPassedHook(DeciTreeOption<CremoipInfo> option) {
		...
		ActionStd<CremoipInfo> nodeSetupar = new CremoipNodeSetuparL1(option).toAction();
		ActionLazy<CremoipInfo> nodeCuspar = new ActionLazyCommom<CremoipInfo>(option, CremoipVisiNodeCusparL1.class);
		ActionLazy<CremoipInfo> delete = new ActionLazyCommom<CremoipInfo>(option, CremoipVisiDelete.class);
