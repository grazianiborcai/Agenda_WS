...
import br.com.mind5.paymentPartner.partnerMoip.customerMoip.model.action.CusmoipVisiEnforcePhone;
...
public final class CusmoipNodePhoneL2 extends DeciTreeTemplateWrite<CusmoipInfo> {
	
	public CusmoipNodePhoneL2(DeciTreeOption<CusmoipInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CusmoipInfo>> buildActionsOnPassedHook(DeciTreeOption<CusmoipInfo> option) {
		...
		ActionStd<CusmoipInfo> enforcePhone = new ActionStdCommom<CusmoipInfo>(option, CusmoipVisiEnforcePhone.class);
