...
public final class CusmoipVisiEnforceDocument extends ActionVisitorTemplateEnforce<CusmoipInfo> {
	
	public CusmoipVisiEnforceDocument(DeciTreeOption<CusmoipInfo> option) {
		super(option);
	}
