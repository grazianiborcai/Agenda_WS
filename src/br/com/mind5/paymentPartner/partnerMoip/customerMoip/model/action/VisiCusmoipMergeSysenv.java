...
final class VisiCusmoipMergeSysenv extends ActionVisitorTemplateMerge<CusmoipInfo, SysenvInfo> {
	
	public VisiCusmoipMergeSysenv(DeciTreeOption<CusmoipInfo> option) {
