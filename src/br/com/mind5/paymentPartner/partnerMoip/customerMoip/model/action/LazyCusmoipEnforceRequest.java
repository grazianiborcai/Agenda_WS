...
public final class LazyCusmoipEnforceRequest extends ActionLazyTemplateV1<CusmoipInfo, CusmoipInfo> {

	public LazyCusmoipEnforceRequest(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusmoipInfo> getInstanceOfActionHook(DeciTreeOption<CusmoipInfo> option) {
		return new StdCusmoipEnforceRequest(option);
	}
