...
final class VisiCusmoipEnforceRequest extends ActionVisitorTemplateEnforceV2<CusmoipInfo> {
	
	public VisiCusmoipEnforceRequest(DeciTreeOption<CusmoipInfo> option) {
		super(option);
	}
