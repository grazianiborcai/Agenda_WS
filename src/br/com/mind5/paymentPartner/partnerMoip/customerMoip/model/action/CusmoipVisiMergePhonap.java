...
public final class CusmoipVisiMergePhonap extends ActionVisitorTemplateMerge<CusmoipInfo, PhonapInfo> {
	
	public CusmoipVisiMergePhonap(DeciTreeOption<CusmoipInfo> option) {
