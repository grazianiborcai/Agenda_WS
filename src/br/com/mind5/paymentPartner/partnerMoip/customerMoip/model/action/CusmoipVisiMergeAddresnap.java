...
public final class CusmoipVisiMergeAddresnap extends ActionVisitorTemplateMerge<CusmoipInfo, AddresnapInfo> {
	
	public CusmoipVisiMergeAddresnap(DeciTreeOption<CusmoipInfo> option) {
