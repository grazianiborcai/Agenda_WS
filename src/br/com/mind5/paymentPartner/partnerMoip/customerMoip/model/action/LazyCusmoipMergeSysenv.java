...
public final class LazyCusmoipMergeSysenv extends ActionLazyTemplateV2<CusmoipInfo, CusmoipInfo> {

	public LazyCusmoipMergeSysenv(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusmoipInfo> getInstanceOfActionHook(DeciTreeOption<CusmoipInfo> option) {
		return new StdCusmoipMergeSysenv(option);
	}
