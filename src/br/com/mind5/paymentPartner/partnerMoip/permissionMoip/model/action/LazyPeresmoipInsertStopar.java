...
public final class LazyPeresmoipInsertStopar extends ActionLazyTemplateV1<PeresmoipInfo, PeresmoipInfo> {
	
	public LazyPeresmoipInsertStopar(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PeresmoipInfo> getInstanceOfActionHook(DeciTreeOption<PeresmoipInfo> option) {
		return new StdPeresmoipInsertStopar(option);
	}
