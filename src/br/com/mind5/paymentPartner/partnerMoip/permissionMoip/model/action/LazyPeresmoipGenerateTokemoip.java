...
public final class LazyPeresmoipGenerateTokemoip extends ActionLazyTemplateV1<PeresmoipInfo, PeresmoipInfo> {
	
	public LazyPeresmoipGenerateTokemoip(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PeresmoipInfo> getInstanceOfActionHook(DeciTreeOption<PeresmoipInfo> option) {
		return new StdPeresmoipGenerateTokemoip(option);
	}
