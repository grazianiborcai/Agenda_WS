...
import br.com.mind5.paymentPartner.partnerMoip.permissionMoip.dao.PeresmoipInsert;
import br.com.mind5.paymentPartner.partnerMoip.permissionMoip.info.PeresmoipInfo;

public final class StdPeresmoipInsert implements ActionStdV1<PeresmoipInfo> {
	private ActionStdV1<PeresmoipInfo> actionHelper;
	
	
	public StdPeresmoipInsert(DeciTreeOption<PeresmoipInfo> option) {
	...
	private DaoStmtExec_<PeresmoipInfo> buildStmtExec(DeciTreeOption<PeresmoipInfo> option) {
		...
		return new PeresmoipInsert(stmtExecOptions);
	}
