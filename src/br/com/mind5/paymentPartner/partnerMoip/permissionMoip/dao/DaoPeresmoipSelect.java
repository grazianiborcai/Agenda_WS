...
public final class DaoPeresmoipSelect implements DaoStmtExec<PeresmoipInfo> {
	private DaoStmtExec<PeresmoipInfo> helper;
	
	
	public DaoPeresmoipSelect(List<DaoStmtExecOption<PeresmoipInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoPeresmoipSelectSingle.class, PeresmoipInfo.class);
	}
