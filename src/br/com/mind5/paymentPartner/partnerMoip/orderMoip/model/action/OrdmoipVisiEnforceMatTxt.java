...
public final class OrdmoipVisiEnforceMatTxt extends ActionVisitorTemplateEnforce<OrdmoipInfo> {
	
	public OrdmoipVisiEnforceMatTxt(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
