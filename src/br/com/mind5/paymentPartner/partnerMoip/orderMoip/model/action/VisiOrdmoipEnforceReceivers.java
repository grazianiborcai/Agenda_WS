...
final class VisiOrdmoipEnforceReceivers extends ActionVisitorTemplateEnforceV2<OrdmoipInfo> {
	
	public VisiOrdmoipEnforceReceivers(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
