...
public final class OrdmoipVisiEnforceReceiverStore extends ActionVisitorTemplateEnforce<OrdmoipInfo> {
	
	public OrdmoipVisiEnforceReceiverStore(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
