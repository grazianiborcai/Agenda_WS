...
final class VisiOrdmoipEnforceSetup extends ActionVisitorTemplateEnforceV2<OrdmoipInfo> {
	
	public VisiOrdmoipEnforceSetup(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
