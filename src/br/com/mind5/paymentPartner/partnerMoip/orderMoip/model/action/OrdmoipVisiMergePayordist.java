...
public final class OrdmoipVisiMergePayordist extends ActionVisitorTemplateMerge<OrdmoipInfo, PayordistInfo> {
	
	public OrdmoipVisiMergePayordist(DeciTreeOption<OrdmoipInfo> option) {
