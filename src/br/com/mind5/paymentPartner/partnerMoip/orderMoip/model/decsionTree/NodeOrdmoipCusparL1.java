...
public final class NodeOrdmoipCusparL1 extends DeciTreeTemplateWriteV2<OrdmoipInfo> {
	...
	@Override protected List<ActionStdV2<OrdmoipInfo>> buildActionsOnPassedHook(DeciTreeOption<OrdmoipInfo> option) {
		...
		ActionStdV2<OrdmoipInfo> mergeCuspar = new StdOrdmoipMergeCuspar(option);	
