...
public final class LazyOrdmoipEnforceReceivers extends ActionLazyTemplateV2<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceReceivers(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceReceivers(option);
	}
