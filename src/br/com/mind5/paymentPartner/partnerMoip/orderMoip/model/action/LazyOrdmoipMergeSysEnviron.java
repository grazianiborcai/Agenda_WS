...
public final class LazyOrdmoipMergeSysEnviron extends ActionLazyTemplateV2<OrdmoipInfo, OrdmoipInfo> {

	public LazyOrdmoipMergeSysEnviron(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipMergeSysEnviron(option);
	}
