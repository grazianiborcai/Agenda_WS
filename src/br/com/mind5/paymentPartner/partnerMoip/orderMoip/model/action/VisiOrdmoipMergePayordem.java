...
final class VisiOrdmoipMergePayordem extends ActionVisitorTemplateMergeV2<OrdmoipInfo, PayordemInfo> {
	
	public VisiOrdmoipMergePayordem(DeciTreeOption<OrdmoipInfo> option) {
