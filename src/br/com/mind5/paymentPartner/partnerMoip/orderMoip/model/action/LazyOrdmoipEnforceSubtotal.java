...
public final class LazyOrdmoipEnforceSubtotal extends ActionLazyTemplateV1<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceSubtotal(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceSubtotal(option);
	}
