...
public final class OrdmoipVisiEnforceSubtotal extends ActionVisitorTemplateEnforce<OrdmoipInfo> {
	
	public OrdmoipVisiEnforceSubtotal(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
