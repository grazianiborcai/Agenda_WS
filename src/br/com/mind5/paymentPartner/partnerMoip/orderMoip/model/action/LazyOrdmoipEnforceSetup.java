...
public final class LazyOrdmoipEnforceSetup extends ActionLazyTemplateV2<OrdmoipInfo, OrdmoipInfo> {

	public LazyOrdmoipEnforceSetup(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceSetup(option);
	}
