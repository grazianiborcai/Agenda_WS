...
public final class OrdmoipVisiEnforceSetup extends ActionVisitorTemplateEnforce<OrdmoipInfo> {
	
	public OrdmoipVisiEnforceSetup(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
