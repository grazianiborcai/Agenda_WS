...
public final class StdOrdmoipEnforceReceivers implements ActionStdV1<OrdmoipInfo> {
	private ActionStdV1<OrdmoipInfo> actionHelper;	
	
	
	public StdOrdmoipEnforceReceivers(DeciTreeOption<OrdmoipInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiOrdmoipEnforceReceivers());
	}
