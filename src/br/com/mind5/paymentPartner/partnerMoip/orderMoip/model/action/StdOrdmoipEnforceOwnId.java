...
public final class StdOrdmoipEnforceOwnId implements ActionStdV1<OrdmoipInfo> {
	private ActionStdV1<OrdmoipInfo> actionHelper;	
	
	
	public StdOrdmoipEnforceOwnId(DeciTreeOption<OrdmoipInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiOrdmoipEnforceOwnId());
	}
