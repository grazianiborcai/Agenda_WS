...
public final class LazyOrdmoipEnforceResponseAttr extends ActionLazyTemplateV2<OrdmoipInfo, OrdmoipInfo> {

	public LazyOrdmoipEnforceResponseAttr(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceResponseAttr(option);
	}
