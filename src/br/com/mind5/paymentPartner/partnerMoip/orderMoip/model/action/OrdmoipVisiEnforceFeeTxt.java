...
public final class OrdmoipVisiEnforceFeeTxt extends ActionVisitorTemplateEnforce<OrdmoipInfo> {
	
	public OrdmoipVisiEnforceFeeTxt(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
