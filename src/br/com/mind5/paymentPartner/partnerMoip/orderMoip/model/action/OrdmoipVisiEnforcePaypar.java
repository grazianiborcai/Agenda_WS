...
public final class OrdmoipVisiEnforcePaypar extends ActionVisitorTemplateEnforce<OrdmoipInfo> {
	
	public OrdmoipVisiEnforcePaypar(DeciTreeOption<OrdmoipInfo> option) {
		super(option);
	}
