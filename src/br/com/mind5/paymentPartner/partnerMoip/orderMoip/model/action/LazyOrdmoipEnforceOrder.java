...
public final class LazyOrdmoipEnforceOrder extends ActionLazyTemplateV2<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceOrder(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceOrder(option);
	}
