...
public final class LazyOrdmoipEnforceOwnId extends ActionLazyTemplateV2<OrdmoipInfo, OrdmoipInfo> {
	
	public LazyOrdmoipEnforceOwnId(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipEnforceOwnId(option);
	}
