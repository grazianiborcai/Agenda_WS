...
public final class LazyOrdmoipMergeSyspar extends ActionLazyTemplate<OrdmoipInfo, OrdmoipInfo> {

	public LazyOrdmoipMergeSyspar(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipMergeSyspar(option);
	}
