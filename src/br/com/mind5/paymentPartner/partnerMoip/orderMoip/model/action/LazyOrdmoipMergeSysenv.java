...
public final class LazyOrdmoipMergeSysenv extends ActionLazyTemplateV2<OrdmoipInfo, OrdmoipInfo> {

	public LazyOrdmoipMergeSysenv(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<OrdmoipInfo> getInstanceOfActionHook(DeciTreeOption<OrdmoipInfo> option) {
		return new StdOrdmoipMergeSysenv(option);
	}
