...
public final class LazyPaymoipEnforceCard extends ActionLazyTemplateV1<PaymoipInfo, PaymoipInfo> {

	public LazyPaymoipEnforceCard(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PaymoipInfo> getInstanceOfActionHook(DeciTreeOption<PaymoipInfo> option) {
		return new StdPaymoipEnforceCard(option);
	}
