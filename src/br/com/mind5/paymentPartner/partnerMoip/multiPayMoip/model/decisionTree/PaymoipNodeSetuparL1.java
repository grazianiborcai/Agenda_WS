...
import br.com.mind5.paymentPartner.partnerMoip.multiPayMoip.model.action.PaymoipVisiNodeSetuparL2;
import br.com.mind5.paymentPartner.partnerMoip.multiPayMoip.model.action.PaymoipVisiMergeSetupar;

public final class PaymoipNodeSetuparL1 extends DeciTreeTemplateWrite<PaymoipInfo> {
	
	public PaymoipNodeSetuparL1(DeciTreeOption<PaymoipInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PaymoipInfo>> buildActionsOnPassedHook(DeciTreeOption<PaymoipInfo> option) {
		...
		ActionStd<PaymoipInfo> mergeSetupar = new ActionStdCommom<PaymoipInfo>(option, PaymoipVisiMergeSetupar.class);
		ActionLazy<PaymoipInfo> nodeL2 = new ActionLazyCommom<PaymoipInfo>(option, PaymoipVisiNodeSetuparL2.class);
