...
public final class PaymoipVisiEnforcePayment extends ActionVisitorTemplateEnforce<PaymoipInfo> {
	
	public PaymoipVisiEnforcePayment(DeciTreeOption<PaymoipInfo> option) {
		super(option);
	}
