...
public final class StdPaymoipMergeCrecard implements ActionStdV1<PaymoipInfo> {
	private ActionStdV1<PaymoipInfo> actionHelper;	
	
	
	public StdPaymoipMergeCrecard(DeciTreeOption<PaymoipInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPaymoipMergeCrecard(option.conn, option.schemaName));
	}
