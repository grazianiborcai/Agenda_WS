...
public final class LazyPaymoipMergeSysEnviron extends ActionLazyTemplateV1<PaymoipInfo, PaymoipInfo> {

	public LazyPaymoipMergeSysEnviron(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PaymoipInfo> getInstanceOfActionHook(DeciTreeOption<PaymoipInfo> option) {
		return new StdPaymoipMergeSysEnviron(option);
	}
