...
final class OrdapaMergerVisiCus extends InfoMergerVisitorTemplate<OrdapaInfo, CusInfo> {

	@Override public boolean shouldMerge(OrdapaInfo baseInfo, CusInfo selectedInfo) {
	...
	@Override public List<OrdapaInfo> merge(OrdapaInfo baseInfo, CusInfo selectedInfo) {
