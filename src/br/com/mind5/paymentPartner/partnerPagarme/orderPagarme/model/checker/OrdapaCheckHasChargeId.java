...
public final class OrdapaCheckHasChargeId extends ModelCheckerTemplateSimple<OrdapaInfo> {

	public OrdapaCheckHasChargeId(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(OrdapaInfo recordInfo, Connection conn, String schemaName) {
		...
		if (recordInfo.payordemData.idPaymentPartner == null)			
			return super.FAILED;
