...
import br.com.mind5.paymentPartner.partnerPagarme.orderPagarme.model.action.OrdapaVisiEnforceResponseTran;
...
public final class OrdapaNodeCancel extends DeciTreeTemplateWrite<OrdapaInfo> {
	...
	@Override protected List<ActionStd<OrdapaInfo>> buildActionsOnPassedHook(DeciTreeOption<OrdapaInfo> option) {
		...
		ActionLazy<OrdapaInfo> enforceResponseTran = new ActionLazyCommom<OrdapaInfo>(option, OrdapaVisiEnforceResponseTran.class);
		
		cancel.addPostAction(enforceResponseTran);
