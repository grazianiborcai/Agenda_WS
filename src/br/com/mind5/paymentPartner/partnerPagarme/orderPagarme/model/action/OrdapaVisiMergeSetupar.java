...
public final class OrdapaVisiMergeSetupar extends ActionVisitorTemplateMerge<OrdapaInfo, SetuparInfo> {
	
	public OrdapaVisiMergeSetupar(DeciTreeOption<OrdapaInfo> option) {
	...
	@Override protected List<OrdapaInfo> mergeHook(List<OrdapaInfo> baseInfos, List<SetuparInfo> selectedInfos) {	
		return OrdapaMerger.mergeWithSetupar(baseInfos, selectedInfos);
	}
