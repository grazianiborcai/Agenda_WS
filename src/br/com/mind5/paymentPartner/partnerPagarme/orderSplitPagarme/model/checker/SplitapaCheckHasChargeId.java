...
public final class SplitapaCheckHasChargeId extends ModelCheckerTemplateSimple<SplitapaInfo> {

	public SplitapaCheckHasChargeId(ModelCheckerOption option) {
		super(option);
	}
	...
	@Override protected boolean checkHook(SplitapaInfo recordInfo, Connection conn, String schemaName) {
		...
		if (recordInfo.payordData.idPaymentPartner == null)			
			return super.FAILED;
