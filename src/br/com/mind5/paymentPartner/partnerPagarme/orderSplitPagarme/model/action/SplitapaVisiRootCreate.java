...
import br.com.mind5.paymentPartner.partnerPagarme.orderSplitPagarme.model.decisionTree.SplitapaRootCreate;

public final class SplitapaVisiRootCreate extends ActionVisitorTemplateAction<SplitapaInfo, SplitapaInfo> {

	public SplitapaVisiRootCreate(DeciTreeOption<SplitapaInfo> option) {
	...
	@Override protected Class<? extends DeciTree<SplitapaInfo>> getTreeClassHook() {
		return SplitapaRootCreate.class;
	}
