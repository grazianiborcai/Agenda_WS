...
import br.com.mind5.paymentPartner.partnerPagarme.orderSplitPagarme.model.decisionTree.SplitapaNodeCreate;

public final class SplitapaVisiNodeCreate extends ActionVisitorTemplateAction<SplitapaInfo, SplitapaInfo> {

	public SplitapaVisiNodeCreate(DeciTreeOption<SplitapaInfo> option) {
	...
	@Override protected Class<? extends DeciTree<SplitapaInfo>> getTreeClassHook() {
		return SplitapaNodeCreate.class;
	}
