...
public final class SplitapaCheckHasCustomer extends ModelCheckerTemplateSimple<SplitapaInfo> {

	public SplitapaCheckHasCustomer(ModelCheckerOption option) {
		super(option);
	}
