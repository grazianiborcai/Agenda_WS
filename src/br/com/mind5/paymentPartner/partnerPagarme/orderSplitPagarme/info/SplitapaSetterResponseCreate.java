...
public final class SplitapaSetterResponseCreate extends InfoSetterTemplate<SplitapaInfo> {
	...
	private SplitapaInfo setRootAttr(SplitapaInfo recordInfo, JsonElement json) {
	...
	private SplitapaInfo setItems(SplitapaInfo recordInfo, JsonElement json) {
	...
	private SplitapaInfo setCharges(SplitapaInfo recordInfo, JsonElement json) {
