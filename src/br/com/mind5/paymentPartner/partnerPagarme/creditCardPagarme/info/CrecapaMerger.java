...
public final class CrecapaMerger {
	public static List<CrecapaInfo> mergeWithCrecard(List<CrecapaInfo> baseInfos, List<CrecardInfo> selectedInfos) {
		InfoMergerBuilder<CrecapaInfo, CrecardInfo> builder = new InfoMergerBuilder<>();
		
		builder.addBaseInfos(baseInfos);
		builder.addSelectedInfos(selectedInfos);
		builder.addVisitor(new CrecapaMergerVisiCrecard());
		InfoMerger<CrecapaInfo, CrecardInfo> merger = builder.build();		
