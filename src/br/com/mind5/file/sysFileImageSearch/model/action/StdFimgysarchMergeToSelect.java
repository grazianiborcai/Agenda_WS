...
public final class StdFimgysarchMergeToSelect extends ActionStdTemplate<FimgysarchInfo> {

	public StdFimgysarchMergeToSelect(DeciTreeOption<FimgysarchInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<FimgysarchInfo> buildVisitorHook(DeciTreeOption<FimgysarchInfo> option) {
		return new VisiFimgysarchMergeToSelect(option);
	}
}
