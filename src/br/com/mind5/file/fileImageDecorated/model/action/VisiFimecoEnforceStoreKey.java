...
final class VisiFimecoEnforceStoreKey extends ActionVisitorTemplateEnforce<FimecoInfo> {
	
	public VisiFimecoEnforceStoreKey(DeciTreeOption<FimecoInfo> option) {
		super(option);
	}
