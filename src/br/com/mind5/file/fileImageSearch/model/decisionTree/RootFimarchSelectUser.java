...
public final class RootFimarchSelectUser extends DeciTreeTemplateReadV2<FimarchInfo> {
	...
	@Override protected List<ActionStdV2<FimarchInfo>> buildActionsOnPassedHook(DeciTreeOption<FimarchInfo> option) {
		...
		ActionStdV2<FimarchInfo> enforceUser = new StdFimarchEnforceUser(option);
