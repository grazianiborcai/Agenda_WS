...
import br.com.mind5.file.fileImageSearch.model.action.FimarchVisiMergeToSelect;
...
public final class FimarchRootSelect extends DeciTreeTemplateRead<FimarchInfo> {
	
	public FimarchRootSelect(DeciTreeOption<FimarchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimarchInfo>> buildActionsOnPassedHook(DeciTreeOption<FimarchInfo> option) {
		...
		ActionStd<FimarchInfo> select = new ActionStdCommom<FimarchInfo>(option, FimarchVisiMergeToSelect.class);
