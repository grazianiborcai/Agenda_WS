...
public final class StdFimarchEnforceCus implements ActionStdV1<FimarchInfo> {
	private ActionStdV1<FimarchInfo> actionHelper;	
	
	
	public StdFimarchEnforceCus(DeciTreeOption<FimarchInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiFimarchEnforceCus());
	}
