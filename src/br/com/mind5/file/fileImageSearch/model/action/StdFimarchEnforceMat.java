...
public final class StdFimarchEnforceMat implements ActionStdV1<FimarchInfo> {
	private ActionStdV1<FimarchInfo> actionHelper;	
	
	
	public StdFimarchEnforceMat(DeciTreeOption<FimarchInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiFimarchEnforceMat());
	}
