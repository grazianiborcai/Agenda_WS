...
public final class FimgysDaoUpdateSingle extends DaoStmtTemplate<FimgysInfo> {
	private final String MAIN_TABLE = DaoDbTable.SYS_FILE_IMG_TABLE;	
	
	
	public FimgysDaoUpdateSingle(Connection conn, FimgysInfo recordInfo, String schemaName) {
