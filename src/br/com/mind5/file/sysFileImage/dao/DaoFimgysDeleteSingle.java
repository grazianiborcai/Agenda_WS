...
public final class DaoFimgysDeleteSingle extends DaoStmtTemplate<FimgysInfo> {
	private final String MAIN_TABLE = DaoDbTable.SYS_FILE_IMG_TABLE;		
	
	
	public DaoFimgysDeleteSingle(Connection conn, FimgysInfo recordInfo, String schemaName) {
