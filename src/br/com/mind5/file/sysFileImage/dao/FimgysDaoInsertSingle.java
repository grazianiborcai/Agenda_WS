...
public final class FimgysDaoInsertSingle extends DaoStmtTemplate<FimgysInfo> {
	private final String MAIN_TABLE = DaoDbTable.SYS_FILE_IMG_TABLE;		
	
	
	public FimgysDaoInsertSingle(Connection conn, FimgysInfo recordInfo, String schemaName) {
