...
import br.com.mind5.file.sysFileImage.model.action.FimgysVisiEnforceCoverOff;
...
public final class FimgysNodeCoverOffL1 extends DeciTreeTemplateWrite<FimgysInfo> {
	
	public FimgysNodeCoverOffL1(DeciTreeOption<FimgysInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgysInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgysInfo> option) {
		...
		ActionStd<FimgysInfo> enforceCoverOff = new ActionStdCommom<FimgysInfo>(option, FimgysVisiEnforceCoverOff.class);
