...
import br.com.mind5.file.sysFileImage.model.action.StdFimgysMergeToSelect;
...
public final class RootFimgysSelect extends DeciTreeTemplateRead<FimgysInfo> {
	
	public RootFimgysSelect(DeciTreeOption<FimgysInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgysInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgysInfo> option) {
		...
		ActionStd<FimgysInfo> select = new StdFimgysMergeToSelect(option);
