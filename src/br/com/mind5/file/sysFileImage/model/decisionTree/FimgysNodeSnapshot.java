...
import br.com.mind5.file.sysFileImage.model.action.FimgysVisiFimgysapInsert;
...
public final class FimgysNodeSnapshot extends DeciTreeTemplateWrite<FimgysInfo> {
	
	public FimgysNodeSnapshot(DeciTreeOption<FimgysInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgysInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgysInfo> option) {
		...
		ActionStd<FimgysInfo> insertSnapshot = new ActionStdCommom<FimgysInfo>(option, FimgysVisiFimgysapInsert.class);	
