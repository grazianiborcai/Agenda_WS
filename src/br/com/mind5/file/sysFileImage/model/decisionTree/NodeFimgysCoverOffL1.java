...
import br.com.mind5.file.sysFileImage.model.action.StdFimgysEnforceCoverOff;
...
public final class NodeFimgysCoverOffL1 extends DeciTreeTemplateWrite<FimgysInfo> {
	
	public NodeFimgysCoverOffL1(DeciTreeOption<FimgysInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgysInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgysInfo> option) {
		...
		ActionStd<FimgysInfo> enforceCoverOff = new StdFimgysEnforceCoverOff(option);
