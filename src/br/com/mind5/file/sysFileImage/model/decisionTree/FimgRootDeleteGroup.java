...
import br.com.mind5.file.sysFileImage.model.action.FimgysVisiNodeDeleteGroup;
...
public final class FimgRootDeleteGroup extends DeciTreeTemplateWrite<FimgysInfo> {
	
	public FimgRootDeleteGroup(DeciTreeOption<FimgysInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgysInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgysInfo> option) {
		...
		ActionLazy<FimgysInfo> delete = new ActionLazyCommom<FimgysInfo>(option, FimgysVisiNodeDeleteGroup.class);
