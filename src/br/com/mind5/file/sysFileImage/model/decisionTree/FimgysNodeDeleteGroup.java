...
public final class FimgysNodeDeleteGroup extends DeciTreeTemplateWrite<FimgysInfo> {
	
	public FimgysNodeDeleteGroup(DeciTreeOption<FimgysInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgysInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgysInfo> option) {
		...
		ActionStd<FimgysInfo> delete = new FimgysRootDelete(option).toAction();
