...
import br.com.mind5.file.sysFileImage.model.decisionTree.FimgysRootReplace;
import br.com.mind5.model.action.ActionVisitorTemplateAction;
import br.com.mind5.model.decisionTree.DeciTree;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class FimgysVisiRootReplace extends ActionVisitorTemplateAction<FimgysInfo, FimgysInfo> {

	public FimgysVisiRootReplace(DeciTreeOption<FimgysInfo> option) {
	...
	@Override protected Class<? extends DeciTree<FimgysInfo>> getTreeClassHook() {
		return FimgysRootReplace.class;
	}
