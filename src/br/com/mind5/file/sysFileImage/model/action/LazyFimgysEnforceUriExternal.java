...
public final class LazyFimgysEnforceUriExternal extends ActionLazyTemplate<FimgysInfo, FimgysInfo> {
	
	public LazyFimgysEnforceUriExternal(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgysInfo> getInstanceOfActionHook(DeciTreeOption<FimgysInfo> option) {
		return new StdFimgysEnforceUriExternal(option);
	}
