...
public final class LazyFimgysEnforceLChanged extends ActionLazyTemplate<FimgysInfo, FimgysInfo> {
	
	public LazyFimgysEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgysInfo> getInstanceOfActionHook(DeciTreeOption<FimgysInfo> option) {
		return new StdFimgysEnforceLChanged(option);
	}
