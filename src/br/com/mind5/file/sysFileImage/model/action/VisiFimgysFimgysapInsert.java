...
final class VisiFimgysFimgysapInsert extends ActionVisitorTemplateAction<FimgysInfo, FimgysapInfo> {
	
	public VisiFimgysFimgysapInsert(DeciTreeOption<FimgysInfo> option) {
