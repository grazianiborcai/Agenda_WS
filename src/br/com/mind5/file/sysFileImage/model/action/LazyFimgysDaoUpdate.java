...
public final class LazyFimgysDaoUpdate extends ActionLazyTemplate<FimgysInfo, FimgysInfo> {
	
	public LazyFimgysDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgysInfo> getInstanceOfActionHook(DeciTreeOption<FimgysInfo> option) {
		return new StdFimgysDaoUpdate(option);
	}
