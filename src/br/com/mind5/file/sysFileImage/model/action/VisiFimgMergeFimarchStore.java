...
final class VisiFimgMergeFimarchStore extends ActionVisitorTemplateMerge<FimgysInfo, FimarchInfo> {
	
	public VisiFimgMergeFimarchStore(DeciTreeOption<FimgysInfo> option) {
