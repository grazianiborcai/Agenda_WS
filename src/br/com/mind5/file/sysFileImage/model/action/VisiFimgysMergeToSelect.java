...
final class VisiFimgysMergeToSelect extends ActionVisitorTemplateMerge<FimgysInfo, FimgysInfo> {
	
	public VisiFimgysMergeToSelect(DeciTreeOption<FimgysInfo> option) {
