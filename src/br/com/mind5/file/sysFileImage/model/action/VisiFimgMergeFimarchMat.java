...
final class VisiFimgMergeFimarchMat extends ActionVisitorTemplateMerge<FimgysInfo, FimarchInfo> {
	
	public VisiFimgMergeFimarchMat(DeciTreeOption<FimgysInfo> option) {
