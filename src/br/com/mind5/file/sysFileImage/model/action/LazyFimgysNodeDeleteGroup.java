...
import br.com.mind5.file.sysFileImage.model.decisionTree.NodeFimgysDeleteGroup;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyFimgysNodeDeleteGroup extends ActionLazyTemplate<FimgysInfo, FimgysInfo> {

	public LazyFimgysNodeDeleteGroup(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgysInfo> getInstanceOfActionHook(DeciTreeOption<FimgysInfo> option) {
		return new NodeFimgysDeleteGroup(option).toAction();
	}
