...
public final class LazyFimgysMergeFath extends ActionLazyTemplate<FimgysInfo, FimgysInfo> {
	
	public LazyFimgysMergeFath(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgysInfo> getInstanceOfActionHook(DeciTreeOption<FimgysInfo> option) {
		return new StdFimgysMergeFath(option);
	}
