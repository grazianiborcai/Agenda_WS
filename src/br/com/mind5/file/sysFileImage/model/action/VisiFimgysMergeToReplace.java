...
final class VisiFimgysMergeToReplace extends ActionVisitorTemplateMerge<FimgysInfo, FimgysInfo> {
	
	public VisiFimgysMergeToReplace(DeciTreeOption<FimgysInfo> option) {
