...
final class VisiFimgysMergeFimgysarchGroup extends ActionVisitorTemplateMerge<FimgysInfo, FimgysarchInfo> {
	
	public VisiFimgysMergeFimgysarchGroup(DeciTreeOption<FimgysInfo> option) {
