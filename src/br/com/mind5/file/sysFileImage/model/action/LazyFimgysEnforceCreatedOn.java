...
public final class LazyFimgysEnforceCreatedOn extends ActionLazyTemplate<FimgysInfo, FimgysInfo> {
	
	public LazyFimgysEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgysInfo> getInstanceOfActionHook(DeciTreeOption<FimgysInfo> option) {
		return new StdFimgysEnforceCreatedOn(option);
	}
