...
public final class FimgysVisiMergeToReplace extends ActionVisitorTemplateMerge<FimgysInfo, FimgysInfo> {
	
	public FimgysVisiMergeToReplace(DeciTreeOption<FimgysInfo> option) {
	...
	@Override protected List<FimgysInfo> mergeHook(List<FimgysInfo> baseInfos, List<FimgysInfo> selectedInfos) {	
		return FimgysMerger.mergeToReplace(baseInfos, selectedInfos);
	}
