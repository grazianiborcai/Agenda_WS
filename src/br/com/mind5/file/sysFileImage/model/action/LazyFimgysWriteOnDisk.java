...
public final class LazyFimgysWriteOnDisk extends ActionLazyTemplate<FimgysInfo, FimgysInfo> {
	
	public LazyFimgysWriteOnDisk(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgysInfo> getInstanceOfActionHook(DeciTreeOption<FimgysInfo> option) {
		return new StdFimgysWriteOnDisk(option);
	}
