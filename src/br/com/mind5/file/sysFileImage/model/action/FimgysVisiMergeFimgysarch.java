...
public final class FimgysVisiMergeFimgysarch extends ActionVisitorTemplateMerge<FimgysInfo, FimgysarchInfo> {
	
	public FimgysVisiMergeFimgysarch(DeciTreeOption<FimgysInfo> option) {
