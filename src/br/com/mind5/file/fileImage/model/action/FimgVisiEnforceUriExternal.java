...
public final class FimgVisiEnforceUriExternal extends ActionVisitorTemplateEnforce<FimgInfo> {
	
	public FimgVisiEnforceUriExternal(DeciTreeOption<FimgInfo> option) {
		super(option);	
	}
