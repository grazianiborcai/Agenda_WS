...
import br.com.mind5.file.fileImage.model.decisionTree.RootFimgReplace;
import br.com.mind5.model.action.ActionLazyTemplateV1;
import br.com.mind5.model.action.ActionStdV1;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyFimgRootReplace extends ActionLazyTemplateV1<FimgInfo, FimgInfo> {

	public LazyFimgRootReplace(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new RootFimgReplace(option).toAction();
	}
