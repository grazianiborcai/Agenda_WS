...
import br.com.mind5.file.fileImage.model.decisionTree.RootFimgCopy;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyFimgRootCopy extends ActionLazyTemplate<FimgInfo, FimgInfo> {

	public LazyFimgRootCopy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new RootFimgCopy(option).toAction();
	}
