...
public final class FimgVisiMergeFimarchMat extends ActionVisitorTemplateMerge<FimgInfo, FimarchInfo> {
	
	public FimgVisiMergeFimarchMat(DeciTreeOption<FimgInfo> option) {
	...
	@Override protected Class<? extends DeciTree<FimarchInfo>> getTreeClassHook() {
		return FimarchRootSelectMat.class;
	}
