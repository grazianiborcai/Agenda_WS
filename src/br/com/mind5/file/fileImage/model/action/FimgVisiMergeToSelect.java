...
public final class FimgVisiMergeToSelect extends ActionVisitorTemplateMerge<FimgInfo, FimgInfo> {
	
	public FimgVisiMergeToSelect(DeciTreeOption<FimgInfo> option) {
