...
import br.com.mind5.file.fileImage.dao.FimgDelete;
...
public final class StdFimgDelete implements ActionStdV1<FimgInfo> {
	private ActionStdV1<FimgInfo> actionHelper;
	
	
	public StdFimgDelete(DeciTreeOption<FimgInfo> option) {
	...
	private DaoStmtExec_<FimgInfo> buildStmtExec(DeciTreeOption<FimgInfo> option) {
		...
		return new FimgDelete(stmtExecOptions);
	}
