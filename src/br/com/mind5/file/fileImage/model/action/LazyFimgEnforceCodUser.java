...
public final class LazyFimgEnforceCodUser extends ActionLazyTemplateV1<FimgInfo, FimgInfo> {
	
	public LazyFimgEnforceCodUser(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgEnforceCodUser(option);
	}
