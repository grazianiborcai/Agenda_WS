...
public final class LazyFimgEnforceCreatedBy extends ActionLazyTemplateV1<FimgInfo, FimgInfo> {
	
	public LazyFimgEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgEnforceCreatedBy(option);
	}
