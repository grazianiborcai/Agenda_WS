...
public final class LazyFimgDaoDelete extends ActionLazyTemplateV2<FimgInfo, FimgInfo> {

	public LazyFimgDaoDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgDaoDelete(option);
	}
