...
public final class LazyFimgEnforceUriExternal extends ActionLazyTemplateV2<FimgInfo, FimgInfo> {
	
	public LazyFimgEnforceUriExternal(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgEnforceUriExternal(option);
	}
