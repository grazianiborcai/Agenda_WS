...
public final class LazyFimgRootInsert extends ActionLazyTemplateV1<FimgInfo, FimgInfo> {

	public LazyFimgRootInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new RootFimgInsert(option).toAction();
	}
