...
public final class FimgVisiMergeToReplace extends ActionVisitorTemplateMerge<FimgInfo, FimgInfo> {
	
	public FimgVisiMergeToReplace(DeciTreeOption<FimgInfo> option) {
