...
public final class LazyFimgEnforceCreatedOn extends ActionLazyTemplateV1<FimgInfo, FimgInfo> {
	
	public LazyFimgEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgEnforceCreatedOn(option);
	}
