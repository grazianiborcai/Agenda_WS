...
public final class LazyFimgEnforceCopy extends ActionLazyTemplate<FimgInfo, FimgInfo> {
	
	public LazyFimgEnforceCopy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgEnforceCopy(option);
	}
