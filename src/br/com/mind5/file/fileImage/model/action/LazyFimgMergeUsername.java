...
public final class LazyFimgMergeUsername extends ActionLazyTemplateV2<FimgInfo, FimgInfo> {
	
	public LazyFimgMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgMergeUsername(option);
	}
