...
public final class FimgVisiMergeToCopy extends ActionVisitorTemplateMerge<FimgInfo, FimgInfo> {
	
	public FimgVisiMergeToCopy(DeciTreeOption<FimgInfo> option) {
	...
	@Override protected List<FimgInfo> mergeHook(List<FimgInfo> baseInfos, List<FimgInfo> selectedInfos) {	
		return FimgMerger.mergeToCopy(baseInfos, selectedInfos);
	}
