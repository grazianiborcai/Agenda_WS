...
public final class StdFimgMergeToReplace implements ActionStdV1<FimgInfo> {
	private ActionStdV1<FimgInfo> actionHelper;	
	
	
	public StdFimgMergeToReplace(DeciTreeOption<FimgInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiFimgMergeToReplace(option.conn, option.schemaName));
	}
