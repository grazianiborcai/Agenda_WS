...
public final class LazyFimgMergeFath extends ActionLazyTemplateV1<FimgInfo, FimgInfo> {
	
	public LazyFimgMergeFath(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<FimgInfo> getInstanceOfActionHook(DeciTreeOption<FimgInfo> option) {
		return new StdFimgMergeFath(option);
	}
