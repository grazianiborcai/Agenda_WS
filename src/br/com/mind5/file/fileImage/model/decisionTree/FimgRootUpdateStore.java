...
import br.com.mind5.file.fileImage.model.action.FimgVisiNodeUpdateStore;
...
public final class FimgRootUpdateStore extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootUpdateStore(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazy<FimgInfo> update = new ActionLazyCommom<FimgInfo>(option, FimgVisiNodeUpdateStore.class);
