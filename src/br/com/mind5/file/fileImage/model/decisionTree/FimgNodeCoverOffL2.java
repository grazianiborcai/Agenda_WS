...
import br.com.mind5.file.fileImage.model.action.FimgVisiMergeFimarchStore;
...
public final class FimgNodeCoverOffL2 extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgNodeCoverOffL2(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionStd<FimgInfo> mergeFimarch = new ActionStdCommom<FimgInfo>(option, FimgVisiMergeFimarchStore.class);	
