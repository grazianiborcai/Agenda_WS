...
import br.com.mind5.file.fileImage.model.action.FimgVisiNodeDeleteMat;
...
public final class FimgRootDeleteMat extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootDeleteMat(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazy<FimgInfo> delete = new ActionLazyCommom<FimgInfo>(option, FimgVisiNodeDeleteMat.class);
