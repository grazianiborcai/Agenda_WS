...
import br.com.mind5.file.fileImage.model.action.FimgVisiNodeDeleteOwner;
...
public final class FimgRootDeleteOwner extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootDeleteOwner(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazy<FimgInfo> delete = new ActionLazyCommom<FimgInfo>(option, FimgVisiNodeDeleteOwner.class);
