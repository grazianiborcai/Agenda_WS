...
import br.com.mind5.file.fileImage.model.action.FimgVisiNodeDeleteUser;
...
public final class FimgRootDeleteUser extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootDeleteUser(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazy<FimgInfo> delete = new ActionLazyCommom<FimgInfo>(option, FimgVisiNodeDeleteUser.class);
