...
public final class RootFimgDeleteOwner extends DeciTreeTemplateWriteV1<FimgInfo> {
	...
	@Override protected List<ActionStdV1<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazyV1<FimgInfo> delete = new LazyFimgNodeDeleteOwner(option.conn, option.schemaName);
