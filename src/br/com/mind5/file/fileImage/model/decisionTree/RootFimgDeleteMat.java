...
import br.com.mind5.file.fileImage.model.action.LazyFimgNodeDeleteMat;
...
public final class RootFimgDeleteMat extends DeciTreeTemplateWriteV2<FimgInfo> {
	
	public RootFimgDeleteMat(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazyV1<FimgInfo> delete = new LazyFimgNodeDeleteMat(option.conn, option.schemaName);
