...
import br.com.mind5.file.fileImage.model.action.LazyFimgNodeDeleteStore;
...
public final class RootFimgDeleteStore extends DeciTreeTemplateWriteV1<FimgInfo> {
	
	public RootFimgDeleteStore(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazyV1<FimgInfo> delete = new LazyFimgNodeDeleteStore(option.conn, option.schemaName);
