...
import br.com.mind5.file.fileImage.model.action.LazyFimgNodeUpdateMat;
...
public final class RootFimgUpdateMat extends DeciTreeTemplateWriteV1<FimgInfo> {
	
	public RootFimgUpdateMat(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStdV1<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazyV1<FimgInfo> update = new LazyFimgNodeUpdateMat(option.conn, option.schemaName);
