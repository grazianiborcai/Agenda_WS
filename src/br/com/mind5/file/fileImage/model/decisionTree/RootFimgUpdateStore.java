...
import br.com.mind5.file.fileImage.model.action.LazyFimgNodeUpdateStore;
...
public final class RootFimgUpdateStore extends DeciTreeTemplateWriteV1<FimgInfo> {
	...
	@Override protected List<ActionStdV1<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazyV1<FimgInfo> update = new LazyFimgNodeUpdateStore(option.conn, option.schemaName);
