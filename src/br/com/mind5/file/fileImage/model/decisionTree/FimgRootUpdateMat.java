...
import br.com.mind5.file.fileImage.model.action.FimgVisiNodeUpdateMat;
...
public final class FimgRootUpdateMat extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootUpdateMat(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazy<FimgInfo> update = new ActionLazyCommom<FimgInfo>(option, FimgVisiNodeUpdateMat.class);
