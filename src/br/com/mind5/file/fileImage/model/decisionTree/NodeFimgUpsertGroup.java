...
import br.com.mind5.file.fileImage.model.checker.FimgCheckExistGroup;
...
public final class NodeFimgUpsertGroup extends DeciTreeTemplateWrite<FimgInfo> {
	
	public NodeFimgUpsertGroup(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected ModelChecker<FimgInfo> buildCheckerHook(DeciTreeOption<FimgInfo> option) {
		...
		checker = new FimgCheckExistGroup(checkerOption);
		queue.add(checker);
