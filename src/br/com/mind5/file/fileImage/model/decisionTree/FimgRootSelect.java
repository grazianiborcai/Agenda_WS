...
public final class FimgRootSelect extends DeciTreeTemplateRead<FimgInfo> {
	
	public FimgRootSelect(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionStd<FimgInfo> select = new ActionStdCommom<FimgInfo>(option, FimgVisiMergeToSelect.class);
