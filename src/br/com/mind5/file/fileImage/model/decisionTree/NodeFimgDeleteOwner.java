...
import br.com.mind5.file.fileImage.model.checker.FimgCheckIsOwner;
...
public final class NodeFimgDeleteOwner extends DeciTreeTemplateWriteV1<FimgInfo> {
	
	public NodeFimgDeleteOwner(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected ModelCheckerV1<FimgInfo> buildCheckerHook(DeciTreeOption<FimgInfo> option) {
		...
		checker = new FimgCheckIsOwner(checkerOption);
		queue.add(checker);
