...
import br.com.mind5.file.fileImage.model.action.FimgVisiRootInsert;
import br.com.mind5.file.fileImage.model.action.FimgVisiEnforceStore;
...
public final class FimgRootInsertStore extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootInsertStore(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionStd<FimgInfo> enforceStore = new ActionStdCommom<FimgInfo>(option, FimgVisiEnforceStore.class);	
		ActionLazy<FimgInfo> insert = new ActionLazyCommom<FimgInfo>(option, FimgVisiRootInsert.class);
