...
public final class FimgRootUpdate extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootUpdate(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionStd<FimgInfo> update = new FimgNodeUpdate(option).toAction();		
