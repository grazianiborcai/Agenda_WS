...
import br.com.mind5.file.fileImage.model.action.FimgVisiNodeDeleteEmp;
...
public final class FimgRootDeleteEmp extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootDeleteEmp(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazy<FimgInfo> delete = new ActionLazyCommom<FimgInfo>(option, FimgVisiNodeDeleteEmp.class);
