...
import br.com.mind5.file.fileImage.model.action.FimgVisiEnforceCoverOff;
...
public final class FimgNodeCoverOffL4 extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgNodeCoverOffL4(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionStd<FimgInfo> enforceCoverOff = new ActionStdCommom<FimgInfo>(option, FimgVisiEnforceCoverOff.class);	
