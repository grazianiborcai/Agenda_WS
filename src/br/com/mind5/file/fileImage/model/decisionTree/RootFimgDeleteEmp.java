...
import br.com.mind5.file.fileImage.model.action.LazyFimgNodeDeleteEmp;
...
public final class RootFimgDeleteEmp extends DeciTreeTemplateWriteV2<FimgInfo> {
	...
	@Override protected List<ActionStdV1<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazyV1<FimgInfo> delete = new LazyFimgNodeDeleteEmp(option.conn, option.schemaName);
