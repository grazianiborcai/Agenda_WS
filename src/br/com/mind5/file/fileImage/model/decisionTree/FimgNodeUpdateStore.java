...
public final class FimgNodeUpdateStore extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgNodeUpdateStore(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionStd<FimgInfo> update = new FimgRootUpdate(option).toAction();
