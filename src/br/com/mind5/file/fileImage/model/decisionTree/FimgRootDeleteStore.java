...
import br.com.mind5.file.fileImage.model.action.FimgVisiNodeDeleteStore;
...
public final class FimgRootDeleteStore extends DeciTreeTemplateWrite<FimgInfo> {
	
	public FimgRootDeleteStore(DeciTreeOption<FimgInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<FimgInfo>> buildActionsOnPassedHook(DeciTreeOption<FimgInfo> option) {
		...
		ActionLazy<FimgInfo> delete = new ActionLazyCommom<FimgInfo>(option, FimgVisiNodeDeleteStore.class);
