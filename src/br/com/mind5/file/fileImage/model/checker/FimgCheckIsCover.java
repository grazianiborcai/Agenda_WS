...
public final class FimgCheckIsCover extends ModelCheckerTemplateSimpleV2<FimgInfo> {

	public FimgCheckIsCover(ModelCheckerOption option) {
		super(option);
	}
