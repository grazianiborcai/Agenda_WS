...
import br.com.mind5.file.fileImageSearch.model.decisionTree.FimarchRootSelectOwner;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.checker.ModelCheckerOption;
import br.com.mind5.model.checker.ModelCheckerTemplateAction;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class FimgCheckExistOwner extends ModelCheckerTemplateAction<FimgInfo, FimarchInfo> {	
	...
	@Override protected ActionStd<FimarchInfo> buildActionHook(DeciTreeOption<FimarchInfo> option) {
		ActionStd<FimarchInfo> select = new FimarchRootSelectOwner(option).toAction();
		return select;
	}
