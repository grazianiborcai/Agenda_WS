...
public final class FimgCheckExistCus extends ModelCheckerTemplateActionV2<FimgInfo, FimarchInfo> {	
	...
	@Override protected ActionStdV2<FimarchInfo> buildActionHook(DeciTreeOption<FimarchInfo> option) {
		ActionStdV2<FimarchInfo> select = new RootFimarchSelectCus(option).toAction();
		return select;
	}
