...
public final class FimgDaoUpdateSingle extends DaoStmtTemplate<FimgInfo> {
	private final String MAIN_TABLE = DaoDbTable.FILE_IMG_TABLE;	
	
	
	public FimgDaoUpdateSingle(Connection conn, FimgInfo recordInfo, String schemaName) {
