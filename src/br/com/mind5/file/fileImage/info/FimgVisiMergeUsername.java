...
final class FimgVisiMergeUsername implements InfoMergerVisitor<FimgInfo, UsernameInfo> {
	...
	@Override public FimgInfo writeRecord(UsernameInfo sourceOne, FimgInfo sourceTwo) {
	...
	private void checkArgument(UsernameInfo sourceOne, FimgInfo sourceTwo) {
	...
	private FimgInfo merge(UsernameInfo sourceOne, FimgInfo sourceTwo) {
	...
	@Override public boolean shouldWrite(UsernameInfo sourceOne, FimgInfo sourceTwo) {
