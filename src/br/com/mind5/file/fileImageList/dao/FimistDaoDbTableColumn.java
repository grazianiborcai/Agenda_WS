...
public final class FimistDaoDbTableColumn extends DaoDbTableColumnTemplate {	
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.FILE_IMG_LIST_VIEW, columns);
		return results;
	}
}
