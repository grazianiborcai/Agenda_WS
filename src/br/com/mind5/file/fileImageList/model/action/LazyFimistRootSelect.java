...
public final class LazyFimistRootSelect extends ActionLazyTemplateV2<FimistInfo, FimistInfo> {
	...
	@Override protected ActionStdV1<FimistInfo> getInstanceOfActionHook(DeciTreeOption<FimistInfo> option) {
