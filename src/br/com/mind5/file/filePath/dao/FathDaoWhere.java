...
public final class FathDaoWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public FathDaoWhere(DaoWhereBuilderOption whereOption, String tableName, FathInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, FathInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case FathDaoDbTableColumn.COL_COD_FILE_PATH :
