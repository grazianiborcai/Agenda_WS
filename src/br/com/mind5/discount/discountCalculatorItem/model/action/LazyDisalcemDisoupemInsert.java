...
public final class LazyDisalcemDisoupemInsert extends ActionLazyTemplate<DisalcemInfo, DisalcemInfo> {
	
	public LazyDisalcemDisoupemInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisalcemInfo> getInstanceOfActionHook(DeciTreeOption<DisalcemInfo> option) {
		return new StdDisalcemDisoupemInsert(option);
	}
