...
public final class LazyDisalcemMergeDisore extends ActionLazyTemplate<DisalcemInfo, DisalcemInfo> {
	
	public LazyDisalcemMergeDisore(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisalcemInfo> getInstanceOfActionHook(DeciTreeOption<DisalcemInfo> option) {
		return new StdDisalcemMergeDisore(option);
	}
