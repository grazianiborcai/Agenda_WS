...
public final class StdDisorapDaoSelect extends ActionStdTemplate<DisorapInfo> {

	public StdDisorapDaoSelect(DeciTreeOption<DisorapInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<DisorapInfo> buildVisitorHook(DeciTreeOption<DisorapInfo> option) {
		return new VisiDisorapDaoSelect(option);
	}
}
