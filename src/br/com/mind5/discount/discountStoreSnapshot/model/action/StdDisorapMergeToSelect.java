...
public final class StdDisorapMergeToSelect extends ActionStdTemplate<DisorapInfo> {

	public StdDisorapMergeToSelect(DeciTreeOption<DisorapInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<DisorapInfo> buildVisitorHook(DeciTreeOption<DisorapInfo> option) {
		return new VisiDisorapMergeToSelect(option);
	}
}
