...
public final class LazyDisoupemEnforceCreatedBy extends ActionLazyTemplate<DisoupemInfo, DisoupemInfo> {
	
	public LazyDisoupemEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoupemInfo> getInstanceOfActionHook(DeciTreeOption<DisoupemInfo> option) {
		return new StdDisoupemEnforceCreatedBy(option);
	}
