...
public final class LazyDisoupemEnforceLChanged extends ActionLazyTemplate<DisoupemInfo, DisoupemInfo> {

	public LazyDisoupemEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoupemInfo> getInstanceOfActionHook(DeciTreeOption<DisoupemInfo> option) {
		return new StdDisoupemEnforceLChanged(option);
	}
