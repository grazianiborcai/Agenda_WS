...
public final class LazyDisoupemEnforceCreatedOn extends ActionLazyTemplate<DisoupemInfo, DisoupemInfo> {
	
	public LazyDisoupemEnforceCreatedOn(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoupemInfo> getInstanceOfActionHook(DeciTreeOption<DisoupemInfo> option) {
		return new StdDisoupemEnforceCreatedOn(option);
	}
