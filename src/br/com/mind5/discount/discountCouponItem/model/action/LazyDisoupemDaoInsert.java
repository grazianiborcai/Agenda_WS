...
public final class LazyDisoupemDaoInsert extends ActionLazyTemplate<DisoupemInfo, DisoupemInfo> {
	
	public LazyDisoupemDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoupemInfo> getInstanceOfActionHook(DeciTreeOption<DisoupemInfo> option) {
		return new StdDisoupemDaoInsert(option);
	}
