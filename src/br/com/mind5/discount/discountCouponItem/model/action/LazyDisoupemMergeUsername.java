...
public final class LazyDisoupemMergeUsername extends ActionLazyTemplate<DisoupemInfo, DisoupemInfo> {
	
	public LazyDisoupemMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoupemInfo> getInstanceOfActionHook(DeciTreeOption<DisoupemInfo> option) {
		return new StdDisoupemMergeUsername(option);
	}
