...
public final class StdDisoupemDaoUpdate extends ActionStdTemplate<DisoupemInfo> {

	public StdDisoupemDaoUpdate(DeciTreeOption<DisoupemInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<DisoupemInfo> buildVisitorHook(DeciTreeOption<DisoupemInfo> option) {
		return new VisiDisoupemDaoUpdate(option);
	}
}
