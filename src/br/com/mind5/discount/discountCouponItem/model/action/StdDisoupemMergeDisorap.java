...
public final class StdDisoupemMergeDisorap extends ActionStdTemplate<DisoupemInfo> {

	public StdDisoupemMergeDisorap(DeciTreeOption<DisoupemInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<DisoupemInfo> buildVisitorHook(DeciTreeOption<DisoupemInfo> option) {
		return new VisiDisoupemMergeDisorap(option);
	}
}
