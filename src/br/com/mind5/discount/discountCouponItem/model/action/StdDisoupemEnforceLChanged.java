...
public final class StdDisoupemEnforceLChanged extends ActionStdTemplate<DisoupemInfo> {

	public StdDisoupemEnforceLChanged(DeciTreeOption<DisoupemInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<DisoupemInfo> buildVisitorHook(DeciTreeOption<DisoupemInfo> option) {
		return new VisiDisoupemEnforceLChanged(option);
	}
}
