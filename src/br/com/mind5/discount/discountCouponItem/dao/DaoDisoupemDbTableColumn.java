...
public final class DaoDisoupemDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public static final String COL_DISCOUNT_PERCENT = DaoDbField.COL_DISCOUNT_PERCENT;
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.DISCOUNT_COUPON_TABLE;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_DISCOUNT_PERCENT;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
