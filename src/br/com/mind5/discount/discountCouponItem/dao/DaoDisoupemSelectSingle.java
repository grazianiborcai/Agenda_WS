		...
		return new DaoResultParser<DisoupemInfo>() {
			@Override public List<DisoupemInfo> parseResult(DisoupemInfo redcordInfo, ResultSet stmtResult, long lastId) throws SQLException {
				...
				do {
					...
					dataInfo.codCouponItem = DaoFormatter.sqlToLong(stmtResult, DaoDisoupemDbTableColumn.COL_COD_COUPON_ITEM);
					...
					dataInfo.codDiscountSnapshot = DaoFormatter.sqlToLong(stmtResult, DaoDisoupemDbTableColumn.COL_COD_DISCOUNT_SNAPSHOT);					
					dataInfo.discountPrice = DaoFormatter.sqlToDouble(stmtResult, DaoDisoupemDbTableColumn.COL_DISCOUNT_PRICE);
