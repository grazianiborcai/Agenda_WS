...
public final class DisoreRootSelectActive extends DeciTreeTemplateRead<DisoreInfo> {
	
	public DisoreRootSelectActive(DeciTreeOption<DisoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<DisoreInfo>> buildActionsOnPassedHook(DeciTreeOption<DisoreInfo> option) {
		...
		ActionStd<DisoreInfo> select = new DisoreRootSelect(option).toAction();
