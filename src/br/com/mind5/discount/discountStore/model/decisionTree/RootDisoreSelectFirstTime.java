...
import br.com.mind5.discount.discountStore.model.action.StdDisoreMergeDisorarchFirstTime;
...
public final class RootDisoreSelectFirstTime extends DeciTreeTemplateRead<DisoreInfo> {
	
	public RootDisoreSelectFirstTime(DeciTreeOption<DisoreInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<DisoreInfo>> buildActionsOnPassedHook(DeciTreeOption<DisoreInfo> option) {
		...
		ActionStd<DisoreInfo> search = new StdDisoreMergeDisorarchFirstTime(option);
