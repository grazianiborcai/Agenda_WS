...
public final class DisoreCheckInsertFirstTime extends ModelCheckerTemplateSimple<DisoreInfo> {

	public DisoreCheckInsertFirstTime(ModelCheckerOption option) {
		super(option);
	}
