...
public final class LazyDisoreMergeUsername extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreMergeUsername(option);
	}
