...
public final class LazyDisoreEnforceValidToMax extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreEnforceValidToMax(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreEnforceValidToMax(option);
	}
