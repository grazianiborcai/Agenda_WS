...
import br.com.mind5.discount.discountStore.model.decisionTree.NodeDisoreSnapshot;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyDisoreNodeSnapshot extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreNodeSnapshot(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new NodeDisoreSnapshot(option).toAction();
	}
