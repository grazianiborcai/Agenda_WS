...
public final class LazyDisoreEnforceLChanged extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {

	public LazyDisoreEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreEnforceLChanged(option);
	}
