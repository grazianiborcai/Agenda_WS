...
public final class LazyDisoreEnforceFirstTimeStrategy extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreEnforceFirstTimeStrategy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreEnforceFirstTimeStrategy(option);
	}
