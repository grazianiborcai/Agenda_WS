...
public final class LazyDisoreMergeDisegy extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreMergeDisegy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreMergeDisegy(option);
	}
