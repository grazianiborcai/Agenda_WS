...
public final class LazyDisoreEnforceInactive extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreEnforceInactive(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreEnforceInactive(option);
	}
