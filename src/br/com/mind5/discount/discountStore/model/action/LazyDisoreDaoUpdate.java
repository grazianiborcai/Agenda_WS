...
public final class LazyDisoreDaoUpdate extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreDaoUpdate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreDaoUpdate(option);
	}
