...
public final class LazyDisoreEnforceCreatedBy extends ActionLazyTemplate<DisoreInfo, DisoreInfo> {
	
	public LazyDisoreEnforceCreatedBy(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisoreInfo> getInstanceOfActionHook(DeciTreeOption<DisoreInfo> option) {
		return new StdDisoreEnforceCreatedBy(option);
	}
