...
public final class DisoreDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.DISCOUNT_STORE_TABLE;
