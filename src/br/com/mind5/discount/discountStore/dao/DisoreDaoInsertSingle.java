...
public final class DisoreDaoInsertSingle extends DaoStmtTemplate<DisoreInfo> {
	private final String MAIN_TABLE = DaoDbTable.DISCOUNT_STORE_TABLE;	
	
	
	public DisoreDaoInsertSingle(Connection conn, DisoreInfo recordInfo, String schemaName) {
