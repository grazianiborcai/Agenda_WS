...
public final class DisoreDaoUpdateSingle extends DaoStmtTemplate<DisoreInfo> {
	private final String MAIN_TABLE = DaoDbTable.DISCOUNT_STORE_TABLE;	
	
	
	public DisoreDaoUpdateSingle(Connection conn, DisoreInfo recordInfo, String schemaName) {
