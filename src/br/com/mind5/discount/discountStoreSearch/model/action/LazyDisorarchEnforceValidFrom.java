...
public final class LazyDisorarchEnforceValidFrom extends ActionLazyTemplate<DisorarchInfo, DisorarchInfo> {
	
	public LazyDisorarchEnforceValidFrom(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisorarchInfo> getInstanceOfActionHook(DeciTreeOption<DisorarchInfo> option) {
		return new StdDisorarchEnforceValidFrom(option);
	}
