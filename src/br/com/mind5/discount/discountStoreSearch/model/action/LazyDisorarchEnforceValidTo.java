...
public final class LazyDisorarchEnforceValidTo extends ActionLazyTemplate<DisorarchInfo, DisorarchInfo> {
	
	public LazyDisorarchEnforceValidTo(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisorarchInfo> getInstanceOfActionHook(DeciTreeOption<DisorarchInfo> option) {
		return new StdDisorarchEnforceValidTo(option);
	}
