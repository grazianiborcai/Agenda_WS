...
import br.com.mind5.discount.discountStoreSearch.model.decisionTree.NodeDisorarchActive;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazyDisorarchNodeActive_ extends ActionLazyTemplate<DisorarchInfo, DisorarchInfo> {
	
	public LazyDisorarchNodeActive_(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisorarchInfo> getInstanceOfActionHook(DeciTreeOption<DisorarchInfo> option) {
		return new NodeDisorarchActive(option).toAction();
	}
