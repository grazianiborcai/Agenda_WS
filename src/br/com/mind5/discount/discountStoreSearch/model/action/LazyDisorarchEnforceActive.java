...
public final class LazyDisorarchEnforceActive extends ActionLazyTemplate<DisorarchInfo, DisorarchInfo> {
	
	public LazyDisorarchEnforceActive(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<DisorarchInfo> getInstanceOfActionHook(DeciTreeOption<DisorarchInfo> option) {
		return new StdDisorarchEnforceActive(option);
	}
