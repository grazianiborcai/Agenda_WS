...
public final class DaoStmtExecHelperV2<T extends InfoRecord> implements DaoStmtExecV2<T> {
	private List<DaoStmt<T>> sqlStmts;
	private List<T> resultset;
	private Class<?> stmtClass;	
	
	
	public DaoStmtExecHelperV2(List<DaoStmtExecOption<T>> options, Class<? extends DaoStmt<T>> classOfStmt, Class<T> classOfT) {
