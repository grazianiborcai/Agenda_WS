...
final class DaoStmtBuilderSelectDistinct extends DaoStmtBuilderTemplate {

	DaoStmtBuilderSelectDistinct(DaoStmtBuilderOption option, Class<?> clazz) {
		super(option, clazz);
	}
	...
	private StringBuilder appendOperation(StringBuilder statement) {
		statement.append(DaoOperation.SELECT_DISTINCT.toString());
