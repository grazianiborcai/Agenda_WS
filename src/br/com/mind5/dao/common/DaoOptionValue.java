...
public final class DaoOptionValue {
	...
	public static final boolean LOCK_WRITE = true;
	public static final boolean DONT_LOCK_WRITE = false;
	public static final boolean IGNORE_AUTO_INCREMENTED = true;
	public static final boolean DONT_IGNORE_AUTO_INCREMENTED = false;
	public static final boolean IGNORE_LOOKUP = true;
	public static final boolean DONT_IGNORE_LOOKUP = false;
}
