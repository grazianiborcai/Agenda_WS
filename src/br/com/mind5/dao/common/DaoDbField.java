...
public final class DaoDbField {	
	...
	public static final String COL_COUNT_EMPLOYEE = "count_employee";
	public static final String COL_COUNT_GOODS = "count_goods";
	public static final String COL_COUNT_ORDER_CANCELLED_DAY = "count_order_cancelled_day";
	public static final String COL_COUNT_ORDER_CANCELLED_MONTH = "count_order_cancelled_month";
	public static final String COL_COUNT_ORDER_CANCELLED_MONTH_LAST_YEAR = "count_order_cancelled_month_last_year";
	public static final String COL_COUNT_ORDER_CREATED_DAY = "count_order_created_day";
	public static final String COL_COUNT_ORDER_CREATED_MONTH = "count_order_created_month";
	public static final String COL_COUNT_ORDER_CREATED_MONTH_LAST_YEAR = "count_order_created_month_last_year";
	public static final String COL_COUNT_ORDER_PAID_DAY = "count_order_paid_day";
	public static final String COL_COUNT_ORDER_PAID_MONTH = "count_order_paid_month";
	public static final String COL_COUNT_ORDER_PAID_MONTH_LAST_YEAR = "count_order_paid_month_last_year";
	public static final String COL_COUNT_ORDER_PLACED_DAY = "count_order_placed_day";
	public static final String COL_COUNT_ORDER_PLACED_MONTH = "count_order_placed_month";
	public static final String COL_COUNT_ORDER_PLACED_MONTH_LAST_YEAR = "count_order_placed_month_last_year";
	public static final String COL_COUNT_ORDER_TOTAL_DAY = "count_order_total_day";
	...
	public static final String COL_COUNT_ORDER_WAITING_DAY = "count_order_waiting_day";
	public static final String COL_COUNT_ORDER_WAITING_MONTH = "count_order_waiting_month";
	public static final String COL_COUNT_ORDER_WAITING_MONTH_LAST_YEAR = "count_order_waiting_month_last_year";	
	public static final String COL_COUNT_SCHEDULE_TOTAL_DAY = "count_schedule_total_day";
	public static final String COL_COUNT_SCHEDULE_TOTAL = "count_schedule_total";
	...
	public static final String COL_COUNT_SCHEDULE_CANCELLED = "count_schedule_canceled";
	...
	public static final String COL_COUNT_SCHEDULE_WAITING = "count_schedule_waiting";
	public static final String COL_COUNT_SCHEDULE_WAITING_MONTH = "count_schedule_waiting_month";
	public static final String COL_COUNT_SCHEDULE_WAITING_MONTH_LAST_YEAR = "count_schedule_waiting_month_last_year";
	public static final String COL_COUNT_SCHEDULE_CONFIRMED_DAY = "count_schedule_confirmed_day";
	public static final String COL_COUNT_SCHEDULE_CONFIRMED = "count_schedule_confirmed";
	public static final String COL_COUNT_SCHEDULE_CONFIRMED_MONTH = "count_schedule_confirmed_month";
	public static final String COL_COUNT_SCHEDULE_CONFIRMED_MONTH_LAST_YEAR = "count_schedule_confirmed_month_last_year";
	public static final String COL_COUNT_SCHEDULE_TOTAL_VAR = "count_schedule_total_var";
	public static final String COL_COUNT_SCHEDULE_CANCELLED_VAR = "count_schedule_canceled_var";
	...
	public static final String COL_COUNT_SERVICE = "count_service";	
	...
	public static final String COL_COD_BANK_ACCOUNT_SNAPSHOT = "cod_bank_account_snapshot";
	...
	public static final String COL_COD_COMPE = "cod_compe";	
	...
	public static final String COL_STORE_PARTNER_CREATION = "store_partner_creation";	
	...
	public static final String COL_TOTAL_FEE_12M = "total_fee_12m";
	public static final String COL_TOTAL_FEE_30D = "total_fee_30d";
	public static final String COL_TOTAL_FEE_DAY = "total_fee_day";
	public static final String COL_TOTAL_FEE_CANCELLED_12M = "total_fee_cancelled_12m";
	public static final String COL_TOTAL_FEE_CANCELLED_30D = "total_fee_cancelled_30d";
	public static final String COL_TOTAL_FEE_CANCELLED_DAY = "total_fee_cancelled_day";
	public static final String COL_TOTAL_FEE_CANCELLED_MONTH = "total_fee_cancelled_month";
	public static final String COL_TOTAL_FEE_CANCELLED_MONTH_LAST_YEAR = "total_fee_cancelled_month_last_year";
	public static final String COL_TOTAL_FEE_CREATED_DAY = "total_fee_created_day";
	public static final String COL_TOTAL_FEE_CREATED_MONTH = "total_fee_created_month";
	public static final String COL_TOTAL_FEE_CREATED_MONTH_LAST_YEAR = "total_fee_created_month_last_year";
	...
	public static final String COL_TOTAL_FEE_PAID_12M = "total_fee_paid_12m";
	public static final String COL_TOTAL_FEE_PAID_30D = "total_fee_paid_30d";
	public static final String COL_TOTAL_FEE_PAID_DAY = "total_fee_paid_day";
	public static final String COL_TOTAL_FEE_PAID_MONTH = "total_fee_paid_month";
	public static final String COL_TOTAL_FEE_PAID_MONTH_LAST_YEAR = "total_fee_paid_month_last_year";
	public static final String COL_TOTAL_FEE_PLACED_12M = "total_fee_placed_12m";
	public static final String COL_TOTAL_FEE_PLACED_30D = "total_fee_placed_30d";
	public static final String COL_TOTAL_FEE_PLACED_DAY = "total_fee_placed_day";
	public static final String COL_TOTAL_FEE_PLACED_MONTH = "total_fee_placed_month";
	public static final String COL_TOTAL_FEE_PLACED_MONTH_LAST_YEAR = "total_fee_placed_month_last_year";
	public static final String COL_TOTAL_FEE_VAR = "total_fee_var";
	public static final String COL_TOTAL_FEE_WAITING_12M = "total_fee_waiting_12m";
	public static final String COL_TOTAL_FEE_WAITING_30D = "total_fee_waiting_30d";
	public static final String COL_TOTAL_FEE_WAITING_DAY = "total_fee_waiting_day";
	public static final String COL_TOTAL_FEE_WAITING_MONTH = "total_fee_waiting_month_last_year";
	public static final String COL_TOTAL_FEE_WAITING_MONTH_LAST_YEAR = "total_fee_waiting_month";
	...
	public static final String COL_TOTAL_SALE_12M = "total_sale_12m";
	public static final String COL_TOTAL_SALE_30D = "total_sale_30d";
	public static final String COL_TOTAL_SALE_CANCELLED_12M = "total_sale_cancelled_12m";
	public static final String COL_TOTAL_SALE_CANCELLED_30D = "total_sale_cancelled_30d";
	public static final String COL_TOTAL_SALE_CANCELLED_DAY = "total_sale_cancelled_day";
	public static final String COL_TOTAL_SALE_CANCELLED_MONTH = "total_sale_cancelled_month";
	public static final String COL_TOTAL_SALE_CANCELLED_MONTH_LAST_YEAR = "total_sale_cancelled_month_last_year";
	public static final String COL_TOTAL_SALE_CREATED_12M = "total_sale_created_12m";
	public static final String COL_TOTAL_SALE_CREATED_30D = "total_sale_created_30d";
	public static final String COL_TOTAL_SALE_CREATED_DAY = "total_sale_created_day";
	public static final String COL_TOTAL_SALE_CREATED_MONTH = "total_sale_created_month";
	public static final String COL_TOTAL_SALE_CREATED_MONTH_LAST_YEAR = "total_sale_created_month_last_year";
	public static final String COL_TOTAL_SALE_DAY = "total_sale_day";
	...
	public static final String COL_TOTAL_SALE_PAID_12M = "total_sale_paid_12m";
	public static final String COL_TOTAL_SALE_PAID_30D = "total_sale_paid_30d";
	public static final String COL_TOTAL_SALE_PAID_DAY = "total_sale_paid_day";
	public static final String COL_TOTAL_SALE_PAID_MONTH = "total_sale_paid_month";
	public static final String COL_TOTAL_SALE_PAID_MONTH_LAST_YEAR = "total_sale_paid_month_last_year";
	public static final String COL_TOTAL_SALE_PLACED_12M = "total_sale_placed_12m";
	public static final String COL_TOTAL_SALE_PLACED_30D = "total_sale_placed_30d";
	public static final String COL_TOTAL_SALE_PLACED_DAY = "total_sale_placed_day";
	public static final String COL_TOTAL_SALE_PLACED_MONTH = "total_sale_placed_month";
	public static final String COL_TOTAL_SALE_PLACED_MONTH_LAST_YEAR = "total_sale_placed_month_last_year";
	public static final String COL_TOTAL_SALE_VAR = "total_sale_var";
	public static final String COL_TOTAL_SALE_WAITING_12M = "total_sale_waiting_12m";
	public static final String COL_TOTAL_SALE_WAITING_30D = "total_sale_waiting_30d";
	public static final String COL_TOTAL_SALE_WAITING_DAY = "total_sale_waiting_day";
	public static final String COL_TOTAL_SALE_WAITING_MONTH = "total_sale_waiting_month";
	public static final String COL_TOTAL_SALE_WAITING_MONTH_LAST_YEAR = "total_sale_waiting_month_last_year";
