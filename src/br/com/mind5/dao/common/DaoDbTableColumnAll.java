...
import br.com.mind5.business.bankAccountSearch.dao.BankaccarchDaoDbTableColumn;
import br.com.mind5.business.bankAccountSnapshot.dao.BankaccnapDaoDbTableColumn;
...
import br.com.mind5.discount.discountStoreSearch.dao.DisorarchDaoDbTableColumn;
import br.com.mind5.discount.discountStoreSnapshot.dao.DisorapDaoDbTableColumn;
...
import br.com.mind5.masterData.bankHolderTypeSearch.dao.BankoldyperchDaoDbTableColumn;
import br.com.mind5.masterData.bankSearch.dao.BankarchDaoDbTableColumn;
...
import br.com.mind5.masterData.monthSearch.dao.MontharchDaoDbTableColumn;
...
import br.com.mind5.masterData.paymentPartnerDefault.dao.PayparultDaoDbTableColumn;
...
import br.com.mind5.masterData.petWeightSearch.dao.PeteightarchDaoDbTableColumn;
import br.com.mind5.masterData.position.dao.PositionDaoDbTableColumn;
import br.com.mind5.masterData.prospectStatus.dao.ProstusDaoDbTableColumn;
...
import br.com.mind5.message.sysMessage.dao.SymsgDaoDbTableColumn;
...
import br.com.mind5.payment.marketplacePartner.dao.MktparDaoDbTableColumn;
import br.com.mind5.payment.marketplacePartnerSearch.dao.MktpararchDaoDbTableColumn;
...
import br.com.mind5.stats.statsUserStore.userStoreLive.dao.StusoreveDaoDbTableColumn;
...
public final class DaoDbTableColumnAll {
	...
	static {
		...
		addTable(new MktpararchDaoDbTableColumn());
		addTable(new MktparDaoDbTableColumn());
		...
		addTable(new SymsgDaoDbTableColumn());
		...
		addTable(new MoonasarchDaoDbTableColumn());
		addTable(new MoonaseDaoDbTableColumn());
		addTable(new MooncalDaoDbTableColumn());
		addTable(new CalateDaoDbTableColumn());
		addTable(new StateDaoDbTableColumn());
		addTable(new StatarchDaoDbTableColumn());
		...
		addTable(new MatunitarchDaoDbTableColumn());
		...
		addTable(new RefugrarchDaoDbTableColumn());
		...
		addTable(new ProstusDaoDbTableColumn());
		addTable(new ProstarchDaoDbTableColumn());
		...
		addTable(new SytotinDaoDbTableColumn());
		...
		addTable(new PeteightarchDaoDbTableColumn());
