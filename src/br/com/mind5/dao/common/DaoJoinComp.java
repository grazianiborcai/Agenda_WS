...
public final class DaoJoinComp implements DaoJoinBuilder {
	private final String leftTable;
	
	
	public DaoJoinComp(String leftTableName) {
	...
	@Override public DaoJoin build() {
		...
		join.rightTableName = DaoDbTable.COMP_TABLE;
	...
	private List<DaoJoinColumn> getJoinColumns(String leftTableName) {
		...
		oneColumn.leftColumnName = DaoDbField.COL_COD_COMPANY;
		oneColumn.rightColumnName = DaoDbField.COL_COD_COMPANY;
