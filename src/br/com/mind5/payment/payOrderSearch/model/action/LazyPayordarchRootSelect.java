...
public final class LazyPayordarchRootSelect extends ActionLazyTemplateV1<PayordarchInfo, PayordarchInfo> {
	...
	@Override protected ActionStdV1<PayordarchInfo> getInstanceOfActionHook(DeciTreeOption<PayordarchInfo> option) {
