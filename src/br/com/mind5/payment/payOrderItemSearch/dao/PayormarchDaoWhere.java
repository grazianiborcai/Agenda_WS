...
public final class PayormarchDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public PayormarchDaoWhere(DaoWhereBuilderOption whereOption, String tableName, PayormarchInfo recordInfo) {
