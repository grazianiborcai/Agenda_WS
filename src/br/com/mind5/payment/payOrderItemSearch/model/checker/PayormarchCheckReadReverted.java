...
public final class PayormarchCheckReadReverted extends ModelCheckerTemplateSimple<PayormarchInfo> {

	public PayormarchCheckReadReverted(ModelCheckerOption option) {
		super(option);
	}
