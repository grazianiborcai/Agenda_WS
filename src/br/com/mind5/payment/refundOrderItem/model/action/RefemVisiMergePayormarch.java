...
public final class RefemVisiMergePayormarch extends ActionVisitorTemplateMerge<RefemInfo, PayormarchInfo> {
	
	public RefemVisiMergePayormarch(DeciTreeOption<RefemInfo> option) {
