...
import br.com.mind5.payment.refundOrderItem.model.decisionTree.RefemNodeRefundL1;

public final class RefemVisiNodeRefundL1 extends ActionVisitorTemplateAction<RefemInfo, RefemInfo> {

	public RefemVisiNodeRefundL1(DeciTreeOption<RefemInfo> option) {
	...
	@Override protected Class<? extends DeciTree<RefemInfo>> getTreeClassHook() {
		return RefemNodeRefundL1.class;
	}
