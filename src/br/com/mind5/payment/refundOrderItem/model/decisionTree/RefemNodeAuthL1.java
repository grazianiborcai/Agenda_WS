...
public final class RefemNodeAuthL1 extends DeciTreeTemplateWrite<RefemInfo> {
	
	public RefemNodeAuthL1(DeciTreeOption<RefemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<RefemInfo>> buildActionsOnFailedHook(DeciTreeOption<RefemInfo> option) {
		...
		ActionStd<RefemInfo> nodeL2 = new RefemNodeAuthL2(option).toAction();	
