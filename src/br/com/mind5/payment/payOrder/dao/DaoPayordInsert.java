...
public final class DaoPayordInsert implements DaoStmtExecV2<PayordInfo> {
	private DaoStmtExecV2<PayordInfo> helper;
	
	
	public DaoPayordInsert(List<DaoStmtExecOption<PayordInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoPayordInsertSingle.class, PayordInfo.class);
	}
