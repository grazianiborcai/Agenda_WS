...
public final class PayordDaoUpdateSingle extends DaoStmtTemplate<PayordInfo> {
	private final String MAIN_TABLE = DaoDbTable.PAY_ORDER_HDR_TABLE;
	
	
	public PayordDaoUpdateSingle(Connection conn, PayordInfo recordInfo, String schemaName) {
