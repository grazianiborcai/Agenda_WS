...
public final class PayordRootSelectAuth extends DeciTreeTemplateRead<PayordInfo> {
	
	public PayordRootSelectAuth(DeciTreeOption<PayordInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PayordInfo>> buildActionsOnPassedHook(DeciTreeOption<PayordInfo> option) {
		...
		ActionStd<PayordInfo> nodeSelect = new PayordRootSelect(option).toAction();
