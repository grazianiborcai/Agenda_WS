...
public final class PayordRootRefreshAuth extends DeciTreeTemplateRead<PayordInfo> {
	
	public PayordRootRefreshAuth(DeciTreeOption<PayordInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PayordInfo>> buildActionsOnPassedHook(DeciTreeOption<PayordInfo> option) {
		...
		ActionStd<PayordInfo> nodeRefresh = new PayordRootRefresh(option).toAction();
		
		actions.add(nodeAuth);		
		actions.add(nodeRefresh);
