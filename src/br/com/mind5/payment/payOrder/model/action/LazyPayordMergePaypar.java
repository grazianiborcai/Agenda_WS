...
public final class LazyPayordMergePaypar extends ActionLazyTemplateV1<PayordInfo, PayordInfo> {
	
	public LazyPayordMergePaypar(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordMergePaypar(option);
	}
