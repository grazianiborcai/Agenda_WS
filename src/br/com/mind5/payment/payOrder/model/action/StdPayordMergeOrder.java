...
public final class StdPayordMergeOrder implements ActionStdV1<PayordInfo> {
	private ActionStdV1<PayordInfo> actionHelper;	
	
	
	public StdPayordMergeOrder(DeciTreeOption<PayordInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPayordMergeOrder(option.conn, option.schemaName));
	}
