...
public final class LazyPayordOrderRefresh extends ActionLazyTemplateV2<PayordInfo, PayordInfo> {
	
	public LazyPayordOrderRefresh(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordOrderRefresh(option);
	}
