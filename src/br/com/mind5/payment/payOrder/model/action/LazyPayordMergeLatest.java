...
public final class LazyPayordMergeLatest extends ActionLazyTemplate<PayordInfo, PayordInfo> {
	
	public LazyPayordMergeLatest(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordMergeLatest(option);
	}
