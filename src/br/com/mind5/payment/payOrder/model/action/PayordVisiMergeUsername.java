...
public final class PayordVisiMergeUsername extends ActionVisitorTemplateMerge<PayordInfo, UsernameInfo> {
	
	public PayordVisiMergeUsername(DeciTreeOption<PayordInfo> option) {
