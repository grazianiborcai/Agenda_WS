...
final class VisiPayordMergeCrecardAuth extends ActionVisitorTemplateMergeV2<PayordInfo, CrecardInfo> {
	
	public VisiPayordMergeCrecardAuth(DeciTreeOption<PayordInfo> option) {
