...
public final class LazyPayordMergePayordem extends ActionLazyTemplateV1<PayordInfo, PayordInfo> {
	
	public LazyPayordMergePayordem(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordMergePayordem(option);
	}
