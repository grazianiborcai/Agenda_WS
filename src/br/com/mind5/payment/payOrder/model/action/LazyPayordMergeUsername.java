...
public final class LazyPayordMergeUsername extends ActionLazyTemplateV1<PayordInfo, PayordInfo> {
	
	public LazyPayordMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordMergeUsername(option);
	}
