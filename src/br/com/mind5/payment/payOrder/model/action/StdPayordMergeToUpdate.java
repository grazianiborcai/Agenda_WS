...
public final class StdPayordMergeToUpdate implements ActionStdV1<PayordInfo> {
	private ActionStdV1<PayordInfo> actionHelper;	
	
	
	public StdPayordMergeToUpdate(DeciTreeOption<PayordInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPayordMergeToUpdate(option.conn, option.schemaName));
	}
