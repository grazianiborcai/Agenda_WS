...
import br.com.mind5.payment.payOrder.model.decisionTree.NodePayordUserL2;

public final class LazyPayordNodeUserL2 extends ActionLazyTemplate<PayordInfo, PayordInfo> {
	
	public LazyPayordNodeUserL2(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new NodePayordUserL2(option).toAction();
	}
