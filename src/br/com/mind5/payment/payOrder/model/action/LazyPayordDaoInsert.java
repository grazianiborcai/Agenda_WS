...
public final class LazyPayordDaoInsert extends ActionLazyTemplateV2<PayordInfo, PayordInfo> {
	
	public LazyPayordDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordDaoInsert(option);
	}
