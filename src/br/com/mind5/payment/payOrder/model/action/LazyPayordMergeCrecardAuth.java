...
public final class LazyPayordMergeCrecardAuth extends ActionLazyTemplateV2<PayordInfo, PayordInfo> {
	
	public LazyPayordMergeCrecardAuth(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordMergeCrecardAuth(option);
	}
