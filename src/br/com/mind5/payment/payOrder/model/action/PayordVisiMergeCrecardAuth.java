...
public final class PayordVisiMergeCrecardAuth extends ActionVisitorTemplateMerge<PayordInfo, CrecardInfo> {
	
	public PayordVisiMergeCrecardAuth(DeciTreeOption<PayordInfo> option) {
