...
public final class LazyPayordMergeToSelect extends ActionLazyTemplateV2<PayordInfo, PayordInfo> {
	
	public LazyPayordMergeToSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordMergeToSelect(option);
	}
