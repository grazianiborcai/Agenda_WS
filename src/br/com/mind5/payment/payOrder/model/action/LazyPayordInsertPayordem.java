...
public final class LazyPayordInsertPayordem extends ActionLazyTemplateV1<PayordInfo, PayordInfo> {

	public LazyPayordInsertPayordem(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordInsertPayordem(option);
	}
