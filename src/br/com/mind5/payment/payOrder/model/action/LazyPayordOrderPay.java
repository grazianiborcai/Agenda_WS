...
public final class LazyPayordOrderPay extends ActionLazyTemplateV1<PayordInfo, PayordInfo> {
	
	public LazyPayordOrderPay(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PayordInfo> getInstanceOfActionHook(DeciTreeOption<PayordInfo> option) {
		return new StdPayordOrderPay(option);
	}
