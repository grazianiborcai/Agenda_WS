...
public final class DaoCusparSelect implements DaoStmtExecV2<CusparInfo> {
	private DaoStmtExecV2<CusparInfo> helper;
	
	
	public DaoCusparSelect(List<DaoStmtExecOption<CusparInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoCusparSelectSingle.class, CusparInfo.class);
	}
