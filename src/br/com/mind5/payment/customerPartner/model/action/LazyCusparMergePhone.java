...
public final class LazyCusparMergePhone extends ActionLazyTemplateV1<CusparInfo, CusparInfo> {

	public LazyCusparMergePhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusparInfo> getInstanceOfActionHook(DeciTreeOption<CusparInfo> option) {
		return new StdCusparMergePhone(option);
	}
