...
public final class StdCusparMergeToSelect implements ActionStdV1<CusparInfo> {
	private ActionStdV1<CusparInfo> actionHelper;	
	
	
	public StdCusparMergeToSelect(DeciTreeOption<CusparInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiCusparMergeToSelect(option.conn, option.schemaName));
	}
