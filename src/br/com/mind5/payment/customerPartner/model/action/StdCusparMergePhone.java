...
public final class StdCusparMergePhone implements ActionStdV1<CusparInfo> {
	private ActionStdV1<CusparInfo> actionHelper;	
	
	
	public StdCusparMergePhone(DeciTreeOption<CusparInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiCusparMergePhone(option.conn, option.schemaName));
	}
