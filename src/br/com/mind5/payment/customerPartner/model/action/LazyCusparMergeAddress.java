...
public final class LazyCusparMergeAddress extends ActionLazyTemplateV2<CusparInfo, CusparInfo> {

	public LazyCusparMergeAddress(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusparInfo> getInstanceOfActionHook(DeciTreeOption<CusparInfo> option) {
		return new StdCusparMergeAddress(option);
	}
