...
public final class LazyCusparMergeUserap extends ActionLazyTemplate<CusparInfo, CusparInfo> {

	public LazyCusparMergeUserap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusparInfo> getInstanceOfActionHook(DeciTreeOption<CusparInfo> option) {
		return new StdCusparMergeUserap(option);
	}
