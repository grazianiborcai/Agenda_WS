...
public final class LazyCusparEnforceLChanged extends ActionLazyTemplateV1<CusparInfo, CusparInfo> {

	public LazyCusparEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CusparInfo> getInstanceOfActionHook(DeciTreeOption<CusparInfo> option) {
		return new StdCusparEnforceLChanged(option);
	}
