...
import br.com.mind5.payment.customerPartner.dao.CusparUpdate;
import br.com.mind5.payment.customerPartner.info.CusparInfo;

public final class StdCusparUpdate implements ActionStdV1<CusparInfo> {
	private ActionStdV1<CusparInfo> actionHelper;
	
	
	public StdCusparUpdate(DeciTreeOption<CusparInfo> option) {
	...
	private DaoStmtExec_<CusparInfo> buildStmtExec(DeciTreeOption<CusparInfo> option) {
		...
		return new CusparUpdate(stmtExecOptions);
	}
