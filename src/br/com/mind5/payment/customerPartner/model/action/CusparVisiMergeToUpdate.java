...
public final class CusparVisiMergeToUpdate extends ActionVisitorTemplateMerge<CusparInfo, CusparInfo> {
	
	public CusparVisiMergeToUpdate(DeciTreeOption<CusparInfo> option) {
	...
	@Override protected List<CusparInfo> mergeHook(List<CusparInfo> baseInfos, List<CusparInfo> selectedInfos) {	
		return CusparMerger.mergeToUpdate(baseInfos, selectedInfos);
	}
