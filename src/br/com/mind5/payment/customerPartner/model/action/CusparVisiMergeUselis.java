...
public final class CusparVisiMergeUselis extends ActionVisitorTemplateMerge<CusparInfo, UselisInfo> {
	
	public CusparVisiMergeUselis(DeciTreeOption<CusparInfo> option) {
