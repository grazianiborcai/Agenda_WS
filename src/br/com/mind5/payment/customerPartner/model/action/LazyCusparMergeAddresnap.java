...
public final class LazyCusparMergeAddresnap extends ActionLazyTemplate<CusparInfo, CusparInfo> {

	public LazyCusparMergeAddresnap(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<CusparInfo> getInstanceOfActionHook(DeciTreeOption<CusparInfo> option) {
		return new StdCusparMergeAddresnap(option);
	}
