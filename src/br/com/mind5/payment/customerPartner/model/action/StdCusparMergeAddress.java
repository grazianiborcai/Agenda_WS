...
public final class StdCusparMergeAddress implements ActionStdV1<CusparInfo> {
	private ActionStdV1<CusparInfo> actionHelper;	
	
	
	public StdCusparMergeAddress(DeciTreeOption<CusparInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiCusparMergeAddress(option.conn, option.schemaName));
	}
