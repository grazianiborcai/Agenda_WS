...
public final class CusparCheckPhonarchUser extends ModelCheckerTemplateAction<CusparInfo, PhonarchInfo> {	
	
	public CusparCheckPhonarchUser(ModelCheckerOption option) {
