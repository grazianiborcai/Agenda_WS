...
import br.com.mind5.payment.customerPartner.model.action.CusparVisiNodeSelectL1;
...
public final class CusparRootSelect extends DeciTreeTemplateRead<CusparInfo> {
	
	public CusparRootSelect(DeciTreeOption<CusparInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CusparInfo>> buildActionsOnPassedHook(DeciTreeOption<CusparInfo> option) {
		...
		ActionLazy<CusparInfo> nodeL1 = new ActionLazyCommom<CusparInfo>(option, CusparVisiNodeSelectL1.class);
