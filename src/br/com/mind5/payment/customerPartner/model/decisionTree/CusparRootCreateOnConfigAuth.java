...
import br.com.mind5.payment.customerPartner.model.action.CusparVisiRootCreateOnConfig;
...
public final class CusparRootCreateOnConfigAuth extends DeciTreeTemplateWrite<CusparInfo> {
	
	public CusparRootCreateOnConfigAuth(DeciTreeOption<CusparInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CusparInfo>> buildActionsOnPassedHook(DeciTreeOption<CusparInfo> option) {
		...
		ActionLazy<CusparInfo> create = new ActionLazyCommom<CusparInfo>(option, CusparVisiRootCreateOnConfig.class);
