...
public final class StoparDaoUpdateSingle extends DaoStmtTemplate<StoparInfo> {
	private final String MAIN_TABLE = DaoDbTable.PAY_PARTNER_STORE_TABLE;	
	
	
	public StoparDaoUpdateSingle(Connection conn, StoparInfo recordInfo, String schemaName) {
