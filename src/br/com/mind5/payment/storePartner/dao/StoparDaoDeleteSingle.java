...
public final class StoparDaoDeleteSingle extends DaoStmtTemplate<StoparInfo> {
	private final String MAIN_TABLE = DaoDbTable.PAY_PARTNER_STORE_TABLE;	
	
	
	public StoparDaoDeleteSingle(Connection conn, StoparInfo recordInfo, String schemaName) {
