...
public final class DaoStoparUpdate implements DaoStmtExecV2<StoparInfo> {
	private DaoStmtExecV2<StoparInfo> helper;
	
	
	public DaoStoparUpdate(List<DaoStmtExecOption<StoparInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoStoparUpdateSingle.class, StoparInfo.class);
	}
