...
import br.com.mind5.payment.storePartner.model.action.StoparVisiMergePaypar;
import br.com.mind5.payment.storePartner.model.action.StoparVisiMergeToSelect;
...
public final class StoparRootSelect extends DeciTreeTemplateRead<StoparInfo> {
	
	public StoparRootSelect(DeciTreeOption<StoparInfo> option) {
		super(option);
	}
