...
public final class StdStoparEnforceDel implements ActionStdV1<StoparInfo> {
	private ActionStdV1<StoparInfo> actionHelper;	
	
	
	public StdStoparEnforceDel(DeciTreeOption<StoparInfo> option) {			
		actionHelper = new ActionStdHelperEnforce<>(option.recordInfos, new VisiStoparEnforceDel());
	}
