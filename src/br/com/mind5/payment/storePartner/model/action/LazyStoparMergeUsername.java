...
public final class LazyStoparMergeUsername extends ActionLazyTemplateV2<StoparInfo, StoparInfo> {
	
	public LazyStoparMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoparInfo> getInstanceOfActionHook(DeciTreeOption<StoparInfo> option) {
		return new StdStoparMergeUsername(option);
	}
