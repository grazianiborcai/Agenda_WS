...
public final class LazyStoparMergePaypar extends ActionLazyTemplateV1<StoparInfo, StoparInfo> {
	
	public LazyStoparMergePaypar(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoparInfo> getInstanceOfActionHook(DeciTreeOption<StoparInfo> option) {
		return new StdStoparMergePaypar(option);
	}
