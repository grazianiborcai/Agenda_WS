...
import br.com.mind5.payment.storePartner.dao.StoparUpdate;
import br.com.mind5.payment.storePartner.info.StoparInfo;

public final class StdStoparUpdate implements ActionStdV1<StoparInfo> {
	private ActionStdV1<StoparInfo> actionHelper;
	
	
	public StdStoparUpdate(DeciTreeOption<StoparInfo> option) {
	...
	private DaoStmtExec_<StoparInfo> buildStmtExec(DeciTreeOption<StoparInfo> option) {
		...
		return new StoparUpdate(stmtExecOptions);
	}
