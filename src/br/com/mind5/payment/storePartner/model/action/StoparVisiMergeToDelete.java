...
public final class StoparVisiMergeToDelete extends ActionVisitorTemplateMerge<StoparInfo, StoparInfo> {
	
	public StoparVisiMergeToDelete(DeciTreeOption<StoparInfo> option) {
