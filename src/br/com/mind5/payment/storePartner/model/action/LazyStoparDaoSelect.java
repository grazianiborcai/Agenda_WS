...
public final class LazyStoparDaoSelect extends ActionLazyTemplateV2<StoparInfo, StoparInfo> {
	
	public LazyStoparDaoSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<StoparInfo> getInstanceOfActionHook(DeciTreeOption<StoparInfo> option) {
		return new StdStoparDaoSelect(option);
	}
