...
public final class StoparVisiMergeStoparchStore extends ActionVisitorTemplateMerge<StoparInfo, StoparchInfo> {
	
	public StoparVisiMergeStoparchStore(DeciTreeOption<StoparInfo> option) {
	...
	@Override protected Class<? extends DeciTree<StoparchInfo>> getTreeClassHook() {
		return StoparchRootSelectStore.class;
	}
