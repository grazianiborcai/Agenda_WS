...
public final class StdPayordemistSelect implements ActionStd<PayordemistInfo> {
	...
	public StdPayordemistSelect(DeciTreeOption<PayordemistInfo> option) {
		DaoStmtExec<PayordemistInfo> sqlStmtExecutor = buildStmtExec(option);
		actionHelper = new ActionStdHelperStmt<>(sqlStmtExecutor);
	}
	
	
	
	private DaoStmtExec<PayordemistInfo> buildStmtExec(DeciTreeOption<PayordemistInfo> option) {
