...
public final class CounparchSelect implements DaoStmtExec<CounparchInfo> {
	private DaoStmtExec<CounparchInfo> helper;
	
	
	public CounparchSelect(List<DaoStmtExecOption<CounparchInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, CounparchSelectSingle.class, CounparchInfo.class);
	}
