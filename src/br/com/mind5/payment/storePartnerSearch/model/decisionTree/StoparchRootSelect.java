...
import br.com.mind5.payment.storePartnerSearch.model.action.StoparchVisiMergeToSelect;
...
public final class StoparchRootSelect extends DeciTreeTemplateRead<StoparchInfo> {
	
	public StoparchRootSelect(DeciTreeOption<StoparchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StoparchInfo>> buildActionsOnPassedHook(DeciTreeOption<StoparchInfo> option) {
		...
		ActionStd<StoparchInfo> select = new ActionStdCommom<StoparchInfo>(option, StoparchVisiMergeToSelect.class);
