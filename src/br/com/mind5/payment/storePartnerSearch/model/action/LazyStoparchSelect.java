...
public final class LazyStoparchSelect extends ActionLazyTemplateV1<StoparchInfo, StoparchInfo> {
	...
	@Override protected ActionStdV1<StoparchInfo> getInstanceOfActionHook(DeciTreeOption<StoparchInfo> option) {
