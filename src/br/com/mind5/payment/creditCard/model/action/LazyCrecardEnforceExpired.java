...
public final class LazyCrecardEnforceExpired extends ActionLazyTemplateV2<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardEnforceExpired(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new StdCrecardEnforceExpired(option);
	}
