...
public final class LazyCrecardMergeUsername extends ActionLazyTemplateV1<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardMergeUsername(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new StdCrecardMergeUsername(option);
	}
