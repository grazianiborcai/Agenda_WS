...
public final class LazyCrecardEnforceLChanged extends ActionLazyTemplateV1<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new StdCrecardEnforceLChanged(option);
	}
