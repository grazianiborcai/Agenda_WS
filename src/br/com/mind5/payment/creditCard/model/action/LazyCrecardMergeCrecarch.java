...
public final class LazyCrecardMergeCrecarch extends ActionLazyTemplateV1<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardMergeCrecarch(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new StdCrecardMergeCrecarch(option);
	}
