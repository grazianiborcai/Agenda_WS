...
public final class LazyCrecardEnforceUpperCase extends ActionLazyTemplate<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardEnforceUpperCase(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV2<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new StdCrecardEnforceUpperCase(option);
	}
