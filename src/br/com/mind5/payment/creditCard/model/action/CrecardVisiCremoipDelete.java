...
public final class CrecardVisiCremoipDelete extends ActionVisitorTemplateAction<CrecardInfo, CremoipInfo> {
	
	public CrecardVisiCremoipDelete(DeciTreeOption<CrecardInfo> option) {
