...
import br.com.mind5.payment.creditCard.model.decisionTree.NodeCrecardPhone;

public final class LazyCrecardNodePhone extends ActionLazyTemplateV1<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardNodePhone(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new NodeCrecardPhone(option).toAction();
	}
