...
public final class LazyCrecardMergeToDelete extends ActionLazyTemplateV2<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardMergeToDelete(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new StdCrecardMergeToDelete(option);
	}
