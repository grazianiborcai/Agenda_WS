...
import br.com.mind5.payment.creditCard.dao.CrecardInsert;
import br.com.mind5.payment.creditCard.info.CrecardInfo;

public final class StdCrecardInsert implements ActionStdV1<CrecardInfo> {
	private ActionStdV1<CrecardInfo> actionHelper;
	
	
	public StdCrecardInsert(DeciTreeOption<CrecardInfo> option) {
	...
	private DaoStmtExec_<CrecardInfo> buildStmtExec(DeciTreeOption<CrecardInfo> option) {
		...
		return new CrecardInsert(stmtExecOptions);
	}
