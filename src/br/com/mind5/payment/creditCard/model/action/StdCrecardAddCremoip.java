...
public final class StdCrecardAddCremoip implements ActionStdV1<CrecardInfo> {
	private ActionStdV1<CrecardInfo> actionHelper;	
	
	
	public StdCrecardAddCremoip(DeciTreeOption<CrecardInfo> option) {			
		actionHelper = new ActionStdHelperAction<>(option.recordInfos, new VisiCrecardAddCremoip(option.conn, option.schemaName));
	}
