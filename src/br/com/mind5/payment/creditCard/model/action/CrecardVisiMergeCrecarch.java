...
import br.com.mind5.payment.creditCardSearch.model.decisionTree.CrecarchRootSelectCuspar;

public final class CrecardVisiMergeCrecarch extends ActionVisitorTemplateMerge<CrecardInfo, CrecarchInfo> {
	
	public CrecardVisiMergeCrecarch(DeciTreeOption<CrecardInfo> option) {
	...
	@Override protected Class<? extends DeciTree<CrecarchInfo>> getTreeClassHook() {
		return CrecarchRootSelectCuspar.class;
	}
