...
public final class LazyCrecardEnforceUserKey extends ActionLazyTemplateV2<CrecardInfo, CrecardInfo> {
	
	public LazyCrecardEnforceUserKey(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<CrecardInfo> getInstanceOfActionHook(DeciTreeOption<CrecardInfo> option) {
		return new StdCrecardEnforceUserKey(option);
	}
