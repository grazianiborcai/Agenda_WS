...
import br.com.mind5.payment.creditCard.model.action.CrecardVisiNodeCusparRefL1;

public final class CrecardNodeAuth extends DeciTreeTemplateWrite<CrecardInfo> {
	
	public CrecardNodeAuth(DeciTreeOption<CrecardInfo> option) {
		super(option);
	}
