...
public final class NodeCrecardAuth extends DeciTreeTemplateWriteV2<CrecardInfo> {
	...
	@Override protected List<ActionStdV1<CrecardInfo>> buildActionsOnPassedHook(DeciTreeOption<CrecardInfo> option) {
		...
		ActionLazyV1<CrecardInfo> nodeCusparRef = new LazyCrecardNodeCusparRefL1(option.conn, option.schemaName);
