...
public final class NodeCrecardInsertMoip extends DeciTreeTemplateWriteV2<CrecardInfo> {
	...
	@Override protected List<ActionStdV2<CrecardInfo>> buildActionsOnPassedHook(DeciTreeOption<CrecardInfo> option) {
		...
		ActionStdV2<CrecardInfo> addCremoip = new StdCrecardAddCremoip(option);
