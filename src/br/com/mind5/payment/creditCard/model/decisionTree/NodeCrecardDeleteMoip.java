...
public final class NodeCrecardDeleteMoip extends DeciTreeTemplateWriteV2<CrecardInfo> {
	...
	@Override protected List<ActionStdV2<CrecardInfo>> buildActionsOnPassedHook(DeciTreeOption<CrecardInfo> option) {
		...
		ActionStdV2<CrecardInfo> deleteCremoip = new StdCrecardDeleteCremoip(option);
