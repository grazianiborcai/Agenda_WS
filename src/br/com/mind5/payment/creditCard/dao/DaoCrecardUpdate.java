...
public final class DaoCrecardUpdate implements DaoStmtExecV2<CrecardInfo> {
	private DaoStmtExecV2<CrecardInfo> helper;
	
	
	public DaoCrecardUpdate(List<DaoStmtExecOption<CrecardInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoCrecardUpdateSingle.class, CrecardInfo.class);
	}
