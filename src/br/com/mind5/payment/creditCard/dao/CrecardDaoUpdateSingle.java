...
public final class CrecardDaoUpdateSingle extends DaoStmtTemplate<CrecardInfo> {
	private final String MAIN_TABLE = DaoDbTable.CREDIT_CARD_TABLE;
	
	
	public CrecardDaoUpdateSingle(Connection conn, CrecardInfo recordInfo, String schemaName) {
