...
public final class DaoCrecardDelete implements DaoStmtExecV2<CrecardInfo> {
	private DaoStmtExecV2<CrecardInfo> helper;
	
	
	public DaoCrecardDelete(List<DaoStmtExecOption<CrecardInfo>> options) {
		helper = new DaoStmtExecHelperV2<>(options, DaoCrecardDeleteSingle.class, CrecardInfo.class);
	}
