...
public final class DaoCrecardSelect implements DaoStmtExec<CrecardInfo> {
	private DaoStmtExec<CrecardInfo> helper;
	
	
	public DaoCrecardSelect(List<DaoStmtExecOption<CrecardInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoCrecardSelectSingle.class, CrecardInfo.class);
	}
