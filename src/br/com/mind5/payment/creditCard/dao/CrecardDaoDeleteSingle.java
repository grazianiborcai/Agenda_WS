...
public final class CrecardDaoDeleteSingle extends DaoStmtTemplate<CrecardInfo> {
	private final String MAIN_TABLE = DaoDbTable.CREDIT_CARD_TABLE;	
	
	
	public CrecardDaoDeleteSingle(Connection conn, CrecardInfo recordInfo, String schemaName) {
