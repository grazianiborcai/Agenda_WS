...
final class VisiOwnparMergeToSelect extends ActionVisitorTemplateMergeV1<OwnparInfo, OwnparInfo> {
	...
	@Override protected Class<? extends ActionStdV1<OwnparInfo>> getActionClassHook() {
