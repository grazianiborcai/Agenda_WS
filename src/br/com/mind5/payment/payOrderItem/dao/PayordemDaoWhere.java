...
public final class PayordemDaoWhere implements DaoStmtWhere {	
	private String whereClause;	
	
	
	public PayordemDaoWhere(DaoWhereBuilderOption whereOption, String tableName, PayordemInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, PayordemInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case PayordemDaoDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case PayordemDaoDbTableColumn.COL_COD_PAY_ORDER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codPayOrder));
					break;
					
				case PayordemDaoDbTableColumn.COL_COD_PAY_ORDER_ITEM :
