...
public final class DaoPayordemUpdate implements DaoStmtExec<PayordemInfo> {
	private DaoStmtExec<PayordemInfo> helper;
	
	
	public DaoPayordemUpdate(List<DaoStmtExecOption<PayordemInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoPayordemUpdateSingle.class, PayordemInfo.class);
	}
