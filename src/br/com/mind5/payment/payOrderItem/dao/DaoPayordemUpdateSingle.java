...
public class DaoPayordemUpdateSingle extends DaoStmtTemplate<PayordemInfo> {
	private final String MAIN_TABLE = DaoDbTable.PAY_ORDER_ITM_TABLE;	
	
	
	public DaoPayordemUpdateSingle(Connection conn, PayordemInfo recordInfo, String schemaName) {
