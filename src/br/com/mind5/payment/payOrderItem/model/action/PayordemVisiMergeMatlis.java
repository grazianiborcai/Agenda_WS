...
public final class PayordemVisiMergeMatlis extends ActionVisitorTemplateMerge<PayordemInfo, MatlisInfo> {
	
	public PayordemVisiMergeMatlis(DeciTreeOption<PayordemInfo> option) {
