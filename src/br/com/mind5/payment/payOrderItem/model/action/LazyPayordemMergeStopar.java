...
public final class LazyPayordemMergeStopar extends ActionLazyTemplate<PayordemInfo, PayordemInfo> {
	
	public LazyPayordemMergeStopar(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<PayordemInfo> getInstanceOfActionHook(DeciTreeOption<PayordemInfo> option) {
		return new StdPayordemMergeStopar(option);
	}
