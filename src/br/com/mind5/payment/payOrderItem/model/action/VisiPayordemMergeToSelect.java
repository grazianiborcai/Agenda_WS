...
final class VisiPayordemMergeToSelect extends ActionVisitorTemplateMerge<PayordemInfo, PayordemInfo> {
	
	public VisiPayordemMergeToSelect(DeciTreeOption<PayordemInfo> option) {
