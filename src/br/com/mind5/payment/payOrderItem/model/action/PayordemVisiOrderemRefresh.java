...
public final class PayordemVisiOrderemRefresh extends ActionVisitorTemplateAction<PayordemInfo, OrderemInfo> {
	
	public PayordemVisiOrderemRefresh(DeciTreeOption<PayordemInfo> option) {
