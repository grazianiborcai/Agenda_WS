...
final class VisiPayordemMergeMatlis extends ActionVisitorTemplateMergeV2<PayordemInfo, MatlisInfo> {
	
	public VisiPayordemMergeMatlis(Connection conn, String schemaName) {
