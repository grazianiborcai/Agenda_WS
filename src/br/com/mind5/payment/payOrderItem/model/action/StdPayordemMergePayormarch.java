...
public final class StdPayordemMergePayormarch implements ActionStdV1<PayordemInfo> {
	private ActionStdV1<PayordemInfo> actionHelper;	
	
	
	public StdPayordemMergePayormarch(DeciTreeOption<PayordemInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPayordemMergePayormarch(option.conn, option.schemaName));
	}
