...
public final class StdPayordemMergeFeecat implements ActionStdV1<PayordemInfo> {
	private ActionStdV1<PayordemInfo> actionHelper;	
	
	
	public StdPayordemMergeFeecat(DeciTreeOption<PayordemInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPayordemMergeFeecat(option.conn, option.schemaName));
	}
