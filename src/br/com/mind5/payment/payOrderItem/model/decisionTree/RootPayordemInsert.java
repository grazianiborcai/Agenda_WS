...
public final class RootPayordemInsert extends DeciTreeTemplateWriteV2<PayordemInfo> {
	...
	@Override protected List<ActionStdV1<PayordemInfo>> buildActionsOnPassedHook(DeciTreeOption<PayordemInfo> option) {
		...
		ActionLazyV1<PayordemInfo> insert = new LazyPayordemDaoInsert(option.conn, option.schemaName);
		ActionLazyV1<PayordemInfo> nodePay = new LazyPayordemNodePay(option.conn, option.schemaName);
