...
import br.com.mind5.payment.payOrderItem.model.action.PayordemVisiMergeFeecat;
import br.com.mind5.payment.payOrderItem.model.checker.PayordemCheckIsFee;

public final class PayordemNodeSelectL1 extends DeciTreeTemplateWrite<PayordemInfo> {
	
	public PayordemNodeSelectL1(DeciTreeOption<PayordemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PayordemInfo>> buildActionsOnPassedHook(DeciTreeOption<PayordemInfo> option) {
		...
		ActionStd<PayordemInfo> mergeFeecat = new ActionStdCommom<PayordemInfo>(option, PayordemVisiMergeFeecat.class);
	...
	@Override protected List<ActionStd<PayordemInfo>> buildActionsOnFailedHook(DeciTreeOption<PayordemInfo> option) {
		...
		ActionStd<PayordemInfo> nodeL2 = new PayordemNodeSelectL2(option).toAction();
