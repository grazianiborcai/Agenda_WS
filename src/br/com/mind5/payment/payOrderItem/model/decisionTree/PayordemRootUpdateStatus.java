...
public final class PayordemRootUpdateStatus extends DeciTreeTemplateWrite<PayordemInfo> {
	
	public PayordemRootUpdateStatus(DeciTreeOption<PayordemInfo> option) {
		super(option);
	}
