...
import br.com.mind5.payment.payOrderItem.model.action.PayordemVisiMergeToUpdate;
...
public final class PayordemRootUpdate extends DeciTreeTemplateWrite<PayordemInfo> {
	
	public PayordemRootUpdate(DeciTreeOption<PayordemInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PayordemInfo>> buildActionsOnPassedHook(DeciTreeOption<PayordemInfo> option) {
		...
		ActionStd <PayordemInfo> select = new ActionStdCommom <PayordemInfo>(option, PayordemVisiMergeToUpdate.class);
