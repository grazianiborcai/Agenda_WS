...
public final class NodePayordemRefresh extends DeciTreeTemplateWrite<PayordemInfo> {
	...
	@Override protected List<ActionStd<PayordemInfo>> buildActionsOnPassedHook(DeciTreeOption<PayordemInfo> option) {
		...
		ActionStd<PayordemInfo> orderemRefresh = new StdPayordemOrderemRefresh(option);
