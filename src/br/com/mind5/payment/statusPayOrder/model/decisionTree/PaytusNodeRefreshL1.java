...
public final class PaytusNodeRefreshL1 extends DeciTreeTemplateWrite<PaytusInfo> {
	
	public PaytusNodeRefreshL1(DeciTreeOption<PaytusInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<PaytusInfo>> buildActionsOnFailedHook(DeciTreeOption<PaytusInfo> option) {
		...
		ActionStd <PaytusInfo> nodeL2 = new PaytusNodeRefreshL2(option).toAction();	
