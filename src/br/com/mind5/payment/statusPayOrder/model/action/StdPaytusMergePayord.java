...
public final class StdPaytusMergePayord implements ActionStdV1<PaytusInfo> {
	private ActionStdV1<PaytusInfo> actionHelper;	
	
	
	public StdPaytusMergePayord(DeciTreeOption<PaytusInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPaytusMergePayord(option.conn, option.schemaName));
	}
