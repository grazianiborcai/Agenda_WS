...
public final class LazyPaytusPaytusemRefresh extends ActionLazyTemplateV1<PaytusInfo, PaytusInfo> {
	
	public LazyPaytusPaytusemRefresh(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PaytusInfo> getInstanceOfActionHook(DeciTreeOption<PaytusInfo> option) {
		return new StdPaytusPaytusemRefresh(option);
	}
