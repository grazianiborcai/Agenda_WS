...
public final class StdPaytusMergeMultmoip implements ActionStdV1<PaytusInfo> {
	private ActionStdV1<PaytusInfo> actionHelper;	
	
	
	public StdPaytusMergeMultmoip(DeciTreeOption<PaytusInfo> option) {			
		actionHelper = new ActionStdHelperMerge<>(option.recordInfos, new VisiPaytusMergeMultmoip(option.conn, option.schemaName));
	}
