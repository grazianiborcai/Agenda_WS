...
final class VisiPaytusMergeUsername extends ActionVisitorTemplateMergeV1<PaytusInfo, UsernameInfo> {
	
	public VisiPaytusMergeUsername(Connection conn, String schemaName) {
