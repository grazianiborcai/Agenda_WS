...
public final class LazyPaytusPayordRefresh extends ActionLazyTemplateV1<PaytusInfo, PaytusInfo> {
	
	public LazyPaytusPayordRefresh(Connection conn, String schemaName) {
	...
	@Override protected ActionStdV1<PaytusInfo> getInstanceOfActionHook(DeciTreeOption<PaytusInfo> option) {
		return new StdPaytusPayordRefresh(option);
	}
