...
import br.com.mind5.stats.statsUserOrderYear.userOrderYearStgnSearch.model.action.StusorygerchVisiMergeToSelect;
import br.com.mind5.stats.statsUserOrderYear.userOrderYearStgnSearch.model.checker.StusorygerchCheckRead;


public final class StusorygerchRootSelect extends DeciTreeTemplateWrite<StusorygerchInfo> {
	
	public StusorygerchRootSelect(DeciTreeOption<StusorygerchInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StusorygerchInfo>> buildActionsOnPassedHook(DeciTreeOption<StusorygerchInfo> option) {
		...
		ActionStd<StusorygerchInfo> select = new ActionStdCommom<StusorygerchInfo>(option, StusorygerchVisiMergeToSelect.class);
