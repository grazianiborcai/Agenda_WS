...
public final class StdStusoryliDaoSelect extends ActionStdTemplate<StusoryliInfo> {

	public StdStusoryliDaoSelect(DeciTreeOption<StusoryliInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StusoryliInfo> buildVisitorHook(DeciTreeOption<StusoryliInfo> option) {
		return new VisiStusoryliDaoSelect(option);
	}
}
