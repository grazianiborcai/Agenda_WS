...
public final class StdStusoryMergeStusorygr extends ActionStdTemplate<StusoryInfo> {

	public StdStusoryMergeStusorygr(DeciTreeOption<StusoryInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StusoryInfo> buildVisitorHook(DeciTreeOption<StusoryInfo> option) {
		return new VisiStusoryMergeStusorygr(option);
	}
}
