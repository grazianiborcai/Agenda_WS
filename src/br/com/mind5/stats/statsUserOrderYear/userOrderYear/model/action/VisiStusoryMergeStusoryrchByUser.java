...
final class VisiStusoryMergeStusoryrchByUser extends ActionVisitorTemplateMerge<StusoryInfo, StusoryrchInfo> {
	
	public VisiStusoryMergeStusoryrchByUser(DeciTreeOption<StusoryInfo> option) {
