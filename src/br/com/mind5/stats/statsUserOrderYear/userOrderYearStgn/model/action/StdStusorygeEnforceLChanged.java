...
public final class StdStusorygeEnforceLChanged extends ActionStdTemplate<StusorygeInfo> {

	public StdStusorygeEnforceLChanged(DeciTreeOption<StusorygeInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StusorygeInfo> buildVisitorHook(DeciTreeOption<StusorygeInfo> option) {
		return new VisiStusorygeEnforceLChanged(option);
	}
}
