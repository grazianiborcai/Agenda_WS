...
public final class StdStusorygeDaoInsert extends ActionStdTemplate<StusorygeInfo> {

	public StdStusorygeDaoInsert(DeciTreeOption<StusorygeInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StusorygeInfo> buildVisitorHook(DeciTreeOption<StusorygeInfo> option) {
		return new VisiStusorygeDaoInsert(option);
	}
}
