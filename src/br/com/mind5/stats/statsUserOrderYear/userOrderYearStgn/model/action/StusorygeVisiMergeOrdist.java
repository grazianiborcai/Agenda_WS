...
public final class StusorygeVisiMergeOrdist extends ActionVisitorTemplateMerge<StusorygeInfo, OrdistInfo> {
	
	public StusorygeVisiMergeOrdist(DeciTreeOption<StusorygeInfo> option) {
