...
public final class SowusarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public SowusarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STAT_OWNER_USER_MONTH_TABLE;
		...
		results.put(DaoDbTable.STAT_OWNER_USER_MONTH_SEARCH_VIEW, columns);
		return results;
	}
}
