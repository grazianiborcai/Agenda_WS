package br.com.mind5.stats.statsOwnerUser.userAccountLive.dao;
		...
		return new DaoResultParser<SowusiveInfo>() {
			@Override public List<SowusiveInfo> parseResult(SowusiveInfo recordInfo, ResultSet stmtResult, long lastId) throws SQLException {
				...
				do {
					...
					dataInfo.countUserCreatedCumulative = DaoFormatter.sqlToInt(stmtResult, DaoSowusiveDbTableColumn.COL_COUNT_USER_CREATION_CUMULATIVE);
					...
					dataInfo.countUserActiveCumulative = DaoFormatter.sqlToInt(stmtResult, DaoSowusiveDbTableColumn.COL_COUNT_USER_ACTIVE_CUMULATIVE);
					...
					dataInfo.countUserInactiveCumulative = DaoFormatter.sqlToInt(stmtResult, DaoSowusiveDbTableColumn.COL_COUNT_USER_INACTIVE_CUMULATIVE);
					...
					dataInfo.countOrderCumulative = DaoFormatter.sqlToInt(stmtResult, DaoSowusiveDbTableColumn.COL_COUNT_ORDER_TOTAL_CUMULATIVE);
					...
					dataInfo.userEngagementCumulative = DaoFormatter.sqlToInt(stmtResult, DaoSowusiveDbTableColumn.COL_COUNT_USER_ENGAGEMENT_CUMULATIVE);
