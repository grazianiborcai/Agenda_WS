...
public final class StdSowusiveEnforceHasData extends ActionStdTemplate<SowusiveInfo> {

	public StdSowusiveEnforceHasData(DeciTreeOption<SowusiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowusiveInfo> buildVisitorHook(DeciTreeOption<SowusiveInfo> option) {
		return new VisiSowusiveEnforceHasData(option);
	}
}
