...
public final class StdSowusiveMergeState extends ActionStdTemplate<SowusiveInfo> {

	public StdSowusiveMergeState(DeciTreeOption<SowusiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowusiveInfo> buildVisitorHook(DeciTreeOption<SowusiveInfo> option) {
		return new VisiSowusiveMergeState(option);
	}
}
