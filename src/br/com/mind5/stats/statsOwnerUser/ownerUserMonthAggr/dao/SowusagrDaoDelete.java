...
public final class SowusagrDaoDelete implements DaoStmtExec<SowusagrInfo> {
	private DaoStmtExec<SowusagrInfo> helper;
	
	
	public SowusagrDaoDelete(List<DaoStmtExecOption<SowusagrInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, SowusagrDaoDeleteSingle.class, SowusagrInfo.class);
	}
