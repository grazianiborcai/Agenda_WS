...
public final class SowusagrDaoInsert implements DaoStmtExec<SowusagrInfo> {
	private DaoStmtExec<SowusagrInfo> helper;
	
	
	public SowusagrDaoInsert(List<DaoStmtExecOption<SowusagrInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, SowusagrDaoInsertSingle.class, SowusagrInfo.class);
	}
