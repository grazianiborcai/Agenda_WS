...
public final class SuseracInfo extends InfoRecord implements Cloneable {
	...
	public static SuseracInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, SuseracInfo.class);
	}
	
	
	
	public static List<SuseracInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, SuseracInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof SuseracInfo))
			return false;
		
		
		SuseracInfo obj = (SuseracInfo) o;		
