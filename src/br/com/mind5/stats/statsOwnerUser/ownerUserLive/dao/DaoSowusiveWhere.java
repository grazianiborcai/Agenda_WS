...
public final class DaoSowusiveWhere implements DaoStmtWhere {
	private String whereClause;	
	
	
	public DaoSowusiveWhere(DaoWhereBuilderOption whereOption, String tableName, SowusiveInfo recordInfo) {
	...
	private void generateWhereClause(DaoWhereBuilderOption whereOption, String tableName, SowusiveInfo recordInfo) {
		...
		for (DaoColumn eachColumn : columns) {			
			switch(eachColumn.columnName) {
				case DaoSowusiveDbTableColumn.COL_COD_OWNER :
					builder.addClauseEqualAnd(eachColumn, DaoFormatter.numberToString(recordInfo.codOwner));
					break;
					
				case DaoSowusiveDbTableColumn.COL_CALMONTH :
