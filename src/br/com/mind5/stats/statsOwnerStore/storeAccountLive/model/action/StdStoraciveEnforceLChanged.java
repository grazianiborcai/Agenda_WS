...
public final class StdStoraciveEnforceLChanged extends ActionStdTemplate<StoraciveInfo> {

	public StdStoraciveEnforceLChanged(DeciTreeOption<StoraciveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoraciveInfo> buildVisitorHook(DeciTreeOption<StoraciveInfo> option) {
		return new VisiStoraciveEnforceLChanged(option);
	}
}
