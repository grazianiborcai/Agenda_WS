...
public final class LazyStoraciveMergeState extends ActionLazyTemplate<StoraciveInfo, StoraciveInfo> {

	public LazyStoraciveMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoraciveInfo> getInstanceOfActionHook(DeciTreeOption<StoraciveInfo> option) {
		return new StdStoraciveMergeState(option);
	}
