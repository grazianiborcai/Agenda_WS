...
public final class StdStoraciveMergeToSelect extends ActionStdTemplate<StoraciveInfo> {

	public StdStoraciveMergeToSelect(DeciTreeOption<StoraciveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoraciveInfo> buildVisitorHook(DeciTreeOption<StoraciveInfo> option) {
		return new VisiStoraciveMergeToSelect(option);
	}
}
