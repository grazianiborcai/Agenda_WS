...
public final class StdSowotiveMergeToSelect extends ActionStdTemplate<SowotiveInfo> {

	public StdSowotiveMergeToSelect(DeciTreeOption<SowotiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowotiveInfo> buildVisitorHook(DeciTreeOption<SowotiveInfo> option) {
		return new VisiSowotiveMergeToSelect(option);
	}
}
