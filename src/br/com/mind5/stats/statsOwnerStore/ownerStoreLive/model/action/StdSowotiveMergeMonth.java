...
public final class StdSowotiveMergeMonth extends ActionStdTemplate<SowotiveInfo> {

	public StdSowotiveMergeMonth(DeciTreeOption<SowotiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowotiveInfo> buildVisitorHook(DeciTreeOption<SowotiveInfo> option) {
		return new VisiSowotiveMergeMonth(option);
	}
}
