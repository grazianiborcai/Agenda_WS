...
public final class LazySowotiveEnforceLChanged extends ActionLazyTemplate<SowotiveInfo, SowotiveInfo> {

	public LazySowotiveEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SowotiveInfo> getInstanceOfActionHook(DeciTreeOption<SowotiveInfo> option) {
		return new StdSowotiveEnforceLChanged(option);
	}
