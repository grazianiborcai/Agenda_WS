...
public final class LazySowotiveEnforceHasData extends ActionLazyTemplate<SowotiveInfo, SowotiveInfo> {

	public LazySowotiveEnforceHasData(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SowotiveInfo> getInstanceOfActionHook(DeciTreeOption<SowotiveInfo> option) {
		return new StdSowotiveEnforceHasData(option);
	}
