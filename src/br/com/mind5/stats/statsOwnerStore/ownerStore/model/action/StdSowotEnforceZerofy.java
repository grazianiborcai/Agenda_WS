...
public final class StdSowotEnforceZerofy extends ActionStdTemplate<SowotInfo> {

	public StdSowotEnforceZerofy(DeciTreeOption<SowotInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowotInfo> buildVisitorHook(DeciTreeOption<SowotInfo> option) {
		return new VisiSowotEnforceZerofy(option);
	}
}
