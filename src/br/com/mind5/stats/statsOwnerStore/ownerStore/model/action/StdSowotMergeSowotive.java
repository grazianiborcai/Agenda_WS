...
public final class StdSowotMergeSowotive extends ActionStdTemplate<SowotInfo> {

	public StdSowotMergeSowotive(DeciTreeOption<SowotInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowotInfo> buildVisitorHook(DeciTreeOption<SowotInfo> option) {
		return new VisiSowotMergeSowotive(option);
	}
}
