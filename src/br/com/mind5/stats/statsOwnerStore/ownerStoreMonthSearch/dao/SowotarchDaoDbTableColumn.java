...
public final class SowotarchDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public SowotarchDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		...
		results.put(DaoDbTable.STAT_OWNER_STORE_MONTH_SEARCH_VIEW, columns);
		return results;
	}
}
