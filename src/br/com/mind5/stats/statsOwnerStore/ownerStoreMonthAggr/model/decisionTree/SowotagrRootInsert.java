...
import br.com.mind5.stats.statsOwnerStore.ownerStoreMonthAggr.model.action.SowotagrVisiDaoInsert;
import br.com.mind5.stats.statsOwnerStore.ownerStoreMonthAggr.model.action.SowotagrVisiEnforceLChanged;
...
public final class SowotagrRootInsert extends DeciTreeTemplateWrite<SowotagrInfo> {
	
	public SowotagrRootInsert(DeciTreeOption<SowotagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowotagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowotagrInfo> option) {
		...
		ActionStd<SowotagrInfo> enforceLChanged = new ActionStdCommom<SowotagrInfo>(option, SowotagrVisiEnforceLChanged.class);
		ActionLazy<SowotagrInfo> insert = new ActionLazyCommom<SowotagrInfo>(option.conn, option.schemaName, SowotagrVisiDaoInsert.class);
