...
import br.com.mind5.stats.statsOwnerStore.ownerStoreMonthAggr.model.decisionTree.SowotagrRootSelectMonth;

public final class SowotagrCheckExistMonth extends ModelCheckerTemplateAction<SowotagrInfo, SowotagrInfo> {
	
	public SowotagrCheckExistMonth(ModelCheckerOption option) {
