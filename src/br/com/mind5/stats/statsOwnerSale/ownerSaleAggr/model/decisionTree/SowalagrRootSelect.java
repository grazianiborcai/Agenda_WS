...
import br.com.mind5.stats.statsOwnerSale.ownerSaleAggr.model.action.SowalagrVisiMergeState;
import br.com.mind5.stats.statsOwnerSale.ownerSaleAggr.model.action.SowalagrVisiMergeToSelect;
...
import br.com.mind5.stats.statsOwnerSale.ownerSaleAggr.model.checker.SowalagrCheckRead;


public final class SowalagrRootSelect extends DeciTreeTemplateWrite<SowalagrInfo> {
	
	public SowalagrRootSelect(DeciTreeOption<SowalagrInfo> option) {
		super(option);
	}
	...
	@Override protected ModelChecker<SowalagrInfo> buildCheckerHook(DeciTreeOption<SowalagrInfo> option) {
		...
		checker = new SowalagrCheckRead(checkerOption);
		queue.add(checker);
