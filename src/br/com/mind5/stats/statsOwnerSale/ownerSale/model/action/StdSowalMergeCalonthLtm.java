...
public final class StdSowalMergeCalonthLtm extends ActionStdTemplate<SowalInfo> {

	public StdSowalMergeCalonthLtm(DeciTreeOption<SowalInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowalInfo> buildVisitorHook(DeciTreeOption<SowalInfo> option) {
		return new VisiSowalMergeCalonthLtm(option);
	}
}
