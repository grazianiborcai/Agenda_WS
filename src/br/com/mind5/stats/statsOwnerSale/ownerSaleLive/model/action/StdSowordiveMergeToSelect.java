...
public final class StdSowordiveMergeToSelect extends ActionStdTemplate<SowaliveInfo> {

	public StdSowordiveMergeToSelect(DeciTreeOption<SowaliveInfo> option) {
		super(option);
	}
