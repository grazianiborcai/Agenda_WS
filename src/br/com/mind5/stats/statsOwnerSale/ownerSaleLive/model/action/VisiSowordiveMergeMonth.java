...
final class VisiSowordiveMergeMonth extends ActionVisitorTemplateMerge<SowaliveInfo, MonthInfo> {
	
	public VisiSowordiveMergeMonth(DeciTreeOption<SowaliveInfo> option) {
