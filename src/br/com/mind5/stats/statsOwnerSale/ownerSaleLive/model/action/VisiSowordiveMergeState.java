...
final class VisiSowordiveMergeState extends ActionVisitorTemplateMerge<SowaliveInfo, StateInfo> {
	
	public VisiSowordiveMergeState(DeciTreeOption<SowaliveInfo> option) {
