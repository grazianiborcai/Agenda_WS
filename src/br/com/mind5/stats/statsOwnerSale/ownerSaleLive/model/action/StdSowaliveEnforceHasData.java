...
public final class StdSowaliveEnforceHasData extends ActionStdTemplate<SowaliveInfo> {

	public StdSowaliveEnforceHasData(DeciTreeOption<SowaliveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowaliveInfo> buildVisitorHook(DeciTreeOption<SowaliveInfo> option) {
		return new VisiSowaliveEnforceHasData(option);
	}
}
