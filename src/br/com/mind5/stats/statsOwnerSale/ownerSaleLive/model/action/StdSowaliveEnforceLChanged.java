...
public final class StdSowaliveEnforceLChanged extends ActionStdTemplate<SowaliveInfo> {

	public StdSowaliveEnforceLChanged(DeciTreeOption<SowaliveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowaliveInfo> buildVisitorHook(DeciTreeOption<SowaliveInfo> option) {
		return new VisiSowaliveEnforceLChanged(option);
	}
}
