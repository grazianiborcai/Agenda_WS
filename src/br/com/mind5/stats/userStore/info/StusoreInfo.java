package br.com.mind5.stats.userStore.info;
...
public final class StusoreInfo extends InfoRecord implements Cloneable {
	...
	public static StusoreInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, StusoreInfo.class);
	}
	
	
	
	public static List<StusoreInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, StusoreInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof StusoreInfo))
			return false;
		
		
		StusoreInfo obj = (StusoreInfo) o;		
