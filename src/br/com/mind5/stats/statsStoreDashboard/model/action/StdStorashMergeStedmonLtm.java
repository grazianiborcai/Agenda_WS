...
public final class StdStorashMergeStedmonLtm extends ActionStdTemplate<StorashInfo> {

	public StdStorashMergeStedmonLtm(DeciTreeOption<StorashInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StorashInfo> buildVisitorHook(DeciTreeOption<StorashInfo> option) {
		return new VisiStorashMergeStedmonLtm(option);
	}
}
