...
public final class StorashVisiMergeStedmonLtm extends ActionVisitorTemplateMerge<StorashInfo, StedmonInfo> {
	
	public StorashVisiMergeStedmonLtm(DeciTreeOption<StorashInfo> option) {
