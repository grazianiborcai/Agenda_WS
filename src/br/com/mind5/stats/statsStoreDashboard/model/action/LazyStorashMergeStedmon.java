...
public final class LazyStorashMergeStedmon extends ActionLazyTemplate<StorashInfo, StorashInfo> {

	public LazyStorashMergeStedmon(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorashInfo> getInstanceOfActionHook(DeciTreeOption<StorashInfo> option) {
		return new StdStorashMergeStedmon(option);
	}
