...
public final class LazyStorashMergeStedmonLtm extends ActionLazyTemplate<StorashInfo, StorashInfo> {

	public LazyStorashMergeStedmonLtm(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorashInfo> getInstanceOfActionHook(DeciTreeOption<StorashInfo> option) {
		return new StdStorashMergeStedmonLtm(option);
	}
