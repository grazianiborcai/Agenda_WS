...
public final class LazyStorashMergeStoronLtm extends ActionLazyTemplate<StorashInfo, StorashInfo> {

	public LazyStorashMergeStoronLtm(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StorashInfo> getInstanceOfActionHook(DeciTreeOption<StorashInfo> option) {
		return new StdStorashMergeStoronLtm(option);
	}
