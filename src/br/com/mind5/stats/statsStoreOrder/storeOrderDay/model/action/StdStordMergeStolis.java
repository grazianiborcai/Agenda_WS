...
public final class StdStordMergeStolis extends ActionStdTemplate<StordInfo> {

	public StdStordMergeStolis(DeciTreeOption<StordInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StordInfo> buildVisitorHook(DeciTreeOption<StordInfo> option) {
		return new VisiStordMergeStolis(option);
	}
}
