...
public final class StdStordMergeStordagr extends ActionStdTemplate<StordInfo> {

	public StdStordMergeStordagr(DeciTreeOption<StordInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StordInfo> buildVisitorHook(DeciTreeOption<StordInfo> option) {
		return new VisiStordMergeStordagr(option);
	}
}
