...
public final class LazyStordStordagrUpsert extends ActionLazyTemplate<StordInfo, StordInfo> {

	public LazyStordStordagrUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StordInfo> getInstanceOfActionHook(DeciTreeOption<StordInfo> option) {
		return new StdStordStordagrUpsert(option);
	}
