...
public final class LazyStordStordagrInsert extends ActionLazyTemplate<StordInfo, StordInfo> {

	public LazyStordStordagrInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StordInfo> getInstanceOfActionHook(DeciTreeOption<StordInfo> option) {
		return new StdStordStordagrInsert(option);
	}
