...
public final class StordInfo extends InfoRecord implements Cloneable {
	...
	public static StordInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, StordInfo.class);
	}
	
	
	
	public static List<StordInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, StordInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof StordInfo))
			return false;
		
		
		StordInfo obj = (StordInfo) o;
