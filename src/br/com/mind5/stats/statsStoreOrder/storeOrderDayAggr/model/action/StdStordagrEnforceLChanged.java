...
public final class StdStordagrEnforceLChanged extends ActionStdTemplate<StordagrInfo> {

	public StdStordagrEnforceLChanged(DeciTreeOption<StordagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StordagrInfo> buildVisitorHook(DeciTreeOption<StordagrInfo> option) {
		return new VisiStordagrEnforceLChanged(option);
	}
}
