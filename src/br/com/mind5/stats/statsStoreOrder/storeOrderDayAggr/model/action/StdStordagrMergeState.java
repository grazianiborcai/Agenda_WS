...
public final class StdStordagrMergeState extends ActionStdTemplate<StordagrInfo> {

	public StdStordagrMergeState(DeciTreeOption<StordagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StordagrInfo> buildVisitorHook(DeciTreeOption<StordagrInfo> option) {
		return new VisiStordagrMergeState(option);
	}
}
