...
public final class LazyStordagrDaoInsert extends ActionLazyTemplate<StordagrInfo, StordagrInfo> {

	public LazyStordagrDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StordagrInfo> getInstanceOfActionHook(DeciTreeOption<StordagrInfo> option) {
		return new StdStordagrDaoInsert(option);
	}
