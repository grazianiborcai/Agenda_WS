...
final class VisiStordagrMergeState extends ActionVisitorTemplateMerge<StordagrInfo, StateInfo> {
	
	public VisiStordagrMergeState(DeciTreeOption<StordagrInfo> option) {
