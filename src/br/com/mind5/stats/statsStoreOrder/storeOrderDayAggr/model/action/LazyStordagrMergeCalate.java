...
public final class LazyStordagrMergeCalate extends ActionLazyTemplate<StordagrInfo, StordagrInfo> {

	public LazyStordagrMergeCalate(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StordagrInfo> getInstanceOfActionHook(DeciTreeOption<StordagrInfo> option) {
		return new StdStordagrMergeCalate(option);
	}
