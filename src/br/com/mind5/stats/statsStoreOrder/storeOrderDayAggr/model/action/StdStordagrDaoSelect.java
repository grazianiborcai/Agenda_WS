...
public final class StdStordagrDaoSelect extends ActionStdTemplate<StordagrInfo> {

	public StdStordagrDaoSelect(DeciTreeOption<StordagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StordagrInfo> buildVisitorHook(DeciTreeOption<StordagrInfo> option) {
		return new VisiStordagrDaoSelect(option);
	}
}
