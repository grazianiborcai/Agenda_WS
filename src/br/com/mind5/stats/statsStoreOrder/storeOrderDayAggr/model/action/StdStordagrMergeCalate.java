...
public final class StdStordagrMergeCalate extends ActionStdTemplate<StordagrInfo> {

	public StdStordagrMergeCalate(DeciTreeOption<StordagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StordagrInfo> buildVisitorHook(DeciTreeOption<StordagrInfo> option) {
		return new VisiStordagrMergeCalate(option);
	}
}
