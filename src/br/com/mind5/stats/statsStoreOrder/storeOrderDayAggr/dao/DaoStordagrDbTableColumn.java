...
public final class DaoStordagrDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public DaoStordagrDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STAT_STORE_ORDER_DAY_TABLE;
