...
public final class StoroniveInfo extends InfoRecord implements Cloneable {
	...
	public static StoroniveInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, StoroniveInfo.class);
	}
	
	
	
	public static List<StoroniveInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, StoroniveInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof StoroniveInfo))
			return false;
		
		
		StoroniveInfo obj = (StoroniveInfo) o;
