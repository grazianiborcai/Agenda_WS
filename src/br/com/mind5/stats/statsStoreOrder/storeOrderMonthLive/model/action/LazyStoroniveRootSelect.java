...
public final class LazyStoroniveRootSelect extends ActionLazyTemplate<StoroniveInfo, StoroniveInfo> {

	public LazyStoroniveRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoroniveInfo> getInstanceOfActionHook(DeciTreeOption<StoroniveInfo> option) {
		return new RootStoroniveSelect(option).toAction();
	}
