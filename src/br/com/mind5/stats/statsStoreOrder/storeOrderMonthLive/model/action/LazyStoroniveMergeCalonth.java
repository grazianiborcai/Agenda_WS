...
public final class LazyStoroniveMergeCalonth extends ActionLazyTemplate<StoroniveInfo, StoroniveInfo> {

	public LazyStoroniveMergeCalonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoroniveInfo> getInstanceOfActionHook(DeciTreeOption<StoroniveInfo> option) {
		return new StdStoroniveMergeCalonth(option);
	}
