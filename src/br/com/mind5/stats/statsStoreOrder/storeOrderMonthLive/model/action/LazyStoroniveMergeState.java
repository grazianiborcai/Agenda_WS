...
public final class LazyStoroniveMergeState extends ActionLazyTemplate<StoroniveInfo, StoroniveInfo> {

	public LazyStoroniveMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoroniveInfo> getInstanceOfActionHook(DeciTreeOption<StoroniveInfo> option) {
		return new StdStoroniveMergeState(option);
	}
