...
public final class StoroniveVisiMergeSytotauh extends ActionVisitorTemplateMerge<StoroniveInfo, SytotauhInfo> {
	
	public StoroniveVisiMergeSytotauh(DeciTreeOption<StoroniveInfo> option) {
