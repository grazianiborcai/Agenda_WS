...
public final class StdStoroniveMergeToSelect extends ActionStdTemplate<StoroniveInfo> {

	public StdStoroniveMergeToSelect(DeciTreeOption<StoroniveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoroniveInfo> buildVisitorHook(DeciTreeOption<StoroniveInfo> option) {
		return new VisiStoroniveMergeToSelect(option);
	}
}
