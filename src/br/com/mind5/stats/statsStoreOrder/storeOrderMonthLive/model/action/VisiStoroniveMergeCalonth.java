...
final class VisiStoroniveMergeCalonth extends ActionVisitorTemplateMerge<StoroniveInfo, CalonthInfo> {
	
	public VisiStoroniveMergeCalonth(DeciTreeOption<StoroniveInfo> option) {
