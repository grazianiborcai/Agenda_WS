...
public final class StdStoroniveMergeSytotauh extends ActionStdTemplate<StoroniveInfo> {

	public StdStoroniveMergeSytotauh(DeciTreeOption<StoroniveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoroniveInfo> buildVisitorHook(DeciTreeOption<StoroniveInfo> option) {
		return new VisiStoroniveMergeSytotauh(option);
	}
}
