...
public final class StdStoroniveDaoSelect extends ActionStdTemplate<StoroniveInfo> {

	public StdStoroniveDaoSelect(DeciTreeOption<StoroniveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoroniveInfo> buildVisitorHook(DeciTreeOption<StoroniveInfo> option) {
		return new VisiStoroniveDaoSelect(option);
	}
}
