...
public final class LazyStordiveEnforceLChanged extends ActionLazyTemplate<StordiveInfo, StordiveInfo> {

	public LazyStordiveEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StordiveInfo> getInstanceOfActionHook(DeciTreeOption<StordiveInfo> option) {
		return new StdStordiveEnforceLChanged(option);
	}
