...
final class VisiStordiveMergeState extends ActionVisitorTemplateMerge<StordiveInfo, StateInfo> {
	
	public VisiStordiveMergeState(DeciTreeOption<StordiveInfo> option) {
