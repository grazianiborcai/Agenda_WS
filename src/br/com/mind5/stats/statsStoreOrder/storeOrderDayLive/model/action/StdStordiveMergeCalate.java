...
public final class StdStordiveMergeCalate extends ActionStdTemplate<StordiveInfo> {

	public StdStordiveMergeCalate(DeciTreeOption<StordiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StordiveInfo> buildVisitorHook(DeciTreeOption<StordiveInfo> option) {
		return new VisiStordiveMergeCalate(option);
	}
}
