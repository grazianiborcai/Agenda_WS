...
public final class StordiveVisiMergeSytotauh extends ActionVisitorTemplateMerge<StordiveInfo, SytotauhInfo> {
	
	public StordiveVisiMergeSytotauh(DeciTreeOption<StordiveInfo> option) {
