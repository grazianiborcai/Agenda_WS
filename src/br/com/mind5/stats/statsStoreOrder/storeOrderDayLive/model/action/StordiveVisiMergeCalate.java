...
public final class StordiveVisiMergeCalate extends ActionVisitorTemplateMerge<StordiveInfo, CalateInfo> {
	
	public StordiveVisiMergeCalate(DeciTreeOption<StordiveInfo> option) {
