...
public final class LazyStoronagrDaoInsert extends ActionLazyTemplate<StoronagrInfo, StoronagrInfo> {

	public LazyStoronagrDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoronagrInfo> getInstanceOfActionHook(DeciTreeOption<StoronagrInfo> option) {
		return new StdStoronagrDaoInsert(option);
	}
