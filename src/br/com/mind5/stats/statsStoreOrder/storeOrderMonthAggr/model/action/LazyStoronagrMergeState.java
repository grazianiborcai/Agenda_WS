...
public final class LazyStoronagrMergeState extends ActionLazyTemplate<StoronagrInfo, StoronagrInfo> {

	public LazyStoronagrMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoronagrInfo> getInstanceOfActionHook(DeciTreeOption<StoronagrInfo> option) {
		return new StdStoronagrMergeState(option);
	}
