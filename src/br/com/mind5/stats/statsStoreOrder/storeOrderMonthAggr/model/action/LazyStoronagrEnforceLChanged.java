...
public final class LazyStoronagrEnforceLChanged extends ActionLazyTemplate<StoronagrInfo, StoronagrInfo> {

	public LazyStoronagrEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoronagrInfo> getInstanceOfActionHook(DeciTreeOption<StoronagrInfo> option) {
		return new StdStoronagrEnforceLChanged(option);
	}
