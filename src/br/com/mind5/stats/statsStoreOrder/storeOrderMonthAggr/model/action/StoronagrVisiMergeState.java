...
public final class StoronagrVisiMergeState extends ActionVisitorTemplateMerge<StoronagrInfo, StateInfo> {
	
	public StoronagrVisiMergeState(DeciTreeOption<StoronagrInfo> option) {
