...
public final class StdStoronagrDaoDelete extends ActionStdTemplate<StoronagrInfo> {

	public StdStoronagrDaoDelete(DeciTreeOption<StoronagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoronagrInfo> buildVisitorHook(DeciTreeOption<StoronagrInfo> option) {
		return new VisiStoronagrDaoDelete(option);
	}
}
