...
public final class StoronagrInfo extends InfoRecord implements Cloneable {
	...
	public static StoronagrInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, StoronagrInfo.class);
	}
	
	
	
	public static List<StoronagrInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, StoronagrInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof StoronagrInfo))
			return false;
		
		
		StoronagrInfo obj = (StoronagrInfo) o;
