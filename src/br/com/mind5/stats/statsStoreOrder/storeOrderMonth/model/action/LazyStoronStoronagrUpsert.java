...
public final class LazyStoronStoronagrUpsert extends ActionLazyTemplate<StoronInfo, StoronInfo> {

	public LazyStoronStoronagrUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoronInfo> getInstanceOfActionHook(DeciTreeOption<StoronInfo> option) {
		return new StdStoronStoronagrUpsert(option);
	}
