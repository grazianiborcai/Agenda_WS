...
public final class StdStoronEnforceZerofy extends ActionStdTemplate<StoronInfo> {

	public StdStoronEnforceZerofy(DeciTreeOption<StoronInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoronInfo> buildVisitorHook(DeciTreeOption<StoronInfo> option) {
		return new VisiStoronEnforceZerofy(option);
	}
}
