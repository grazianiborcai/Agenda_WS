...
public final class StdStoronMergeStolis extends ActionStdTemplate<StoronInfo> {

	public StdStoronMergeStolis(DeciTreeOption<StoronInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoronInfo> buildVisitorHook(DeciTreeOption<StoronInfo> option) {
		return new VisiStoronMergeStolis(option);
	}
}
