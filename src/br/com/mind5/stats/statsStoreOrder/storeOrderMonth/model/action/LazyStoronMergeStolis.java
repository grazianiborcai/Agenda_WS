...
public final class LazyStoronMergeStolis extends ActionLazyTemplate<StoronInfo, StoronInfo> {

	public LazyStoronMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoronInfo> getInstanceOfActionHook(DeciTreeOption<StoronInfo> option) {
		return new StdStoronMergeStolis(option);
	}
