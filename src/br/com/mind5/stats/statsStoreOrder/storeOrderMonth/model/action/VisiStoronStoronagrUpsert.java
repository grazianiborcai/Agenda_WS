...
final class VisiStoronStoronagrUpsert extends ActionVisitorTemplateAction<StoronInfo, StoronagrInfo> {

	public VisiStoronStoronagrUpsert(DeciTreeOption<StoronInfo> option) {
