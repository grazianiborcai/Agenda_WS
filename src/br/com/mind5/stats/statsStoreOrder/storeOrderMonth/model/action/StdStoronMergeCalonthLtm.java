...
public final class StdStoronMergeCalonthLtm extends ActionStdTemplate<StoronInfo> {

	public StdStoronMergeCalonthLtm(DeciTreeOption<StoronInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StoronInfo> buildVisitorHook(DeciTreeOption<StoronInfo> option) {
		return new VisiStoronMergeCalonthLtm(option);
	}
}
