...
final class VisiStoronMergeStoronive extends ActionVisitorTemplateMerge<StoronInfo, StoroniveInfo> {
	
	public VisiStoronMergeStoronive(DeciTreeOption<StoronInfo> option) {
