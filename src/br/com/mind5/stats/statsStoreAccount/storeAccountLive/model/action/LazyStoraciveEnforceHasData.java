...
public final class LazyStoraciveEnforceHasData extends ActionLazyTemplate<StoraciveInfo, StoraciveInfo> {

	public LazyStoraciveEnforceHasData(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoraciveInfo> getInstanceOfActionHook(DeciTreeOption<StoraciveInfo> option) {
		return new StdStoraciveEnforceHasData(option);
	}
