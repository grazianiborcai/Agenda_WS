...
public final class LazyStoraciveEnforceLChanged extends ActionLazyTemplate<StoraciveInfo, StoraciveInfo> {

	public LazyStoraciveEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StoraciveInfo> getInstanceOfActionHook(DeciTreeOption<StoraciveInfo> option) {
		return new StdStoraciveEnforceLChanged(option);
	}
