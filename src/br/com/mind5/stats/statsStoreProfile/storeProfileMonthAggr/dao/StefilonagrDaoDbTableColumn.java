...
public final class StefilonagrDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public StefilonagrDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STAT_STORE_PROFILE_MONTH_TABLE;
