...
public final class StefilonVisiMergeCalonthLtm extends ActionVisitorTemplateMerge<StefilonInfo, CalonthInfo> {
	
	public StefilonVisiMergeCalonthLtm(DeciTreeOption<StefilonInfo> option) {
