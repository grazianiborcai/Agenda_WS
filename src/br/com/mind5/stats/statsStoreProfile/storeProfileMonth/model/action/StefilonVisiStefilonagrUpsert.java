...
import br.com.mind5.stats.statsStoreProfile.storeProfileMonthAggr.model.decisionTree.StefilonagrRootUpsert;

public final class StefilonVisiStefilonagrUpsert extends ActionVisitorTemplateAction<StefilonInfo, StefilonagrInfo> {

	public StefilonVisiStefilonagrUpsert(DeciTreeOption<StefilonInfo> option) {
	...
	@Override protected Class<? extends DeciTree<StefilonagrInfo>> getTreeClassHook() {
		return StefilonagrRootUpsert.class;
	}
