...
public final class SoweduliveInfo extends InfoRecord implements Cloneable {
	...
	public static SoweduliveInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, SoweduliveInfo.class);
	}
	
	
	
	public static List<SoweduliveInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, SoweduliveInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof SoweduliveInfo))
			return false;
		
		
		SoweduliveInfo obj = (SoweduliveInfo) o;		
