...
public final class StdSoweduliveMergeState extends ActionStdTemplate<SoweduliveInfo> {

	public StdSoweduliveMergeState(DeciTreeOption<SoweduliveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SoweduliveInfo> buildVisitorHook(DeciTreeOption<SoweduliveInfo> option) {
		return new VisiSoweduliveMergeState(option);
	}
}
