...
final class VisiSowedulagrMergeCalonth extends ActionVisitorTemplateMerge<SowedulagrInfo, CalonthInfo> {
	
	public VisiSowedulagrMergeCalonth(DeciTreeOption<SowedulagrInfo> option) {
