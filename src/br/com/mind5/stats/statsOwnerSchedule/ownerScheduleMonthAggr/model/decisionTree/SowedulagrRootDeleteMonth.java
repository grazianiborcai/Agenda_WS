...
public final class SowedulagrRootDeleteMonth extends DeciTreeTemplateWrite<SowedulagrInfo> {
	
	public SowedulagrRootDeleteMonth(DeciTreeOption<SowedulagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowedulagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowedulagrInfo> option) {
		...
		ActionStd<SowedulagrInfo> nodeL1 = new SowedulagrNodeDeleteMonth(option).toAction();
