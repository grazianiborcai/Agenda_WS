...
public final class SowedulagrNodeUpsert extends DeciTreeTemplateWrite<SowedulagrInfo> {
	
	public SowedulagrNodeUpsert(DeciTreeOption<SowedulagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowedulagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowedulagrInfo> option) {
		...
		ActionStd<SowedulagrInfo> delete = new SowedulagrRootDelete(option).toAction();
		ActionStd<SowedulagrInfo> insert = new SowedulagrRootInsert(option).toAction();
