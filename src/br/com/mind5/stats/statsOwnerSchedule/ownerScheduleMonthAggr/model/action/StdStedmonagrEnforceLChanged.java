...
public final class StdStedmonagrEnforceLChanged extends ActionStdTemplate<SowedulagrInfo> {

	public StdStedmonagrEnforceLChanged(DeciTreeOption<SowedulagrInfo> option) {
		super(option);
	}
