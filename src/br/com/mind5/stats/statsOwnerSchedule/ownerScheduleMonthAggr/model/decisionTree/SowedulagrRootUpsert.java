...
public final class SowedulagrRootUpsert extends DeciTreeTemplateWrite<SowedulagrInfo> {
	
	public SowedulagrRootUpsert(DeciTreeOption<SowedulagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowedulagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowedulagrInfo> option) {
		...
		ActionStd<SowedulagrInfo> nodeL1 = new SowedulagrNodeUpsert(option).toAction();
