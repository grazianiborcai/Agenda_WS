...
final class VisiSowedulagrMergeState extends ActionVisitorTemplateMerge<SowedulagrInfo, StateInfo> {
	
	public VisiSowedulagrMergeState(DeciTreeOption<SowedulagrInfo> option) {
