...
final class VisiSowedulagrMergeSowedularchMonth extends ActionVisitorTemplateMerge<SowedulagrInfo, SowedularchInfo> {
	
	public VisiSowedulagrMergeSowedularchMonth(DeciTreeOption<SowedulagrInfo> option) {
	...
	@Override protected Class<? extends DeciTree<SowedularchInfo>> getTreeClassHook() {
		return RootSowedularchSelectMonth.class;
	}
