...
public final class StdStedmonagrMergeToSelect extends ActionStdTemplate<SowedulagrInfo> {

	public StdStedmonagrMergeToSelect(DeciTreeOption<SowedulagrInfo> option) {
		super(option);
	}
