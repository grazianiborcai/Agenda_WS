...
final class VisiStedmonagrMergeState extends ActionVisitorTemplateMerge<SowedulagrInfo, StateInfo> {
	
	public VisiStedmonagrMergeState(DeciTreeOption<SowedulagrInfo> option) {
