...
public final class SowedulagrInfo extends InfoRecord implements Cloneable {
	...
	public static SowedulagrInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, SowedulagrInfo.class);
	}
	
	
	
	public static List<SowedulagrInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, SowedulagrInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof SowedulagrInfo))
			return false;
		
		
		SowedulagrInfo obj = (SowedulagrInfo) o;
