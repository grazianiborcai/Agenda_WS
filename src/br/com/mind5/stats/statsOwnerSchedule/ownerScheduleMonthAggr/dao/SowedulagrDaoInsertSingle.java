...
public final class SowedulagrDaoInsertSingle extends DaoStmtTemplate<SowedulagrInfo> {
	private final String MAIN_TABLE = DaoDbTable.STAT_OWNER_SCHEDULE_MONTH_TABLE;
	
	
	public SowedulagrDaoInsertSingle(Connection conn, SowedulagrInfo recordInfo, String schemaName) {
