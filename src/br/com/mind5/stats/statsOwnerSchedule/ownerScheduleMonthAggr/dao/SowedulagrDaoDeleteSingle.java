...
public final class SowedulagrDaoDeleteSingle extends DaoStmtTemplate<SowedulagrInfo> {
	private final String MAIN_TABLE = DaoDbTable.STAT_OWNER_SCHEDULE_MONTH_TABLE;	
	
	
	public SowedulagrDaoDeleteSingle(Connection conn, SowedulagrInfo recordInfo, String schemaName) {
