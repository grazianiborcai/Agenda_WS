...
import br.com.mind5.stats.statsOwnerSchedule.ownerScheduleMonth.model.action.LazySowedulSowedulagrUpsert;
...
public final class NodeSowedulUpsertL2 extends DeciTreeTemplateWrite<SowedulInfo> {
	
	public NodeSowedulUpsertL2(DeciTreeOption<SowedulInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowedulInfo>> buildActionsOnPassedHook(DeciTreeOption<SowedulInfo> option) {
		...
		ActionLazy<SowedulInfo> upsertSowedulagr = new LazySowedulSowedulagrUpsert(option.conn, option.schemaName);
