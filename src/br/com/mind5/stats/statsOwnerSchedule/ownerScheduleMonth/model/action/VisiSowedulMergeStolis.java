...
final class VisiSowedulMergeStolis extends ActionVisitorTemplateMerge<SowedulInfo, StolisInfo> {
	
	public VisiSowedulMergeStolis(DeciTreeOption<SowedulInfo> option) {
