...
public final class DaoSoweduliveDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public static final String COL_COUNT_SCHEDULE_CANCELLED_VAR = DaoDbField.COL_COUNT_SCHEDULE_CANCELLED_VAR;
	...
	public static final String COL_COUNT_SCHEDULE_CONFIRMED_VAR = DaoDbField.COL_COUNT_SCHEDULE_CONFIRMED_VAR;
	...
	public static final String COL_COUNT_SCHEDULE_TOTAL_VAR = DaoDbField.COL_COUNT_SCHEDULE_TOTAL_VAR;
	...
	public static final String COL_COUNT_SCHEDULE_WAITING_VAR = DaoDbField.COL_COUNT_SCHEDULE_WAITING_VAR;
	...
	public DaoSoweduliveDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STAT_STORE_SCHEDULE_DASH_LIVE_TABLE;
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_COUNT_SCHEDULE_CANCELLED_VAR;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_COUNT_SCHEDULE_WAITING_VAR;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_COUNT_SCHEDULE_TOTAL_VAR;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
		...
		oneColumn = new DaoColumn();
		oneColumn.tableName = TABLE_NAME;
		oneColumn.columnName = COL_COUNT_SCHEDULE_CONFIRMED_VAR;
		oneColumn.isPK = NEGATIVE;
		oneColumn.isLookUp = NEGATIVE;
		oneColumn.isAutoIncremented = NEGATIVE;
		columns.add(oneColumn);
