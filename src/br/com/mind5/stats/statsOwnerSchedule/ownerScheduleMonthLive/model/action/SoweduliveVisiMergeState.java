...
public final class SoweduliveVisiMergeState extends ActionVisitorTemplateMerge<SoweduliveInfo, StateInfo> {
	
	public SoweduliveVisiMergeState(DeciTreeOption<SoweduliveInfo> option) {
