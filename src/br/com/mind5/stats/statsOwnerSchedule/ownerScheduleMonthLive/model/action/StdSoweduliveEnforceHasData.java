...
public final class StdSoweduliveEnforceHasData extends ActionStdTemplate<SoweduliveInfo> {

	public StdSoweduliveEnforceHasData(DeciTreeOption<SoweduliveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SoweduliveInfo> buildVisitorHook(DeciTreeOption<SoweduliveInfo> option) {
		return new VisiSoweduliveEnforceHasData(option);
	}
}
