...
public final class LazySoweduliveEnforceHasData extends ActionLazyTemplate<SoweduliveInfo, SoweduliveInfo> {

	public LazySoweduliveEnforceHasData(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SoweduliveInfo> getInstanceOfActionHook(DeciTreeOption<SoweduliveInfo> option) {
		return new StdSoweduliveEnforceHasData(option);
	}
