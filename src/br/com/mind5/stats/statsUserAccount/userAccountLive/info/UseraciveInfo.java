...
public final class UseraciveInfo extends InfoRecord implements Cloneable {
	...
	public static UseraciveInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, UseraciveInfo.class);
	}
	
	
	
	public static List<UseraciveInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, UseraciveInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof UseraciveInfo))
			return false;
		
		
		UseraciveInfo obj = (UseraciveInfo) o;		
