...
public final class LazyUseraciveEnforceLChanged extends ActionLazyTemplate<UseraciveInfo, UseraciveInfo> {

	public LazyUseraciveEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UseraciveInfo> getInstanceOfActionHook(DeciTreeOption<UseraciveInfo> option) {
		return new StdUseraciveEnforceLChanged(option);
	}
