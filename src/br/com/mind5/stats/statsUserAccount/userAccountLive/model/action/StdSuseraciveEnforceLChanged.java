...
public final class StdSuseraciveEnforceLChanged extends ActionStdTemplate<SuseraciveInfo> {

	public StdSuseraciveEnforceLChanged(DeciTreeOption<SuseraciveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SuseraciveInfo> buildVisitorHook(DeciTreeOption<SuseraciveInfo> option) {
		return new VisiSuseraciveEnforceLChanged(option);
	}
}
