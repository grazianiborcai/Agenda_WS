...
public final class LazySuseraciveEnforceLChanged extends ActionLazyTemplate<SuseraciveInfo, SuseraciveInfo> {

	public LazySuseraciveEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SuseraciveInfo> getInstanceOfActionHook(DeciTreeOption<SuseraciveInfo> option) {
		return new StdSuseraciveEnforceLChanged(option);
	}
