...
public final class StdSuseraciveMergeState extends ActionStdTemplate<SuseraciveInfo> {

	public StdSuseraciveMergeState(DeciTreeOption<SuseraciveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SuseraciveInfo> buildVisitorHook(DeciTreeOption<SuseraciveInfo> option) {
		return new VisiSuseraciveMergeState(option);
	}
}
