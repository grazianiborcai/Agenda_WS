...
public final class LazySuseraciveMergeMonth extends ActionLazyTemplate<SuseraciveInfo, SuseraciveInfo> {

	public LazySuseraciveMergeMonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SuseraciveInfo> getInstanceOfActionHook(DeciTreeOption<SuseraciveInfo> option) {
		return new StdSuseraciveMergeMonth(option);
	}
