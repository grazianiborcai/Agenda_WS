...
public final class LazySuseraciveMergeState extends ActionLazyTemplate<SuseraciveInfo, SuseraciveInfo> {

	public LazySuseraciveMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SuseraciveInfo> getInstanceOfActionHook(DeciTreeOption<SuseraciveInfo> option) {
		return new StdSuseraciveMergeState(option);
	}
