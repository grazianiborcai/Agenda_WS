...
public final class LazyUseraciveMergeMonth extends ActionLazyTemplate<UseraciveInfo, UseraciveInfo> {

	public LazyUseraciveMergeMonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<UseraciveInfo> getInstanceOfActionHook(DeciTreeOption<UseraciveInfo> option) {
		return new StdUseraciveMergeMonth(option);
	}
