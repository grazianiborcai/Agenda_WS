...
public final class StdSuseraciveDaoSelect extends ActionStdTemplate<SuseraciveInfo> {

	public StdSuseraciveDaoSelect(DeciTreeOption<SuseraciveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SuseraciveInfo> buildVisitorHook(DeciTreeOption<SuseraciveInfo> option) {
		return new VisiSuseraciveDaoSelect(option);
	}
}
