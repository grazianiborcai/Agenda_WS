...
public final class StdStusoreveMergeCurrency extends ActionStdTemplate<StusoraggInfo> {

	public StdStusoreveMergeCurrency(DeciTreeOption<StusoraggInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StusoraggInfo> buildVisitorHook(DeciTreeOption<StusoraggInfo> option) {
		return new VisiStusoraggMergeCurrency(option);
	}
}
