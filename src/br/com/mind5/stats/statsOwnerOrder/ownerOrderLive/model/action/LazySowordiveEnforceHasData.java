...
public final class LazySowordiveEnforceHasData extends ActionLazyTemplate<SowordiveInfo, SowordiveInfo> {

	public LazySowordiveEnforceHasData(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SowordiveInfo> getInstanceOfActionHook(DeciTreeOption<SowordiveInfo> option) {
		return new StdSowordiveEnforceHasData(option);
	}
