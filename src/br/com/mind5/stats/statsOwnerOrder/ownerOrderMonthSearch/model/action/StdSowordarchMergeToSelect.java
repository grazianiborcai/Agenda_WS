...
public final class StdSowordarchMergeToSelect extends ActionStdTemplate<SowordarchInfo> {

	public StdSowordarchMergeToSelect(DeciTreeOption<SowordarchInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowordarchInfo> buildVisitorHook(DeciTreeOption<SowordarchInfo> option) {
		return new VisiSowordarchMergeToSelect(option);
	}
}
