...
public final class StdSowordagrMergeToSelect extends ActionStdTemplate<SowordagrInfo> {

	public StdSowordagrMergeToSelect(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowordagrInfo> buildVisitorHook(DeciTreeOption<SowordagrInfo> option) {
		return new VisiSowordagrMergeToSelect(option);
	}
}
