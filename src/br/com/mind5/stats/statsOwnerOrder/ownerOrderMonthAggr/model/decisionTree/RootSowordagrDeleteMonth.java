...
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonthAggr.model.checker.SowordagrCheckDeleteMonth;


public final class RootSowordagrDeleteMonth extends DeciTreeTemplateWrite<SowordagrInfo> {
	
	public RootSowordagrDeleteMonth(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	@Override protected ModelChecker<SowordagrInfo> buildCheckerHook(DeciTreeOption<SowordagrInfo> option) {
		...
		checker = new SowordagrCheckDeleteMonth(checkerOption);
		queue.add(checker);
	...
	@Override protected List<ActionStd<SowordagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowordagrInfo> option) {
		...
		ActionStd<SowordagrInfo> nodeL1 = new NodeSowordagrDeleteMonth(option).toAction();
