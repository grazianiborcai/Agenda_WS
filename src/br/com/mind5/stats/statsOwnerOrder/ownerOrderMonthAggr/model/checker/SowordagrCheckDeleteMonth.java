...
public final class SowordagrCheckDeleteMonth extends ModelCheckerTemplateSimple<SowordagrInfo> {

	public SowordagrCheckDeleteMonth(ModelCheckerOption option) {
		super(option);
	}
