...
public final class StdSowordagrMergeCalonth extends ActionStdTemplate<SowordagrInfo> {

	public StdSowordagrMergeCalonth(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowordagrInfo> buildVisitorHook(DeciTreeOption<SowordagrInfo> option) {
		return new VisiSowordagrMergeCalonth(option);
	}
}
