...
public final class NodeSowordagrUpsert extends DeciTreeTemplateWrite<SowordagrInfo> {
	
	public NodeSowordagrUpsert(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowordagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowordagrInfo> option) {
		...
		ActionStd<SowordagrInfo> delete = new RootSowordagrDelete(option).toAction();
		ActionStd<SowordagrInfo> insert = new RootSowordagrInsert(option).toAction();
