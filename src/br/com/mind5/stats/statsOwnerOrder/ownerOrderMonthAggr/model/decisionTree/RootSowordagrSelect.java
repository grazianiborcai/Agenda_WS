...
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonthAggr.model.action.LazySowordagrMergeCalonth;
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonthAggr.model.action.LazySowordagrMergeState;
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonthAggr.model.action.StdSowordagrMergeToSelect;
...
public final class RootSowordagrSelect extends DeciTreeTemplateWrite<SowordagrInfo> {
	
	public RootSowordagrSelect(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowordagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowordagrInfo> option) {
		...
		ActionStd<SowordagrInfo> select = new StdSowordagrMergeToSelect(option);
		ActionLazy<SowordagrInfo> mergeState = new LazySowordagrMergeState(option.conn, option.schemaName);
		ActionLazy<SowordagrInfo> mergeCalonth = new LazySowordagrMergeCalonth(option.conn, option.schemaName);
