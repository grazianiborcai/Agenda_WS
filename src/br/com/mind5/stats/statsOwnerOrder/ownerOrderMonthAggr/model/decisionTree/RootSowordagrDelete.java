...
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonthAggr.model.action.StdSowordagrDaoDelete;
...
public final class RootSowordagrDelete extends DeciTreeTemplateWrite<SowordagrInfo> {
	...
	public RootSowordagrDelete(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowordagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowordagrInfo> option) {
		...
		ActionStd<SowordagrInfo> delete = new StdSowordagrDaoDelete(option);
