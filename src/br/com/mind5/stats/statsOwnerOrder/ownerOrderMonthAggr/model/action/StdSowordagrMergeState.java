...
public final class StdSowordagrMergeState extends ActionStdTemplate<SowordagrInfo> {

	public StdSowordagrMergeState(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowordagrInfo> buildVisitorHook(DeciTreeOption<SowordagrInfo> option) {
		return new VisiSowordagrMergeState(option);
	}
}
