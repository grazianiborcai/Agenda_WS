...
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonthAggr.model.action.LazySowordagrDaoInsert;
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonthAggr.model.action.StdSowordagrEnforceLChanged;
...
public final class RootSowordagrInsert extends DeciTreeTemplateWrite<SowordagrInfo> {
	
	public RootSowordagrInsert(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowordagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowordagrInfo> option) {
		...
		ActionStd<SowordagrInfo> enforceLChanged = new StdSowordagrEnforceLChanged(option);
		ActionLazy<SowordagrInfo> insert = new LazySowordagrDaoInsert(option.conn, option.schemaName);
