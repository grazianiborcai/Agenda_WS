...
public final class SowordagrRootUpsert extends DeciTreeTemplateWrite<SowordagrInfo> {
	
	public SowordagrRootUpsert(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowordagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowordagrInfo> option) {
		...
		ActionStd<SowordagrInfo> nodeL1 = new SowordagrNodeUpsert(option).toAction();
