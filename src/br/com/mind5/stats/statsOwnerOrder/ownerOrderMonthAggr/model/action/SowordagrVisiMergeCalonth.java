...
public final class SowordagrVisiMergeCalonth extends ActionVisitorTemplateMerge<SowordagrInfo, CalonthInfo> {
	
	public SowordagrVisiMergeCalonth(DeciTreeOption<SowordagrInfo> option) {
