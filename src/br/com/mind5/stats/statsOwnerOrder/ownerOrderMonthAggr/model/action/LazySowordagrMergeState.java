...
public final class LazySowordagrMergeState extends ActionLazyTemplate<SowordagrInfo, SowordagrInfo> {

	public LazySowordagrMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SowordagrInfo> getInstanceOfActionHook(DeciTreeOption<SowordagrInfo> option) {
		return new StdSowordagrMergeState(option);
	}
