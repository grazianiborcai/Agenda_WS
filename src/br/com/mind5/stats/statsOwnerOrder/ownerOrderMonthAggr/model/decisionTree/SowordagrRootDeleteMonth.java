...
public final class SowordagrRootDeleteMonth extends DeciTreeTemplateWrite<SowordagrInfo> {
	
	public SowordagrRootDeleteMonth(DeciTreeOption<SowordagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SowordagrInfo>> buildActionsOnPassedHook(DeciTreeOption<SowordagrInfo> option) {
		...
		ActionStd<SowordagrInfo> nodeL1 = new SowordagrNodeDeleteMonth(option).toAction();
