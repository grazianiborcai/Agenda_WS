...
public final class DaoSowordagrInsertSingle extends DaoStmtTemplate<SowordagrInfo> {
	private final String MAIN_TABLE = DaoDbTable.STAT_OWNER_ORDER_MONTH_TABLE;
	
	
	public DaoSowordagrInsertSingle(Connection conn, SowordagrInfo recordInfo, String schemaName) {
