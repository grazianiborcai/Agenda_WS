...
public final class SowordagrDaoSelect implements DaoStmtExec<SowordagrInfo> {
	private DaoStmtExec<SowordagrInfo> helper;
	
	
	public SowordagrDaoSelect(List<DaoStmtExecOption<SowordagrInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, SowordagrDaoSelectSingle.class, SowordagrInfo.class);
	}
