...
public final class DaoSowordagrDeleteSingle extends DaoStmtTemplate<SowordagrInfo> {
	private final String MAIN_TABLE = DaoDbTable.STAT_OWNER_ORDER_MONTH_TABLE;
	
	
	public DaoSowordagrDeleteSingle(Connection conn, SowordagrInfo recordInfo, String schemaName) {
