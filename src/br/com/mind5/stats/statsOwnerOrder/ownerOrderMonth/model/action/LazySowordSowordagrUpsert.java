...
public final class LazySowordSowordagrUpsert extends ActionLazyTemplate<SowordInfo, SowordInfo> {

	public LazySowordSowordagrUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SowordInfo> getInstanceOfActionHook(DeciTreeOption<SowordInfo> option) {
		return new StdSowordSowordagrUpsert(option);
	}
