...
import br.com.mind5.stats.statsOwnerOrder.ownerOrderMonth.model.decisionTree.NodeSowordSelectL1;

public final class LazySowordNodeSelectL1 extends ActionLazyTemplate<SowordInfo, SowordInfo> {

	public LazySowordNodeSelectL1(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SowordInfo> getInstanceOfActionHook(DeciTreeOption<SowordInfo> option) {
		return new NodeSowordSelectL1(option).toAction();
	}
