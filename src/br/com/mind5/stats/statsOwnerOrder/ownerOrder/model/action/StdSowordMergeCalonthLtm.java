...
public final class StdSowordMergeCalonthLtm extends ActionStdTemplate<SowordInfo> {

	public StdSowordMergeCalonthLtm(DeciTreeOption<SowordInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowordInfo> buildVisitorHook(DeciTreeOption<SowordInfo> option) {
		return new VisiSowordMergeCalonthLtm(option);
	}
}
