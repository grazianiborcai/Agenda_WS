package br.com.mind5.stats.userStorePurchaseStgn.model.checker;
...
public final class StusorageCheckRead extends ModelCheckerTemplateSimple<StusorageInfo> {

	public StusorageCheckRead(ModelCheckerOption option) {
		super(option);
	}
