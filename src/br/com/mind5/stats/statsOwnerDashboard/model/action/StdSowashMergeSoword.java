...
public final class StdSowashMergeSoword extends ActionStdTemplate<SowashInfo> {

	public StdSowashMergeSoword(DeciTreeOption<SowashInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SowashInfo> buildVisitorHook(DeciTreeOption<SowashInfo> option) {
		return new VisiSowashMergeSoword(option);
	}
}
