...
public final class SowashVisiMergeSoword extends ActionVisitorTemplateMerge<SowashInfo, SowordInfo> {
	
	public SowashVisiMergeSoword(DeciTreeOption<SowashInfo> option) {
