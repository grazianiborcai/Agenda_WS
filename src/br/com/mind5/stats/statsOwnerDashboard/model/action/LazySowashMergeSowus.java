...
public final class LazySowashMergeSowus extends ActionLazyTemplate<SowashInfo, SowashInfo> {

	public LazySowashMergeSowus(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SowashInfo> getInstanceOfActionHook(DeciTreeOption<SowashInfo> option) {
		return new StdSowashMergeSowus(option);
	}
