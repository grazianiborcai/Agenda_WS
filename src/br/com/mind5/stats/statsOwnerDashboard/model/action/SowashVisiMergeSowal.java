...
public final class SowashVisiMergeSowal extends ActionVisitorTemplateMerge<SowashInfo, SowalInfo> {
	
	public SowashVisiMergeSowal(DeciTreeOption<SowashInfo> option) {
