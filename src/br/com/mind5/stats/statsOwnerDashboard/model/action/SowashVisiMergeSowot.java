...
public final class SowashVisiMergeSowot extends ActionVisitorTemplateMerge<SowashInfo, SowotInfo> {
	
	public SowashVisiMergeSowot(DeciTreeOption<SowashInfo> option) {
