...
public final class CustamoniveInfo extends InfoRecord implements Cloneable {
	...
	public static CustamoniveInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, CustamoniveInfo.class);
	}
	
	
	
	public static List<CustamoniveInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, CustamoniveInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof CustamoniveInfo))
			return false;
		
		
		CustamoniveInfo obj = (CustamoniveInfo) o;
