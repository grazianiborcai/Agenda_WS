...
public final class CustamoniveDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public CustamoniveDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STAT_CUSTOMER_SCHEDULE_MONTH_LIVE_TABLE;
