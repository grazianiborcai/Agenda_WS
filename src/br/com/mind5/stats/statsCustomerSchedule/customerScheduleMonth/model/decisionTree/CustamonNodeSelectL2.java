...
public final class CustamonNodeSelectL2 extends DeciTreeTemplateWrite<CustamonInfo> {
	
	public CustamonNodeSelectL2(DeciTreeOption<CustamonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CustamonInfo>> buildActionsOnPassedHook(DeciTreeOption<CustamonInfo> option) {
		...
		mergeCustamonive.addPostAction(insertCustamonagr);
