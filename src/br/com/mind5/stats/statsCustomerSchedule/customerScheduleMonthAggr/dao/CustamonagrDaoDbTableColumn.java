...
public final class CustamonagrDaoDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public CustamonagrDaoDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STAT_CUSTOMER_SCHEDULE_MONTH_TABLE;
