...
public final class CustamonagrDaoDelete implements DaoStmtExec<CustamonagrInfo> {
	private DaoStmtExec<CustamonagrInfo> helper;
	
	
	public CustamonagrDaoDelete(List<DaoStmtExecOption<CustamonagrInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, CustamonagrDaoDeleteSingle.class, CustamonagrInfo.class);
	}
