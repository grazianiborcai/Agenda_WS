...
public final class CustamonagrDaoSelect implements DaoStmtExec<CustamonagrInfo> {
	private DaoStmtExec<CustamonagrInfo> helper;
	
	
	public CustamonagrDaoSelect(List<DaoStmtExecOption<CustamonagrInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, CustamonagrDaoSelectSingle.class, CustamonagrInfo.class);
	}
