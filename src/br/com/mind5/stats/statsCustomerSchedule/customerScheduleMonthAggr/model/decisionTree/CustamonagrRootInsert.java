...
import br.com.mind5.stats.statsCustomerSchedule.customerScheduleMonthAggr.model.action.CustamonagrVisiDaoInsert;
import br.com.mind5.stats.statsCustomerSchedule.customerScheduleMonthAggr.model.action.CustamonagrVisiEnforceLChanged;
...
public final class CustamonagrRootInsert extends DeciTreeTemplateWrite<CustamonagrInfo> {
	
	public CustamonagrRootInsert(DeciTreeOption<CustamonagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CustamonagrInfo>> buildActionsOnPassedHook(DeciTreeOption<CustamonagrInfo> option) {
		...
		ActionStd<CustamonagrInfo> enforceLChanged = new ActionStdCommom<CustamonagrInfo>(option, CustamonagrVisiEnforceLChanged.class);
		ActionLazy<CustamonagrInfo> insert = new ActionLazyCommom<CustamonagrInfo>(option, CustamonagrVisiDaoInsert.class);
