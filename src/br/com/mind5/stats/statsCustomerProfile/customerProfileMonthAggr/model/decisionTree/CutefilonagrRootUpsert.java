...
public final class CutefilonagrRootUpsert extends DeciTreeTemplateWrite<CutefilonagrInfo> {
	
	public CutefilonagrRootUpsert(DeciTreeOption<CutefilonagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CutefilonagrInfo>> buildActionsOnPassedHook(DeciTreeOption<CutefilonagrInfo> option) {
		...
		ActionStd<CutefilonagrInfo> nodeL1 = new CutefilonagrNodeUpsert(option).toAction();
