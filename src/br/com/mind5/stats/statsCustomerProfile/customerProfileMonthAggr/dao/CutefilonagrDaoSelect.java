...
public final class CutefilonagrDaoSelect implements DaoStmtExec<CutefilonagrInfo> {
	private DaoStmtExec<CutefilonagrInfo> helper;
	
	
	public CutefilonagrDaoSelect(List<DaoStmtExecOption<CutefilonagrInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, CutefilonagrDaoSelectSingle.class, CutefilonagrInfo.class);
	}
