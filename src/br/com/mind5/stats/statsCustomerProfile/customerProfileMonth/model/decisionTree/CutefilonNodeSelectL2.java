...
import br.com.mind5.stats.statsCustomerProfile.customerProfileMonth.model.action.CutefilonVisiCutefilonagrInsert;
import br.com.mind5.stats.statsCustomerProfile.customerProfileMonth.model.checker.CutefilonCheckStefilonive;


public final class CutefilonNodeSelectL2 extends DeciTreeTemplateWrite<CutefilonInfo> {
	
	public CutefilonNodeSelectL2(DeciTreeOption<CutefilonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<CutefilonInfo>> buildActionsOnPassedHook(DeciTreeOption<CutefilonInfo> option) {
		...
		ActionLazy<CutefilonInfo> insertCutefilonagr = new ActionLazyCommom<CutefilonInfo>(option, CutefilonVisiCutefilonagrInsert.class);
		
		mergeCutefilonive.addPostAction(insertCutefilonagr);
	...
	@Override protected List<ActionStd<CutefilonInfo>> buildActionsOnFailedHook(DeciTreeOption<CutefilonInfo> option) {
		...
		zerofy.addPostAction(insertCutefilonagr);
