...
import br.com.mind5.stats.statsStoreSchedule.storeScheduleMonthAggr.model.action.LazyStedmonagrMergeCalonth;
import br.com.mind5.stats.statsStoreSchedule.storeScheduleMonthAggr.model.action.LazyStedmonagrMergeState;
import br.com.mind5.stats.statsStoreSchedule.storeScheduleMonthAggr.model.action.StdStedmonagrMergeToSelect;
...
public final class RootStedmonagrSelect extends DeciTreeTemplateWrite<StedmonagrInfo> {
	
	public RootStedmonagrSelect(DeciTreeOption<StedmonagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StedmonagrInfo>> buildActionsOnPassedHook(DeciTreeOption<StedmonagrInfo> option) {
		...
		ActionStd<StedmonagrInfo> select = new StdStedmonagrMergeToSelect(option);
		ActionLazy<StedmonagrInfo> mergeState = new LazyStedmonagrMergeState(option.conn, option.schemaName);
		ActionLazy<StedmonagrInfo> mergeCalonth = new LazyStedmonagrMergeCalonth(option.conn, option.schemaName);
