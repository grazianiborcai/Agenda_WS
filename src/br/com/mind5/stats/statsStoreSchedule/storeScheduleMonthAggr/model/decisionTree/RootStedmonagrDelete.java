...
import br.com.mind5.stats.statsStoreSchedule.storeScheduleMonthAggr.model.action.StdStedmonagrDaoDelete;
...
public final class RootStedmonagrDelete extends DeciTreeTemplateWrite<StedmonagrInfo> {
	
	public RootStedmonagrDelete(DeciTreeOption<StedmonagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StedmonagrInfo>> buildActionsOnPassedHook(DeciTreeOption<StedmonagrInfo> option) {
		...
		ActionStd<StedmonagrInfo> delete = new StdStedmonagrDaoDelete(option);	
