...
public final class StedmonagrVisiMergeCalonth extends ActionVisitorTemplateMerge<StedmonagrInfo, CalonthInfo> {
	
	public StedmonagrVisiMergeCalonth(DeciTreeOption<StedmonagrInfo> option) {
