...
public final class LazyStedmonagrMergeState extends ActionLazyTemplate<StedmonagrInfo, StedmonagrInfo> {

	public LazyStedmonagrMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StedmonagrInfo> getInstanceOfActionHook(DeciTreeOption<StedmonagrInfo> option) {
		return new StdStedmonagrMergeState(option);
	}
