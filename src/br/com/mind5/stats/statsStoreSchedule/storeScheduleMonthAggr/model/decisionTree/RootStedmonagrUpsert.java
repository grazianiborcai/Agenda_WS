...
public final class RootStedmonagrUpsert extends DeciTreeTemplateWrite<StedmonagrInfo> {
	
	public RootStedmonagrUpsert(DeciTreeOption<StedmonagrInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StedmonagrInfo>> buildActionsOnPassedHook(DeciTreeOption<StedmonagrInfo> option) {
		...
		ActionStd<StedmonagrInfo> nodeL1 = new NodeStedmonagrUpsert(option).toAction();
