...
public final class StdStedmonagrMergeCalonth extends ActionStdTemplate<StedmonagrInfo> {

	public StdStedmonagrMergeCalonth(DeciTreeOption<StedmonagrInfo> option) {
		super(option);
	}
