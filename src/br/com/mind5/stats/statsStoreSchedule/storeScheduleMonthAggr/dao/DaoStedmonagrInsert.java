...
public final class DaoStedmonagrInsert implements DaoStmtExec<StedmonagrInfo> {
	private DaoStmtExec<StedmonagrInfo> helper;
	
	
	public DaoStedmonagrInsert(List<DaoStmtExecOption<StedmonagrInfo>> options) {
		helper = new DaoStmtExecHelper<>(options, DaoStedmonagrInsertSingle.class, StedmonagrInfo.class);
	}
