...
public final class DaoStedmonagrDbTableColumn extends DaoDbTableColumnTemplate {
	...
	public DaoStedmonagrDbTableColumn() {
		super();
	}
	...
	@Override protected Hashtable<String, List<DaoColumn>> buildTableColumnsHook() {
		final String TABLE_NAME = DaoDbTable.STAT_STORE_SCHEDULE_MONTH_TABLE;
