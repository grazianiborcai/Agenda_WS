...
import br.com.mind5.stats.statsStoreSchedule.storeScheduleDayAggr.model.decisionTree.RootSteddagrUpsert;

final class VisiSteddSteddagrUpsert extends ActionVisitorTemplateAction<SteddInfo, SteddagrInfo> {

	public VisiSteddSteddagrUpsert(DeciTreeOption<SteddInfo> option) {
	...
	@Override protected Class<? extends DeciTree<SteddagrInfo>> getTreeClassHook() {
		return RootSteddagrUpsert.class;
	}
