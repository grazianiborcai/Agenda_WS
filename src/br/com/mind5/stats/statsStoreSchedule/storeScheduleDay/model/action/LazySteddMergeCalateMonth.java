...
public final class LazySteddMergeCalateMonth extends ActionLazyTemplate<SteddInfo, SteddInfo> {

	public LazySteddMergeCalateMonth(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SteddInfo> getInstanceOfActionHook(DeciTreeOption<SteddInfo> option) {
		return new StdSteddMergeCalateMonth(option);
	}
