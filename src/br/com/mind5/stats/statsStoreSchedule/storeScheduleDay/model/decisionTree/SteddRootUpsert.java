...
public final class SteddRootUpsert extends DeciTreeTemplateWrite<SteddInfo> {
	
	public SteddRootUpsert(DeciTreeOption<SteddInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SteddInfo>> buildActionsOnPassedHook(DeciTreeOption<SteddInfo> option) {
		...
		ActionStd<SteddInfo> nodeL1 = new SteddNodeUpsert(option).toAction();		
