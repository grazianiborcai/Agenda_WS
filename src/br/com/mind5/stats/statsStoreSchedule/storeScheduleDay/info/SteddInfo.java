...
public final class SteddInfo extends InfoRecord implements Cloneable {
	...
	public static SteddInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, SteddInfo.class);
	}
	
	
	
	public static List<SteddInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, SteddInfo.class);
	}
