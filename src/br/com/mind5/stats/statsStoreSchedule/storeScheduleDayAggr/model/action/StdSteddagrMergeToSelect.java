...
public final class StdSteddagrMergeToSelect extends ActionStdTemplate<SteddagrInfo> {

	public StdSteddagrMergeToSelect(DeciTreeOption<SteddagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SteddagrInfo> buildVisitorHook(DeciTreeOption<SteddagrInfo> option) {
		return new VisiSteddagrMergeToSelect(option);
	}
}
