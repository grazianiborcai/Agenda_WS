...
public final class StdSteddagrDaoDelete extends ActionStdTemplate<SteddagrInfo> {

	public StdSteddagrDaoDelete(DeciTreeOption<SteddagrInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SteddagrInfo> buildVisitorHook(DeciTreeOption<SteddagrInfo> option) {
		return new VisiSteddagrDaoDelete(option);
	}
}
