...
public final class LazySteddagrDaoInsert extends ActionLazyTemplate<SteddagrInfo, SteddagrInfo> {

	public LazySteddagrDaoInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SteddagrInfo> getInstanceOfActionHook(DeciTreeOption<SteddagrInfo> option) {
		return new StdSteddagrDaoInsert(option);
	}
