...
public final class LazySteddagrMergeState extends ActionLazyTemplate<SteddagrInfo, SteddagrInfo> {

	public LazySteddagrMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SteddagrInfo> getInstanceOfActionHook(DeciTreeOption<SteddagrInfo> option) {
		return new StdSteddagrMergeState(option);
	}
