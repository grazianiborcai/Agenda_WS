...
public final class LazySteddiveMergeState extends ActionLazyTemplate<SteddiveInfo, SteddiveInfo> {

	public LazySteddiveMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SteddiveInfo> getInstanceOfActionHook(DeciTreeOption<SteddiveInfo> option) {
		return new StdSteddiveMergeState(option);
	}
