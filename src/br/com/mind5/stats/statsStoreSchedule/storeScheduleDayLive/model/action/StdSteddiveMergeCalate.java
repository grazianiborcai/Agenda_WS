...
public final class StdSteddiveMergeCalate extends ActionStdTemplate<SteddiveInfo> {

	public StdSteddiveMergeCalate(DeciTreeOption<SteddiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SteddiveInfo> buildVisitorHook(DeciTreeOption<SteddiveInfo> option) {
		return new VisiSteddiveMergeCalate(option);
	}
}
