...
public final class LazySteddiveEnforceHasData extends ActionLazyTemplate<SteddiveInfo, SteddiveInfo> {

	public LazySteddiveEnforceHasData(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SteddiveInfo> getInstanceOfActionHook(DeciTreeOption<SteddiveInfo> option) {
		return new StdSteddiveEnforceHasData(option);
	}
