...
public final class StdSteddiveEnforceHasData extends ActionStdTemplate<SteddiveInfo> {

	public StdSteddiveEnforceHasData(DeciTreeOption<SteddiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SteddiveInfo> buildVisitorHook(DeciTreeOption<SteddiveInfo> option) {
		return new VisiSteddiveEnforceHasData(option);
	}
}
