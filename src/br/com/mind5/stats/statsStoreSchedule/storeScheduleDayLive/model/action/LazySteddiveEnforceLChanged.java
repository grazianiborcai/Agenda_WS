...
public final class LazySteddiveEnforceLChanged extends ActionLazyTemplate<SteddiveInfo, SteddiveInfo> {

	public LazySteddiveEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SteddiveInfo> getInstanceOfActionHook(DeciTreeOption<SteddiveInfo> option) {
		return new StdSteddiveEnforceLChanged(option);
	}
