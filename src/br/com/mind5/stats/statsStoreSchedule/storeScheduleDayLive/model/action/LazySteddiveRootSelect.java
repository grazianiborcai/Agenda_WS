...
public final class LazySteddiveRootSelect extends ActionLazyTemplate<SteddiveInfo, SteddiveInfo> {

	public LazySteddiveRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SteddiveInfo> getInstanceOfActionHook(DeciTreeOption<SteddiveInfo> option) {
		return new RootSteddiveSelect(option).toAction();
	}
