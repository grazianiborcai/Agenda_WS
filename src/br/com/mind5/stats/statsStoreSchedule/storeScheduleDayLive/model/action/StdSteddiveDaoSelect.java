...
public final class StdSteddiveDaoSelect extends ActionStdTemplate<SteddiveInfo> {

	public StdSteddiveDaoSelect(DeciTreeOption<SteddiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SteddiveInfo> buildVisitorHook(DeciTreeOption<SteddiveInfo> option) {
		return new VisiSteddiveDaoSelect(option);
	}
}
