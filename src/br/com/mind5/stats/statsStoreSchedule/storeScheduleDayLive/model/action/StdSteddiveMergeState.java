...
public final class StdSteddiveMergeState extends ActionStdTemplate<SteddiveInfo> {

	public StdSteddiveMergeState(DeciTreeOption<SteddiveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<SteddiveInfo> buildVisitorHook(DeciTreeOption<SteddiveInfo> option) {
		return new VisiSteddiveMergeState(option);
	}
}
