...
public final class LazyStedmonRootSelect extends ActionLazyTemplate<StedmonInfo, StedmonInfo> {

	public LazyStedmonRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StedmonInfo> getInstanceOfActionHook(DeciTreeOption<StedmonInfo> option) {
		return new RootStedmonSelect(option).toAction();
	}
