...
public final class StdStedmonStedmonagrInsert extends ActionStdTemplate<StedmonInfo> {

	public StdStedmonStedmonagrInsert(DeciTreeOption<StedmonInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StedmonInfo> buildVisitorHook(DeciTreeOption<StedmonInfo> option) {
		return new VisiStedmonStedmonagrInsert(option);
	}
}
