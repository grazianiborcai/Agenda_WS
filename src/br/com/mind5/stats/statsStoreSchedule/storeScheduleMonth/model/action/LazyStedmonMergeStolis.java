...
public final class LazyStedmonMergeStolis extends ActionLazyTemplate<StedmonInfo, StedmonInfo> {

	public LazyStedmonMergeStolis(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StedmonInfo> getInstanceOfActionHook(DeciTreeOption<StedmonInfo> option) {
		return new StdStedmonMergeStolis(option);
	}
