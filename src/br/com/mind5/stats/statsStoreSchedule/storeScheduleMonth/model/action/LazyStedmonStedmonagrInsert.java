...
public final class LazyStedmonStedmonagrInsert extends ActionLazyTemplate<StedmonInfo, StedmonInfo> {

	public LazyStedmonStedmonagrInsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StedmonInfo> getInstanceOfActionHook(DeciTreeOption<StedmonInfo> option) {
		return new StdStedmonStedmonagrInsert(option);
	}
