...
public final class RootStedmonSelect extends DeciTreeTemplateWrite<StedmonInfo> {
	
	public RootStedmonSelect(DeciTreeOption<StedmonInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StedmonInfo>> buildActionsOnPassedHook(DeciTreeOption<StedmonInfo> option) {
		...
		ActionStd<StedmonInfo> nodeL1 = new NodeStedmonSelectL1(option).toAction();
