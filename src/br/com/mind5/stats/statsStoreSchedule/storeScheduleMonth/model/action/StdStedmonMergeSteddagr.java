...
public final class StdStedmonMergeSteddagr extends ActionStdTemplate<StedmonInfo> {

	public StdStedmonMergeSteddagr(DeciTreeOption<StedmonInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StedmonInfo> buildVisitorHook(DeciTreeOption<StedmonInfo> option) {
		return new VisiStedmonMergeStedmonagr(option);
	}
}
