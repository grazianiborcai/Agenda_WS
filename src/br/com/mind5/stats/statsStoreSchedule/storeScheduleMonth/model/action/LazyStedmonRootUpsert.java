...
public final class LazyStedmonRootUpsert extends ActionLazyTemplate<StedmonInfo, StedmonInfo> {

	public LazyStedmonRootUpsert(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StedmonInfo> getInstanceOfActionHook(DeciTreeOption<StedmonInfo> option) {
		return new RootStedmonUpsert(option).toAction();
	}
