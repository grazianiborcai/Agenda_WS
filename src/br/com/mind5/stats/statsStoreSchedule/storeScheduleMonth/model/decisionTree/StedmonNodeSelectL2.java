...
import br.com.mind5.stats.statsStoreSchedule.storeScheduleMonth.model.action.StedmonVisiStedmonagrInsert;
import br.com.mind5.stats.statsStoreSchedule.storeScheduleMonth.model.checker.StedmonCheckStedmonive;


public final class StedmonNodeSelectL2 extends DeciTreeTemplateWrite<StedmonInfo> {
	
	public StedmonNodeSelectL2(DeciTreeOption<StedmonInfo> option) {
		super(option);
	}
