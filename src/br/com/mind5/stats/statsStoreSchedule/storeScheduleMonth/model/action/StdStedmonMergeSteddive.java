...
public final class StdStedmonMergeSteddive extends ActionStdTemplate<StedmonInfo> {

	public StdStedmonMergeSteddive(DeciTreeOption<StedmonInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StedmonInfo> buildVisitorHook(DeciTreeOption<StedmonInfo> option) {
		return new VisiStedmonMergeStedmonive(option);
	}
}
