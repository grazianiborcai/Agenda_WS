...
public final class StedmoniveInfo extends InfoRecord implements Cloneable {
	...
	public static StedmoniveInfo copyFrom(Object sourceObj) {
		return copyFrom(sourceObj, StedmoniveInfo.class);
	}
	
	
	
	public static List<StedmoniveInfo> copyFrom(List<?> sourceObjs) {
		return copyFrom(sourceObjs, StedmoniveInfo.class);
	}
	...
	@Override public boolean equals(Object o) {
		...
		if (!(o instanceof StedmoniveInfo))
			return false;
		
		
		StedmoniveInfo obj = (StedmoniveInfo) o;
