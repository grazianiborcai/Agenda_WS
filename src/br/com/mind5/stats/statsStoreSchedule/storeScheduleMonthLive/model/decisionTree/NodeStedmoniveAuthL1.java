...
public final class NodeStedmoniveAuthL1 extends DeciTreeTemplateWrite<StedmoniveInfo> {
	
	public NodeStedmoniveAuthL1(DeciTreeOption<StedmoniveInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<StedmoniveInfo>> buildActionsOnFailedHook(DeciTreeOption<StedmoniveInfo> option) {
		...
		ActionStd<StedmoniveInfo> nodeL2 = new NodeStedmoniveAuthL2(option).toAction();
