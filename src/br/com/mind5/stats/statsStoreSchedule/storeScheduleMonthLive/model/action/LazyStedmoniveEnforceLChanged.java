...
public final class LazyStedmoniveEnforceLChanged extends ActionLazyTemplate<StedmoniveInfo, StedmoniveInfo> {

	public LazyStedmoniveEnforceLChanged(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StedmoniveInfo> getInstanceOfActionHook(DeciTreeOption<StedmoniveInfo> option) {
		return new StdStedmoniveEnforceLChanged(option);
	}
