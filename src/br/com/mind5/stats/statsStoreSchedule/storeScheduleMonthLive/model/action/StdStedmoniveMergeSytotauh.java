...
public final class StdStedmoniveMergeSytotauh extends ActionStdTemplate<StedmoniveInfo> {

	public StdStedmoniveMergeSytotauh(DeciTreeOption<StedmoniveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StedmoniveInfo> buildVisitorHook(DeciTreeOption<StedmoniveInfo> option) {
		return new VisiStedmoniveMergeSytotauh(option);
	}
}
