...
public final class LazyStedmoniveMergeState extends ActionLazyTemplate<StedmoniveInfo, StedmoniveInfo> {

	public LazyStedmoniveMergeState(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<StedmoniveInfo> getInstanceOfActionHook(DeciTreeOption<StedmoniveInfo> option) {
		return new StdStedmoniveMergeState(option);
	}
