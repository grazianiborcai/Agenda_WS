...
public final class StdStedmoniveMergeState extends ActionStdTemplate<StedmoniveInfo> {

	public StdStedmoniveMergeState(DeciTreeOption<StedmoniveInfo> option) {
		super(option);
	}
	...
	protected ActionVisitor<StedmoniveInfo> buildVisitorHook(DeciTreeOption<StedmoniveInfo> option) {
		return new VisiStedmoniveMergeState(option);
	}
}
