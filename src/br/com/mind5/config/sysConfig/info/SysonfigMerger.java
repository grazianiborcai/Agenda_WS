...
public final class SysonfigMerger {	
	...
	public static List<SysonfigInfo> mergeWithSysonup(List<SysonfigInfo> baseInfos, List<SysonupInfo> selectedInfos) {
		InfoMergerBuilderV3<SysonfigInfo, SysonupInfo> builder = new InfoMergerBuilderV3<>();
		
		builder.addBaseInfos(baseInfos);
		builder.addSelectedInfos(selectedInfos);
		builder.addVisitor(new SysonfigVisiMergeSysonup());
		InfoMergerV3<SysonfigInfo, SysonupInfo> merger = builder.build();		
