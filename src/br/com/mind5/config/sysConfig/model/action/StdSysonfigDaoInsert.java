...
public final class StdSysonfigDaoInsert extends ActionStdTemplateV2<SysonfigInfo> {

	public StdSysonfigDaoInsert(DeciTreeOption<SysonfigInfo> option) {
		super(option);
	}
	...
	protected ActionVisitorV2<SysonfigInfo> buildVisitorHook(DeciTreeOption<SysonfigInfo> option) {
		return new VisiSysonfigDaoInsert(option);
	}
}
