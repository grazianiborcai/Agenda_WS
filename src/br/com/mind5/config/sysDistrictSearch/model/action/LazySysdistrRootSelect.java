...
import br.com.mind5.config.sysDistrictSearch.model.decisionTree.RootSysdistrSelect;
import br.com.mind5.model.action.ActionLazyTemplate;
import br.com.mind5.model.action.ActionStd;
import br.com.mind5.model.decisionTree.DeciResult;
import br.com.mind5.model.decisionTree.DeciTreeOption;

public final class LazySysdistrRootSelect extends ActionLazyTemplate<SysdistrInfo, SysdistrInfo> {

	public LazySysdistrRootSelect(Connection conn, String schemaName) {
	...
	@Override protected ActionStd<SysdistrInfo> getInstanceOfActionHook(DeciTreeOption<SysdistrInfo> option) {
		return new RootSysdistrSelect(option).toAction();
	}
