...
public final class PayrconfCheckEnabled extends ModelCheckerTemplateAction<PayrsocreInfo, PayrsocreInfo> {
	
	public PayrconfCheckEnabled(ModelCheckerOption option) {
