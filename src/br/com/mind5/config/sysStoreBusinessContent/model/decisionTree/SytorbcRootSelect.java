...
import br.com.mind5.config.sysStoreBusinessContent.model.action.SytorbcVisiDaoSelect;
...
public final class SytorbcRootSelect extends DeciTreeTemplateRead<SytorbcInfo> {
	
	public SytorbcRootSelect(DeciTreeOption<SytorbcInfo> option) {
		super(option);
	}
	...
	@Override protected List<ActionStd<SytorbcInfo>> buildActionsOnPassedHook(DeciTreeOption<SytorbcInfo> option) {
		...
		ActionStd<SytorbcInfo> select = new ActionStdCommom<SytorbcInfo>(option, SytorbcVisiDaoSelect.class);
